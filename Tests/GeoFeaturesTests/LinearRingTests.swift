...
/*
    ...
    gyb --line-directive '' -DGeometryType=LinearRing -o LinearRing.swift CoordinateCollectionTests.swift.gyb
...
class LinearRing_Coordinate2D_FloatingPrecision_Cartesian_Tests: XCTestCase {
    ...
    func testInit_CRS() {
        XCTAssertEqual(LinearRing<Coordinate2D>(precision: precision).coordinateReferenceSystem as? Cartesian, crs)
    }
...
class LinearRing_Coordinate2DM_FloatingPrecision_Cartesian_Tests: XCTestCase {
    ...
    func testInit_CRS() {
        XCTAssertEqual(LinearRing<Coordinate2DM>(precision: precision).coordinateReferenceSystem as? Cartesian, crs)
    }
...
class LinearRing_Coordinate3D_FloatingPrecision_Cartesian_Tests: XCTestCase {
    ...
    func testInit_CRS() {
        XCTAssertEqual(LinearRing<Coordinate3D>(precision: precision).coordinateReferenceSystem as? Cartesian, crs)
    }
...
class LinearRing_Coordinate3DM_FloatingPrecision_Cartesian_Tests: XCTestCase {
    ...
    func testInit_CRS() {
        XCTAssertEqual(LinearRing<Coordinate3DM>(precision: precision).coordinateReferenceSystem as? Cartesian, crs)
    }
