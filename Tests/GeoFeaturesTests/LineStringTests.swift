...
class LineString_Coordinate2D_FloatingPrecision_Cartesian_Tests: XCTestCase {
    ...
    func testInit_CRS() {
        XCTAssertEqual(LineString<Coordinate2D>(precision: precision).coordinateReferenceSystem as? Cartesian, crs)
    }
    ...
    func testInit_Copy() {
        let geometry = LineString<Coordinate2D>(other: LineString<Coordinate2D>(elements: [(x: 1.0, y: 1.0),(x: 2.0, y: 2.0)]), precision: precision, coordinateReferenceSystem: crs)
...
class LineString_Coordinate2DM_FloatingPrecision_Cartesian_Tests: XCTestCase {
    ...
    func testInit_CRS() {
        XCTAssertEqual(LineString<Coordinate2DM>(precision: precision).coordinateReferenceSystem as? Cartesian, crs)
    }
    ...
    func testInit_Copy() {
        let geometry = LineString<Coordinate2DM>(other: LineString<Coordinate2DM>(elements: [(x: 1.0, y: 1.0, m: 1.0),(x: 2.0, y: 2.0, m: 2.0)]), precision: precision, coordinateReferenceSystem: crs)
...
class LineString_Coordinate3D_FloatingPrecision_Cartesian_Tests: XCTestCase {
    ...
    func testInit_CRS() {
        XCTAssertEqual(LineString<Coordinate3D>(precision: precision).coordinateReferenceSystem as? Cartesian, crs)
    }
    ...
    func testInit_Copy() {
        let geometry = LineString<Coordinate3D>(other: LineString<Coordinate3D>(elements: [(x: 1.0, y: 1.0, z: 1.0),(x: 2.0, y: 2.0, z: 2.0)]), precision: precision, coordinateReferenceSystem: crs)
...
class LineString_Coordinate3DM_FloatingPrecision_Cartesian_Tests: XCTestCase {
    ...
    func testInit_CRS() {
        XCTAssertEqual(LineString<Coordinate3DM>(precision: precision).coordinateReferenceSystem as? Cartesian, crs)
    }
    ...
    func testInit_Copy() {
        let geometry = LineString<Coordinate3DM>(other: LineString<Coordinate3DM>(elements: [(x: 1.0, y: 1.0, z: 1.0, m: 1.0),(x: 2.0, y: 2.0, z: 2.0, m: 2.0)]), precision: precision, coordinateReferenceSystem: crs)
...
class LineString_Coordinate2D_FixedPrecision_Cartesian_Tests: XCTestCase {
    ...
    func testInit_Copy() {
        let geometry = LineString<Coordinate2D>(other: LineString<Coordinate2D>(elements: [(x: 1.001, y: 1.001),(x: 2.002, y: 2.002)]), precision: precision, coordinateReferenceSystem: crs)
        let expected = LineString<Coordinate2D>(elements: [(x: 1.0, y: 1.0),(x: 2.0, y: 2.0)], precision: precision, coordinateReferenceSystem: crs)
...
class LineString_Coordinate2DM_FixedPrecision_Cartesian_Tests: XCTestCase {
    ...
    func testInit_Copy() {
        let geometry = LineString<Coordinate2DM>(other: LineString<Coordinate2DM>(elements: [(x: 1.001, y: 1.001, m: 1.001),(x: 2.002, y: 2.002, m: 2.002)]), precision: precision, coordinateReferenceSystem: crs)
        let expected = LineString<Coordinate2DM>(elements: [(x: 1.0, y: 1.0, m: 1.0),(x: 2.0, y: 2.0, m: 2.0)], precision: precision, coordinateReferenceSystem: crs)
...
class LineString_Coordinate3D_FixedPrecision_Cartesian_Tests: XCTestCase {
    ...
    func testInit_Copy() {
        let geometry = LineString<Coordinate3D>(other: LineString<Coordinate3D>(elements: [(x: 1.001, y: 1.001, z: 1.001),(x: 2.002, y: 2.002, z: 2.002)]), precision: precision, coordinateReferenceSystem: crs)
        let expected = LineString<Coordinate3D>(elements: [(x: 1.0, y: 1.0, z: 1.0),(x: 2.0, y: 2.0, z: 2.0)], precision: precision, coordinateReferenceSystem: crs)
...
class LineString_Coordinate3DM_FixedPrecision_Cartesian_Tests: XCTestCase {
    ...
    func testInit_Copy() {
        let geometry = LineString<Coordinate3DM>(other: LineString<Coordinate3DM>(elements: [(x: 1.001, y: 1.001, z: 1.001, m: 1.001),(x: 2.002, y: 2.002, z: 2.002, m: 2.002)]), precision: precision, coordinateReferenceSystem: crs)
        let expected = LineString<Coordinate3DM>(elements: [(x: 1.0, y: 1.0, z: 1.0, m: 1.0),(x: 2.0, y: 2.0, z: 2.0, m: 2.0)], precision: precision, coordinateReferenceSystem: crs)
