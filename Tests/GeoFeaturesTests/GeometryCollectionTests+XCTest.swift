...
extension GeometryCollection_Coordinate2D_FloatingPrecision_Cartesian_Tests {

   static var allTests: [(String, (GeometryCollection_Coordinate2D_FloatingPrecision_Cartesian_Tests) -> () throws -> Void)] {
      return [
