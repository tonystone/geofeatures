...
extension LinearRing_Curve_Coordinate2D_FloatingPrecision_Cartesian_Tests {

   static var allTests: [(String, (LinearRing_Curve_Coordinate2D_FloatingPrecision_Cartesian_Tests) -> () throws -> Void)] {
      return [
...
extension LinearRing_Curve_Coordinate3D_FloatingPrecision_Cartesian_Tests {
