...
extension MultiPoint: Collection {
    ...
    public mutating func insert(_ newElement: Element, at index: Int) {
        guard (index >= 0) && (index < buffer.header.count) else { preconditionFailure("Index out of range, can't insert Point.") }
    ...
    public mutating func remove(at index: Int) -> Element {
        guard (index >= 0) && (index < buffer.header.count) else { preconditionFailure("Index out of range, can't remove Point.") }
    ...
    public mutating func removeLast() -> Element {
        guard buffer.header.count > 0 else { preconditionFailure("can't removeLast from an empty MultiPoint.") }
