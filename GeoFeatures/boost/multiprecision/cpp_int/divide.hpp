      ...
      signed_limb_type& b)
{
   cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1> r;
   bool s = a.sign() != (b < 0);
   divide_unsigned_helper(&result, a, static_cast<limb_type>(geofeatures_boost::multiprecision::detail::unsigned_abs(b)), r);
   result.sign(s);
}
...
{
   bool s = a.sign();
   divide_unsigned_helper(static_cast<cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>* >(0), a, static_cast<limb_type>(geofeatures_boost::multiprecision::detail::unsigned_abs(b)), result);
   result.sign(s);
}
