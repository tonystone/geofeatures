...
class basic_managed_memory_impl
{
   ...
   //!memory is available throws a geofeatures_boost::interprocess::bad_alloc exception
   ...
   //!
   //!-> Throws geofeatures_boost::interprocess::bad_alloc if there is no available memory
   //!
