...
//! Atomically increment an geofeatures_boost::uint32_t by 1
//! "mem": pointer to the object
//! Returns the old value pointed to by mem
inline geofeatures_boost::uint32_t atomic_inc32(volatile geofeatures_boost::uint32_t *mem);

//! Atomically read an geofeatures_boost::uint32_t from memory
inline geofeatures_boost::uint32_t atomic_read32(volatile geofeatures_boost::uint32_t *mem);

//! Atomically set an geofeatures_boost::uint32_t in memory
//! "mem": pointer to the object
//! "param": val value that the object will assume
inline void atomic_write32(volatile geofeatures_boost::uint32_t *mem, geofeatures_boost::uint32_t val);

//! Compare an geofeatures_boost::uint32_t's value with "cmp".
//! If they are the same swap the value with "with"
//! "mem": pointer to the value
//! "with": what to swap it with
//! "cmp": the value to compare it to
//! Returns the old value of *mem
inline geofeatures_boost::uint32_t atomic_cas32
   (volatile geofeatures_boost::uint32_t *mem, geofeatures_boost::uint32_t with, geofeatures_boost::uint32_t cmp);
...
//! Atomically decrement an geofeatures_boost::uint32_t by 1
//! "mem": pointer to the atomic value
//! Returns the old value pointed to by mem
inline geofeatures_boost::uint32_t atomic_dec32(volatile geofeatures_boost::uint32_t *mem)
...
inline geofeatures_boost::uint32_t atomic_read32(volatile geofeatures_boost::uint32_t *mem)
{
    const geofeatures_boost::uint32_t val = *mem;
...
inline geofeatures_boost::uint32_t atomic_cas32
   (volatile geofeatures_boost::uint32_t *mem, geofeatures_boost::uint32_t with, geofeatures_boost::uint32_t cmp)
{
   geofeatures_boost::uint32_t prev = cmp;
...
//! Atomically add 'val' to an geofeatures_boost::uint32_t
//! "mem": pointer to the object
//! "val": amount to add
//! Returns the old value pointed to by mem
inline geofeatures_boost::uint32_t atomic_add32
   (volatile geofeatures_boost::uint32_t *mem, geofeatures_boost::uint32_t val)
{
   // int r = *pw;
   // *mem += val;
   // return r;
...
//! Returns the old value pointed to by mem
inline geofeatures_boost::uint32_t atomic_dec32(volatile geofeatures_boost::uint32_t *mem)
{  return atomic_add32(mem, (geofeatures_boost::uint32_t)-1);  }
...
//! "val": amount to add
//! Returns the old value pointed to by mem
inline geofeatures_boost::uint32_t atomic_add32(volatile geofeatures_boost::uint32_t *mem, geofeatures_boost::uint32_t val)
{
   geofeatures_boost::uint32_t prev, temp;
...
inline geofeatures_boost::uint32_t atomic_cas32
   (volatile geofeatures_boost::uint32_t *mem, geofeatures_boost::uint32_t with, geofeatures_boost::uint32_t cmp)
{
   geofeatures_boost::uint32_t prev;
...
//! Returns the old value pointed to by mem
inline geofeatures_boost::uint32_t atomic_dec32(volatile geofeatures_boost::uint32_t *mem)
{  return atomic_add32(mem, geofeatures_boost::uint32_t(-1u));  }
...
//! Returns the old value pointed to by mem
inline geofeatures_boost::uint32_t atomic_dec32(volatile geofeatures_boost::uint32_t *mem)
{  return atomic_add_32_nv(reinterpret_cast<volatile ::uint32_t*>(mem), (geofeatures_boost::uint32_t)-1) + 1; }
...
inline geofeatures_boost::uint32_t atomic_dec32(volatile geofeatures_boost::uint32_t *mem)
{  geofeatures_boost::uint32_t old_val = __ATOMIC_DECREMENT_LONG(mem); __MB(); return old_val; }
...
inline geofeatures_boost::uint32_t atomic_read32(volatile geofeatures_boost::uint32_t *mem)
{  geofeatures_boost::uint32_t old_val = *mem; __MB(); return old_val;  }
...
//first define geofeatures_boost::uint32_t versions of __lwarx and __stwcx to avoid poluting
...
inline geofeatures_boost::uint32_t lwarxu(volatile geofeatures_boost::uint32_t *mem)
{
   return static_cast<geofeatures_boost::uint32_t>(__lwarx(reinterpret_cast<volatile int*>(mem)));
}
...
//!unsuccessful
inline bool stwcxu(volatile geofeatures_boost::uint32_t* mem, geofeatures_boost::uint32_t val)
{
...
inline geofeatures_boost::uint32_t atomic_add32
   (volatile geofeatures_boost::uint32_t *mem, geofeatures_boost::uint32_t val)
{
   geofeatures_boost::uint32_t oldValue;
   do
   {
      oldValue = lwarxu(mem);
...
{
   geofeatures_boost::uint32_t oldValue;
   geofeatures_boost::uint32_t valueToStore;
   do
   {
      oldValue = lwarxu(mem);
...
inline geofeatures_boost::uint32_t atomic_add32
   (volatile geofeatures_boost::uint32_t *mem, geofeatures_boost::uint32_t val)
{  return __sync_fetch_and_add(const_cast<geofeatures_boost::uint32_t *>(mem), val);   }
...
//! Atomically read an geofeatures_boost::uint32_t from memory
inline geofeatures_boost::uint32_t atomic_read32(volatile geofeatures_boost::uint32_t *mem)
{  geofeatures_boost::uint32_t old_val = *mem; __sync_synchronize(); return old_val;  }
...
inline geofeatures_boost::uint32_t atomic_cas32
   (volatile geofeatures_boost::uint32_t *mem, geofeatures_boost::uint32_t with, geofeatures_boost::uint32_t cmp)
{  return __sync_val_compare_and_swap(const_cast<geofeatures_boost::uint32_t *>(mem), cmp, with);   }
...
inline bool atomic_add_unless32
   (volatile geofeatures_boost::uint32_t *mem, geofeatures_boost::uint32_t value, geofeatures_boost::uint32_t unless_this)
{
   geofeatures_boost::uint32_t old, c(atomic_read32(mem));
