...
class basic_multiallocation_chain
   : public geofeatures_boost::container::container_detail::
      basic_multiallocation_chain<VoidPointer>
{
   ...
   basic_multiallocation_chain(BOOST_RV_REF(basic_multiallocation_chain) other)
      :  base_t(::geofeatures_boost::move(static_cast<base_t&>(other)))
   {}

   basic_multiallocation_chain& operator=(BOOST_RV_REF(basic_multiallocation_chain) other)
   {
      this->base_t::operator=(::geofeatures_boost::move(static_cast<base_t&>(other)));
      return *this;
   }

   void *pop_front()
   {
      return geofeatures_boost::interprocess::ipcdetail::to_raw_pointer(this->base_t::pop_front());
   }
};
      ...
      (MemoryAlgorithm *memory_algo, size_type nbytes, size_type alignment)
   {
      ...
      if(alignment <= Alignment){
         ...
         return memory_algo->priv_allocate
            (geofeatures_boost::interprocess::allocate_new, nbytes, real_size, ignore_reuse);
      }
      ...
      real_size = request;
      void *ignore_reuse = 0;
      void *buffer = memory_algo->priv_allocate(geofeatures_boost::interprocess::allocate_new, request, real_size, ignore_reuse);
      if(!buffer){
         return 0;
      }
      ...
      if(total_request_units && !multiplication_overflows(total_request_units, Alignment)){
         ...
         while(low_idx < n_elements){
            ...
            void *ret = memory_algo->priv_allocate
               (geofeatures_boost::interprocess::allocate_new, min_allocation, received_size, ignore_reuse);
            if(!ret){
               break;
            }
