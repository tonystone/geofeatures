...
class rbtree_best_fit
{
   ...
   typedef typename geofeatures_boost::intrusive::pointer_traits<char_ptr>::difference_type difference_type;
   typedef typename geofeatures_boost::container::container_detail::make_unsigned<difference_type>::type     size_type;
   ...
   {
      //-----------------------
      geofeatures_boost::interprocess::scoped_lock<mutex_type> guard(m_header);
      //-----------------------
   ...
   template<class T>
   T * allocation_command  (geofeatures_boost::interprocess::allocation_type command, size_type limit_size,
                           size_type &prefer_in_recvd_out_size, T *&reuse);

   void * raw_allocation_command (geofeatures_boost::interprocess::allocation_type command,   size_type limit_object,
   ...
   void* priv_allocation_command(geofeatures_boost::interprocess::allocation_type command,   size_type limit_size,
                        size_type &prefer_in_recvd_out_size, void *&reuse_ptr, size_type sizeof_object);


   //!Real allocation algorithm with min allocation option
   void * priv_allocate( geofeatures_boost::interprocess::allocation_type command
   ...
   void* priv_expand_both_sides(geofeatures_boost::interprocess::allocation_type command
                               ,size_type min_size
                               ,size_type &prefer_in_recvd_out_size
                               ,void *reuse_ptr
   ...
   static const size_type Alignment = !MemAlignment
      ? size_type(::geofeatures_boost::container::container_detail::alignment_of
                  < ::geofeatures_boost::container::container_detail::max_align_t>::value)
   ...
   BOOST_STATIC_ASSERT((Alignment >= ::geofeatures_boost::container::container_detail::alignment_of<void_pointer>::value));
...
void rbtree_best_fit<MutexFamily, VoidPointer, MemAlignment>::shrink_to_fit()
{
   ...
   if(priv_next_block(first_block) == old_end_block){
      ...
      void *ignore_reuse = 0;
      unique_buffer = priv_allocate(geofeatures_boost::interprocess::allocate_new, 0, ignore_recvd, ignore_reuse);
   ...
   allocate(size_type nbytes)
{
   ...
   void *ignore_reuse = 0;
   return priv_allocate(geofeatures_boost::interprocess::allocate_new, nbytes, ignore_recvd, ignore_reuse);
}
...
inline T* rbtree_best_fit<MutexFamily, VoidPointer, MemAlignment>::
   allocation_command  (geofeatures_boost::interprocess::allocation_type command,   size_type limit_size,
                        size_type &prefer_in_recvd_out_size, T *&reuse)
{
   ...
   BOOST_ASSERT(0 == ((std::size_t)ret % ::geofeatures_boost::container::container_detail::alignment_of<T>::value));
   return static_cast<T*>(ret);
}

template<class MutexFamily, class VoidPointer, std::size_t MemAlignment>
inline void* rbtree_best_fit<MutexFamily, VoidPointer, MemAlignment>::
   raw_allocation_command  (geofeatures_boost::interprocess::allocation_type command,   size_type limit_objects,
                        size_type &prefer_in_recvd_out_objects, void *&reuse_ptr, size_type sizeof_object)
{
   ...
   if(command & geofeatures_boost::interprocess::try_shrink_in_place){
...
template<class MutexFamily, class VoidPointer, std::size_t MemAlignment>
inline void* rbtree_best_fit<MutexFamily, VoidPointer, MemAlignment>::
   priv_allocation_command (geofeatures_boost::interprocess::allocation_type command,   size_type limit_size,
                       size_type &prefer_in_recvd_out_size,
...
template<class MutexFamily, class VoidPointer, std::size_t MemAlignment>
void* rbtree_best_fit<MutexFamily, VoidPointer, MemAlignment>::
   priv_expand_both_sides(geofeatures_boost::interprocess::allocation_type command
                         ,size_type min_size
                         ,size_type &prefer_in_recvd_out_size
                         ,void *reuse_ptr
                         ,bool only_preferred_backwards
                         ,size_type backwards_multiple)
{
   ...
   if(command & geofeatures_boost::interprocess::expand_fwd){
   ...
   if(command & geofeatures_boost::interprocess::expand_bwd){
      //Obtain the real size of the block
...
template<class MutexFamily, class VoidPointer, std::size_t MemAlignment>
void * rbtree_best_fit<MutexFamily, VoidPointer, MemAlignment>::
   priv_allocate(geofeatures_boost::interprocess::allocation_type command
...
{
   size_type const preferred_size = prefer_in_recvd_out_size;
   if(command & geofeatures_boost::interprocess::shrink_in_place){
      if(!reuse_ptr)  return static_cast<void*>(0);
      bool success =
   ...
   if(reuse_ptr && (command & (geofeatures_boost::interprocess::expand_fwd | geofeatures_boost::interprocess::expand_bwd))){
   ...
   if(command & geofeatures_boost::interprocess::allocate_new){
