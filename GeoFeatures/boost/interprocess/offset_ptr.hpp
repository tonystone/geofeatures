...
namespace ipcdetail {
   ...
   union offset_ptr_internal
   {
      ...
      typename ::geofeatures_boost::container::container_detail::aligned_storage
         < sizeof(OffsetType)
         , (OffsetAlignment == offset_type_alignment) ?
            ::geofeatures_boost::container::container_detail::alignment_of<OffsetType>::value : OffsetAlignment
...
inline geofeatures_boost::interprocess::offset_ptr<T1, P1, O1, A1>
   static_pointer_cast(const geofeatures_boost::interprocess::offset_ptr<T2, P2, O2, A2> & r)
{
   return geofeatures_boost::interprocess::offset_ptr<T1, P1, O1, A1>
            (r, geofeatures_boost::interprocess::ipcdetail::static_cast_tag());
}

//!Simulation of const_cast between pointers. Never throws.
template<class T1, class P1, class O1, std::size_t A1, class T2, class P2, class O2, std::size_t A2>
inline geofeatures_boost::interprocess::offset_ptr<T1, P1, O1, A1>
   const_pointer_cast(const geofeatures_boost::interprocess::offset_ptr<T2, P2, O2, A2> & r)
{
   return geofeatures_boost::interprocess::offset_ptr<T1, P1, O1, A1>
            (r, geofeatures_boost::interprocess::ipcdetail::const_cast_tag());
}

//!Simulation of dynamic_cast between pointers. Never throws.
template<class T1, class P1, class O1, std::size_t A1, class T2, class P2, class O2, std::size_t A2>
inline geofeatures_boost::interprocess::offset_ptr<T1, P1, O1, A1>
   dynamic_pointer_cast(const geofeatures_boost::interprocess::offset_ptr<T2, P2, O2, A2> & r)
{
   return geofeatures_boost::interprocess::offset_ptr<T1, P1, O1, A1>
            (r, geofeatures_boost::interprocess::ipcdetail::dynamic_cast_tag());
}

//!Simulation of reinterpret_cast between pointers. Never throws.
template<class T1, class P1, class O1, std::size_t A1, class T2, class P2, class O2, std::size_t A2>
inline geofeatures_boost::interprocess::offset_ptr<T1, P1, O1, A1>
   reinterpret_pointer_cast(const geofeatures_boost::interprocess::offset_ptr<T2, P2, O2, A2> & r)
{
   return geofeatures_boost::interprocess::offset_ptr<T1, P1, O1, A1>
            (r, geofeatures_boost::interprocess::ipcdetail::reinterpret_cast_tag());
}
...
struct has_trivial_destructor< ::geofeatures_boost::interprocess::offset_ptr<T, P, O, A> >
{
...
///has_trivial_destructor<> == true_type specialization for optimizations
template <class T, class P, class O, std::size_t A>
struct is_trivially_destructible< ::geofeatures_boost::interprocess::offset_ptr<T, P, O, A> >
{
   static const bool value = true;
};
...
//!to_raw_pointer() enables geofeatures_boost::mem_fn to recognize offset_ptr.
//!Never throws.
template <class T, class P, class O, std::size_t A>
inline T * to_raw_pointer(geofeatures_boost::interprocess::offset_ptr<T, P, O, A> const & p)
...
struct max_pointer_plus_bits<geofeatures_boost::interprocess::offset_ptr<void, P, O, A>, OffsetAlignment>
{
   //The offset ptr can embed one bit less than the alignment since it
   //uses offset == 1 to store the null pointer.
   static const std::size_t value = ::geofeatures_boost::interprocess::ipcdetail::ls_zeros<OffsetAlignment>::value - 1;
};
...
struct pointer_plus_bits<geofeatures_boost::interprocess::offset_ptr<T, P, O, A>, NumBits>
{
   typedef geofeatures_boost::interprocess::offset_ptr<T, P, O, A>      pointer;
   typedef ::geofeatures_boost::interprocess::pointer_size_t_caster<T*> caster_t;
...
struct pointer_to_other
   < ::geofeatures_boost::interprocess::offset_ptr<PointedType, DifferenceType, OffsetType, OffsetAlignment>, U >
{
   typedef ::geofeatures_boost::interprocess::offset_ptr<U, DifferenceType, OffsetType, OffsetAlignment> type;
};
