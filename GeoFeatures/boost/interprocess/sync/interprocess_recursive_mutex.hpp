...
inline void interprocess_recursive_mutex::lock()
{
      ...
      geofeatures_boost::posix_time::ptime wait_time
         = geofeatures_boost::posix_time::microsec_clock::universal_time()
         + geofeatures_boost::posix_time::milliseconds(BOOST_INTERPROCESS_TIMEOUT_WHEN_LOCKING_DURATION_MS);
...
inline bool interprocess_recursive_mutex::timed_lock(const geofeatures_boost::posix_time::ptime &abs_time)
