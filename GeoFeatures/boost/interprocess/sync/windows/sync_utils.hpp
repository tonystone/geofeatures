...
class sync_id
{
   ...
   {  return geofeatures_boost::hash_value(m.rand_);  }
...
class sync_handles
{
   ...
   typedef geofeatures_boost::unordered_map<sync_id, void*> umap_type;
   typedef geofeatures_boost::container::map<const sync_id*, umap_type::iterator, address_less> map_type;
