...
class shared_memory_object
{
   ...
   {
      shared_memory_object tmp(geofeatures_boost::move(moved));
      this->swap(tmp);
      return *this;
   }
...
{
   geofeatures_boost::adl_move_swap(m_handle, other.m_handle);
   geofeatures_boost::adl_move_swap(m_mode,   other.m_mode);
