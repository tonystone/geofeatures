...
#include <boost/utility/addressof.hpp> //geofeatures_boost::addressof
#include <boost/assert.hpp>   //BOOST_ASSERT
#include <boost/interprocess/exceptions.hpp> //bad_alloc
#include <boost/interprocess/sync/scoped_lock.hpp> //scoped_lock
#include <boost/interprocess/containers/allocation_type.hpp> //geofeatures_boost::interprocess::allocation_type
...
struct get_or_create_node_pool_func
{
   ...
   //!Can throw geofeatures_boost::interprocess::bad_alloc
   void operator()()
   {
      //Find or create the node_pool_t
      mp_node_pool =    mp_segment_manager->template find_or_construct
                        <NodePool>(geofeatures_boost::interprocess::unique_instance)(mp_segment_manager);
...
struct destroy_if_last_link_func
{
   ...
   void operator()()
   {
      ...
      mp_node_pool->get_segment_manager()->template destroy<NodePool>(geofeatures_boost::interprocess::unique_instance);
   }
...
class cache_impl
{
   ...
   {
      ::geofeatures_boost::adl_move_swap(mp_node_pool, other.mp_node_pool);
      ::geofeatures_boost::adl_move_swap(m_cached_nodes, other.m_cached_nodes);
      ::geofeatures_boost::adl_move_swap(m_max_cached_nodes, other.m_max_cached_nodes);
   }
};
...
class array_allocation_impl
{
   ...
   typedef geofeatures_boost::container::container_detail::transform_multiallocation_chain
   ...
   pointer allocation_command(geofeatures_boost::interprocess::allocation_type command,
   ...
   {  return pointer(geofeatures_boost::addressof(value));  }

   //!Returns address of non mutable object.
   //!Never throws
   const_pointer address(const_reference value) const
   {  return const_pointer(geofeatures_boost::addressof(value));  }
   ...
   {  ::new((void*)ipcdetail::to_raw_pointer(ptr), boost_container_new_t()) value_type(::geofeatures_boost::forward<P>(p));  }
      ...
      , SegmentManager>
{
   ...
   //!Throws geofeatures_boost::interprocess::bad_alloc if there is no enough memory
         ...
         <cached_allocator_impl<T, NodePool, Version>, T, typename NodePool::segment_manager>
{
   ...
   {  ::geofeatures_boost::adl_move_swap(alloc1.m_cache, alloc2.m_cache);   }
   ...
   : public private_node_allocator_t
{
 ...
 public:
   ...
   //!Allocates array of count elements. Can throw geofeatures_boost::interprocess::bad_alloc
   void *allocate_node()
   {
      //-----------------------
