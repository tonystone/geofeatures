...
class allocator
{
   ...
   typedef geofeatures_boost::interprocess::version_type<allocator, 2>   version;
   ...
   {  geofeatures_boost::adl_move_swap(alloc1.mp_mngr, alloc2.mp_mngr);   }
...
template<class T, class SegmentManager>
struct has_trivial_destructor
   <geofeatures_boost::interprocess::allocator <T, SegmentManager> >
{
