...
#if defined(BOOST_HAS_THREADS)
  geofeatures_boost::detail::lightweight_mutex mutex;
#endif
};
...
void safe_iterator_base::attach(safe_container_base* cont_)
{
  ...
  if(cont){
#if defined(BOOST_HAS_THREADS)
    geofeatures_boost::detail::lightweight_mutex::scoped_lock lock(cont->mutex);
#endif
...
private:
  friend class geofeatures_boost::multi_index::detail::iter_adaptor_access;
...
template<typename Iterator,typename Container>
struct version<
  geofeatures_boost::multi_index::safe_mode::safe_iterator<Iterator,Container>
>
{
  BOOST_STATIC_CONSTANT(
    int,value=geofeatures_boost::serialization::version<Iterator>::value);
};
} /* namespace serialization */
#endif
