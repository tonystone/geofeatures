...
protected:
  ...
  final_node_type* insert_(const value_type& v,final_node_type*& x,lvalue_tag)
  {
    ...
    BOOST_TRY{
      geofeatures_boost::detail::allocator::construct(&x->value(),v);
    }
    BOOST_CATCH(...){
  ...
  final_node_type* insert_(const value_type& v,final_node_type*& x,rvalue_tag)
  {
    ...
    BOOST_TRY{
       ...
       * geofeatures_boost::detail::allocator::construct, but 
      ...
      new (&x->value()) value_type(geofeatures_boost::move(const_cast<value_type&>(v)));
    }
    BOOST_CATCH(...){
      final().deallocate_node(x);
      BOOST_RETHROW;
  ...
  {
    x->value()=geofeatures_boost::move(const_cast<value_type&>(v));
    return true;
  }
