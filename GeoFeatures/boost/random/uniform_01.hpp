 ...
 * (to-be-invented) @c geofeatures_boost::bigfloat class with random bits efficiently.
...
{
  typedef geofeatures_boost::random::detail::ptr_helper<UniformRandomNumberGenerator> traits;
public:
