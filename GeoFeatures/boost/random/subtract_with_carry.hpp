...
struct subtract_with_carry_discard
{
    ...
    static void apply(Engine& eng, geofeatures_boost::uintmax_t z)
    {
...
public:
                                        ...
                                        IntType, value)
    {
        ...
        gen_t intgen(static_cast<geofeatures_boost::uint32_t>(value == 0 ? default_seed : value));
    ...
    { return geofeatures_boost::low_bits_mask_t<w>::sig_bits; }
...
public:
    ...
    BOOST_STATIC_CONSTANT(std::size_t, long_lag = r);
    BOOST_STATIC_CONSTANT(std::size_t, short_lag = s);
    BOOST_STATIC_CONSTANT(geofeatures_boost::uint32_t, default_seed = 19780503u);
    ...
    BOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(subtract_with_carry_01_engine,
                                               geofeatures_boost::uint32_t, value)
...
class subtract_with_carry :
    public subtract_with_carry_engine<IntType,
        geofeatures_boost::static_log2<m>::value, s, r>
{
    typedef subtract_with_carry_engine<IntType,
        geofeatures_boost::static_log2<m>::value, s, r> base_type;
public:
    subtract_with_carry() {}
