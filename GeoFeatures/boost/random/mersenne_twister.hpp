...
private:
     ...
     */
    void discard_many(geofeatures_boost::uintmax_t z)
    {
...
BOOST_RANDOM_PTR_HELPER_SPEC(geofeatures_boost::mt11213b)
BOOST_RANDOM_PTR_HELPER_SPEC(geofeatures_boost::mt19937)
BOOST_RANDOM_PTR_HELPER_SPEC(geofeatures_boost::mt19937_64)
