...
public:
    ...
    public:
        ...
        param_type(const IntervalRange& intervals_arg,
          ...
          : _intervals(geofeatures_boost::begin(intervals_arg), geofeatures_boost::end(intervals_arg)),
            _weights(geofeatures_boost::begin(weights_arg), geofeatures_boost::end(weights_arg))
        {
            if(_intervals.size() < 2) {
                _weights.clear();
                _weights.push_back(RealType(1));
