...
T generate_uniform_int(
    ...
    geofeatures_boost::mpl::true_ /** is_integral<Engine::result_type> */)
{
...
inline T generate_uniform_int(
    Engine& eng, T min_value, T max_value,
    geofeatures_boost::mpl::false_ /** is_integral<Engine::result_type> */)
{
    uniform_int_float<Engine> wrapper(eng);
    return generate_uniform_int(wrapper, min_value, max_value, geofeatures_boost::mpl::true_());
}
