...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace graph { namespace distributed { namespace detail {
...
} } } } // end namespace geofeatures_boost::graph::distributed::detail
