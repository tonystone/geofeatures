...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace graph { namespace detail {

template<typename ProcessGroup>
void do_synchronize(ProcessGroup& pg)
{ 
  using geofeatures_boost::parallel::synchronize;
  synchronize(pg);
}
  ...
  BOOST_STATIC_CONSTANT
    (bool, 
     queued = (is_convertible<
                 ...
                 geofeatures_boost::parallel::bsp_process_group_tag>::value));
...
} } } // end namespace geofeatures_boost::graph::detail
