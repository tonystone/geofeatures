...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace graph { namespace distributed {
...
namespace detail {
  ...
  class crauser_et_al_dijkstra_queue
    : public graph::detail::remote_update_set<
               ...
               typename geofeatures_boost::graph::parallel::process_group_type<Graph>::type,
               ...
               typename property_map<Graph, vertex_owner_t>::const_type>
  {
    ...
    typedef typename property_map<Graph, vertex_owner_t>::const_type
      OwnerPropertyMap;
    typedef typename geofeatures_boost::graph::parallel::process_group_type<Graph>::type
      process_group_type;
  ...
  public:
    ...
    crauser_et_al_dijkstra_queue(const Graph& g,
      ...
      : inherited(geofeatures_boost::graph::parallel::process_group(g), get(vertex_owner, g)),
    ...
    bool do_synchronize()
    {
      using geofeatures_boost::parallel::all_reduce;
      using geofeatures_boost::parallel::minimum;
                            ...
                            directed_tag, incidence_graph_tag)
  {
    ...
    using geofeatures_boost::graph::parallel::process_group;
   ...
   DijkstraVisitor vis)
{
  ...
  ::geofeatures_boost::detail::dijkstra_bfs_visitor<
      DijkstraVisitor, Queue, WeightMap,
      geofeatures_boost::parallel::caching_property_map<PredecessorMap>,
      geofeatures_boost::parallel::caching_property_map<DistanceMap>, Combine, Compare
    > bfs_vis(vis, Q, weight,
              geofeatures_boost::parallel::make_caching_property_map(predecessor),
              geofeatures_boost::parallel::make_caching_property_map(distance),
...
} } // end namespace geofeatures_boost::graph
