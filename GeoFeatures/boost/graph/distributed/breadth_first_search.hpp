  ...
  namespace detail {
    ...
    void parallel_bfs_helper
      (DistributedGraph& g,
       ...
       ColorMap color,
       BFSVisitor vis,
       geofeatures_boost::param_not_found,
       VertexIndexMap vertex_index)
    {
      ...
      typedef typename geofeatures_boost::graph::parallel::process_group_type<DistributedGraph>::type 
        process_group_type;
      ...
      typedef geofeatures_boost::graph::distributed::distributed_queue<
