...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost {
  ...
  namespace detail {
    ...
    {
      geofeatures_boost::graph_detail::erase_if(el, detail::target_is<vertex_descriptor>(v));
    }
    // O(log(E/V))
    template <class EdgeList, class vertex_descriptor>
    void erase_from_incidence_list(EdgeList& el, vertex_descriptor v,
    ...
    template <class Vertex>
    class stored_edge
      : public geofeatures_boost::equality_comparable1< stored_edge<Vertex>,
        geofeatures_boost::less_than_comparable1< stored_edge<Vertex> > >
    {
    public:
      ...
      const detail::stored_ra_edge_iter<Vertex, EdgeVec, Property>& e)
  {
    ...
    namespace detail {
      ...
      remove_directed_edge_if_dispatch(incidence_iterator first,
                                       ...
                                       geofeatures_boost::allow_parallel_edge_tag)
      {
        // remove_if
      ...
      remove_directed_edge_if_dispatch(incidence_iterator first,
                                       ...
                                       EdgeList& el,
                                       Predicate pred,
                                       geofeatures_boost::disallow_parallel_edge_tag)
      {
                       ...
                       directed_graph_helper<Config>& g_)
    {
      ...
      geofeatures_boost::tie(first, last) = out_edges(u, g);
    ...
    remove_edge_if(Predicate pred, directed_graph_helper<Config>& g_)
    {
      ...
      for (geofeatures_boost::tie(vi, vi_end) = vertices(g); vi != vi_end; ++vi)
                 ...
                 directed_graph_helper<Config>& g_)
    {
      ...
      for (geofeatures_boost::tie(vi, viend) = vertices(g); vi != viend; ++vi)
             ...
             directed_graph_helper<Config>& g_)
    {
      ...
      bool inserted;
      geofeatures_boost::tie(i, inserted) = geofeatures_boost::graph_detail::push(g.out_edge_list(u),
                                            StoredEdge(v, p));
    ...
    namespace detail {
      ...
      remove_edge_and_property(Graph& g, EdgeList& el, Vertex v,
                               geofeatures_boost::allow_parallel_edge_tag cat)
      {
        typedef typename Graph::global_edgelist_selector EdgeListS;
        BOOST_STATIC_ASSERT((!is_same<EdgeListS, vecS>::value));
        ...
        for (; i != end; ++i) {
          if ((*i).get_target() == v) {
            ...
            bool skip = (geofeatures_boost::next(i) != end && i->get_iter() == geofeatures_boost::next(i)->get_iter());
    ...
    struct list_edge // short name due to VC++ truncation and linker problems
      : public geofeatures_boost::detail::edge_base<geofeatures_boost::undirected_tag, Vertex>
    {
      typedef EdgeProperty property_type;
      typedef geofeatures_boost::detail::edge_base<geofeatures_boost::undirected_tag, Vertex> Base;
    ...
    remove_edge_if(Predicate pred, undirected_graph_helper<Config>& g_)
    {
      ...
      geofeatures_boost::tie(ei, ei_end) = edges(g);
                 ...
                 undirected_graph_helper<Config>& g_)
    {
      ...
      while (true) {
        ...
        geofeatures_boost::tie(ei, ei_end) = out_edges(u, g);
        if (ei == ei_end) break;
        remove_edge(*ei, g);
      }
    }
             ...
             undirected_graph_helper<Config>& g_)
    {
      ...
      if (inserted) {
        geofeatures_boost::graph_detail::push(g.out_edge_list(v), StoredEdge(u, p_iter, &g.m_edges));
                       ...
                       bidirectional_graph_helper_with_property<Config>& g_)
    {
      ...
      for (geofeatures_boost::tie(out_i, out_end) = out_edges(u, g); out_i != out_end; ++out_i)
        if (pred(*out_i)) {
          detail::remove_directed_edge_dispatch
                      ...
                      bidirectional_graph_helper_with_property<Config>& g_)
    {
      ...
      for (geofeatures_boost::tie(in_i, in_end) = in_edges(v, g); in_i != in_end; ++in_i)
        if (pred(*in_i)) {
      ...
      geofeatures_boost::tie(first, last) = in_edges(v, g);
      typedef typename Config::edge_parallel_category Cat;
      detail::remove_directed_edge_if_dispatch
             ...
             bidirectional_graph_helper_with_property<Config>& g_)
    {
      ...
      geofeatures_boost::tie(i, inserted) = geofeatures_boost::graph_detail::push(g.out_edge_list(u),
                                        StoredEdge(v, p_iter, &g.m_edges));
      if (inserted) {
        geofeatures_boost::graph_detail::push(in_edge_list(g, v), StoredEdge(u, p_iter, &g.m_edges));
                          ...
                          const adj_list_helper<Config, Base>& g_)
    {
      ...
      typedef typename Config::inv_adjacency_iterator inv_adjacency_iterator;
      typename Config::in_edge_iterator first, last;
      geofeatures_boost::tie(first, last) = in_edges(u, g);
               ...
               const adj_list_helper<Config, Base>& g_)
    {
      ...
      geofeatures_boost::tie(first, last) = graph_detail::
    ...
    namespace detail {
      ...
      inline
      typename geofeatures_boost::property_map<typename Config::graph_type,
        Property>::type
      get_dispatch(adj_list_helper<Config,Base>&, Property p,
                   geofeatures_boost::edge_property_tag) {
        typedef typename Config::graph_type Graph;
        typedef typename geofeatures_boost::property_map<Graph, Property>::type PA;
        return PA(p);
      }
      template <class Config, class Base, class Property>
      inline
      ...
      get_dispatch(const adj_list_helper<Config,Base>&, Property p,
                   geofeatures_boost::edge_property_tag) {
        typedef typename Config::graph_type Graph;
        typedef typename geofeatures_boost::property_map<Graph, Property>::const_type PA;
        return PA(p);
      }
      ...
      get_dispatch(adj_list_helper<Config,Base>& g, Property p,
                   geofeatures_boost::vertex_property_tag) {
        typedef typename Config::graph_type Graph;
        typedef typename geofeatures_boost::property_map<Graph, Property>::type PA;
    ...
    template <class Config, class Base, class Property>
    inline
    typename geofeatures_boost::property_map<typename Config::graph_type, Property>::type
    ...
    inline
    typename geofeatures_boost::property_traits<
      typename geofeatures_boost::property_map<typename Config::graph_type,
        Property>::type
    >::reference
    ...
    {
      typedef typename Config::graph_type Graph;
      typedef typename geofeatures_boost::property_map<Graph, Property>::type Map;
    ...
    public:
      ...
      inline void copy_impl(const adj_list_impl& x_)
      {
        ...
        for (geofeatures_boost::tie(vi, vi_end) = vertices(x); vi != vi_end; ++vi) {
        ...
        for (geofeatures_boost::tie(ei, ei_end) = edges(x); ei != ei_end; ++ei) {
          edge_descriptor e;
          bool inserted;
          vertex_descriptor s = source(*ei,x), t = target(*ei,x);
          geofeatures_boost::tie(e, inserted) = add_edge(vertex_map[(stored_vertex*)s],
    ...
    add_vertex(adj_list_impl<Derived, Config, Base>& g_)
    {
      ...
      bool inserted;
      geofeatures_boost::tie(pos,inserted) = geofeatures_boost::graph_detail::push(g.m_vertices, v);
      v->m_position = pos;
      g.added_vertex(v);
      return v;
    }
                              ...
                              adj_list_impl<Derived, Config, Base>& g_)
    {
      typedef typename Config::stored_vertex stored_vertex;
      Derived& g = static_cast<Derived&>(g_);
      g.removing_vertex(u, geofeatures_boost::graph_detail::iterator_stability(g_.m_vertices));
    ...
    namespace detail {
      ...
      remove_vertex_dispatch(Graph& g, vertex_descriptor u,
                             geofeatures_boost::directed_tag)
      {
      ...
      inline void
      remove_vertex_dispatch(Graph& g, vertex_descriptor u,
                             geofeatures_boost::undirected_tag)
      {
        typedef typename Graph::global_edgelist_selector EdgeListS;
        BOOST_STATIC_ASSERT((!is_same<EdgeListS, vecS>::value));
      ...
      inline void
      remove_vertex_dispatch(Graph& g, vertex_descriptor u,
                             geofeatures_boost::bidirectional_tag)
      {
        typedef typename Graph::global_edgelist_selector EdgeListS;
        BOOST_STATIC_ASSERT((!is_same<EdgeListS, vecS>::value));
    ...
    public:
      ...
      //    protected:
      inline geofeatures_boost::integer_range<vertex_descriptor> vertex_set() const {
        return geofeatures_boost::integer_range<vertex_descriptor>(0, m_vertices.size());
      }
      inline OutEdgeList& out_edge_list(vertex_descriptor v) {
      ...
      inline void copy_impl(const vec_adj_list_impl& x_)
      {
        ...
        for (geofeatures_boost::tie(ei, ei_end) = edges(x); ei != ei_end; ++ei) {
          edge_descriptor e;
          bool inserted;
          geofeatures_boost::tie(e, inserted) = add_edge(source(*ei,x), target(*ei,x) , *this);
          *((edge_property_type*)e.m_eproperty)
            = *((edge_property_type*)(*ei).m_eproperty);
        }
      }
                              ...
                              vec_adj_list_impl<Graph, Config, Base>& g_)
    {
      ...
      Graph& g = static_cast<Graph&>(g_);
      g.removing_vertex(v, geofeatures_boost::graph_detail::iterator_stability(g_.m_vertices));
  ...
  namespace detail {
    ...
    struct adj_list_gen
    {
      ...
      struct config
      {
        ...
        typedef geofeatures_boost::integer_range<vertex_descriptor> RandVertexList;
        ...
        typedef geofeatures_boost::detail::iterator_traits<OutEdgeIter> OutEdgeIterTraits;
        ...
        typedef geofeatures_boost::detail::iterator_traits<EdgeIter> EdgeIterTraits;
    ...
    struct adj_list_vertex_property_map
      : public geofeatures_boost::put_get_helper<
          Reference,
    ...
    struct adj_list_vertex_all_properties_map
      : public geofeatures_boost::put_get_helper<PropRef,
        ...
        >
    {
      typedef ValueType value_type;
      typedef Reference reference;
      typedef typename geofeatures_boost::graph_traits<Graph>::vertex_descriptor key_type;
      typedef geofeatures_boost::lvalue_property_map_tag category;
    ...
    struct vec_adj_list_vertex_all_properties_map
      : public geofeatures_boost::put_get_helper<PropertyRef,
        ...
        >
    {
      ...
      typedef geofeatures_boost::readable_property_map_tag category;
  ...
  namespace detail {
    ...
    struct adj_list_choose_vertex_pa
      : geofeatures_boost::mpl::if_<
          geofeatures_boost::is_same<Tag, vertex_all_t>,
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost {
  ...
  template <typename V>
  struct hash< geofeatures_boost::detail::stored_edge<V> >
  {
    std::size_t
    operator()(const geofeatures_boost::detail::stored_edge<V>& e) const
    {
  ...
  struct hash< geofeatures_boost::detail::stored_edge_property <V,P> >
  {
    std::size_t
    operator()(const geofeatures_boost::detail::stored_edge_property<V,P>& e) const
    {
      return hash<V>()(e.m_target);
    }
  };
  ...
  struct hash< geofeatures_boost::detail::stored_edge_iter<V,I, P> >
  {
    std::size_t
    operator()(const geofeatures_boost::detail::stored_edge_iter<V,I,P>& e) const
    {
      return hash<V>()(e.m_target);
    }
  };
