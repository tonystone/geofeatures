...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost {
  ...
  inline void property_map_swap(
         PropMap prop_map,
         const typename geofeatures_boost::property_traits<PropMap>::key_type& ka, 
         const typename geofeatures_boost::property_traits<PropMap>::key_type& kb) {
    typename geofeatures_boost::property_traits<PropMap>::value_type va = get(prop_map, ka);
  ...
  namespace detail {
    ...
    class fixed_max_size_vector {
      geofeatures_boost::shared_array<Value> m_data;
      std::size_t m_size;
  ...
  class d_ary_heap_indirect {
    ...
    typedef typename geofeatures_boost::property_traits<DistanceMap>::value_type key_type;
    ...
    // distance map
    typedef typename geofeatures_boost::property_traits<DistanceMap>::value_type distance_type;
