...
namespace std {
  ...
  operator<<(std::basic_ostream<Char, Traits>& os,
             const geofeatures_boost::detail::edge_desc_impl<D,V>& e)
  {
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost {
  ...
  struct hash<geofeatures_boost::detail::edge_desc_impl<D, V> >
  {
    std::size_t operator()(const geofeatures_boost::detail::edge_desc_impl<D, V> & x) const
