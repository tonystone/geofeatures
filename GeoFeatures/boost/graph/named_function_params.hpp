...
#define BOOST_BGL_ONE_PARAM_REF(name, key) \
    ...
    bgl_named_params<geofeatures_boost::reference_wrapper<PType>, BOOST_PP_CAT(key, _t), self> \
    name(PType& p) const { \
      typedef bgl_named_params<geofeatures_boost::reference_wrapper<PType>, BOOST_PP_CAT(key, _t), self> Params; \
      return Params(geofeatures_boost::ref(p), *this); \
    } \
...
#define BOOST_BGL_ONE_PARAM_REF(name, key) \
    template <typename PType> \
    bgl_named_params<geofeatures_boost::reference_wrapper<PType>, BOOST_PP_CAT(key, _t)> \
    name(PType& p) { \
      typedef bgl_named_params<geofeatures_boost::reference_wrapper<PType>, BOOST_PP_CAT(key, _t)> Params; \
      return Params(geofeatures_boost::ref(p)); \
    } \
...
#undef BOOST_BGL_ONE_PARAM_CREF
  ...
  namespace detail {
    ...
    struct choose_impl_result:
      geofeatures_boost::mpl::eval_if<
        geofeatures_boost::is_same<Param, param_not_found>, 
        geofeatures_boost::mpl::eval_if<
          GraphIsConst,
          detail::const_type_as_type<property_map<Graph, Tag> >,
          property_map<Graph, Tag> >,
        geofeatures_boost::mpl::identity<Param> > {};
    ...
    template <> struct choose_impl_helper<false> {
      ...
      static typename property_map<typename geofeatures_boost::remove_const<Graph>::type, PropertyTag>::const_type
      f(geofeatures_boost::mpl::true_, const Graph& g, const Param&, PropertyTag tag) {
        return get(tag, g);
      }

      template <typename Param, typename Graph, typename PropertyTag>
      static typename property_map<typename geofeatures_boost::remove_const<Graph>::type, PropertyTag>::type
      f(geofeatures_boost::mpl::false_, Graph& g, const Param&, PropertyTag tag) {
        return get(tag, g);
      }
    };
  ...
  template <typename Param, typename Graph, typename PropertyTag>
  typename detail::choose_impl_result<geofeatures_boost::mpl::true_, Graph, Param, PropertyTag>::type
  choose_const_pmap(const Param& p, const Graph& g, PropertyTag tag)
  { 
    return detail::choose_impl_helper<!geofeatures_boost::is_same<Param, param_not_found>::value>
             ::f(geofeatures_boost::mpl::true_(), g, p, tag);
  }

  template <typename Param, typename Graph, typename PropertyTag>
  typename detail::choose_impl_result<geofeatures_boost::mpl::false_, Graph, Param, PropertyTag>::type
  choose_pmap(const Param& p, Graph& g, PropertyTag tag)
  { 
    return detail::choose_impl_helper<!geofeatures_boost::is_same<Param, param_not_found>::value>
             ::f(geofeatures_boost::mpl::false_(), g, p, tag);
  }
  ...
  namespace detail {
    ...
    struct edge_capacity_value
    {
      ...
      typedef typename detail::choose_impl_result<geofeatures_boost::mpl::true_, Graph, typename get_param_type<Params, edge_capacity_t>::type, edge_capacity_t>::type CapacityEdgeMap;
...
#define BOOST_BGL_ONE_PARAM_REF(name, key) \
    ...
    struct convert_one_keyword<BOOST_PP_CAT(key, _t)> { \
      typedef geofeatures_boost::graph::keywords::tag::name type; \
    };
...
#undef BOOST_BGL_ONE_PARAM_CREF
    ...
    struct convert_bgl_params_to_boost_parameter {
      ...
      typedef geofeatures_boost::parameter::aux::tagged_argument<new_kw, const typename T::value_type> tagged_arg_type;
      typedef convert_bgl_params_to_boost_parameter<typename T::next_type> rest_conv;
      typedef geofeatures_boost::parameter::aux::arg_list<tagged_arg_type, typename rest_conv::type> type;
    ...
    template <>
    struct convert_bgl_params_to_boost_parameter<geofeatures_boost::no_property> {
      typedef geofeatures_boost::parameter::aux::empty_arg_list type;
      static type conv(const geofeatures_boost::no_property&) {return type();}
    };

    template <>
    struct convert_bgl_params_to_boost_parameter<geofeatures_boost::no_named_parameters> {
      typedef geofeatures_boost::parameter::aux::empty_arg_list type;
      static type conv(const geofeatures_boost::no_named_parameters&) {return type();}
    };

    struct bgl_parameter_not_found_type {};

    template <typename ArgPack, typename KeywordType>
    struct parameter_exists : geofeatures_boost::mpl::not_<geofeatures_boost::is_same<typename geofeatures_boost::parameter::binding<ArgPack, KeywordType, bgl_parameter_not_found_type>::type, bgl_parameter_not_found_type> > {};
  }

#define BOOST_GRAPH_DECLARE_CONVERTED_PARAMETERS(old_type, old_var) \
  typedef typename geofeatures_boost::detail::convert_bgl_params_to_boost_parameter<old_type>::type arg_pack_type; \
  arg_pack_type arg_pack = geofeatures_boost::detail::convert_bgl_params_to_boost_parameter<old_type>::conv(old_var);

  namespace detail {

    template <typename ArgType, typename Prop, typename Graph, bool Exists>
    struct override_const_property_t {
      typedef typename geofeatures_boost::remove_const<ArgType>::type result_type;
    ...
    struct override_const_property_t<ArgType, Prop, Graph, false> {
      typedef typename geofeatures_boost::property_map<Graph, Prop>::const_type result_type;
    ...
    struct override_const_property_result {
      typedef 
        typename override_const_property_t<
                   typename geofeatures_boost::parameter::value_type<ArgPack, Tag, int>::type,
                   Prop,
                   Graph,
                   geofeatures_boost::detail::parameter_exists<ArgPack, Tag>::value
                 >::result_type
        type;
    };
    ...
    override_const_property(const ArgPack& ap, const geofeatures_boost::parameter::keyword<Tag>& t, const Graph& g, Prop) {
    ...
    struct override_property_t {
      ...
      result_type operator()(const Graph&, const typename geofeatures_boost::add_reference<ArgType>::type a) const {return a;}
    };

    template <typename ArgType, typename Prop, typename Graph>
    struct override_property_t<ArgType, Prop, Graph, false> {
      typedef typename geofeatures_boost::property_map<Graph, Prop>::type result_type;
      result_type operator()(const Graph& g, const ArgType&) const {return get(Prop(), g);}
    };
    ...
    override_property(const ArgPack& ap, const geofeatures_boost::parameter::keyword<Tag>& t, const Graph& g, Prop) {
    ...
    template <> struct make_arg_pack_type<void()> {typedef geofeatures_boost::parameter::aux::empty_arg_list type;};
    template <typename K, typename A>
    struct make_arg_pack_type<void(K, A)> {
      typedef geofeatures_boost::parameter::aux::tagged_argument<K, A> type;
    };

#define BOOST_GRAPH_OPENING_PART_OF_PAIR(z, i, n) geofeatures_boost::parameter::aux::arg_list<geofeatures_boost::parameter::aux::tagged_argument<BOOST_PP_CAT(Keyword, BOOST_PP_SUB(n, i)),  BOOST_PP_CAT(Arg, BOOST_PP_SUB(n, i))>,
#define BOOST_GRAPH_MAKE_PAIR_PARAM(z, i, _) const geofeatures_boost::parameter::aux::tagged_argument<BOOST_PP_CAT(Keyword, i), BOOST_PP_CAT(Arg, i)>& BOOST_PP_CAT(kw, i)
...
#define BOOST_GRAPH_MAKE_AP_TYPE_SPECIALIZATION(z, i, _) \
    ...
    struct make_arg_pack_type<void(BOOST_PP_ENUM_PARAMS(i, Keyword), BOOST_PP_ENUM_PARAMS(i, Arg))> { \
      typedef \
        BOOST_PP_REPEAT(i, BOOST_GRAPH_OPENING_PART_OF_PAIR, BOOST_PP_DEC(i)) geofeatures_boost::parameter::aux::empty_arg_list BOOST_PP_REPEAT(i, > BOOST_PP_TUPLE_EAT(3), ~) \
        type; \
    };
...
#define BOOST_GRAPH_MAKE_FORWARDING_FUNCTION(name, nfixed, nnamed_max) \
  ...
  typename geofeatures_boost::result_of< \
  ...
  typename geofeatures_boost::result_of< \
             detail::BOOST_PP_CAT(name, _impl)<BOOST_PP_ENUM_PARAMS(nfixed, Param)> \
               (BOOST_PP_ENUM_PARAMS(nfixed, Param) BOOST_PP_COMMA_IF(nfixed) \
                const typename geofeatures_boost::detail::make_arg_pack_type<void(BOOST_PP_ENUM_PARAMS(nnamed, Keyword) BOOST_PP_COMMA_IF(nnamed) BOOST_PP_ENUM_PARAMS(nnamed, Arg))>::type&) \
           >::type \
  name(BOOST_PP_ENUM_BINARY_PARAMS(nfixed, const Param, & param) \
    ...
    return detail::BOOST_PP_CAT(name, _impl)<BOOST_PP_ENUM_PARAMS(nfixed, Param)>() \
             (BOOST_PP_ENUM_PARAMS(nfixed, param), \
              (geofeatures_boost::parameter::aux::empty_arg_list() BOOST_PP_ENUM_TRAILING_PARAMS(nnamed, kw))); \
  }
...
#define BOOST_GRAPH_MAKE_OLD_STYLE_PARAMETER_FUNCTION(name, nfixed) \
  ...
  typename geofeatures_boost::result_of< \
    ::geofeatures_boost::graph::detail::BOOST_PP_CAT(name, _impl) BOOST_PP_EXPR_IF(nfixed, <) BOOST_PP_ENUM_PARAMS(nfixed, Param) BOOST_PP_EXPR_IF(nfixed, >) \
      (BOOST_PP_ENUM_PARAMS(nfixed, Param) BOOST_PP_COMMA_IF(nfixed) \
       const typename geofeatures_boost::detail::convert_bgl_params_to_boost_parameter<geofeatures_boost::bgl_named_params<P, T, R> >::type &) \
    >::type \
  name(BOOST_PP_ENUM_BINARY_PARAMS(nfixed, const Param, & param) BOOST_PP_COMMA_IF(nfixed) const geofeatures_boost::bgl_named_params<P, T, R>& old_style_params) { \
    typedef geofeatures_boost::bgl_named_params<P, T, R> old_style_params_type; \
    BOOST_GRAPH_DECLARE_CONVERTED_PARAMETERS(old_style_params_type, old_style_params) \
    return ::geofeatures_boost::graph::BOOST_PP_CAT(name, _with_named_params)(BOOST_PP_ENUM_PARAMS(nfixed, param) BOOST_PP_COMMA_IF(nfixed) arg_pack); \
  } \
  \
  BOOST_PP_EXPR_IF(nfixed, template <) BOOST_PP_ENUM_PARAMS(nfixed, typename Param) BOOST_PP_EXPR_IF(nfixed, >) \
  BOOST_PP_EXPR_IF(nfixed, typename) geofeatures_boost::result_of< \
    ::geofeatures_boost::graph::detail::BOOST_PP_CAT(name, _impl) BOOST_PP_EXPR_IF(nfixed, <) BOOST_PP_ENUM_PARAMS(nfixed, Param) BOOST_PP_EXPR_IF(nfixed, >) \
      (BOOST_PP_ENUM_PARAMS(nfixed, Param) BOOST_PP_COMMA_IF(nfixed) const geofeatures_boost::parameter::aux::empty_arg_list &) \
    >::type \
  name(BOOST_PP_ENUM_BINARY_PARAMS(nfixed, const Param, & param)) { \
    BOOST_GRAPH_DECLARE_CONVERTED_PARAMETERS(geofeatures_boost::no_named_parameters, geofeatures_boost::no_named_parameters()) \
    return ::geofeatures_boost::graph::BOOST_PP_CAT(name, _with_named_params)(BOOST_PP_ENUM_PARAMS(nfixed, param) BOOST_PP_COMMA_IF(nfixed) arg_pack); \
  }
  ...
  namespace detail {
    ...
    struct map_maker_helper<false, Graph, ArgPack, Value, PM> {
      typedef typename geofeatures_boost::remove_const<
        typename override_const_property_t<
          typename geofeatures_boost::parameter::value_type<
            ArgPack, geofeatures_boost::graph::keywords::tag::vertex_index_map, int>::type,
          geofeatures_boost::vertex_index_t,
          Graph,
          geofeatures_boost::detail::parameter_exists<
            ArgPack, geofeatures_boost::graph::keywords::tag::vertex_index_map>::value
        >::result_type>::type vi_map_type;
      typedef
        geofeatures_boost::shared_array_property_map<Value, vi_map_type>
        map_type;
      static map_type make_map(const Graph& g,
        ...
        return make_shared_array_property_map(
                 ...
                 override_const_property(
                   ap,
                   geofeatures_boost::graph::keywords::_vertex_index_map,
                   g, vertex_index));
      }
    };
    ...
    struct map_maker {
      ...
      typedef map_maker_helper<has_map, Graph, ArgPack, ValueType,
                               typename geofeatures_boost::remove_const<
                                 typename geofeatures_boost::parameter::value_type<
                                            ArgPack,
                                            MapTag,
                                            int
      ...
      static map_type make_map(const Graph& g, const ArgPack& ap, ValueType default_value) {
        return helper::make_map(g, default_value, ap[::geofeatures_boost::parameter::keyword<MapTag>::instance | 0], ap);
      }
    };
    ...
    static const
      make_property_map_from_arg_pack_gen<
        geofeatures_boost::graph::keywords::tag::color_map,
        default_color_type>
    ...
    struct priority_queue_maker_helper<false, Graph, ArgPack, KeyT, ValueT, KeyMapTag, IndexInHeapMapTag, Compare, Q> {
      ...
      typedef geofeatures_boost::d_ary_heap_indirect<ValueT, 4, index_in_heap_map, typename map_maker<Graph, ArgPack, KeyMapTag, KeyT>::helper::map_type, Compare> priority_queue_type;
      ...
      make_queue(const Graph& g, const ArgPack& ap, KeyT defaultKey, const Q&) {
        return priority_queue_type(
            ...
            map_maker<Graph, ArgPack, IndexInHeapMapTag, default_index_in_heap_type>::make_map(g, ap, typename geofeatures_boost::property_traits<index_in_heap_map>::value_type(-1))
          );
      }
    };
    ...
    struct priority_queue_maker {
      BOOST_STATIC_CONSTANT(
        ...
        g_hasQ =
          (parameter_exists<ArgPack, PriorityQueueTag>
           ::value));
      typedef geofeatures_boost::reference_wrapper<int> int_refw;
      typedef typename geofeatures_boost::parameter::value_type<
                         ArgPack,
                         PriorityQueueTag,
                         int_refw
                       >::type
      ...
      typedef typename param_value_type_wrapper::type
        param_value_type;
      typedef typename geofeatures_boost::remove_const<param_value_type>::type param_value_type_no_const;
      ...
      static priority_queue_type make_queue(const Graph& g, const ArgPack& ap, KeyT defaultKey) {
        return helper::make_queue(g, ap, defaultKey, ap[::geofeatures_boost::parameter::keyword<PriorityQueueTag>::instance | 0]);
      }
    };

    template <class PriorityQueueTag, class KeyT, class ValueT, class Compare = std::less<KeyT>, class KeyMapTag = geofeatures_boost::graph::keywords::tag::distance_map, class IndexInHeapMapTag = geofeatures_boost::graph::keywords::tag::index_in_heap_map>
    ...
    template <typename G>
    typename geofeatures_boost::graph_traits<G>::vertex_descriptor
    get_null_vertex(const G&) {return geofeatures_boost::graph_traits<G>::null_vertex();}

    template <typename G>
    typename geofeatures_boost::graph_traits<G>::vertex_descriptor
    get_default_starting_vertex(const G& g) {
      std::pair<typename geofeatures_boost::graph_traits<G>::vertex_iterator, typename geofeatures_boost::graph_traits<G>::vertex_iterator> iters = vertices(g);
      return (iters.first == iters.second) ? geofeatures_boost::graph_traits<G>::null_vertex() : *iters.first;
    }

    template <typename G>
    struct get_default_starting_vertex_t {
      typedef typename geofeatures_boost::graph_traits<G>::vertex_descriptor result_type;
      const G& g;
