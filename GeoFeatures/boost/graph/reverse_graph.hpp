...
struct vertex_property_type<reverse_graph<BidirectionalGraph, GraphRef> > {
  typedef typename geofeatures_boost::vertex_property_type<BidirectionalGraph>::type type;
};

template <class BidirectionalGraph, class GraphRef>
struct edge_property_type<reverse_graph<BidirectionalGraph, GraphRef> > {
  typedef typename geofeatures_boost::edge_property_type<BidirectionalGraph>::type type;
};

template <class BidirectionalGraph, class GraphRef>
struct graph_property_type<reverse_graph<BidirectionalGraph, GraphRef> > {
  typedef typename geofeatures_boost::graph_property_type<BidirectionalGraph>::type type;
};
...
struct property_map<reverse_graph<BidirGraph, GRef>, Property> {
  typedef geofeatures_boost::is_same<typename detail::property_kind_from_graph<BidirGraph, Property>::type, edge_property_tag> is_edge_prop;
  typedef geofeatures_boost::is_const<typename geofeatures_boost::remove_reference<GRef>::type> is_ref_const;
  typedef typename geofeatures_boost::mpl::if_<
                     is_ref_const,
  ...
  typedef typename geofeatures_boost::mpl::if_<is_edge_prop, detail::reverse_graph_edge_property_map<orig_type>, orig_type>::type type;
  typedef typename geofeatures_boost::mpl::if_<is_edge_prop, detail::reverse_graph_edge_property_map<orig_const_type>, orig_const_type>::type const_type;
};
...
template <typename T> struct is_reverse_graph: geofeatures_boost::mpl::false_ {};
template <typename G, typename R> struct is_reverse_graph<reverse_graph<G, R> >: geofeatures_boost::mpl::true_ {};
...
typename geofeatures_boost::mpl::if_<
           geofeatures_boost::is_const<typename geofeatures_boost::remove_reference<GRef>::type>,
