...
geofeatures_boost::mpl::aux::weighted_tag<1>::type operator==( assert_, assert_ );
geofeatures_boost::mpl::aux::weighted_tag<2>::type operator!=( assert_, assert_ );
geofeatures_boost::mpl::aux::weighted_tag<3>::type operator>(  assert_, assert_ );
geofeatures_boost::mpl::aux::weighted_tag<4>::type operator>=( assert_, assert_ );
geofeatures_boost::mpl::aux::weighted_tag<5>::type operator<( assert_, assert_ );
geofeatures_boost::mpl::aux::weighted_tag<6>::type operator<=( assert_, assert_ );
...
struct eval_assert {
    ...
    typedef typename ::geofeatures_boost::mpl::if_c<p_type::value,
...
struct eval_assert_not {
    ...
    typedef typename ::geofeatures_boost::mpl::if_c<!p_type::value,
        AUX778076_ASSERT_ARG(assert<false>),
        failed ************ ::geofeatures_boost::mpl::not_<P>::************
    >::type type;
};
...
template< typename Pred >
failed ************ (geofeatures_boost::mpl::not_<Pred>::************ 
...
template< typename Pred >
typename assert_arg_type< geofeatures_boost::mpl::not_<Pred> >::type 
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          geofeatures_boost::mpl::assertion_failed<false>( \
              geofeatures_boost::mpl::make_assert_arg< \
                  typename geofeatures_boost::mpl::eval_assert<void pred>::type \
                >() \
            ) \
        ) \
    ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          geofeatures_boost::mpl::assertion_failed<false>( \
              geofeatures_boost::mpl::make_assert_arg< \
                  typename geofeatures_boost::mpl::eval_assert_not<void pred>::type \
                >() \
            ) \
        ) \
    ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          geofeatures_boost::mpl::assertion_failed<false>( \
              geofeatures_boost::mpl::assert_arg( (void (*) pred)0, 1 ) \
            ) \
        ) \
    ) \
/**/
...
enum { \
      BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          geofeatures_boost::mpl::assertion<false>::failed( \
              geofeatures_boost::mpl::assert_not_arg( (void (*) pred)0, 1 ) \
            ) \
        ) \
}\
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        geofeatures_boost::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
            (geofeatures_boost::mpl::failed ************ ( geofeatures_boost::mpl::assert_relation< \
                  geofeatures_boost::mpl::assert_::relations( sizeof( \
                      geofeatures_boost::mpl::assert_::arg rel geofeatures_boost::mpl::assert_::arg \
                    ) ) \
                , x \
                , y \
                >::************)) 0 ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        geofeatures_boost::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
              geofeatures_boost::mpl::assert_rel_arg( geofeatures_boost::mpl::assert_relation< \
                  geofeatures_boost::mpl::assert_::relations(BOOST_PP_CAT(mpl_assert_rel,counter)) \
                , x \
                , y \
                >() ) \
            ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        geofeatures_boost::mpl::assertion_failed<(x rel y)>( geofeatures_boost::mpl::assert_rel_arg( \
              geofeatures_boost::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&geofeatures_boost::mpl::operator rel))() \
            ) ) \
        ) \
    ) \
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        geofeatures_boost::mpl::assertion_failed<(x rel y)>( (geofeatures_boost::mpl::failed ************ ( \
            geofeatures_boost::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&geofeatures_boost::mpl::operator rel))::************))0 ) \
        ) \
    ) \
/**/
#   endif
...
struct msg; \
typedef struct BOOST_PP_CAT(msg,counter) : geofeatures_boost::mpl::assert_ \
{ \
    using geofeatures_boost::mpl::assert_::types; \
    static geofeatures_boost::mpl::failed ************ (msg::************ assert_arg()) types_ \
    { return 0; } \
} BOOST_PP_CAT(mpl_assert_arg,counter); \
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        geofeatures_boost::mpl::assertion<(c)>::failed( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#else
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        geofeatures_boost::mpl::assertion_failed<(c)>( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#endif
