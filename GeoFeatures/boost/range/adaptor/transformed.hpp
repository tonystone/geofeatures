...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost
{
    namespace range_detail
    {
        ...
        private:
            ...
            typedef geofeatures_boost::iterator_range<transform_iter_t> base;
        ...
        public:
            ...
            transformed_range(transform_fn_type f, R& r)
                : base(transform_iter_t(geofeatures_boost::begin(r), f),
                       transform_iter_t(geofeatures_boost::end(r), f))
            {
            }
        };
