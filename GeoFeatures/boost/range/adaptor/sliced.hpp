...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost
{
    namespace adaptors
    {
        ...
        class sliced_range : public geofeatures_boost::iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<RandomAccessRange>::type >
        {
            typedef geofeatures_boost::iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<RandomAccessRange>::type > base_t;
        public:
            template<typename Rng, typename T, typename U>
            sliced_range(Rng& rng, T t, U u)
                : base_t(geofeatures_boost::next(geofeatures_boost::begin(rng), t),
                         geofeatures_boost::next(geofeatures_boost::begin(rng), u))
            {
            }
        };
        ...
        slice( RandomAccessRange& rng, std::size_t t, std::size_t u )
        {
            ...
            BOOST_ASSERT( static_cast<std::size_t>(geofeatures_boost::size(rng)) >= u &&
