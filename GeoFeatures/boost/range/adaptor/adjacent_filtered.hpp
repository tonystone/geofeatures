...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost
{
    namespace range_detail
    {
        ...
        {
        private:
            typedef geofeatures_boost::iterator_adaptor<
                        skip_iterator<Iter,Pred,default_pass>,
                        Iter,
                        BOOST_DEDUCED_TYPENAME std::iterator_traits<Iter>::value_type,
                        geofeatures_boost::forward_traversal_tag,
        ...
        public:
            ...
            : base_range(skip_iter(geofeatures_boost::begin(r), geofeatures_boost::end(r), p),
                         skip_iter(geofeatures_boost::end(r), geofeatures_boost::end(r), p))
            {
            }
        };
