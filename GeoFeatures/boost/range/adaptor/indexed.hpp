...
public:
    ...
    index_type index()
    {
        return geofeatures_boost::tuples::get<0>(*this);
    }
    ...
    value_type value()
    {
        return geofeatures_boost::tuples::get<1>(*this);
    }
...
{
    typedef ::geofeatures_boost::range::index_value<
    ...
    >
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT((
        geofeatures_boost::SinglePassRangeConcept<SinglePassRange>));
public:
    ...
    indexed_range(
        ...
        : base_t(iterator(geofeatures_boost::begin(r), i),
                 iterator(geofeatures_boost::end(r), i))
    {
    }
    ...
    indexed_range(
        ...
        : base_t(iterator(geofeatures_boost::begin(r), i),
                 iterator(geofeatures_boost::end(r), i + geofeatures_boost::size(r)))
    {
    }
};
...
{
    BOOST_RANGE_CONCEPT_ASSERT((
        geofeatures_boost::SinglePassRangeConcept<const SinglePassRange>
    ));
