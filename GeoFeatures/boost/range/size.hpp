...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost
{
    namespace range_detail
    {
        ...
        range_calculate_size(const SinglePassRange& rng)
        {
            return std::distance(geofeatures_boost::begin(rng), geofeatures_boost::end(rng));
        }
    }
...
// but only on the Mac!
        ...
        BOOST_RANGE_CONCEPT_ASSERT((geofeatures_boost::SinglePassRangeConcept<SinglePassRange>));
#endif
