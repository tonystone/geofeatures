...
void raise_error(const char* function, const char* message)
{
...
#ifndef BOOST_NO_RTTI
  msg += (geofeatures_boost::format(function) % geofeatures_boost::math::policies::detail::name_of<T>()).str();
#else
  msg += function;
#endif
  msg += ": ";
  ...
  E e(msg);
  geofeatures_boost::throw_exception(e);
}
...
void raise_error(const char* function, const char* message, const T& val)
{
  ...
  msg = do_format(geofeatures_boost::format(msg), geofeatures_boost::io::group(std::setprecision(prec), val));
...
inline T raise_domain_error(
           ...
           const char* message,
           const T& val,
           const ::geofeatures_boost::math::policies::domain_error< ::geofeatures_boost::math::policies::throw_on_error>&)
{
...
inline T raise_domain_error(
           ...
           const char* ,
           const T& ,
           const ::geofeatures_boost::math::policies::domain_error< ::geofeatures_boost::math::policies::ignore_error>&)
{
...
inline T raise_domain_error(
           ...
           const char* ,
           const T& ,
           const ::geofeatures_boost::math::policies::domain_error< ::geofeatures_boost::math::policies::errno_on_error>&)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
...
inline T raise_domain_error(
           ...
           const char* message,
           const T& val,
           const  ::geofeatures_boost::math::policies::domain_error< ::geofeatures_boost::math::policies::user_error>&)
{
...
inline T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::geofeatures_boost::math::policies::pole_error< ::geofeatures_boost::math::policies::throw_on_error>&)
{
   return geofeatures_boost::math::policies::detail::raise_domain_error(function, message, val,  ::geofeatures_boost::math::policies::domain_error< ::geofeatures_boost::math::policies::throw_on_error>());
}
...
inline T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::geofeatures_boost::math::policies::pole_error< ::geofeatures_boost::math::policies::ignore_error>&)
{
   return  ::geofeatures_boost::math::policies::detail::raise_domain_error(function, message, val,  ::geofeatures_boost::math::policies::domain_error< ::geofeatures_boost::math::policies::ignore_error>());
}
...
inline T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::geofeatures_boost::math::policies::pole_error< ::geofeatures_boost::math::policies::errno_on_error>&)
{
   return  ::geofeatures_boost::math::policies::detail::raise_domain_error(function, message, val,  ::geofeatures_boost::math::policies::domain_error< ::geofeatures_boost::math::policies::errno_on_error>());
}
...
inline T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::geofeatures_boost::math::policies::pole_error< ::geofeatures_boost::math::policies::user_error>&)
{
...
inline T raise_overflow_error(
           const char* function,
           const char* message,
           const  ::geofeatures_boost::math::policies::overflow_error< ::geofeatures_boost::math::policies::throw_on_error>&)
{
   raise_error<std::overflow_error, T>(function, message ? message : "numeric overflow");
   // We should never get here:
   return std::numeric_limits<T>::has_infinity ? std::numeric_limits<T>::infinity() : geofeatures_boost::math::tools::max_value<T>();
}
...
inline T raise_overflow_error(
           const char* ,
           const char* ,
           const  ::geofeatures_boost::math::policies::overflow_error< ::geofeatures_boost::math::policies::ignore_error>&)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return std::numeric_limits<T>::has_infinity ? std::numeric_limits<T>::infinity() : geofeatures_boost::math::tools::max_value<T>();
...
inline T raise_overflow_error(
           const char* ,
           const char* ,
           const  ::geofeatures_boost::math::policies::overflow_error< ::geofeatures_boost::math::policies::errno_on_error>&)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_underflow_error(
           const char* function,
           const char* message,
           const  ::geofeatures_boost::math::policies::underflow_error< ::geofeatures_boost::math::policies::throw_on_error>&)
{
...
inline T raise_underflow_error(
           const char* ,
           const char* ,
           const  ::geofeatures_boost::math::policies::underflow_error< ::geofeatures_boost::math::policies::ignore_error>&)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return T(0);
...
inline T raise_underflow_error(
           const char* /* function */,
           const char* /* message */,
           const  ::geofeatures_boost::math::policies::underflow_error< ::geofeatures_boost::math::policies::errno_on_error>&)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_underflow_error(
           const char* function,
           const char* message,
           const  ::geofeatures_boost::math::policies::underflow_error< ::geofeatures_boost::math::policies::user_error>&)
{
...
inline T raise_denorm_error(
           ...
           const char* message,
           const T& /* val */,
           const  ::geofeatures_boost::math::policies::denorm_error< ::geofeatures_boost::math::policies::throw_on_error>&)
{
...
inline T raise_denorm_error(
           ...
           const char* ,
           const T&  val,
           const  ::geofeatures_boost::math::policies::denorm_error< ::geofeatures_boost::math::policies::ignore_error>&)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return val;
...
inline T raise_denorm_error(
           ...
           const char* ,
           const T& val,
           const  ::geofeatures_boost::math::policies::denorm_error< ::geofeatures_boost::math::policies::errno_on_error>&)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_denorm_error(
           ...
           const char* message,
           const T& val,
           const  ::geofeatures_boost::math::policies::denorm_error< ::geofeatures_boost::math::policies::user_error>&)
{
...
inline T raise_evaluation_error(
           ...
           const char* message,
           const T& val,
           const  ::geofeatures_boost::math::policies::evaluation_error< ::geofeatures_boost::math::policies::throw_on_error>&)
{
   raise_error<geofeatures_boost::math::evaluation_error, T>(function, message, val);
   // we never get here:
   return T(0);
}
...
inline T raise_evaluation_error(
           ...
           const char* ,
           const T& val,
           const  ::geofeatures_boost::math::policies::evaluation_error< ::geofeatures_boost::math::policies::ignore_error>&)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return val;
...
inline T raise_evaluation_error(
           ...
           const char* ,
           const T& val,
           const  ::geofeatures_boost::math::policies::evaluation_error< ::geofeatures_boost::math::policies::errno_on_error>&)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_evaluation_error(
           ...
           const char* message,
           const T& val,
           const  ::geofeatures_boost::math::policies::evaluation_error< ::geofeatures_boost::math::policies::user_error>&)
{
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::geofeatures_boost::math::policies::rounding_error< ::geofeatures_boost::math::policies::throw_on_error>&)
{
   raise_error<geofeatures_boost::math::rounding_error, T>(function, message, val);
   // we never get here:
   return TargetType(0);
}
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::geofeatures_boost::math::policies::rounding_error< ::geofeatures_boost::math::policies::ignore_error>&)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::geofeatures_boost::math::policies::rounding_error< ::geofeatures_boost::math::policies::errno_on_error>&)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_indeterminate_result_error(
           ...
           const T& val,
           const R& ,
           const ::geofeatures_boost::math::policies::indeterminate_result_error< ::geofeatures_boost::math::policies::throw_on_error>&)
{
   raise_error<std::domain_error, T>(function, message, val);
   // we never get here:
   return std::numeric_limits<T>::quiet_NaN();
...
inline T raise_indeterminate_result_error(
           ...
           const T& ,
           const R& result,
           const ::geofeatures_boost::math::policies::indeterminate_result_error< ::geofeatures_boost::math::policies::ignore_error>&)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return result;
...
inline T raise_indeterminate_result_error(
           ...
           const T& ,
           const R& result,
           const ::geofeatures_boost::math::policies::indeterminate_result_error< ::geofeatures_boost::math::policies::errno_on_error>&)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_indeterminate_result_error(
           ...
           const T& val,
           const R& ,
           const ::geofeatures_boost::math::policies::indeterminate_result_error< ::geofeatures_boost::math::policies::user_error>&)
{
...
inline bool check_overflow(T val, R* result, const char* function, const Policy& pol)
{
   ...
   {
      geofeatures_boost::math::policies::detail::raise_overflow_error<R>(function, 0, pol);
...
inline bool check_underflow(T val, R* result, const char* function, const Policy& pol)
{
   ...
   {
      *result = static_cast<R>(geofeatures_boost::math::policies::detail::raise_underflow_error<R>(function, 0, pol));
      return true;
   }
   return false;
}
...
inline bool check_denorm(T val, R* result, const char* function, const Policy& pol)
{
   ...
   {
      *result = static_cast<R>(geofeatures_boost::math::policies::detail::raise_denorm_error<R>(function, 0, static_cast<R>(val), pol));
      return true;
   }
   return false;
}
...
template <class T, class Policy>
inline void check_series_iterations(const char* function, geofeatures_boost::uintmax_t max_iter, const Policy& pol)
{
...
template <class T, class Policy>
inline void check_root_iterations(const char* function, geofeatures_boost::uintmax_t max_iter, const Policy& pol)
{
