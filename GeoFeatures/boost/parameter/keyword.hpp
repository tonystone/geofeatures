...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace parameter {
...
#define BOOST_PARAMETER_KEYWORD(tag_namespace,name)                 \
    ...
    namespace                                                       \
    {                                                               \
       ::geofeatures_boost::parameter::keyword<tag_namespace::name> const& name \
       = ::geofeatures_boost::parameter::keyword<tag_namespace::name>::instance;\
    }

}} // namespace geofeatures_boost::parameter
