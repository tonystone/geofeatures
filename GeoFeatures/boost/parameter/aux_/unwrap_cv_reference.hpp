...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { template<class T> class reference_wrapper; }
...
// Can't use geofeatures_boost::unwrap_reference<> here because it
