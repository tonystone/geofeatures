...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost {
  ...
  class indirect_cmp {
  public:
    typedef typename geofeatures_boost::property_traits<ReadablePropertyMap>::value_type T;
    typedef typename geofeatures_boost::property_traits<ReadablePropertyMap>::key_type K;
