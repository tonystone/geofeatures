...
class basic_string_base
{
 ...
 public:
   ...
   typedef ::geofeatures_boost::intrusive::pointer_traits<pointer> pointer_traits;
   ...
   basic_string_base(BOOST_RV_REF(allocator_type) a)
      :  members_(geofeatures_boost::move(a))
   {  this->init();  }
      ...
      :  public Allocator
   {
      ...
      explicit members_holder(BOOST_FWD_REF(AllocatorConvertible) a)
         :  Allocator(geofeatures_boost::forward<AllocatorConvertible>(a))
      {}
   ...
   typedef container_detail::integral_constant<unsigned,
      geofeatures_boost::container::container_detail::version<Allocator>::value> alloc_version;
   ...
   void swap_data(basic_string_base& other)
   {
      if(this->is_short()){
         ...
         if(other.is_short()){
            ...
            geofeatures_boost::adl_move_swap(this->members_.m_repr.long_repr(), other.members_.m_repr.long_repr());
         }
      }
   }
};
   ...
   :  private container_detail::basic_string_base<Allocator>
{
   ...
   basic_string(BOOST_RV_REF(basic_string) s) BOOST_NOEXCEPT_OR_NOTHROW
      : base_t(geofeatures_boost::move(s.alloc()))
   {
      ...
      )
   {
      const size_type n_pos = p - this->cbegin();
      if (first != last) {
         const size_type n = geofeatures_boost::container::iterator_distance(first, last);
         const size_type old_size = this->priv_size();
         ...
         if(enough_capacity){
            ...
            if (elems_after >= n) {
               ...
               geofeatures_boost::container::iterator_advance(mid, elems_after + 1);
   ...
   {
      difference_type n = geofeatures_boost::container::iterator_distance(j1, j2);
      ...
      if (len >= n) {
         ...
         ForwardIter m = j1;
         geofeatures_boost::container::iterator_advance(m, len);
   ...
   {
      typedef typename geofeatures_boost::container::iterator_traits<InputIter>::iterator_category Category;
...
{
   x += y;
   return geofeatures_boost::move(x);
}
      ...
      ,BOOST_RV_REF_BEG basic_string<CharT, Traits, Allocator> BOOST_RV_REF_END y)
{
   ...
   return geofeatures_boost::move(y);
}
...
struct has_trivial_destructor_after_move<geofeatures_boost::container::basic_string<C, T, Allocator> >
{
   typedef typename ::geofeatures_boost::container::allocator_traits<Allocator>::pointer pointer;
