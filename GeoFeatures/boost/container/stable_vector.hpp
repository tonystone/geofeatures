...
{
   private:
   typedef typename geofeatures_boost::intrusive::
      ...
      >
{
   ...
   public:
   typename ::geofeatures_boost::intrusive::pointer_traits<Pointer>::element_type value;
};

template<class VoidPtr, class VoidAllocator>
struct index_traits
{
   typedef geofeatures_boost::intrusive::
      pointer_traits
   ...
   typedef ::geofeatures_boost::container::vector
...
{
   typedef geofeatures_boost::intrusive::pointer_traits<Pointer>                                non_const_ptr_traits;
   public:
   ...
   typedef typename ::geofeatures_boost::container::container_detail::if_c
      < IsConst
      , typename non_const_ptr_traits::template
         rebind_pointer<const value_type>::type
      , Pointer
      >::type                                                                       pointer;
   typedef geofeatures_boost::intrusive::pointer_traits<pointer>                                ptr_traits;
...
class stable_vector
{
   ...
   typedef ::geofeatures_boost::container::container_detail::integral_constant
      <unsigned, geofeatures_boost::container::container_detail::
      version<Allocator>::value>                              alloc_version;
   typedef typename allocator_traits_type::
      template portable_rebind_alloc
         <node_type>::type                            node_allocator_type;

   typedef ::geofeatures_boost::container::container_detail::
   ...
   stable_vector(BOOST_RV_REF(stable_vector) x)
      : internal_data(geofeatures_boost::move(x.priv_node_alloc())), index(geofeatures_boost::move(x.index))
   {
      ...
      : internal_data(a), index(a)
   {
      if(this->priv_node_alloc() == x.priv_node_alloc()){
         ...
         stable_vector_detail::clear_on_destroy<stable_vector> cod(*this);
         this->insert(this->cend(), geofeatures_boost::make_move_iterator(x.begin()), geofeatures_boost::make_move_iterator(x.end()));
         STABLE_VECTOR_CHECK_INVARIANT;
         cod.release();
      }
   }
                                  ...
                                  || allocator_traits_type::is_always_equal::value)
   {
      ...
      //Else do a one by one move
         ...
         this->assign( geofeatures_boost::make_move_iterator(x.begin())
                     , geofeatures_boost::make_move_iterator(x.end()));
      }
      return *this;
   }
   ...
   void emplace_back(Args &&...args)
   {
      ...
      EmplaceFunctor &&ef = EmplaceFunctor(geofeatures_boost::forward<Args>(args)...);
   ...
   {
      const size_type num_new = static_cast<size_type>(geofeatures_boost::container::iterator_distance(first, last));
   ...
   void priv_push_back(BOOST_MOVE_CATCH_FWD(U) x)
   {
      if(BOOST_LIKELY(this->priv_capacity_bigger_than_size())){
         ...
         BOOST_ASSERT(!!p);
         {
            ...
            //This might throw
            this->priv_build_node_from_convertible(p, ::geofeatures_boost::forward<U>(x));
            rollback.release();
         }
         ...
         this->insert(this->cend(), ::geofeatures_boost::forward<U>(x));
      }
   }
   ...
   iterator priv_insert(const_iterator p, BOOST_RV_REF(T) x)
   {
      ...
      typedef geofeatures_boost::move_iterator<repeat_it>      repeat_move_it;
   ...
   {
      //This can throw
      geofeatures_boost::container::construct_in_place
   ...
   {
      //This can throw
      geofeatures_boost::container::allocator_traits<node_allocator_type>::construct
         ( this->priv_node_alloc()
         , container_detail::addressof(p->value)
         , ::geofeatures_boost::forward<ValueConvertible>(value_convertible));
      //This does not throw
   ...
   {
      geofeatures_boost::adl_move_swap(this->internal_data.pool_size, x.internal_data.pool_size);
      ...
      : public node_allocator_type
   {
      ...
      explicit ebo_holder(BOOST_FWD_REF(AllocatorRLValue) a)
         : node_allocator_type(geofeatures_boost::forward<AllocatorRLValue>(a))
         , pool_size(0)
         , end_node()
      {}
...
template <class T, class Allocator>
struct has_trivial_destructor_after_move<geofeatures_boost::container::stable_vector<T, Allocator> >
{
   typedef typename ::geofeatures_boost::container::allocator_traits<Allocator>::pointer pointer;
...
}} //namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost{  namespace container {
