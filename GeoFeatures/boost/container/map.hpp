...
//! \tparam MapOptions is an packed option type generated using using geofeatures_boost::container::tree_assoc_options.
   ...
   ///@endcond
{
   ...
   map& operator=(BOOST_RV_REF(map) x)
      BOOST_NOEXCEPT_IF(  allocator_traits_type::is_always_equal::value
                                 && geofeatures_boost::container::container_detail::is_nothrow_move_assignable<Compare>::value )
   ...
   //! Effects: If there is no key equivalent to x in the map, inserts
   //! value_type(geofeatures_boost::move(x), T()) into the map (the key is move-constructed)
   //!
   //! Returns: A reference to the mapped_type corresponding to x in *this.
   //!
   //! Complexity: Logarithmic.
   ...
   { return this->base_t::insert_unique(geofeatures_boost::move(x)); }
   ...
   { return this->base_t::insert_unique(p, geofeatures_boost::move(x)); }
   ...
   {  return this->base_t::emplace_unique(geofeatures_boost::forward<Args>(args)...); }
   ...
   {  return this->base_t::emplace_hint_unique(p, geofeatures_boost::forward<Args>(args)...); }
   ...
   void swap(map& x)
      BOOST_NOEXCEPT_IF(  allocator_traits_type::is_always_equal::value
                                 && geofeatures_boost::container::container_detail::is_nothrow_swappable<Compare>::value )
   ...
   mapped_type& priv_subscript(const key_type &k)
   {
      ...
      if (i == this->end() || this->key_comp()(k, (*i).first)){
         ...
         movable_value_type val(k, geofeatures_boost::move(m.m_t));
         i = insert(i, geofeatures_boost::move(val));
      }
      return (*i).second;
   }
   ...
   mapped_type& priv_subscript(BOOST_RV_REF(key_type) mk)
   {
      ...
      if (i == this->end() || this->key_comp()(k, (*i).first)){
         container_detail::value_init<mapped_type> m;
         movable_value_type val(geofeatures_boost::move(k), geofeatures_boost::move(m.m_t));
         i = insert(i, geofeatures_boost::move(val));
      }
      return (*i).second;
   }
...
struct has_trivial_destructor_after_move<geofeatures_boost::container::map<Key, T, Compare, Allocator> >
{
   typedef typename ::geofeatures_boost::container::allocator_traits<Allocator>::pointer pointer;
   static const bool value = ::geofeatures_boost::has_trivial_destructor_after_move<Allocator>::value &&
                             ...
                             ::geofeatures_boost::has_trivial_destructor_after_move<Compare>::value;
};
...
//! \tparam Allocator is the allocator to allocate the <code>value_type</code>s
//!   (e.g. <i>allocator< std::pair<const Key, T> > </i>).
//! \tparam MultiMapOptions is an packed option type generated using using geofeatures_boost::container::tree_assoc_options.
template < class Key, class T, class Compare = std::less<Key>
   ...
   ///@endcond
{
   ...
   //! @copydoc ::geofeatures_boost::container::set::get_allocator()
   allocator_type get_allocator() const;

   //! @copydoc ::geofeatures_boost::container::set::get_stored_allocator()
   stored_allocator_type &get_stored_allocator();

   //! @copydoc ::geofeatures_boost::container::set::get_stored_allocator() const
   const stored_allocator_type &get_stored_allocator() const;

   //! @copydoc ::geofeatures_boost::container::set::begin()
   iterator begin();

   //! @copydoc ::geofeatures_boost::container::set::begin() const
   const_iterator begin() const;

   //! @copydoc ::geofeatures_boost::container::set::cbegin() const
   const_iterator cbegin() const;

   //! @copydoc ::geofeatures_boost::container::set::end()
   iterator end() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::geofeatures_boost::container::set::end() const
   const_iterator end() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::geofeatures_boost::container::set::cend() const
   const_iterator cend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::geofeatures_boost::container::set::rbegin()
   reverse_iterator rbegin() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::geofeatures_boost::container::set::rbegin() const
   const_reverse_iterator rbegin() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::geofeatures_boost::container::set::crbegin() const
   const_reverse_iterator crbegin() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::geofeatures_boost::container::set::rend()
   reverse_iterator rend() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::geofeatures_boost::container::set::rend() const
   const_reverse_iterator rend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::geofeatures_boost::container::set::crend() const
   const_reverse_iterator crend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::geofeatures_boost::container::set::empty() const
   bool empty() const;

   //! @copydoc ::geofeatures_boost::container::set::size() const
   size_type size() const;

   //! @copydoc ::geofeatures_boost::container::set::max_size() const
   ...
   {  return this->base_t::emplace_equal(geofeatures_boost::forward<Args>(args)...); }
   ...
   template <class... Args>
   iterator emplace_hint(const_iterator p, BOOST_FWD_REF(Args)... args)
   {  return this->base_t::emplace_hint_equal(p, geofeatures_boost::forward<Args>(args)...); }
   ...
   { return this->base_t::insert_equal(geofeatures_boost::move(x)); }
   ...
   //!   is inserted right before p.
   iterator insert(const_iterator p, BOOST_RV_REF(nonconst_value_type) x)
   { return this->base_t::insert_equal(p, geofeatures_boost::move(x)); }
   ...
   //! @copydoc ::geofeatures_boost::container::set::erase(const_iterator)
   iterator erase(const_iterator p);

   //! @copydoc ::geofeatures_boost::container::set::erase(const key_type&)
   size_type erase(const key_type& x);

   //! @copydoc ::geofeatures_boost::container::set::erase(const_iterator,const_iterator)
   iterator erase(const_iterator first, const_iterator last);

   //! @copydoc ::geofeatures_boost::container::set::swap
   void swap(multiset& x)
      BOOST_NOEXCEPT_IF(  allocator_traits_type::is_always_equal::value
                                 && geofeatures_boost::container::container_detail::is_nothrow_swappable<Compare>::value );

   //! @copydoc ::geofeatures_boost::container::set::clear
   void clear() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::geofeatures_boost::container::set::key_comp
   key_compare key_comp() const;

   //! @copydoc ::geofeatures_boost::container::set::value_comp
   value_compare value_comp() const;
...
//!specialization for optimizations
template <class Key, class T, class Compare, class Allocator>
struct has_trivial_destructor_after_move<geofeatures_boost::container::multimap<Key, T, Compare, Allocator> >
{
   typedef typename ::geofeatures_boost::container::allocator_traits<Allocator>::pointer pointer;
   static const bool value = ::geofeatures_boost::has_trivial_destructor_after_move<Allocator>::value &&
                             ::geofeatures_boost::has_trivial_destructor_after_move<pointer>::value &&
