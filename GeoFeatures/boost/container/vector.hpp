...
class vec_iterator
{
   ...
   typedef typename geofeatures_boost::intrusive::pointer_traits<Pointer>::element_type         value_type;
   typedef typename geofeatures_boost::intrusive::pointer_traits<Pointer>::difference_type      difference_type;
   typedef typename if_c
      < IsConst
      , typename geofeatures_boost::intrusive::pointer_traits<Pointer>::template
                                 rebind_pointer<const value_type>::type
      , Pointer
      >::type                                                                       pointer;
   typedef typename geofeatures_boost::intrusive::pointer_traits<pointer>                       ptr_traits;
   ...
   {  return ::geofeatures_boost::intrusive::pointer_traits<pointer>::pointer_to(this->operator*());  }
...
template< class MaybeConstPointer
        , bool ElementTypeIsConst
            = is_const< typename geofeatures_boost::intrusive::pointer_traits<MaybeConstPointer>::element_type>::value >
struct vector_get_ptr_pointer_to_non_const
{
   typedef MaybeConstPointer                                         const_pointer;
   typedef geofeatures_boost::intrusive::pointer_traits<const_pointer>           pointer_traits_t;
   ...
   {  return geofeatures_boost::intrusive::pointer_traits<return_type>::const_cast_from(ptr);  }
};
   ...
   : public Allocator
{
   ...
   typedef geofeatures_boost::container::allocator_traits<Allocator> allocator_traits_type;
   ...
   explicit vector_alloc_holder(BOOST_FWD_REF(AllocConvertible) a) BOOST_NOEXCEPT_OR_NOTHROW
      : Allocator(geofeatures_boost::forward<AllocConvertible>(a)), m_start(), m_size(), m_capacity()
   {}

   //Constructor, does not throw
   template<class AllocConvertible>
   vector_alloc_holder(uninitialized_size_t, BOOST_FWD_REF(AllocConvertible) a, size_type initial_size)
      : Allocator(geofeatures_boost::forward<AllocConvertible>(a))
      , m_start()
   ...
   vector_alloc_holder(pointer p, size_type n, BOOST_FWD_REF(AllocFwd) a)
      : Allocator(::geofeatures_boost::forward<AllocFwd>(a))
      , m_start(p)
      , m_size()
      , m_capacity(n)
   {}
   ...
   pointer allocation_command(geofeatures_boost::container::allocation_type command,
   ...
   {
      geofeatures_boost::adl_move_swap(this->m_start, x.m_start);
      geofeatures_boost::adl_move_swap(this->m_size, x.m_size);
      geofeatures_boost::adl_move_swap(this->m_capacity, x.m_capacity);
   }
   ...
   pointer priv_allocation_command(version_1, geofeatures_boost::container::allocation_type command,
                         size_type ,
   ...
   pointer priv_allocation_command(version_2, geofeatures_boost::container::allocation_type command,
   ...
   : public Allocator
{
   ...
   template<class AllocConvertible>
   explicit vector_alloc_holder(BOOST_FWD_REF(AllocConvertible) a) BOOST_NOEXCEPT_OR_NOTHROW
      : Allocator(geofeatures_boost::forward<AllocConvertible>(a)), m_size()
   {}
   ...
   {
      ::geofeatures_boost::container::uninitialized_move_alloc_n
   ...
   void priv_deep_swap(vector_alloc_holder<OtherAllocator, OtherAllocatorVersion> &x)
   {
      ...
      if(this->m_size < x.m_size){
         geofeatures_boost::container::deep_swap_alloc_n<MaxTmpStorage>(this->alloc(), first_this, this->m_size, first_x, x.m_size);
      }
      else{
         geofeatures_boost::container::deep_swap_alloc_n<MaxTmpStorage>(this->alloc(), first_x, x.m_size, first_this, this->m_size);
      }
      geofeatures_boost::adl_move_swap(this->m_size, x.m_size);
   }
};
...
class vector
{
   ...
   struct value_less
   {
      typedef typename geofeatures_boost::container::allocator_traits<Allocator>::value_type value_type;
      bool operator()(const value_type &a, const value_type &b) const
         {  return a < b;  }
   };

   typedef typename container_detail::version<Allocator>::type alloc_version;
   typedef geofeatures_boost::container::container_detail::vector_alloc_holder<Allocator> alloc_holder_t;
   ...
   typedef typename ::geofeatures_boost::container::allocator_traits<Allocator>::pointer           pointer;
   typedef typename ::geofeatures_boost::container::allocator_traits<Allocator>::const_pointer     const_pointer;
   typedef typename ::geofeatures_boost::container::allocator_traits<Allocator>::reference         reference;
   typedef typename ::geofeatures_boost::container::allocator_traits<Allocator>::const_reference   const_reference;
   typedef typename ::geofeatures_boost::container::allocator_traits<Allocator>::size_type         size_type;
   typedef typename ::geofeatures_boost::container::allocator_traits<Allocator>::difference_type   difference_type;
   typedef Allocator                                                                   allocator_type;
   ...
   #endif
   typedef BOOST_CONTAINER_IMPDEF(geofeatures_boost::container::reverse_iterator<iterator>)        reverse_iterator;
   typedef BOOST_CONTAINER_IMPDEF(geofeatures_boost::container::reverse_iterator<const_iterator>)  const_reverse_iterator;
   ...
   vector(initial_capacity_t, pointer initial_memory, size_type capacity, BOOST_FWD_REF(AllocFwd) a)
      : m_holder(initial_memory, capacity, ::geofeatures_boost::forward<AllocFwd>(a))
   {}
      ...
      :  m_holder(container_detail::uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      geofeatures_boost::container::uninitialized_value_init_alloc_n
      ...
      :  m_holder(container_detail::uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      geofeatures_boost::container::uninitialized_default_init_alloc_n
         (this->m_holder.alloc(), n, container_detail::to_raw_pointer(this->m_holder.start()));
   }
      ...
      :  m_holder(container_detail::uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      geofeatures_boost::container::uninitialized_fill_alloc_n
                 ...
                 , x.size())
   {
      ...
      #endif
      ::geofeatures_boost::container::uninitialized_copy_alloc_n
   ...
   vector(BOOST_RV_REF(vector) x) BOOST_NOEXCEPT_OR_NOTHROW
      :  m_holder(geofeatures_boost::move(x.m_holder))
      ...
      :  m_holder(container_detail::uninitialized_size, a, x.size())
   {
      ...
      this->num_alloc += x.size() != 0;
      #endif
      ::geofeatures_boost::container::uninitialized_copy_alloc_n_source
         ( this->m_holder.alloc(), container_detail::to_raw_pointer(x.m_holder.start())
         , x.size(), container_detail::to_raw_pointer(this->m_holder.start()));
   }
                 ...
                 )
   {
      if(is_propagable_from(x.get_stored_allocator(), x.m_holder.start(), a, true)){
         ...
         this->num_alloc += n != 0;
         #endif
         ::geofeatures_boost::container::uninitialized_move_alloc_n_source
            ( this->m_holder.alloc(), container_detail::to_raw_pointer(x.m_holder.start())
   ...
   ~vector() BOOST_NOEXCEPT_OR_NOTHROW
   {
      geofeatures_boost::container::destroy_alloc_n
   ...
   {
      this->priv_move_assign(geofeatures_boost::move(x));
      return *this;
   }
      ...
      )
   {
      ...
      const size_type input_sz = static_cast<size_type>(geofeatures_boost::container::iterator_distance(first, last));
   ...
   void emplace_back(BOOST_FWD_REF(Args)...args)
   {
      if (BOOST_LIKELY(this->room_enough())){
         ...
         allocator_traits_type::construct(this->m_holder.alloc(), this->back_raw(), ::geofeatures_boost::forward<Args>(args)...);
         ++this->m_holder.m_size;
      }
      else{
         typedef container_detail::insert_emplace_proxy<Allocator, T*, Args...> type;
         this->priv_forward_range_insert_no_capacity
            (this->back_ptr(), 1, type(::geofeatures_boost::forward<Args>(args)...), alloc_version());
      }
   }
   ...
   iterator emplace(const_iterator position, BOOST_FWD_REF(Args) ...args)
   {
      ...
      return this->priv_forward_range_insert( vector_iterator_get_ptr(position), 1
                                            , type(::geofeatures_boost::forward<Args>(args)...));
   }
   ...
   //!
   //! <b>Complexity</b>: Linear to geofeatures_boost::container::iterator_distance [first, last).
   template <class InIt>
      ...
      )
   {
      ...
      return this->priv_forward_range_insert(vector_iterator_get_ptr(pos), geofeatures_boost::container::iterator_distance(first, last), proxy);
   }
   #endif

   //! <b>Requires</b>: p must be a valid iterator of *this. num, must
   //!   be equal to geofeatures_boost::container::iterator_distance(first, last)
   //!
   //! <b>Effects</b>: Insert a copy of the [first, last) range before pos.
   //!
   //! <b>Returns</b>: an iterator to the first inserted element or pos if first == last.
   ...
   //! <b>Complexity</b>: Linear to geofeatures_boost::container::iterator_distance [first, last).
   //!
   //! <b>Note</b>: This function avoids a linear operation to calculate geofeatures_boost::container::iterator_distance[first, last)
   ...
   iterator insert(const_iterator pos, size_type num, InIt first, InIt last)
   {
      BOOST_ASSERT(container_detail::is_input_iterator<InIt>::value ||
                   num == static_cast<size_type>(geofeatures_boost::container::iterator_distance(first, last)));
      (void)last;
   ...
   iterator erase(const_iterator position)
   {
      ...
      T *const new_end_ptr = ::geofeatures_boost::container::move(pos_ptr + 1, beg_ptr + this->m_holder.m_size, pos_ptr);
   ...
   iterator erase(const_iterator first, const_iterator last)
   {
      if (first != last){
         ...
         T* const ptr = container_detail::to_raw_pointer(geofeatures_boost::container::move(last_ptr, old_end_ptr, first_ptr));
   ...
   {  return x.size() == y.size() && ::geofeatures_boost::container::algo_equal(x.begin(), x.end(), y.begin());  }
   ...
   {
      size_type const n = static_cast<size_type>(geofeatures_boost::container::iterator_distance(first, last));
      if(BOOST_LIKELY(n)){
         ...
         if(BOOST_LIKELY(s)){
            ...
            if(new_buffer){
               ...
               geofeatures_boost::uintptr_t const addr = geofeatures_boost::uintptr_t(container_detail::to_raw_pointer(m_holder.start()) + s + n);
      ...
      (UniqueBool, FwdIt first, size_type n, Compare comp, pointer new_storage, size_type const new_cap)
   {
      ...
      while(1){
         if(!n) {
            ::geofeatures_boost::container::uninitialized_move_alloc(this->m_holder.alloc(), pbeg, pend, d_first);
            break;
         } 
         else if(pbeg == pend) {
            ::geofeatures_boost::container::uninitialized_move_alloc_n(this->m_holder.alloc(), first, n, d_first);
            break;
         }
         //maintain stability moving external values only if they are strictly less
         else if(comp(*first, *pbeg)) {
            allocator_traits_type::construct( this->m_holder.alloc(), d_first, ::geofeatures_boost::move(*first) );
            ...
            allocator_traits_type::construct( this->m_holder.alloc(), d_first, ::geofeatures_boost::move(*pbeg) );
            new_values_destroyer.increment_size(1u);
            ++pbeg;
            ++d_first;
         }
      ...
      geofeatures_boost::container::destroy_alloc_n(a, container_detail::to_raw_pointer(old_p), old_size);
         ...
         < container_detail::is_version<OtherAllocator, 0>::value >::type * = 0)
   {
      ...
      geofeatures_boost::container::move_assign_range_alloc_n(this->m_holder.alloc(), other_start, other_sz, this_start, this_sz);
         ...
         >::type * = 0)
   {
      ...
      //Else do a one by one move
         ...
         this->assign( geofeatures_boost::make_move_iterator(container_detail::iterator_to_raw_pointer(x.begin()))
                     , geofeatures_boost::make_move_iterator(container_detail::iterator_to_raw_pointer(x.end()  ))
                     );
      }
         ...
         < container_detail::is_version<OtherAllocator, 0>::value >::type * = 0)
   {
      ...
      const size_type this_sz  = m_holder.m_size;
      const size_type other_sz = static_cast<size_type>(x.m_holder.m_size);
      geofeatures_boost::container::copy_assign_range_alloc_n(this->m_holder.alloc(), other_start, other_sz, this_start, this_sz);
      this->m_holder.m_size = other_sz;
   }
   ...
   void priv_swap(Vector &x, container_detail::false_type)  //version_N
   {
      ...
      if(are_swap_propagable( this->get_stored_allocator(), this->m_holder.start()
         ...
         for(size_type i = 0; i != common_elements; ++i){
            geofeatures_boost::adl_move_swap(sml[i], big[i]);
         }
         //... and move-insert the remaining range
         sml.insert( sml.cend()
                   , geofeatures_boost::make_move_iterator(container_detail::iterator_to_raw_pointer(big.nth(common_elements)))
                   , geofeatures_boost::make_move_iterator(container_detail::iterator_to_raw_pointer(big.end()))
                   );
      }
   ...
   container_detail::insert_range_proxy<Allocator, geofeatures_boost::move_iterator<T*>, T*> priv_dummy_empty_proxy()
   {
      return container_detail::insert_range_proxy<Allocator, geofeatures_boost::move_iterator<T*>, T*>
         (::geofeatures_boost::make_move_iterator((T *)0));
   }
   ...
   void priv_destroy_last_n(const size_type n) BOOST_NOEXCEPT_OR_NOTHROW
   {
      ...
      if(!value_traits::trivial_dctr){
         ...
         geofeatures_boost::container::destroy_alloc_n(this->get_stored_allocator(), destroy_pos, n);
      }
   ...
   void priv_uninitialized_construct_at_end(InpIt first, InpIt last)
   {
      ...
      T* const new_end_pos = geofeatures_boost::container::uninitialized_copy_alloc(this->m_holder.alloc(), first, last, old_end_pos);
   ...
   iterator priv_insert(const const_iterator &p, BOOST_FWD_REF(U) x)
   {
      return this->priv_forward_range_insert
         ( vector_iterator_get_ptr(p), 1, container_detail::get_insert_value_proxy<T*, Allocator>(::geofeatures_boost::forward<U>(x)));
   }
   ...
   void priv_push_back(BOOST_FWD_REF(U) u)
   {
      if (BOOST_LIKELY(this->room_enough())){
         ...
         allocator_traits_type::construct
            ...
            , ::geofeatures_boost::forward<U>(u) );
         ++this->m_holder.m_size;
      }
      else{
         this->priv_forward_range_insert_no_capacity
            ( this->back_ptr(), 1
            , this->priv_single_insert_proxy(::geofeatures_boost::forward<U>(u)), alloc_version());
      }
   }
      ...
      (size_type first_pos, size_type last_pos, size_type limit_pos, size_type shift_count)
   {
      ...
      if((last_pos + shift_count) <= limit_pos){
         //All move assigned
         geofeatures_boost::container::move_backward(first_ptr, last_ptr, last_ptr + shift_count);
      }
      //Case B:
      else if((first_pos + shift_count) >= limit_pos){
         //All uninitialized_moved
         ::geofeatures_boost::container::uninitialized_move_alloc
      ...
      //Case C:
         ...
         ::geofeatures_boost::container::uninitialized_move_alloc(this->m_holder.alloc(), boundary_ptr, last_ptr, limit_ptr);
         //The rest is move assigned
         geofeatures_boost::container::move_backward(first_ptr, boundary_ptr, limit_ptr);
      }
      return hole_size;
   }
   ...
   void priv_forward_range_insert_expand_forward(T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if (!elems_after){
         ...
         geofeatures_boost::container::move_backward(pos, old_finish - n, old_finish);
         ...
         ::geofeatures_boost::container::uninitialized_move_alloc(this->m_holder.alloc(), pos, old_finish, pos + n);
         BOOST_TRY{
         ...
         BOOST_CATCH(...){
            geofeatures_boost::container::destroy_alloc_n(this->get_stored_allocator(), pos + n, elems_after);
            BOOST_RETHROW
         }
         BOOST_CATCH_END
      }
      ...
      (T* const new_start, size_type new_cap, T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if(old_buffer){
         new_finish = ::geofeatures_boost::container::uninitialized_move_alloc
      ...
      if(old_buffer){
         ...
         if(!value_traits::trivial_dctr_after_move)
            geofeatures_boost::container::destroy_alloc_n(this->get_stored_allocator(), old_buffer, this->m_holder.m_size);
          ...
          T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if(s_before >= before_plus_new){
         ...
         T *const new_elem_pos =
            ::geofeatures_boost::container::uninitialized_move_alloc(this->m_holder.alloc(), old_start, pos, new_start);
         ...
         //s_before is so big that divides old_end
            ...
            if(!value_traits::trivial_dctr){
               ...
               ::geofeatures_boost::container::move(pos + raw_gap, old_finish, old_start);
         ...
         if (s_before <= elemsbefore) {
            ...
            T *const next = ::geofeatures_boost::container::move(old_start + s_before, pos, old_start);
            ...
            if(!do_after && (n != s_before)){
               ...
               ::geofeatures_boost::container::move(pos, old_finish, next + new_1st_range);
            }
         }
         else {
            ...
            T * const new_pos = ::geofeatures_boost::container::uninitialized_move_alloc
            ...
            if(do_after){
               ...
               //Displace old_end
               T* const move_end = ::geofeatures_boost::container::move(pos, old_finish, move_start);
               //Destroy remaining moved elements from old_end except if they
               //have trivial destructor after being moved
               size_type n_destroy = s_before - n;
               if(!value_traits::trivial_dctr_after_move)
                  geofeatures_boost::container::destroy_alloc_n(this->get_stored_allocator(), move_end, n_destroy);
         ...
         if(do_after){
            ...
            if (elemsafter >= n_after){
               ...
               geofeatures_boost::container::move_backward(pos, finish_n, old_finish);
...
}} //namespace geofeatures_boost::container
...
struct has_trivial_destructor_after_move<geofeatures_boost::container::vector<T, Allocator> >
{
   typedef typename ::geofeatures_boost::container::allocator_traits<Allocator>::pointer pointer;
   static const bool value = ::geofeatures_boost::has_trivial_destructor_after_move<Allocator>::value &&
                             ::geofeatures_boost::has_trivial_destructor_after_move<pointer>::value;
};
