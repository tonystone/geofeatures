...
struct tree_opt
{
   static const geofeatures_boost::container::tree_type_enum tree_type = TreeType;
...
//! by \c geofeatures_boost::container::set, \c geofeatures_boost::container::multiset
//! \c geofeatures_boost::container::map and \c geofeatures_boost::container::multimap.
//! Supported options are: \c geofeatures_boost::container::optimize_size and \c geofeatures_boost::container::tree_type
...
{
   /// @cond
   typedef typename ::geofeatures_boost::intrusive::pack_options
      < tree_assoc_defaults,
