...
using geofeatures_boost::intrusive::tree_value_compare;

template<class VoidPointer, geofeatures_boost::container::tree_type_enum tree_type_value, bool OptimizeSize>
struct intrusive_tree_hook;

template<class VoidPointer, bool OptimizeSize>
struct intrusive_tree_hook<VoidPointer, geofeatures_boost::container::red_black_tree, OptimizeSize>
{
...
template<class VoidPointer, bool OptimizeSize>
struct intrusive_tree_hook<VoidPointer, geofeatures_boost::container::avl_tree, OptimizeSize>
{
...
template<class VoidPointer, bool OptimizeSize>
struct intrusive_tree_hook<VoidPointer, geofeatures_boost::container::scapegoat_tree, OptimizeSize>
{
...
template<class VoidPointer, bool OptimizeSize>
struct intrusive_tree_hook<VoidPointer, geofeatures_boost::container::splay_tree, OptimizeSize>
{
   typedef typename container_detail::bi::make_bs_set_base_hook
      < container_detail::bi::void_pointer<VoidPointer>
      , container_detail::bi::link_mode<container_detail::bi::normal_link>
...
{
   typedef pair<typename geofeatures_boost::move_detail::remove_const<T1>::type, T2> type;
};

//The node to be store in the tree
template <class T, class VoidPointer, geofeatures_boost::container::tree_type_enum tree_type_value, bool OptimizeSize>
struct tree_node
   :  public intrusive_tree_hook<VoidPointer, tree_type_value, OptimizeSize>::type
{
   ...
   {
      const_cast<T1&>(m_data.first) = ::geofeatures_boost::move(p.first);
      m_data.second = ::geofeatures_boost::move(p.second);
   }
   ...
   {  m_data = ::geofeatures_boost::move(v); }
};
...
template< class NodeType, class NodeCompareType
        ...
        , geofeatures_boost::container::tree_type_enum tree_type_value>
struct intrusive_tree_dispatch;

template<class NodeType, class NodeCompareType, class SizeType, class HookType>
struct intrusive_tree_dispatch
   <NodeType, NodeCompareType, SizeType, HookType, geofeatures_boost::container::red_black_tree>
{
...
template<class NodeType, class NodeCompareType, class SizeType, class HookType>
struct intrusive_tree_dispatch
   <NodeType, NodeCompareType, SizeType, HookType, geofeatures_boost::container::avl_tree>
{
...
template<class NodeType, class NodeCompareType, class SizeType, class HookType>
struct intrusive_tree_dispatch
   <NodeType, NodeCompareType, SizeType, HookType, geofeatures_boost::container::scapegoat_tree>
{
...
template<class NodeType, class NodeCompareType, class SizeType, class HookType>
struct intrusive_tree_dispatch
   <NodeType, NodeCompareType, SizeType, HookType, geofeatures_boost::container::splay_tree>
{
...
template<class Allocator, class ValueCompare, geofeatures_boost::container::tree_type_enum tree_type_value, bool OptimizeSize>
struct intrusive_tree_type
{
   private:
   typedef typename geofeatures_boost::container::
...
template<geofeatures_boost::container::tree_type_enum tree_type_value>
      ...
      >
{
   ...
   typedef geofeatures_boost::container::
   ...
   typedef geofeatures_boost::container::reverse_iterator<iterator>                 reverse_iterator;
   typedef geofeatures_boost::container::reverse_iterator<const_iterator>           const_reverse_iterator;
      ...
      : AllocHolder(value_compare(comp), a)
   {
      if(unique_insertion){
         ...
         this->allocate_many_and_construct
            ( first, geofeatures_boost::container::iterator_distance(first, last)
      ...
      :  AllocHolder(x.value_comp(), a)
   {
      if(this->node_alloc() == x.node_alloc()){
         ...
         this->icont().clone_from
            (geofeatures_boost::move(x.icont()), typename AllocHolder::move_cloner(*this), Destroyer(this->node_alloc()));
      }
   }
   ...
   tree& operator=(BOOST_COPY_ASSIGN_REF(tree) x)
   {
      if (&x != this){
         ...
         //automatically
         Icont other_tree(::geofeatures_boost::move(this->icont()));
                                 ...
                                 && geofeatures_boost::container::container_detail::is_nothrow_move_assignable<Compare>::value )
   {
      ...
      if(propagate_alloc || allocators_equal){
         ...
         //Obtain resources
         this->icont() = geofeatures_boost::move(x.icont());
      }
      //Else do a one by one move
         ...
         //Now recreate the source tree reusing nodes stored by other_tree
         this->icont().clone_from
            (::geofeatures_boost::move(x.icont())
   ...
   {
      NodePtr tmp = AllocHolder::create_node(geofeatures_boost::forward<MovableConvertible>(v));
      scoped_destroy_deallocator<NodeAlloc> destroy_deallocator(tmp, this->node_alloc());
      iterator ret(this->icont().insert_unique_commit(*tmp, data));
      destroy_deallocator.release();
      return ret;
   ...
   std::pair<iterator,bool> insert_unique(BOOST_FWD_REF(MovableConvertible) v)
   {
      ...
      std::pair<iterator,bool> ret =
         this->insert_unique_check(KeyOfValue()(v), data);
      if(ret.second){
         ret.first = this->insert_unique_commit(geofeatures_boost::forward<MovableConvertible>(v), data);
      }
      return ret;
   }
   ...
   {  return this->emplace_unique_impl(AllocHolder::create_node(geofeatures_boost::forward<Args>(args)...));   }

   template <class... Args>
   iterator emplace_hint_unique(const_iterator hint, BOOST_FWD_REF(Args)... args)
   {  return this->emplace_unique_hint_impl(hint, AllocHolder::create_node(geofeatures_boost::forward<Args>(args)...));   }

   template <class... Args>
   iterator emplace_equal(BOOST_FWD_REF(Args)... args)
   {
      NodePtr tmp(AllocHolder::create_node(geofeatures_boost::forward<Args>(args)...));
      scoped_destroy_deallocator<NodeAlloc> destroy_deallocator(tmp, this->node_alloc());
   ...
   iterator insert_unique(const_iterator hint, BOOST_FWD_REF(MovableConvertible) v)
   {
      ...
      if(!ret.second)
         return ret.first;
      return this->insert_unique_commit(geofeatures_boost::forward<MovableConvertible>(v), data);
   }
   ...
   friend bool operator<(const tree& x, const tree& y)
   {  return ::geofeatures_boost::container::algo_lexicographical_compare(x.begin(), x.end(), y.begin(), y.end());  }
...
struct has_trivial_destructor_after_move
   < 
      ::geofeatures_boost::container::container_detail::tree
