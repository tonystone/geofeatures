...
inline typename ::geofeatures_boost::move_detail::enable_if_and
   < T &
   , geofeatures_boost::container::container_detail::is_std_pair<T>
...
struct pair
{
   ...
   pair(BOOST_RV_REF(pair) p)
      : first(::geofeatures_boost::move(p.first)), second(::geofeatures_boost::move(p.second))
   {}
   ...
   pair(BOOST_FWD_REF(U) u, BOOST_FWD_REF(V) v)
      : first(::geofeatures_boost::forward<U>(u))
      , second(::geofeatures_boost::forward<V>(v))
   {}
   ...
   {
      first  = ::geofeatures_boost::move(p.first);
      second = ::geofeatures_boost::move(p.second);
      return *this;
   }

   template <class D, class S>
   typename ::geofeatures_boost::container::container_detail::disable_if_or
      < pair &
      , ::geofeatures_boost::container::container_detail::is_same<T1, D>
      , ::geofeatures_boost::container::container_detail::is_same<T2, S>
      >::type
...
//std::pair copy assignment
   ...
   void swap(pair& p)
   {
      ::geofeatures_boost::adl_move_swap(this->first, p.first);
      ::geofeatures_boost::adl_move_swap(this->second, p.second);
   }
};
...
struct is_enum< ::geofeatures_boost::container::container_detail::pair<T, U> >
{
   static const bool value = false;
};
...
template <class T1, class T2>
struct is_class< ::geofeatures_boost::container::container_detail::pair<T1, T2> >
{
   static const bool value = true;
};
...
template<class T1, class T2>
struct has_move_emulation_enabled< ::geofeatures_boost::container::container_detail::pair<T1, T2> >
{
   static const bool value = true;
};
...
template <class T1, class T2>
struct is_class_or_union< ::geofeatures_boost::container::container_detail::pair<T1, T2> >
//This specialization is needed to avoid instantiation of pair in
//is_class, and allow recursive maps.
{
   static const bool value = true;
