...
class basic_multiallocation_chain
{
   ...
   typedef typename geofeatures_boost::intrusive::pointer_traits
   ...
   typedef bi::slist< node
                    , bi::linear<true>
                    , bi::cache_last<true>
                    , bi::size_type<typename geofeatures_boost::container::container_detail::make_unsigned<difference_type>::type>
                    > slist_impl_t;
   ...
   basic_multiallocation_chain(BOOST_RV_REF(basic_multiallocation_chain) other)
      :  slist_impl_(::geofeatures_boost::move(other.slist_impl_))
   {}
   ...
   {
      typedef typename geofeatures_boost::intrusive::pointer_traits<char_ptr> char_pointer_traits;
   ...
   : public MultiallocationChain
{
   ...
   transform_multiallocation_chain(BOOST_RV_REF(transform_multiallocation_chain) other)
      : MultiallocationChain(::geofeatures_boost::move(static_cast<MultiallocationChain&>(other)))
   {}
   ...
   transform_multiallocation_chain& operator=(BOOST_RV_REF(transform_multiallocation_chain) other)
   {
      return static_cast<MultiallocationChain&>
         (this->MultiallocationChain::operator=(::geofeatures_boost::move(static_cast<MultiallocationChain&>(other))));
   }
/*
