...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace container { namespace container_detail {
...
struct move_insert_range_proxy
{
   ...
   {
      this->first_ = ::geofeatures_boost::container::uninitialized_move_alloc_n_source
         (a, this->first_, n, p);
   }

   void copy_n_and_update(Allocator &, Iterator p, size_type n)
   {
      this->first_ = ::geofeatures_boost::container::move_n_source(this->first_, n, p);
   }
...
struct insert_range_proxy
{
   ...
   void uninitialized_copy_n_and_update(Allocator &a, Iterator p, size_type n)
   {
      this->first_ = ::geofeatures_boost::container::uninitialized_copy_alloc_n_source(a, this->first_, n, p);
   }

   void copy_n_and_update(Allocator &, Iterator p, size_type n)
   {
      this->first_ = ::geofeatures_boost::container::copy_n_source(this->first_, n, p);
   }
...
struct insert_n_copies_proxy
{
   ...
   {  geofeatures_boost::container::uninitialized_fill_alloc_n(a, v_, n, p);  }
...
{
   typedef ::geofeatures_boost::container::allocator_traits<Allocator> alloc_traits;
   typedef typename allocator_traits<Allocator>::size_type size_type;
   typedef typename allocator_traits<Allocator>::value_type value_type;

   void uninitialized_copy_n_and_update(Allocator &a, Iterator p, size_type n) const
   {  geofeatures_boost::container::uninitialized_value_init_alloc_n(a, n, p);  }
...
struct insert_default_initialized_n_proxy
{
   ...
   void uninitialized_copy_n_and_update(Allocator &a, Iterator p, size_type n) const
   {  geofeatures_boost::container::uninitialized_default_init_alloc_n(a, n, p);  }
...
struct insert_move_proxy
{
   ...
   {
      BOOST_ASSERT(n == 1);  (void)n;
      alloc_traits::construct( a, iterator_to_raw_pointer(p), ::geofeatures_boost::move(v_) );
   }

   void copy_n_and_update(Allocator &, Iterator p, size_type n) const
   {
      BOOST_ASSERT(n == 1);  (void)n;
      *p = ::geofeatures_boost::move(v_);
   }
...
insert_move_proxy<Allocator, It> get_insert_value_proxy(BOOST_RV_REF(typename geofeatures_boost::container::iterator_traits<It>::value_type) v)
{
   return insert_move_proxy<Allocator, It>(v);
}

template<class It, class Allocator>
insert_copy_proxy<Allocator, It> get_insert_value_proxy(const typename geofeatures_boost::container::iterator_traits<It>::value_type &v)
{
...
struct insert_nonmovable_emplace_proxy
{
   ...
   {
      BOOST_ASSERT(n == 1); (void)n;
      alloc_traits::construct( a, iterator_to_raw_pointer(p), ::geofeatures_boost::forward<Args>(get<IdxPack>(this->args_))... );
   }
   ...
   :  public insert_nonmovable_emplace_proxy<Allocator, Iterator, Args...>
{
   ...
   explicit insert_emplace_proxy(BOOST_FWD_REF(Args)... args)
      : base_t(::geofeatures_boost::forward<Args>(args)...)
   {}
   ...
   void priv_copy_some_and_update(Allocator &a, const index_tuple<IdxPack...>&, Iterator p, size_type n)
   {
      ...
      alloc_traits::construct(a, vp,
         ::geofeatures_boost::forward<Args>(get<IdxPack>(this->args_))...);
      BOOST_TRY{
         *p = ::geofeatures_boost::move(*vp);
      }
      BOOST_CATCH(...){
...
template<class Allocator, class Iterator>
struct insert_emplace_proxy<Allocator, Iterator, typename geofeatures_boost::container::allocator_traits<Allocator>::value_type>
   : public insert_move_proxy<Allocator, Iterator>
{
   explicit insert_emplace_proxy(typename geofeatures_boost::container::allocator_traits<Allocator>::value_type &&v)
...
struct insert_emplace_proxy<Allocator, Iterator
   , typename geofeatures_boost::container::container_detail::add_const<typename geofeatures_boost::container::allocator_traits<Allocator>::value_type>::type
   >
   : public insert_copy_proxy<Allocator, Iterator>
{
   explicit insert_emplace_proxy(const typename geofeatures_boost::container::allocator_traits<Allocator>::value_type &v)
...
//Specializations to avoid an unneeded temporary when emplacing from a single argument o type value_type
template<class Allocator, class Iterator>
struct insert_emplace_proxy_arg1<Allocator, Iterator, ::geofeatures_boost::rv<typename geofeatures_boost::container::allocator_traits<Allocator>::value_type> >
   : public insert_move_proxy<Allocator, Iterator>
{
   explicit insert_emplace_proxy_arg1(typename geofeatures_boost::container::allocator_traits<Allocator>::value_type &v)
   : insert_move_proxy<Allocator, Iterator>(v)
   {}
};

template<class Allocator, class Iterator>
struct insert_emplace_proxy_arg1<Allocator, Iterator, typename geofeatures_boost::container::allocator_traits<Allocator>::value_type>
   : public insert_copy_proxy<Allocator, Iterator>
{
   explicit insert_emplace_proxy_arg1(const typename geofeatures_boost::container::allocator_traits<Allocator>::value_type &v)
   : insert_copy_proxy<Allocator, Iterator>(v)
   {}
};
