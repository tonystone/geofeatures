...
template<class Iter>
struct decode_type_impl<geofeatures_boost::mpl::size_t<PTR_DATA_MEM_ID>, Iter>
{
    typedef Iter iter0;
    ...
    typedef typename decode_type_impl<geofeatures_boost::mpl::size_t<PTR_DATA_MEM_ID>, Iter>::template workaround<p1>::type type;
    typedef iter2 iter;
};
