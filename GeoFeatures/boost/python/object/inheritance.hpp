...
struct dynamic_id_generator
  : mpl::if_<
        geofeatures_boost::is_polymorphic<T>
        , geofeatures_boost::python::objects::polymorphic_id_generator<T>
        , geofeatures_boost::python::objects::non_polymorphic_id_generator<T>
    >
{};
...
inline void register_conversion(
    bool is_downcast = ::geofeatures_boost::is_base_and_derived<Source,Target>::value
...
}}} // namespace geofeatures_boost::python::object
