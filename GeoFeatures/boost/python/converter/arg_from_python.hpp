...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace python { namespace converter {
...
{
    typedef typename geofeatures_boost::add_reference<
        T
...
struct back_reference_arg_from_python
    : geofeatures_boost::python::arg_from_python<typename T::type>
{
    typedef T result_type;
    ...
    T operator()();
 private:
    typedef geofeatures_boost::python::arg_from_python<typename T::type> base;
    PyObject* m_source;
};
          ...
          , if_2<
              ...
              , if_2<
                  ...
                  , if_2<
                      ...
                      , mpl::if_<
                            geofeatures_boost::python::is_back_reference<T>
...
}}} // namespace geofeatures_boost::python::converter
