...
template <class T>
inline python::type_info unwind_type_id_(geofeatures_boost::type<T>* = 0, mpl::false_ * =0)
{
    return geofeatures_boost::python::detail::unwind_type<unwind_type_id_helper, T> ();
}

inline python::type_info unwind_type_id_(geofeatures_boost::type<void>* = 0, mpl::true_* =0)
{
    return type_id<void>();
}

template <class T>
inline python::type_info unwind_type_id(geofeatures_boost::type<T>* p= 0)
{
    return unwind_type_id_(p, (mpl::bool_<geofeatures_boost::is_void<T>::value >*)0 );
}
}
...
struct expected_pytype_for_arg
{
    static PyTypeObject const *get_pytype()
    {
        const converter::registration *r=converter::registry::query(
            detail::unwind_type_id_((geofeatures_boost::type<T>*)0, (mpl::bool_<geofeatures_boost::is_void<T>::value >*)0 )
            );
