...
#define BOOST_PYTHON_INDEXING_CHECK_INVARIANT check_invariant()
    ...
    public:
        ...
        first_proxy(index_type i)
        {
            ...
            return geofeatures_boost::detail::lower_bound(
            ...
            Container& container, PySliceObject* slice, Index& from_, Index& to_)
        {
            ...
            if (Py_None == slice->start) {
                ...
                if (from < 0) // Clip lower bounds to zero
                    from = 0;
                from_ = geofeatures_boost::numeric_cast<Index>(from);
            ...
            if (Py_None == slice->stop) {
                ...
                if (to < 0)
                    to = 0;
                to_ = geofeatures_boost::numeric_cast<Index>(to);
                if (to_ > max_index)
                    to_ = max_index;
            }
        }        
    ...
    using geofeatures_boost::python::get_pointer;
    using geofeatures_boost::get_pointer;
}} // namespace python::detail
#endif
