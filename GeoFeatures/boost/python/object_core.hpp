...
// attribute/item access or addition.
  ...
  //
  BOOST_PYTHON_IS_XXX_DEF(proxy, geofeatures_boost::python::api::proxy, 1)
...
# define BOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(derived, base)               \
    inline explicit derived(::geofeatures_boost::python::detail::borrowed_reference p)     \
        : base(p) {}                                                           \
    inline explicit derived(::geofeatures_boost::python::detail::new_reference p)          \
        : base(p) {}                                                           \
    inline explicit derived(::geofeatures_boost::python::detail::new_non_null_reference p) \
        : base(p) {}
  ...
  struct object_initializer_impl<false, true>
  {
      ...
      get(T const& x, U)
      {
          return python::incref(get_managed_object(x, geofeatures_boost::python::tag));
      }
  };
...
{ 
  ...
  return geofeatures_boost::python::detail::args_proxy(x); 
} 
...
{ 
  ...
  PyObject *result = PyObject_Call(get_managed_object(self, geofeatures_boost::python::tag), 
                                   args.operator object().ptr(), 
                                   0); 
  return object(geofeatures_boost::python::detail::new_reference(result)); 
