...
template <class T>
inline typeinfo msvc_typeid(geofeatures_boost::type<T>*)
{
    return detail::typeid_ref(
        (geofeatures_boost::type<T>*)0, detail::is_ref_tester1(type<T>())
        );
}

template <>
inline typeinfo msvc_typeid<void>(geofeatures_boost::type<void>*)
{
    return typeid(void);
}
...
{
    return msvc_typeid((geofeatures_boost::type<char const[3]>*)0)
        , msvc_typeid((geofeatures_boost::type<char[3]>*)0);
}
#  endif

}}} // namespace geofeatures_boost::python::detail
