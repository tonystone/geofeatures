...
template <class Generator, class U>
inline typename Generator::result_type
unwind_type(geofeatures_boost::type<U>*p = 0, Generator* = 0);
#endif
...
inline typename Generator::result_type
#ifndef _MSC_VER
unwind_type(geofeatures_boost::type<U>*, Generator*)
#else
unwind_type(geofeatures_boost::type<U>*p =0, Generator* =0)
#endif
{
    BOOST_STATIC_CONSTANT(int, indirection
        = (geofeatures_boost::is_pointer<U>::value ? pointer_ : 0)
                             + (indirect_traits::is_reference_to_pointer<U>::value
                             ? reference_to_pointer_
                             : geofeatures_boost::is_reference<U>::value
                             ? reference_
                             : 0));
