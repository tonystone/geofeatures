...
using geofeatures_boost::python::self_ns::abs;
using geofeatures_boost::python::self_ns::int_;
using geofeatures_boost::python::self_ns::long_;
using geofeatures_boost::python::self_ns::float_;
using geofeatures_boost::python::self_ns::complex_;
using geofeatures_boost::python::self_ns::str;
using geofeatures_boost::python::self_ns::repr;
using geofeatures_boost::python::self_ns::pow;
# endif
