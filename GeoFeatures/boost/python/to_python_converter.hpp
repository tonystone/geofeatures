...
namespace detail
{
    ...
    template<class T>
    struct test_get_pytype : geofeatures_boost::mpl::bool_<test_get_pytype_base<T>::value> 
    {
    };
...
{
#ifndef BOOST_PYTHON_NO_PY_SIGNATURES
    typedef geofeatures_boost::mpl::bool_<has_get_pytype> HasGetPytype;

    static PyTypeObject const* get_pytype_1(geofeatures_boost::mpl::true_ *)
    {
        return Conversion::get_pytype();
    }

    static PyTypeObject const* get_pytype_1(geofeatures_boost::mpl::false_ *)
    {
        return 0;
    }
