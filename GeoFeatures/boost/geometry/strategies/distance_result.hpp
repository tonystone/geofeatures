...
struct distance_result
    <
        Geometry1, geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Strategy
    >
{
    // A set of all variant type combinations that are compatible and
    // implemented
    typedef typename util::combine_if<
        typename geofeatures_boost::mpl::vector1<Geometry1>,
        ...
        //
        // util::is_implemented2<geofeatures_boost::mpl::_1, geofeatures_boost::mpl::_2, dispatch::distance<geofeatures_boost::mpl::_1, geofeatures_boost::mpl::_2> >
        geofeatures_boost::mpl::always<geofeatures_boost::mpl::true_>
    ...
    typedef typename compress_variant<
        typename transform_variant<
            ...
            resolve_strategy::distance_result<
                geofeatures_boost::mpl::first<geofeatures_boost::mpl::_>,
                geofeatures_boost::mpl::second<geofeatures_boost::mpl::_>,
                Strategy
            >,
            geofeatures_boost::mpl::back_inserter<geofeatures_boost::mpl::vector0<> >
        >::type
    >::type type;
};
...
struct distance_result
    ...
    > : public distance_result
        <
            Geometry2, geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Strategy
        >
{};
