...
struct shift<radian>
{
    static inline double full() { return 2.0 * geofeatures_boost::math::constants::pi<double>(); }
    static inline double half() { return geofeatures_boost::math::constants::pi<double>(); }
};
