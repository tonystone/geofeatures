...
// Don't use namespace geofeatures_boost::geometry, to enable the library to stream custom
// geometries which are living outside the namespace geofeatures_boost::geometry
...
{
    os << geofeatures_boost::geometry::wkt(geom);
    return os;
}
