...
/*!
\defgroup predicates Predicates (geofeatures_boost::geometry::index::)
*/
...
geofeatures_boost::geometry::comparable_distance() is used to perform the calculation.
...
geofeatures_boost::tuples::cons<
    Pred1,
    geofeatures_boost::tuples::cons<Pred2, geofeatures_boost::tuples::null_type>
>
operator&&(Pred1 const& p1, Pred2 const& p2)
{
    /*typedef typename geofeatures_boost::mpl::if_c<is_predicate<Pred1>::value, Pred1, Pred1 const&>::type stored1;
    typedef typename geofeatures_boost::mpl::if_c<is_predicate<Pred2>::value, Pred2, Pred2 const&>::type stored2;*/
    namespace bt = geofeatures_boost::tuples;
...
typename tuples::push_back<
    geofeatures_boost::tuples::cons<Head, Tail>, Pred
>::type
operator&&(geofeatures_boost::tuples::cons<Head, Tail> const& t, Pred const& p)
{
    //typedef typename geofeatures_boost::mpl::if_c<is_predicate<Pred>::value, Pred, Pred const&>::type stored;
    namespace bt = geofeatures_boost::tuples;
