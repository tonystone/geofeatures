...
/*!
\defgroup rtree_functions R-tree free functions (geofeatures_boost::geometry::index::)
*/
...
\li <tt>geofeatures_boost::geometry::index::linear</tt>,
 \li <tt>geofeatures_boost::geometry::index::quadratic</tt>,
 \li <tt>geofeatures_boost::geometry::index::rstar</tt>.

\par
Predefined algorithms with run-time parameters are:
 \li \c geofeatures_boost::geometry::index::dynamic_linear,
 \li \c geofeatures_boost::geometry::index::dynamic_quadratic,
 \li \c geofeatures_boost::geometry::index::dynamic_rstar.
...
handle <tt>std::pair<Indexable, T></tt>, <tt>geofeatures_boost::tuple<Indexable, ...></tt>
...
returns the result of <tt>geofeatures_boost::geometry::equals()</tt> for types adapted to
...
public:
    ...
    */
        ...
        : m_members(getter, equal, parameters, allocator)
    {
        typedef detail::rtree::pack<value_type, options_type, translator_type, box_type, allocators_type> pack;
        size_type vc = 0, ll = 0;
        m_members.root = pack::apply(::geofeatures_boost::begin(rng), ::geofeatures_boost::end(rng), vc, ll,
                                     m_members.parameters(), m_members.translator(), m_members.allocators());
        m_members.values_count = vc;
        m_members.leafs_level = ll;
    }
    ...
    */
    inline rtree(BOOST_RV_REF(rtree) src)
        : m_members(src.m_members.indexable_getter(),
                    src.m_members.equal_to(),
                    src.m_members.parameters(),
                    geofeatures_boost::move(src.m_members.allocators()))
    {
        geofeatures_boost::swap(m_members.values_count, src.m_members.values_count);
        geofeatures_boost::swap(m_members.leafs_level, src.m_members.leafs_level);
        geofeatures_boost::swap(m_members.root, src.m_members.root);
    }
...
// TODO - shouldn't here propagate_on_container_copy_assignment be checked like in operator=(const&)?
    ...
    */
    ...
    {
        geofeatures_boost::swap(m_members.indexable_getter(), other.m_members.indexable_getter());
        geofeatures_boost::swap(m_members.equal_to(), other.m_members.equal_to());
        geofeatures_boost::swap(m_members.parameters(), other.m_members.parameters());
        ...
        geofeatures_boost::swap(m_members.values_count, other.m_members.values_count);
        geofeatures_boost::swap(m_members.leafs_level, other.m_members.leafs_level);
        geofeatures_boost::swap(m_members.root, other.m_members.root);
    }
    ...
    */
    ...
    inline void insert(ConvertibleOrRange const& conv_or_rng)
    {
        typedef geofeatures_boost::mpl::bool_
            <
                geofeatures_boost::is_convertible<ConvertibleOrRange, value_type>::value
            > is_conv_t;
    ...
    */
    ...
    \li \c geofeatures_boost::geometry::index::contains(),
    \li \c geofeatures_boost::geometry::index::covered_by(),
    \li \c geofeatures_boost::geometry::index::covers(),
    \li \c geofeatures_boost::geometry::index::disjoint(),
    \li \c geofeatures_boost::geometry::index::intersects(),
    \li \c geofeatures_boost::geometry::index::overlaps(),
    \li \c geofeatures_boost::geometry::index::within(),

    It is possible to negate spatial predicates:
    \li <tt>! geofeatures_boost::geometry::index::contains()</tt>,
    \li <tt>! geofeatures_boost::geometry::index::covered_by()</tt>,
    \li <tt>! geofeatures_boost::geometry::index::covers()</tt>,
    \li <tt>! geofeatures_boost::geometry::index::disjoint()</tt>,
    \li <tt>! geofeatures_boost::geometry::index::intersects()</tt>,
    \li <tt>! geofeatures_boost::geometry::index::overlaps()</tt>,
    \li <tt>! geofeatures_boost::geometry::index::within()</tt>
    ...
    \li \c geofeatures_boost::geometry::index::satisfies().
    ...
    \li \c geofeatures_boost::geometry::index::nearest().
    ...
    tree.query(bgi::intersects(box),
               geofeatures_boost::make_function_output_iterator(do_something()));
    ...
    tree.query(bgi::intersects(box),
               geofeatures_boost::make_function_output_iterator([](value_type const& val){
                   // do something
               }));

    // C++14 (generic lambda expression)
    tree.query(bgi::intersects(box),
               geofeatures_boost::make_function_output_iterator([](auto const& val){
                   // do something
               }));
    \endverbatim
    ...
    */
    ...
    size_type query(Predicates const& predicates, OutIter out_it) const
    {
        ...
        return query_dispatch(predicates, out_it, geofeatures_boost::mpl::bool_<is_distance_predicate>());
    }
...
public:
    ...
    */
    ...
    size_type count(ValueOrIndexable const& vori) const
    {
        ...
        typedef geofeatures_boost::mpl::int_
            <
                geofeatures_boost::is_same<ValueOrIndexable, value_type>::value ?
                    as_val :
                    geofeatures_boost::is_same<ValueOrIndexable, indexable_type>::value ?
                        as_ind :
                        geofeatures_boost::is_convertible<ValueOrIndexable, indexable_type>::value ?
                            as_ind :
                            geofeatures_boost::is_convertible<ValueOrIndexable, value_type>::value ?
                                as_val :
                                dont_know
            > variant;
...
// If exception is thrown, m_values_count may be invalid
    ...
    */
    ...
    inline void insert_dispatch(ValueConvertible const& val_conv,
                                geofeatures_boost::mpl::bool_<true> const& /*is_convertible*/)
    {
        if ( !m_members.root )
            this->raw_create();
    ...
    */
    ...
    inline void insert_dispatch(Range const& rng,
                                geofeatures_boost::mpl::bool_<false> const& /*is_convertible*/)
    {
        ...
        typedef typename geofeatures_boost::range_const_iterator<Range>::type It;
        for ( It it = geofeatures_boost::const_begin(rng); it != geofeatures_boost::const_end(rng) ; ++it )
            this->raw_insert(*it);
    }
    ...
    */
    template <typename Predicates, typename OutIter>
    size_type query_dispatch(Predicates const& predicates, OutIter out_it, geofeatures_boost::mpl::bool_<false> const& /*is_distance_predicate*/) const
    {
    ...
    */
    template <typename Predicates, typename OutIter>
    size_type query_dispatch(Predicates const& predicates, OutIter out_it, geofeatures_boost::mpl::bool_<true> const& /*is_distance_predicate*/) const
    {
    ...
    */
    ...
    public:
        ...
        members_holder(IndGet const& ind_get,
            ...
            , allocators_type(geofeatures_boost::forward<Alloc>(alloc))
            , values_count(0)
            , leafs_level(0)
            , root(0)
        {}
...
// the same as
std::for_each(geofeatures_boost::begin(tree), geofeatures_boost::end(tree), do_something());
\endverbatim
...
struct range_mutable_iterator
    <
        geofeatures_boost::geometry::index::rtree<Value, Parameters, IndexableGetter, EqualTo, Allocator>
    >
{
    typedef typename geofeatures_boost::geometry::index::rtree
        <
