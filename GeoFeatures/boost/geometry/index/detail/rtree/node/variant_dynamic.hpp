...
{
    typedef geofeatures_boost::variant<
...
public:
    ...
    inline allocators(BOOST_FWD_REF(allocators) a)
        : node_allocator_type(geofeatures_boost::move(a.node_allocator()))
    {}

    inline allocators & operator=(BOOST_FWD_REF(allocators) a)
    {
        node_allocator() = geofeatures_boost::move(a.node_allocator());
        return *this;
    }
    ...
    {
        geofeatures_boost::swap(node_allocator(), a.node_allocator());
    }
...
struct create_variant_node
{
    ...
    static inline VariantPtr apply(AllocNode & alloc_node)
    {
        ...
        Al::construct(alloc_node, geofeatures_boost::addressof(*p), Node(alloc_node)); // implicit cast to Variant
...
struct destroy_variant_node
{
    ...
    static inline void apply(AllocNode & alloc_node, VariantPtr n)
    {
        ...
        Al::destroy(alloc_node, geofeatures_boost::addressof(*n));
