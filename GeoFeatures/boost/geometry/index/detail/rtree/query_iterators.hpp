...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace geometry { namespace index { namespace detail { namespace rtree { namespace iterators {
...
public:
    ...
    const value_type * operator->() const
    {
        return geofeatures_boost::addressof(m_visitor.dereference());
    }
...
public:
    ...
    {
        const query_iterator_wrapper * p = dynamic_cast<const query_iterator_wrapper *>(geofeatures_boost::addressof(r));
...
class query_iterator
{
    ...
    typedef geofeatures_boost::scoped_ptr<iterator_base> iterator_ptr;
...
public:
    ...
    {
        if ( this != geofeatures_boost::addressof(o) )
        {
...
public:
    ...
    const value_type * operator->() const
    {
        return geofeatures_boost::addressof(m_ptr->dereference());
    }
...
}}}}}} // namespace geofeatures_boost::geometry::index::detail::rtree::iterators
