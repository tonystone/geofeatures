...
// TODO - use geofeatures_boost::move?
template<typename T>
...
public:
    ...
    {
        geofeatures_boost::serialization::load_construct_data_adl(ar, this->address(), version);
    }
...
private:
    geofeatures_boost::aligned_storage<sizeof(T), geofeatures_boost::alignment_of<T>::value> m_storage;
};
...
{
    namespace bs = geofeatures_boost::serialization;    
    serialization_storage<T> storage(ar, bs::version<T>::value);        // load_construct_data
    ar >> geofeatures_boost::serialization::make_nvp(name, *storage.address());   // serialize
...
{
    namespace bs = geofeatures_boost::serialization;
    bs::save_construct_data_adl(ar, geofeatures_boost::addressof(t), bs::version<T>::value);  // save_construct_data
    ar << geofeatures_boost::serialization::make_nvp(name, t);                                // serialize
    //ar << t;                                                                      // serialize
}
...
// geofeatures_boost::geometry::index::linear

template<class Archive, size_t Max, size_t Min>
void save_construct_data(Archive & ar, const geofeatures_boost::geometry::index::linear<Max, Min> * params, unsigned int )
{
    size_t max = params->get_max_elements(), min = params->get_min_elements();
    ar << geofeatures_boost::serialization::make_nvp("max", max);
    ar << geofeatures_boost::serialization::make_nvp("min", min);
}
template<class Archive, size_t Max, size_t Min>
void load_construct_data(Archive & ar, geofeatures_boost::geometry::index::linear<Max, Min> * params, unsigned int )
{
    size_t max, min;
    ar >> geofeatures_boost::serialization::make_nvp("max", max);
    ar >> geofeatures_boost::serialization::make_nvp("min", min);
    ...
    //::new(params)geofeatures_boost::geometry::index::linear<Max, Min>();
}
template<class Archive, size_t Max, size_t Min> void serialize(Archive &, geofeatures_boost::geometry::index::linear<Max, Min> &, unsigned int) {}

// geofeatures_boost::geometry::index::quadratic

template<class Archive, size_t Max, size_t Min>
void save_construct_data(Archive & ar, const geofeatures_boost::geometry::index::quadratic<Max, Min> * params, unsigned int )
{
    size_t max = params->get_max_elements(), min = params->get_min_elements();
    ar << geofeatures_boost::serialization::make_nvp("max", max);
    ar << geofeatures_boost::serialization::make_nvp("min", min);
...
template<class Archive, size_t Max, size_t Min>
void load_construct_data(Archive & ar, geofeatures_boost::geometry::index::quadratic<Max, Min> * params, unsigned int )
{
    size_t max, min;
    ar >> geofeatures_boost::serialization::make_nvp("max", max);
    ar >> geofeatures_boost::serialization::make_nvp("min", min);
    if ( max != params->get_max_elements() || min != params->get_min_elements() )
        ...
        BOOST_THROW_EXCEPTION(std::runtime_error("parameters not compatible"));
    // the constructor musn't be called for this type
    //::new(params)geofeatures_boost::geometry::index::quadratic<Max, Min>();
}
template<class Archive, size_t Max, size_t Min> void serialize(Archive &, geofeatures_boost::geometry::index::quadratic<Max, Min> &, unsigned int) {}

// geofeatures_boost::geometry::index::rstar

template<class Archive, size_t Max, size_t Min, size_t RE, size_t OCT>
void save_construct_data(Archive & ar, const geofeatures_boost::geometry::index::rstar<Max, Min, RE, OCT> * params, unsigned int )
{
    ...
    ar << geofeatures_boost::serialization::make_nvp("max", max);
    ar << geofeatures_boost::serialization::make_nvp("min", min);
    ar << geofeatures_boost::serialization::make_nvp("re", re);
    ar << geofeatures_boost::serialization::make_nvp("oct", oct);
}
template<class Archive, size_t Max, size_t Min, size_t RE, size_t OCT>
void load_construct_data(Archive & ar, geofeatures_boost::geometry::index::rstar<Max, Min, RE, OCT> * params, unsigned int )
{
    ...
    if ( max != params->get_max_elements() || min != params->get_min_elements() ||
        ...
        BOOST_THROW_EXCEPTION(std::runtime_error("parameters not compatible"));
    // the constructor musn't be called for this type
    //::new(params)geofeatures_boost::geometry::index::rstar<Max, Min, RE, OCT>();
}
template<class Archive, size_t Max, size_t Min, size_t RE, size_t OCT>
void serialize(Archive &, geofeatures_boost::geometry::index::rstar<Max, Min, RE, OCT> &, unsigned int) {}

// geofeatures_boost::geometry::index::dynamic_linear

template<class Archive>
inline void save_construct_data(Archive & ar, const geofeatures_boost::geometry::index::dynamic_linear * params, unsigned int )
{
    size_t max = params->get_max_elements(), min = params->get_min_elements();
    ar << geofeatures_boost::serialization::make_nvp("max", max);
    ar << geofeatures_boost::serialization::make_nvp("min", min);
...
template<class Archive>
inline void load_construct_data(Archive & ar, geofeatures_boost::geometry::index::dynamic_linear * params, unsigned int )
{
    size_t max, min;
    ar >> geofeatures_boost::serialization::make_nvp("max", max);
    ar >> geofeatures_boost::serialization::make_nvp("min", min);
    ::new(params)geofeatures_boost::geometry::index::dynamic_linear(max, min);
}
template<class Archive> void serialize(Archive &, geofeatures_boost::geometry::index::dynamic_linear &, unsigned int) {}

// geofeatures_boost::geometry::index::dynamic_quadratic

template<class Archive>
inline void save_construct_data(Archive & ar, const geofeatures_boost::geometry::index::dynamic_quadratic * params, unsigned int )
{
    size_t max = params->get_max_elements(), min = params->get_min_elements();
    ar << geofeatures_boost::serialization::make_nvp("max", max);
    ar << geofeatures_boost::serialization::make_nvp("min", min);
...
template<class Archive>
inline void load_construct_data(Archive & ar, geofeatures_boost::geometry::index::dynamic_quadratic * params, unsigned int )
{
    size_t max, min;
    ar >> geofeatures_boost::serialization::make_nvp("max", max);
    ar >> geofeatures_boost::serialization::make_nvp("min", min);
    ::new(params)geofeatures_boost::geometry::index::dynamic_quadratic(max, min);
}
template<class Archive> void serialize(Archive &, geofeatures_boost::geometry::index::dynamic_quadratic &, unsigned int) {}

// geofeatures_boost::geometry::index::dynamic_rstar

template<class Archive>
inline void save_construct_data(Archive & ar, const geofeatures_boost::geometry::index::dynamic_rstar * params, unsigned int )
{
    size_t max = params->get_max_elements()
         , min = params->get_min_elements()
         , re = params->get_reinserted_elements()
...
template<class Archive>
inline void load_construct_data(Archive & ar, geofeatures_boost::geometry::index::dynamic_rstar * params, unsigned int )
{
    size_t max, min, re, oct;
    ar >> geofeatures_boost::serialization::make_nvp("max", max);
    ar >> geofeatures_boost::serialization::make_nvp("min", min);
    ar >> geofeatures_boost::serialization::make_nvp("re", re);
    ar >> geofeatures_boost::serialization::make_nvp("oct", oct);
    ::new(params)geofeatures_boost::geometry::index::dynamic_rstar(max, min, re, oct);
}
template<class Archive> void serialize(Archive &, geofeatures_boost::geometry::index::dynamic_rstar &, unsigned int) {}

}} // geofeatures_boost::serialization
...
struct serialize_point
{
    ...
    static inline void save(Archive & ar, P const& p, unsigned int version)
    {
        ...
        ar << geofeatures_boost::serialization::make_nvp("c", c);
...
void save(Archive & ar, geofeatures_boost::geometry::model::point<T, D, C> const& p, unsigned int version)
{
    geofeatures_boost::geometry::index::detail::serialize_point< geofeatures_boost::geometry::model::point<T, D, C> >::save(ar, p, version);
}
template<class Archive, typename T, size_t D, typename C>
void load(Archive & ar, geofeatures_boost::geometry::model::point<T, D, C> & p, unsigned int version)
{
    geofeatures_boost::geometry::index::detail::serialize_point< geofeatures_boost::geometry::model::point<T, D, C> >::load(ar, p, version);
}
template<class Archive, typename T, size_t D, typename C>
inline void serialize(Archive & ar, geofeatures_boost::geometry::model::point<T, D, C> & o, const unsigned int version) { split_free(ar, o, version); }

template<class Archive, typename P>
inline void serialize(Archive & ar, geofeatures_boost::geometry::model::box<P> & b, const unsigned int)
{
    ar & geofeatures_boost::serialization::make_nvp("min", b.min_corner());
    ar & geofeatures_boost::serialization::make_nvp("max", b.max_corner());
}

}} // geofeatures_boost::serialization

// TODO - move to index/detail/rtree/visitors/save.hpp
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace geometry { namespace index { namespace detail { namespace rtree { namespace visitors {
...
public:
    ...
    inline void operator()(internal_node const& n)
    {
        ...
        m_archive << geofeatures_boost::serialization::make_nvp("s", s);
...
}}}}}} // geofeatures_boost::geometry::index::detail::rtree::visitors
...
private:
    ...
    node_pointer raw_apply(Archive & ar, unsigned int version, size_type leafs_level, size_type & values_count, parameters_type const& parameters, Translator const& translator, Allocators & allocators, size_type current_level = 0)
    {
        ...
        ar >> geofeatures_boost::serialization::make_nvp("s", elements_count);
...
}}}}} // geofeatures_boost::geometry::index::detail::rtree
...
}}}}} // namespace geofeatures_boost::geometry::index::detail::rtree

// TODO - move to index/serialization/rtree.hpp
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace serialization {

template<class Archive, typename V, typename P, typename I, typename E, typename A>
void save(Archive & ar, geofeatures_boost::geometry::index::rtree<V, P, I, E, A> const& rt, unsigned int version)
{
    namespace detail = geofeatures_boost::geometry::index::detail;

    typedef geofeatures_boost::geometry::index::rtree<V, P, I, E, A> rtree;
    ...
    ar << geofeatures_boost::serialization::make_nvp("values_count", tree.members().values_count);
    ar << geofeatures_boost::serialization::make_nvp("leafs_level", tree.members().leafs_level);
...
template<class Archive, typename V, typename P, typename I, typename E, typename A>
void load(Archive & ar, geofeatures_boost::geometry::index::rtree<V, P, I, E, A> & rt, unsigned int version)
{
    namespace detail = geofeatures_boost::geometry::index::detail;
    ...
    ar >> geofeatures_boost::serialization::make_nvp("values_count", values_count);
    ar >> geofeatures_boost::serialization::make_nvp("leafs_level", leafs_level);
...
void serialize(Archive & ar, geofeatures_boost::geometry::index::rtree<V, P, I, E, A> & rt, unsigned int version)
{
    split_free(ar, rt, version);
}

template<class Archive, typename V, typename P, typename I, typename E, typename A> inline
void serialize(Archive & ar, geofeatures_boost::geometry::index::rtree<V, P, I, E, A> const& rt, unsigned int version)
{
    split_free(ar, rt, version);
}
