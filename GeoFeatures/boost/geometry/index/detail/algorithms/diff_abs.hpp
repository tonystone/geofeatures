...
template <typename T>
inline T diff_abs_dispatch(T const& v1, T const& v2, geofeatures_boost::mpl::bool_<true> const& /*is_integral*/)
{
    return v1 < v2 ? v2 - v1 : v1 - v2;
}

template <typename T>
inline T diff_abs_dispatch(T const& v1, T const& v2, geofeatures_boost::mpl::bool_<false> const& /*is_integral*/)
{
    return ::fabs(v1 - v2);
}
