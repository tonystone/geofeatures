...
struct tuple_equals
{
    ...
    {
        typedef typename geofeatures_boost::tuples::element<I, Tuple>::type T;

        return equals<T>::apply(geofeatures_boost::get<I>(t1), geofeatures_boost::get<I>(t2))
...
This template is also specialized for std::pair<T1, T2> and geofeatures_boost::tuple<...>.

\tparam Value       The type of objects which are compared by this function object.
\tparam IsIndexable If true, Values are compared using geofeatures_boost::geometry::equals() functions.
*/
...
This specialization compares values of type geofeatures_boost::tuple<...>.
It compares all members of the tuple from the first one to the last one.
*/
template <typename T0, typename T1, typename T2, typename T3, typename T4,
          typename T5, typename T6, typename T7, typename T8, typename T9>
struct equal_to<geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>, false>
{
    typedef geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> value_type;
    ...
    */
    inline bool operator()(value_type const& l, value_type const& r) const
    {
        return detail::tuple_equals<
            value_type, 0, geofeatures_boost::tuples::length<value_type>::value
        >::apply(l ,r);
    }
};
...
The default version handles Values which are Indexables, std::pair<T1, T2>, geofeatures_boost::tuple<...>
and std::tuple<...> if STD tuples and variadic templates are supported.
All members are compared from left to right, Geometries using geofeatures_boost::geometry::equals() function,
