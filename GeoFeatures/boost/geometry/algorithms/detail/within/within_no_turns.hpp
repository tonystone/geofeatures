...
struct within_no_turns<Geometry1, Geometry2, ring_tag, polygon_tag>
{
    ...
    bool apply(Geometry1 const& geometry1, Geometry2 const& geometry2, Strategy const& strategy)
    {
        ...
        typedef typename geofeatures_boost::range_const_iterator
            ...
            >::type iterator;
        for ( iterator it = geofeatures_boost::begin(geometry::interior_rings(geometry2)) ;
              it != geofeatures_boost::end(geometry::interior_rings(geometry2)) ;
              ++it )
        {
            point2_type p;
    ...
    bool apply(Geometry1 const& geometry1, Geometry2 const& geometry2, Strategy const& strategy)
    {
        ...
        typedef typename geofeatures_boost::range_const_iterator
            <
                typename geometry::interior_type<Geometry2>::type
            >::type iterator2;
        for ( iterator2 it = geofeatures_boost::begin(geometry::interior_rings(geometry2)) ;
              it != geofeatures_boost::end(geometry::interior_rings(geometry2)) ;
              ++it )
        {
            point2_type p2;
            ...
            if ( detail::within::point_in_geometry(p2, geometry1, strategy) > 0 )
            {
                ...
                typedef typename geofeatures_boost::range_const_iterator
                    ...
                    >::type iterator1;
                for ( iterator1 it1 = geofeatures_boost::begin(geometry::interior_rings(geometry1)) ;
                      it1 != geofeatures_boost::end(geometry::interior_rings(geometry1)) ;
                      ++it1 )
                {
...
template <typename Geometry1,
          ...
          typename Tag1 = typename geometry::tag<Geometry1>::type,
          typename Tag2 = typename geometry::tag<Geometry2>::type,
          bool IsMulti1 = geofeatures_boost::is_base_of<geometry::multi_tag, Tag1>::value,
          bool IsMulti2 = geofeatures_boost::is_base_of<geometry::multi_tag, Tag2>::value>
...
struct within_no_turns_multi<Geometry1, Geometry2, Tag1, Tag2, true, false>
{
    ...
    bool apply(Geometry1 const& geometry1, Geometry2 const& geometry2, Strategy const& strategy)
    {
        ...
        typedef typename geofeatures_boost::range_value<Geometry1>::type subgeometry1;
        typedef typename geofeatures_boost::range_const_iterator<Geometry1>::type iterator;
        for ( iterator it = geofeatures_boost::begin(geometry1) ; it != geofeatures_boost::end(geometry1) ; ++it )
        {
...
struct within_no_turns_multi<Geometry1, Geometry2, Tag1, Tag2, false, true>
{
    ...
    bool apply(Geometry1 const& geometry1, Geometry2 const& geometry2, Strategy const& strategy)
    {
        ...
        typedef typename geofeatures_boost::range_value<Geometry2>::type subgeometry2;
        typedef typename geofeatures_boost::range_const_iterator<Geometry2>::type iterator;
        for ( iterator it = geofeatures_boost::begin(geometry2) ; it != geofeatures_boost::end(geometry2) ; ++it )
        {
