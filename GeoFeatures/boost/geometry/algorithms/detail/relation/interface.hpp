...
struct relation<geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Geometry2>
{
    template <typename Matrix>
    struct visitor : geofeatures_boost::static_visitor<Matrix>
    {
    ...
    apply(geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& geometry1,
          Geometry2 const& geometry2)
    {
        return geofeatures_boost::apply_visitor(visitor<Matrix>(geometry2), geometry1);
    }
};

template <typename Geometry1, BOOST_VARIANT_ENUM_PARAMS(typename T)>
struct relation<Geometry1, geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{
    template <typename Matrix>
    struct visitor : geofeatures_boost::static_visitor<Matrix>
    {
    ...
    {
        return geofeatures_boost::apply_visitor(visitor<Matrix>(geometry1), geometry2);
    }
};
