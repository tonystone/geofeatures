...
public:
          ...
          OutputIterator oit)
    {
        ...
        {
            oit = process_turn(it, geofeatures_boost::begin(it->operations),
                               entered, enter_count, 
                               linestring,
...
{
protected:
    typedef typename geofeatures_boost::range_value<MultiLinestring>::type Linestring;
    ...
    {
        return geofeatures_boost::begin(it->operations)->seg_id.multi_index;
    }
    ...
    public:
        ...
        {
            return geofeatures_boost::begin(turn.operations)->seg_id.multi_index
                != m_multi_id;
        }
    };
...
public:
          ...
          OutputIterator oit)
    {
        ...
        linestring_iterator ls_first = geofeatures_boost::begin(multilinestring);
        linestring_iterator ls_beyond = geofeatures_boost::end(multilinestring);
