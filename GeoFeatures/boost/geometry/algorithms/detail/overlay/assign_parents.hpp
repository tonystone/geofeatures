            ...
            bool check_for_orientation = false)
{
...

    {
        ...
        typedef typename geofeatures_boost::range_iterator<vector_type const>::type vector_iterator_type;
        ...
        for (map_iterator_type it = geofeatures_boost::begin(ring_map);
            it != geofeatures_boost::end(ring_map); ++it, ++index)
        {
        ...
        if (! check_for_orientation)
        {
            ...
            if (count_positive == 1)
            {
                ...
                index = 0;
                for (vector_iterator_type it = geofeatures_boost::begin(vector);
                    it != geofeatures_boost::end(vector); ++it, ++index)
                {
    ...
    {
        for (map_iterator_type it = geofeatures_boost::begin(ring_map);
            it != geofeatures_boost::end(ring_map); ++it)
        {
