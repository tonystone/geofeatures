...
public:
                             ...
                             Box& mbr)
    {
        ...
        geometry::set
            <
                min_corner, 0
            >(radian_mbr, geofeatures_boost::numeric_cast<box_coordinate_type>(lon1));

        geometry::set
            <
                min_corner, 1
            >(radian_mbr, geofeatures_boost::numeric_cast<box_coordinate_type>(lat1));

        geometry::set
            <
                max_corner, 0
            >(radian_mbr, geofeatures_boost::numeric_cast<box_coordinate_type>(lon2));

        geometry::set
            <
                max_corner, 1
            >(radian_mbr, geofeatures_boost::numeric_cast<box_coordinate_type>(lat2));
