...
public:
    ...
    inline void set()
    {
        ...
        typedef geofeatures_boost::integral_constant<bool, in_bounds> in_bounds_t;
...
template <typename Masks, int I = 0, int N = geofeatures_boost::tuples::length<Masks>::value>
struct interrupt_dispatch_tuple
{
    template <field F1, field F2, char V>
    static inline bool apply(Masks const& masks)
    {
        typedef typename geofeatures_boost::tuples::element<I, Masks>::type mask_type;
        mask_type const& mask = geofeatures_boost::get<I>(masks);
...
//struct interrupt_dispatch<geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>, true>
//{
//    typedef geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> mask_type;
...
struct interrupt_dispatch<geofeatures_boost::tuples::cons<Head, Tail>, true>
{
    typedef geofeatures_boost::tuples::cons<Head, Tail> mask_type;
...
//template <typename T0, typename T1, typename T2, typename T3, typename T4,
//          typename T5, typename T6, typename T7, typename T8, typename T9>
//struct may_update_dispatch< geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >
//{
//    typedef geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> mask_type;
...
template <typename Head, typename Tail>
struct may_update_dispatch< geofeatures_boost::tuples::cons<Head, Tail> >
{
    typedef geofeatures_boost::tuples::cons<Head, Tail> mask_type;
...
//template <typename T0, typename T1, typename T2, typename T3, typename T4,
//          typename T5, typename T6, typename T7, typename T8, typename T9>
//struct check_dispatch< geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >
//{
//    typedef geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> mask_type;
...
template <typename Head, typename Tail>
struct check_dispatch< geofeatures_boost::tuples::cons<Head, Tail> >
{
    typedef geofeatures_boost::tuples::cons<Head, Tail> mask_type;
...
template <typename Tuple,
          int I = 0,
          int N = geofeatures_boost::tuples::length<Tuple>::value>
struct matrix_width_tuple
{
    static const std::size_t
        current = matrix_width<typename geofeatures_boost::tuples::element<I, Tuple>::type>::value;
    static const std::size_t
...
template <typename Head, typename Tail>
struct matrix_width< geofeatures_boost::tuples::cons<Head, Tail> >
{
    static const std::size_t
        value = matrix_width_tuple< geofeatures_boost::tuples::cons<Head, Tail> >::value;
};
...
<
    typename Seq,
    typename First = typename geofeatures_boost::mpl::begin<Seq>::type,
    typename Last = typename geofeatures_boost::mpl::end<Seq>::type
>
struct static_check_characters
    : static_check_characters
        <
            Seq,
            typename geofeatures_boost::mpl::next<First>::type
        >
{
    typedef typename geofeatures_boost::mpl::deref<First>::type type;
...
struct static_mask
{
    ...
    BOOST_STATIC_ASSERT(
        std::size_t(geofeatures_boost::mpl::size<Seq>::type::value) == static_size);
    ...
    struct static_get
    {
        ...
        static const char value
            = geofeatures_boost::mpl::at_c<Seq, F1 * static_width + F2>::type::value;
    };
...
{
    typedef typename geofeatures_boost::mpl::deref<First>::type StaticMask;
    ...
    static const bool value
        = static_should_handle_element_dispatch
            <
                StaticMask,
                F1, F2,
                geofeatures_boost::mpl::is_sequence<StaticMask>::value
            >::value
...
struct static_should_handle_element_dispatch<StaticMask, F1, F2, true>
{
    static const bool value
        = static_should_handle_element_sequence
            <
                typename geofeatures_boost::mpl::begin<StaticMask>::type,
                typename geofeatures_boost::mpl::end<StaticMask>::type,
                F1, F2
            >::value;
};
