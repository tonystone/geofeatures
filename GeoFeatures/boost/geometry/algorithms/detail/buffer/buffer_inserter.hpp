        ...
        Range& simplified)
{
    ...
    if (geofeatures_boost::size(simplified) == 2
...
struct buffer_range
{
    ...
    {
        geofeatures_boost::ignore_unused(side_strategy);
...
struct buffer_inserter<ring_tag, RingInput, RingOutput>
{
            ...
            RobustPolicy const& robust_policy)
    {
        ...
        std::size_t n = geofeatures_boost::size(simplified);
        ...
        if (n >= min_points)
        {
            ...
            if (distance.negative())
            {
                ...
                code = iterate(collection, geofeatures_boost::rbegin(view), geofeatures_boost::rend(view),
                        strategy::buffer::buffer_side_right,
                        distance, side_strategy, join_strategy, end_strategy, robust_policy);
            }
            else
            {
                code = iterate(collection, geofeatures_boost::begin(view), geofeatures_boost::end(view),
            ...
            RobustPolicy const& robust_policy)
    {
        ...
        if (n > 1)
        {
            ...
            code = iterate(collection,
                    geofeatures_boost::begin(simplified), geofeatures_boost::end(simplified),
                    strategy::buffer::buffer_side_left,
                    distance, side_strategy, join_strategy, end_strategy, robust_policy,
                    first_p1);
            ...
            {
                code = iterate(collection,
                        geofeatures_boost::rbegin(simplified), geofeatures_boost::rend(simplified),
                        strategy::buffer::buffer_side_right,
                        distance, side_strategy, join_strategy, end_strategy, robust_policy,
                        first_p1);
            }
...
private:
    ...
    void apply_interior_rings(InteriorRings const& interior_rings,
            ...
            RobustPolicy const& robust_policy)
    {
        iterate(geofeatures_boost::begin(interior_rings), geofeatures_boost::end(interior_rings),
             ...
             <
                ...
                <
                    typename single_tag_of
                                ...
                                >::type,
                    typename geofeatures_boost::range_value<Multi const>::type,
...
{
    geofeatures_boost::ignore_unused(visit_pieces_policy);
    ...
    bool const areal = geofeatures_boost::is_same
        <
            typename tag_cast<typename tag<GeometryInput>::type, areal_tag>::type,
            areal_tag
        >::type::value;
    bool const linear = geofeatures_boost::is_same
        <
