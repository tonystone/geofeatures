...
struct assign_inverse_box_or_segment
{
    ...
    static inline void apply(BoxOrSegment& geometry)
    {
        ...
        initialize<0, 0, dimension<BoxOrSegment>::type::value>::apply(
            geometry, geofeatures_boost::numeric::bounds<bound_type>::highest()
        );
        initialize<1, 0, dimension<BoxOrSegment>::type::value>::apply(
            geometry, geofeatures_boost::numeric::bounds<bound_type>::lowest()
        );
    }
};
...
inline void assign_box_2d_corner(Box const& box, Point& point)
{
    ...
    geometry::set<0>(point, geofeatures_boost::numeric_cast<coordinate_type>(get<Corner1, 0>(box)));
    geometry::set<1>(point, geofeatures_boost::numeric_cast<coordinate_type>(get<Corner2, 1>(box)));
}
...
struct assign_point_to_index
{
    ...
    {
        geometry::set<Index, Dimension>(geometry, geofeatures_boost::numeric_cast
            <
...
struct assign_point_from_index
{
    ...
    {
        geometry::set<Dimension>( point, geofeatures_boost::numeric_cast
            <
...
struct assign_2d_box_or_segment
{
    ...
    {
        geometry::set<0, 0>(geometry, geofeatures_boost::numeric_cast<coordinate_type>(x1));
        geometry::set<0, 1>(geometry, geofeatures_boost::numeric_cast<coordinate_type>(y1));
        geometry::set<1, 0>(geometry, geofeatures_boost::numeric_cast<coordinate_type>(x2));
        geometry::set<1, 1>(geometry, geofeatures_boost::numeric_cast<coordinate_type>(y2));
    }
};
...
struct assign<point_tag, Point, 2>
{
    ...
    {
        set<0>(point, geofeatures_boost::numeric_cast<coordinate_type>(c1));
        set<1>(point, geofeatures_boost::numeric_cast<coordinate_type>(c2));
    }
};
...
struct assign<point_tag, Point, 3>
{
    ...
    static inline void apply(Point& point, T const& c1, T const& c2, T const& c3)
    {
        set<0>(point, geofeatures_boost::numeric_cast<coordinate_type>(c1));
        set<1>(point, geofeatures_boost::numeric_cast<coordinate_type>(c2));
        set<2>(point, geofeatures_boost::numeric_cast<coordinate_type>(c3));
    }
};
