...
public:
                                    ...
                                    bool check_intersection = true)
    {
        ...
        seg_or_box_const_iterator it_min1 = geofeatures_boost::const_begin(seg_or_box_points);
             ...
             pit != points_end(geometry); ++pit, first = false)
        {
            ...
            std::pair
                ...
                = point_to_point_range::apply(*pit,
                                              geofeatures_boost::const_begin(seg_or_box_points),
                                              geofeatures_boost::const_end(seg_or_box_points),
                                              cstrategy,
                                              cd);
        ...
        first = true;
        for (seg_or_box_const_iterator it = geofeatures_boost::const_begin(seg_or_box_points);
             it != geofeatures_boost::const_end(seg_or_box_points); ++it, first = false)
        {
            comparable_return_type cd;
                                    ...
                                    Strategy const& strategy)
    {
        ...
        iterator_type it_min
            = geometry_to_range::apply(segment_or_box,
                                       geofeatures_boost::begin(multipoint),
