...
{
    typedef typename geofeatures_boost::range_value<Geometry>::type value_type;
    typedef typename geofeatures_boost::mpl::if_c
        <
            geofeatures_boost::is_const<Geometry>::value,
            typename geofeatures_boost::add_const<value_type>::type,
            value_type
        >::type sub_type;
