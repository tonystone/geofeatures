...
struct intersection
{
    ...
    {
        typedef typename geofeatures_boost::range_value<GeometryOut>::type OneOut;
...
struct intersection<variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Geometry2>
{
    ...
    apply(variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& geometry1,
          ...
          GeometryOut& geometry_out)
    {
        return geofeatures_boost::apply_visitor(visitor<GeometryOut>(geometry2, geometry_out), geometry1);
    }
};
...
struct intersection<Geometry1, variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{
    ...
    apply(Geometry1 const& geometry1,
          ...
          GeometryOut& geometry_out)
    {
        return geofeatures_boost::apply_visitor(visitor<GeometryOut>(geometry1, geometry_out), geometry2);
    }
};
...
struct intersection<variant<BOOST_VARIANT_ENUM_PARAMS(T1)>, variant<BOOST_VARIANT_ENUM_PARAMS(T2)> >
{
    ...
    apply(const variant<BOOST_VARIANT_ENUM_PARAMS(T1)>& geometry1,
          ...
          GeometryOut& geometry_out)
    {
        return geofeatures_boost::apply_visitor(visitor<GeometryOut>(geometry_out), geometry1, geometry2);
    }
};
...
\tparam GeometryOut Collection of geometries (e.g. std::vector, std::deque, geofeatures_boost::geometry::multi*) of which
