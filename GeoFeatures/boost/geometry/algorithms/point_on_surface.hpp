...
inline void replace_extremes_for_self_tangencies(Extremes& extremes, Intruders& intruders, CoordinateType const& max_intruder)
{
    ...
    if (max_value<Dimension>(intruders, penultimate_value, pu_compare))
    {
        ...
        intruders.erase
            (
                std::remove_if(geofeatures_boost::begin(intruders), geofeatures_boost::end(intruders), predicate),
                geofeatures_boost::end(intruders)
            );
        ...
        std::for_each(geofeatures_boost::begin(intruders), geofeatures_boost::end(intruders), fe_predicate);
    ...
    std::sort(geofeatures_boost::begin(intruders), geofeatures_boost::end(intruders), min_of_intruder<1 - Dimension, CoordinateType>());
