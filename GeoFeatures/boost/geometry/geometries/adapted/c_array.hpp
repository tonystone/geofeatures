...
struct tag<CoordinateType[DimensionCount]>
    : detail::c_array_tag<geofeatures_boost::is_arithmetic<CoordinateType>::value> {};
...
template <typename CoordinateType, std::size_t DimensionCount>
struct dimension<CoordinateType[DimensionCount]>: geofeatures_boost::mpl::int_<DimensionCount> {};
