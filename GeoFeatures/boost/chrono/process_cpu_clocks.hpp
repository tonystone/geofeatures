...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace chrono {
...
namespace chrono
{
  ...
  typedef process_times<nanoseconds::rep> process_cpu_clock_times;
    ...
    public:
        ...
        typedef geofeatures_boost::chrono::duration<times,  nano>                duration;
        typedef duration::rep                       rep;
        typedef duration::period                    period;
...
namespace std {
    ...
    template <typename Rep>
    struct numeric_limits<geofeatures_boost::chrono::process_times<Rep> >
    {
        typedef geofeatures_boost::chrono::process_times<Rep> Res;
