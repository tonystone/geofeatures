...
#define BOOST_CHRONO_SECOND_TEMPLATE_PARAMETER_OF_DURATION_MUST_BE_A_STD_RATIO "Second template parameter of duration must be a geofeatures_boost::ratio"
#define BOOST_CHRONO_DURATION_PERIOD_MUST_BE_POSITIVE "duration period must be positive"
#define BOOST_CHRONO_SECOND_TEMPLATE_PARAMETER_OF_TIME_POINT_MUST_BE_A_BOOST_CHRONO_DURATION "Second template parameter of time_point must be a geofeatures_boost::chrono::duration"
#endif
...
namespace chrono {
    ...
    template <class Duration, class Rep2,
        bool = (
                    ((geofeatures_boost::is_convertible<typename Duration::rep,
                        typename common_type<typename Duration::rep, Rep2>::type>::value))
                &&  ((geofeatures_boost::is_convertible<Rep2,
                        typename common_type<typename Duration::rep, Rep2>::type>::value))
                )
        >
...
///
    ...
    template <class Rep, class Duration,
        bool = (
                ...
                &&  ((geofeatures_boost::is_convertible<Rep,
                        typename common_type<typename Duration::rep, Rep>::type>::value))
                )
        >
...
namespace chrono {
    ...
    typedef duration<geofeatures_boost::int_least64_t, nano> nanoseconds;    // at least 64 bits needed
    typedef duration<geofeatures_boost::int_least64_t, micro> microseconds;  // at least 55 bits needed
    typedef duration<geofeatures_boost::int_least64_t, milli> milliseconds;  // at least 45 bits needed
    typedef duration<geofeatures_boost::int_least64_t> seconds;              // at least 35 bits needed
    typedef duration<geofeatures_boost::int_least32_t, ratio< 60> > minutes; // at least 29 bits needed
    typedef duration<geofeatures_boost::int_least32_t, ratio<3600> > hours;  // at least 23 bits needed
    ...
    struct duration_cast_aux<FromDuration, ToDuration, Period, true, false>
    {
        BOOST_CONSTEXPR ToDuration operator()(const FromDuration& fd) const
        {
            typedef typename common_type<
                ...
                geofeatures_boost::intmax_t>::type C;
...
//----------------------------------------------------------------------------//
    ...
    template <class Rep>
    struct treat_as_floating_point : geofeatures_boost::is_floating_point<Rep> {};
                   ...
                   chrono::duration<Rep2, Period2> >
{
  typedef chrono::duration<typename common_type<Rep1, Rep2>::type,
                      typename geofeatures_boost::ratio_gcd<Period1, Period2>::type> type;
};
...
namespace chrono {
    ...
    {
    //BOOST_CHRONO_STATIC_ASSERT(geofeatures_boost::is_integral<Rep>::value, BOOST_CHRONO_A_DURATION_REPRESENTATION_MUST_BE_INTEGRAL, ());
    BOOST_CHRONO_STATIC_ASSERT(!geofeatures_boost::chrono::detail::is_duration<Rep>::value,
            BOOST_CHRONO_A_DURATION_REPRESENTATION_CAN_NOT_BE_A_DURATION, ());
    BOOST_CHRONO_STATIC_ASSERT(geofeatures_boost::ratio_detail::is_ratio<typename Period::type>::value,
    ...
    public:
        ...
        , typename geofeatures_boost::enable_if <
                    mpl::and_ <
                        geofeatures_boost::is_convertible<Rep2, rep>,
                        mpl::or_ <
...
//----------------------------------------------------------------------------//
    ...
    typename geofeatures_boost::enable_if <
        mpl::and_ <
        geofeatures_boost::is_convertible<Rep1, typename common_type<Rep1, Rep2>::type>,
        geofeatures_boost::is_convertible<Rep2, typename common_type<Rep1, Rep2>::type>
        >,
    ...
    template <class Rep1, class Period, class Rep2>
    inline BOOST_CONSTEXPR
    typename geofeatures_boost::disable_if <geofeatures_boost::chrono::detail::is_duration<Rep2>,
      typename geofeatures_boost::chrono::detail::duration_divide_result<
    ...
    template <class Rep1, class Rep2, class Period>
    inline BOOST_CONSTEXPR
    typename geofeatures_boost::disable_if <geofeatures_boost::chrono::detail::is_duration<Rep1>,
      typename geofeatures_boost::chrono::detail::duration_divide_result2<
    ...
    inline BOOST_CONSTEXPR
    typename geofeatures_boost::disable_if <geofeatures_boost::chrono::detail::is_duration<Rep2>,
      typename geofeatures_boost::chrono::detail::duration_modulo_result<
        duration<Rep1, Period>, Rep2>::type
    >::type
    operator%(const duration<Rep1, Period>& d, const Rep2& s)
    {
...
namespace detail
{
    ...
    operator==(const duration<Rep1, Period1>& lhs,
          const duration<Rep2, Period2>& rhs)
    {
        return geofeatures_boost::chrono::detail::duration_eq<
    ...
    operator< (const duration<Rep1, Period1>& lhs,
          const duration<Rep2, Period2>& rhs)
    {
        return geofeatures_boost::chrono::detail::duration_lt<
          duration<Rep1, Period1>, duration<Rep2, Period2> >()(lhs, rhs);
    }
...
//----------------------------------------------------------------------------//
    ...
    inline BOOST_CONSTEXPR
    typename geofeatures_boost::enable_if <
      geofeatures_boost::chrono::detail::is_duration<ToDuration>, ToDuration>::type
    duration_cast(const duration<Rep, Period>& fd)
    {
        return geofeatures_boost::chrono::detail::duration_cast<
