...
private:
    ...
    template <class Period>
        string_type short_name(Period) const
            {return ::geofeatures_boost::ratio_string<Period, CharT>::short_name() + short_seconds_;}
    ...
    template <class Period>
        string_type long_name(Period) const
            {return ::geofeatures_boost::ratio_string<Period, CharT>::long_name() + long_seconds_;}
