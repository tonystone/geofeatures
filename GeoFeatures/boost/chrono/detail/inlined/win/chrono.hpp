...
namespace chrono_detail
{
  ...
  {
      geofeatures_boost::detail::winapi::LARGE_INTEGER_ freq;
      if ( !geofeatures_boost::detail::winapi::QueryPerformanceFrequency( &freq ) )
          return 0.0L;
  ...
  steady_clock::time_point steady_clock::now() BOOST_NOEXCEPT
  {
    ...
    geofeatures_boost::detail::winapi::LARGE_INTEGER_ pcount;
    ...
    unsigned times=0;
    while ( ! geofeatures_boost::detail::winapi::QueryPerformanceCounter( &pcount ) )
    {
      if ( ++times > 3 )
      {
  ...
  steady_clock::time_point steady_clock::now( system::error_code & ec )
  {
    ...
    geofeatures_boost::detail::winapi::LARGE_INTEGER_ pcount;
    if ( (nanosecs_per_tic <= 0.0L)
            || (!geofeatures_boost::detail::winapi::QueryPerformanceCounter( &pcount )) )
    {
        geofeatures_boost::detail::winapi::DWORD_ cause =
            ((nanosecs_per_tic <= 0.0L)
                    ? ERROR_NOT_SUPPORTED
                    : geofeatures_boost::detail::winapi::GetLastError());
  ...
  {
    geofeatures_boost::detail::winapi::FILETIME_ ft;
    geofeatures_boost::detail::winapi::GetSystemTimeAsFileTime( &ft );  // never fails
