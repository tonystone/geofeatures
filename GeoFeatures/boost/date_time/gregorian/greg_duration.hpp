...
namespace gregorian {
  ...
  typedef geofeatures_boost::date_time::duration_traits_adapted date_duration_rep;

  //! Durations in days for gregorian system
  /*! \ingroup date_basics
   */
  class date_duration :
    public geofeatures_boost::date_time::date_duration< date_duration_rep >
  {
    typedef geofeatures_boost::date_time::date_duration< date_duration_rep > base_type;
