...
namespace date_time {
  ...
  */
  ...
  public:
    ...
    //!Equality operator -- others generated by geofeatures_boost::equality_comparable
    bool operator==(const time_type& rhs) const
    {
      return time_system::is_equal(time_,rhs.time_);
    }
    //!Equality operator -- others generated by geofeatures_boost::less_than_comparable
    bool operator<(const time_type& rhs) const
    {
