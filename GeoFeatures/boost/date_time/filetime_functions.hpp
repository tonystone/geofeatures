...
namespace winapi {
    ...
    extern "C" {
        ...
        struct FILETIME
        {
            geofeatures_boost::uint32_t dwLowDateTime;
            geofeatures_boost::uint32_t dwHighDateTime;
        };
        struct SYSTEMTIME
        {
            geofeatures_boost::uint16_t wYear;
            geofeatures_boost::uint16_t wMonth;
            geofeatures_boost::uint16_t wDayOfWeek;
            geofeatures_boost::uint16_t wDay;
            geofeatures_boost::uint16_t wHour;
            geofeatures_boost::uint16_t wMinute;
            geofeatures_boost::uint16_t wSecond;
            geofeatures_boost::uint16_t wMilliseconds;
        };
     ...
     *       geofeatures_boost::date_time::winapi::file_time type.
     */
    template< typename FileTimeT >
    inline geofeatures_boost::uint64_t file_time_to_microseconds(FileTimeT const& ft)
    {
