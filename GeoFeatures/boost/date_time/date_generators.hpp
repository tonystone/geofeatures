...
namespace date_time {
 ...
 public:
   ...
   date_type get_date(year_type y) const
   {
     if((day_ == 29) && (month_ == 2) && !(calendar_type::is_leap_year(y))) {
       ...
       geofeatures_boost::throw_exception(std::invalid_argument(ss.str()));
     }
 ...
 private:
   ...
   *@code
     typedef geofeatures_boost::date_time::first_kday_after<date> firstkdayafter;
  ...
  /*! Date generator that takes a date and finds kday after
   *@code
     typedef geofeatures_boost::date_time::first_kday_before<date> firstkdaybefore;
