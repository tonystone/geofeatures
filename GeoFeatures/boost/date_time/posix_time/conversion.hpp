...
namespace posix_time {
  ...
  inline
  std::tm to_tm(const geofeatures_boost::posix_time::ptime& t) {
    std::tm timetm = geofeatures_boost::gregorian::to_tm(t.date());
    geofeatures_boost::posix_time::time_duration td = t.time_of_day();
  ...
  inline
  std::tm to_tm(const geofeatures_boost::posix_time::time_duration& td) {
    std::tm timetm;
  ...
  ptime ptime_from_tm(const std::tm& timetm) {
    geofeatures_boost::gregorian::date d = geofeatures_boost::gregorian::date_from_tm(timetm);
  ...
  {
    return geofeatures_boost::date_time::time_from_ftime<TimeT>(ft);
  }

#endif // BOOST_HAS_FTIME

} } //namespace geofeatures_boost::posix_time
