...
#define BOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<geofeatures_boost::date_time::time_resolution_traits_adapted64_impl, geofeatures_boost::date_time::nano,
...
#undef  BOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<
    geofeatures_boost::date_time::time_resolution_traits_adapted64_impl, geofeatures_boost::date_time::micro,
...
// #undef BOOST_DATE_TIME_HAS_NANOSECONDS
//   typedef date_time::time_resolution_traits<geofeatures_boost::int64_t, geofeatures_boost::date_time::tenth,
//                                              10, 0 > time_res_traits;
  ...
  public:
    ...
    time_duration(geofeatures_boost::date_time::special_values sv) :
...
#else
    BOOST_STATIC_CONSTANT(geofeatures_boost::int64_t, tick_per_second = 1000000000);
#endif
  };
  ...
  {
   public:
    typedef geofeatures_boost::int64_t time_rep_type;
...
#if (defined(BOOST_DATE_TIME_NO_MEMBER_INIT)) //help bad compilers
#else
    BOOST_STATIC_CONSTANT(geofeatures_boost::int64_t, tick_per_second = 1000000);
#endif
  };
