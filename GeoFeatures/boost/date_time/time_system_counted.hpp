...
namespace date_time {
  ...
  struct counted_time_rep
  {
    ...
    {
      /* resolution_traits::as_number returns a geofeatures_boost::int64_t & 
       * frac_sec_per_day is also a geofeatures_boost::int64_t so, naturally, 
       * the division operation returns a geofeatures_boost::int64_t. 
