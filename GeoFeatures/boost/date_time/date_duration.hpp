...
namespace date_time {
  ...
  class date_duration : private
              geofeatures_boost::less_than_comparable1< date_duration< duration_rep_traits >
            , geofeatures_boost::equality_comparable1< date_duration< duration_rep_traits >
            , geofeatures_boost::addable1< date_duration< duration_rep_traits >
            , geofeatures_boost::subtractable1< date_duration< duration_rep_traits >
            , geofeatures_boost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  {
  public:
  ...
  {
    typedef long int_type;
    typedef geofeatures_boost::date_time::int_adapter<long> impl_type;
