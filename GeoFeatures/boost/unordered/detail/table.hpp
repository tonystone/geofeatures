...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace unordered { namespace detail {
    ...
    struct value_base
    {
        ...
        typename geofeatures_boost::aligned_storage<
            sizeof(value_type),
            geofeatures_boost::alignment_of<value_type>::value>::type data_;
    ...
    struct move_nodes
    {
        ...
        {
            constructor.construct_with_value2(geofeatures_boost::move(v));
            return constructor.release();
        }
    };
    ...
    struct table :
        geofeatures_boost::unordered::detail::functions<
    ...
    public:
        ...
        typedef geofeatures_boost::unordered::detail::functions<
            typename Types::hasher,
        ...
        typedef geofeatures_boost::unordered::detail::allocator_traits<node_allocator>
            node_allocator_traits;
        typedef geofeatures_boost::unordered::detail::allocator_traits<bucket_allocator>
        ...
        typedef typename bucket_allocator_traits::pointer
            bucket_pointer;
        typedef geofeatures_boost::unordered::detail::node_constructor<node_allocator>
            node_constructor;

        typedef geofeatures_boost::unordered::iterator_detail::
        ...
        geofeatures_boost::unordered::detail::compressed<bucket_allocator, node_allocator>
            allocators_;
        ...
        std::size_t max_size() const
        {
            ...
            // size < mlf_ * count
            return geofeatures_boost::unordered::detail::double_to_size(ceil(
        ...
        void recalculate_max_load()
        {
            ...
            max_load_ = buckets_ ? geofeatures_boost::unordered::detail::double_to_size(ceil(
                    static_cast<double>(mlf_) *
        ...
        std::size_t min_buckets_for_size(std::size_t size) const
        {
            ...
            return policy::new_bucket_count(
                geofeatures_boost::unordered::detail::double_to_size(floor(
        ...
        table(table& x, geofeatures_boost::unordered::detail::move_tag m) :
            functions(x, m),
        ...
        {
            geofeatures_boost::unordered::detail::array_constructor<bucket_allocator>
        ...
        {
            geofeatures_boost::unordered::detail::func::ignore_unused_variable_warning(other);
        ...
        void swap(table& x)
        {
            ...
            geofeatures_boost::swap(buckets_, x.buckets_);
            geofeatures_boost::swap(bucket_count_, x.bucket_count_);
            geofeatures_boost::swap(size_, x.size_);
        ...
        void delete_node(link_pointer prev)
        {
            ...
            geofeatures_boost::unordered::detail::func::destroy_value_impl(node_alloc(),
                n->value_ptr());
            geofeatures_boost::unordered::detail::func::destroy(geofeatures_boost::addressof(*n));
        ...
        void destroy_buckets()
        {
            ...
            {
                geofeatures_boost::unordered::detail::func::destroy(
                    geofeatures_boost::addressof(*it));
            }
        ...
        {
            if (this != geofeatures_boost::addressof(x))
            {
                assign(x,
                    geofeatures_boost::unordered::detail::integral_constant<bool,
                        allocator_traits<node_allocator>::
