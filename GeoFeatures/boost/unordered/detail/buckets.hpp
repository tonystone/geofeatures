...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace unordered { namespace iterator_detail {
    ...
    template <typename Node, typename Policy>
    struct l_iterator
        : public geofeatures_boost::iterator<
            ...
            typename Node::value_type&>
    {
        ...
        friend struct geofeatures_boost::unordered::iterator_detail::cl_iterator;
    private:
#endif
        typedef typename Node::node_pointer node_pointer;
        typedef geofeatures_boost::unordered::iterator_detail::iterator<Node> n_iterator;
        node_pointer ptr_;
        std::size_t bucket_;
    ...
    struct cl_iterator
        : public geofeatures_boost::iterator<
            ...
            typename Node::value_type const&>
    {
        friend struct geofeatures_boost::unordered::iterator_detail::l_iterator
            <Node, Policy>;
    private:
    ...
    public:
        ...
        cl_iterator(geofeatures_boost::unordered::iterator_detail::l_iterator<
...
#if !defined(BOOST_NO_MEMBER_TEMPLATE_FRIENDS)
        template <typename>
        friend struct geofeatures_boost::unordered::iterator_detail::c_iterator;
        template <typename, typename>
        friend struct geofeatures_boost::unordered::iterator_detail::l_iterator;
        template <typename, typename>
        friend struct geofeatures_boost::unordered::iterator_detail::cl_iterator;
        template <typename>
        friend struct geofeatures_boost::unordered::detail::table;
        template <typename>
        friend struct geofeatures_boost::unordered::detail::table_impl;
        template <typename>
        friend struct geofeatures_boost::unordered::detail::grouped_table_impl;
    private:
#endif
        typedef typename Node::node_pointer node_pointer;
        node_pointer node_;
    ...
    struct c_iterator
        : public geofeatures_boost::iterator<
            ...
            typename Node::value_type const&>
    {
        friend struct geofeatures_boost::unordered::iterator_detail::iterator<Node>;
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace unordered { namespace detail {
    ...
    private:
        ...
        typedef geofeatures_boost::unordered::detail::allocator_traits<NodeAlloc>
    ...
    public:
        ...
        {
            construct();
            geofeatures_boost::unordered::detail::func::construct_value_impl(
        ...
        void construct_with_value2(BOOST_FWD_REF(A0) a0)
        {
            ...
            geofeatures_boost::unordered::detail::func::construct_value_impl(
                ...
                BOOST_UNORDERED_EMPLACE_ARGS1(geofeatures_boost::forward<A0>(a0)));
            value_constructed_ = true;
        }
    ...
    node_constructor<Alloc>::~node_constructor()
    {
        if (node_) {
            if (value_constructed_) {
                geofeatures_boost::unordered::detail::func::destroy_value_impl(alloc_,
                    node_->value_ptr());
            }

            if (node_constructed_) {
                geofeatures_boost::unordered::detail::func::destroy(
                    geofeatures_boost::addressof(*node_));
            }
    ...
    void node_constructor<Alloc>::construct()
    {
        if(!node_) {
            ...
            new ((void*) geofeatures_boost::addressof(*node_)) node();
            node_->init(node_);
    ...
    private:
        ...
        typedef geofeatures_boost::unordered::iterator_detail::iterator<node> iterator;
    ...
    public:
        ...
        inline void move_assign_impl(T& v) {
            if (this->node_ && this->value_constructed_) {
                this->node_->value() = geofeatures_boost::move(v);
            }
            else {
                this->construct_with_value2(geofeatures_boost::move(v));
            }
        }
    ...
    node_holder<Alloc>::~node_holder()
    {
        while (nodes_) {
            ...
            geofeatures_boost::unordered::detail::func::destroy_value_impl(this->alloc_,
                p->value_ptr());
            geofeatures_boost::unordered::detail::func::destroy(geofeatures_boost::addressof(*p));
    ...
    struct prime_policy
    {
        ...
        static inline SizeT new_bucket_count(SizeT min) {
            return geofeatures_boost::unordered::detail::next_prime(min);
        }

        static inline SizeT prev_bucket_count(SizeT max) {
            return geofeatures_boost::unordered::detail::prev_prime(max);
        }
    };
    ...
    public:
        static const bool nothrow_move_assignable =
                geofeatures_boost::is_nothrow_move_assignable<H>::value &&
                geofeatures_boost::is_nothrow_move_assignable<P>::value;
        static const bool nothrow_move_constructible =
                geofeatures_boost::is_nothrow_move_constructible<H>::value &&
                geofeatures_boost::is_nothrow_move_constructible<P>::value;

    private:
        friend class geofeatures_boost::unordered::detail::set_hash_functions<H, P,
               nothrow_move_assignable>;
        functions& operator=(functions const&);

        typedef compressed<H, P> function_pair;

        typedef typename geofeatures_boost::aligned_storage<
            sizeof(function_pair),
            geofeatures_boost::alignment_of<function_pair>::value>::type aligned_function;
        ...
        void construct(bool which, function_pair const& f,
                geofeatures_boost::unordered::detail::false_type =
                    geofeatures_boost::unordered::detail::false_type())
        {
        ...
        void construct(bool which, function_pair& f,
                geofeatures_boost::unordered::detail::true_type)
        {
            new((void*) &funcs_[which]) function_pair(f,
                geofeatures_boost::unordered::detail::move_tag());
        }

        void destroy(bool which)
        {
            geofeatures_boost::unordered::detail::func::destroy((function_pair*)(&funcs_[which]));
        }
        
    public:

        typedef geofeatures_boost::unordered::detail::set_hash_functions<H, P,
        ...
        functions(functions& bf, geofeatures_boost::unordered::detail::move_tag)
            : current_(false)
        {
            construct(current_, bf.current(),
                geofeatures_boost::unordered::detail::integral_constant<bool,
    ...
    public:
        ...
        void commit()
        {
            functions_.current().first() = geofeatures_boost::move(hash_);
            functions_.current().second() = geofeatures_boost::move(pred_);
        }
    };
...
#   define BOOST_UNORDERED_RV_REF(T) BOOST_RV_REF(T)
    ...
    template <typename T>
    struct rv_ref :
        geofeatures_boost::detail::if_true<
            geofeatures_boost::is_class<T>::value
        >::BOOST_NESTED_TEMPLATE then <
            geofeatures_boost::unordered::detail::rv_ref_impl<T>,
            please_ignore_this_overload
        >::type
    {};

#   define BOOST_UNORDERED_RV_REF(T) \
        typename geofeatures_boost::unordered::detail::rv_ref<T>::type
#endif
}}}
