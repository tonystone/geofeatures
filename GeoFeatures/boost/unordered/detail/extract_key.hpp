...
namespace detail {
    ...
    struct is_key {
        ...
        enum { value = sizeof(test(geofeatures_boost::unordered::detail::make<T>())) ==
            sizeof(choice2::type) };
    ...
    {
        typedef ValueType value_type;
        typedef typename geofeatures_boost::remove_const<Key>::type key_type;
...
#define BOOST_UNORDERED_KEY_FROM_TUPLE(namespace_)                          \
        template <typename T2>                                              \
        static no_key extract(geofeatures_boost::unordered::piecewise_construct_t,      \
        ...
        static typename is_key<key_type, T>::type                           \
            extract(geofeatures_boost::unordered::piecewise_construct_t,                \
...
BOOST_UNORDERED_KEY_FROM_TUPLE(geofeatures_boost::)
