...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace numeric {
    ...
    #define BOOST_NUMERIC_CONVERSION_SEQ_A() BOOST_NUMERIC_CONVERSION_BASE_BUILTIN_TYPES()(geofeatures_boost::long_long_type)(geofeatures_boost::ulong_long_type)
	#define BOOST_NUMERIC_CONVERSION_SEQ_B() (geofeatures_boost::long_long_type)(geofeatures_boost::ulong_long_type)
