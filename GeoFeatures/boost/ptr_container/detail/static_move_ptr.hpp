...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace ptr_container_detail {
...
private:
    ...
    typedef geofeatures_boost::compressed_pair<element_type*, Deleter> impl_type;
