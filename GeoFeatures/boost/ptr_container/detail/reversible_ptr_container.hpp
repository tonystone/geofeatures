...
namespace ptr_container_detail
{
    ...
    public: // typedefs
        ...
        typedef  BOOST_DEDUCED_TYPENAME Config::const_iterator
                                   const_iterator;
        typedef  geofeatures_boost::reverse_iterator< iterator > 
                                   reverse_iterator;  
        typedef  geofeatures_boost::reverse_iterator< const_iterator >     
    ...
    public: // modifiers
        ...
        {
            return erase( geofeatures_boost::begin(r), geofeatures_boost::end(r) );
        }
    ...
    public: // access interface
        ...
        { 
            ...
            return geofeatures_boost::ptr_container_detail::move( ptr ); 
        }
        ...
        { 
            ...
            return geofeatures_boost::ptr_container_detail::move( old );
        }
...
#define BOOST_PTR_CONTAINER_DEFINE_RELEASE( base_type ) \
    ...
    {                                               \
        return geofeatures_boost::ptr_container_detail::move(base_type::release(i)); \
    }                                               
#else
#define BOOST_PTR_CONTAINER_DEFINE_RELEASE( base_type ) \
