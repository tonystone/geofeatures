...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost
{
    ...
    public:
        ...
        Result    
#else            
        typename geofeatures_boost::result_of< const Fun( typename pointee<T>::type& ) >::type 
#endif            
        ...
        Result    
#else                        
        typename geofeatures_boost::result_of< const Fun( typename pointee<T>::type&,
    ...
    public:
        ...
        typename ptr_container_detail::make_lazy<
            geofeatures_boost::result_of<const Fun(const Arg1&)>, Void>::type
#endif            
        operator()( const Void* r ) const
        { 
            BOOST_STATIC_ASSERT(geofeatures_boost::is_void<Void>::value);
            BOOST_ASSERT( r != 0 );
...
#else                    
        typename ptr_container_detail::make_lazy<
            geofeatures_boost::result_of<const Fun(const Arg1&, const Arg2&)>, Void>::type
#endif            
