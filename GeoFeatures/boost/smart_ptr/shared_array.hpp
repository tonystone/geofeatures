...
public:
    ...
    shared_array( geofeatures_boost::detail::sp_nullptr_t ) BOOST_NOEXCEPT : px( 0 ), pn()
    {
    }
...
// ... except in C++0x, move disables the implicit copy
    ...
    shared_array( shared_array<Y> const & r, typename geofeatures_boost::detail::sp_enable_if_convertible< Y[], T[] >::type = geofeatures_boost::detail::sp_empty() )
...
#include <boost/smart_ptr/detail/operator_bool.hpp>
    ...
    void * _internal_get_deleter( geofeatures_boost::detail::sp_typeinfo const & ti ) const
    {
...
template<class T> inline bool operator==( shared_array<T> const & p, geofeatures_boost::detail::sp_nullptr_t ) BOOST_NOEXCEPT
{
    return p.get() == 0;
}

template<class T> inline bool operator==( geofeatures_boost::detail::sp_nullptr_t, shared_array<T> const & p ) BOOST_NOEXCEPT
{
    return p.get() == 0;
}
