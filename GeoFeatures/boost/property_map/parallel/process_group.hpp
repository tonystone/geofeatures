...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace parallel {
...
} } // end namespace geofeatures_boost::parallel
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace graph { namespace distributed {
  using geofeatures_boost::parallel::trigger_receive_context;
  using geofeatures_boost::parallel::trc_early_receive;
  using geofeatures_boost::parallel::trc_out_of_band;
  using geofeatures_boost::parallel::trc_irecv_out_of_band;
  using geofeatures_boost::parallel::trc_in_synchronization;
  using geofeatures_boost::parallel::trc_none;
  using geofeatures_boost::parallel::attach_distributed_object;
} } } // end namespace geofeatures_boost::graph::distributed
