...
class escape : 
    public geofeatures_boost::iterator_adaptor<
        Derived, 
        Base, 
        typename geofeatures_boost::iterator_value<Base>::type,
        single_pass_traversal_tag,
        typename geofeatures_boost::iterator_value<Base>::type
    >
{
    typedef typename geofeatures_boost::iterator_value<Base>::type base_value_type;
    typedef typename geofeatures_boost::iterator_reference<Base>::type reference_type;
    friend class geofeatures_boost::iterator_core_access;

    typedef typename geofeatures_boost::iterator_adaptor<
        Derived, 
        Base, 
        base_value_type,
        single_pass_traversal_tag,
