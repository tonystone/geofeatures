...
basic_text_oprimitive<OStream>::save_binary(
    ...
    typedef 
        geofeatures_boost::archive::iterators::insert_linebreaks<
            geofeatures_boost::archive::iterators::base64_from_binary<
                geofeatures_boost::archive::iterators::transform_width<
                    const char *,
                    6,
                    8
                >
    ...
    geofeatures_boost::archive::iterators::ostream_iterator<CharType> oi(os);
    std::copy(
    ...
    locale_saver(* os_.rdbuf())
{
    if(! no_codecvt){
        archive_locale.reset(
            add_facet(
                std::locale::classic(),
                new geofeatures_boost::archive::codecvt_null<typename OStream::char_type>
            )
        );
