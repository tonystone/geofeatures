...
public:
    ...
    explicit library_version_type(const unsigned int & t_) : t(t_){
        BOOST_ASSERT(t_ <= geofeatures_boost::integer_traits<base_type>::const_max);
    }
...
#define NULL_POINTER_TAG geofeatures_boost::archive::class_id_type(-1)
...
struct class_name_type : 
    private geofeatures_boost::noncopyable 
{
    char *t;
...
BOOST_CLASS_IMPLEMENTATION(geofeatures_boost::archive::library_version_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(geofeatures_boost::archive::version_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(geofeatures_boost::archive::class_id_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(geofeatures_boost::archive::class_id_reference_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(geofeatures_boost::archive::class_id_optional_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(geofeatures_boost::archive::class_name_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(geofeatures_boost::archive::object_id_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(geofeatures_boost::archive::object_reference_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(geofeatures_boost::archive::tracking_type, primitive_type)
...
BOOST_IS_BITWISE_SERIALIZABLE(geofeatures_boost::archive::library_version_type)
BOOST_IS_BITWISE_SERIALIZABLE(geofeatures_boost::archive::version_type)
BOOST_IS_BITWISE_SERIALIZABLE(geofeatures_boost::archive::class_id_type)
BOOST_IS_BITWISE_SERIALIZABLE(geofeatures_boost::archive::class_id_reference_type)
BOOST_IS_BITWISE_SERIALIZABLE(geofeatures_boost::archive::class_id_optional_type)
BOOST_IS_BITWISE_SERIALIZABLE(geofeatures_boost::archive::class_name_type)
BOOST_IS_BITWISE_SERIALIZABLE(geofeatures_boost::archive::object_id_type)
BOOST_IS_BITWISE_SERIALIZABLE(geofeatures_boost::archive::object_reference_type)
BOOST_IS_BITWISE_SERIALIZABLE(geofeatures_boost::archive::tracking_type)
