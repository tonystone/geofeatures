...
class BOOST_SYMBOL_VISIBLE binary_iarchive :
    public binary_iarchive_impl<
        geofeatures_boost::archive::binary_iarchive, 
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(geofeatures_boost::archive::binary_iarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(geofeatures_boost::archive::binary_iarchive)
