...
protected:
    ...
    void load_override(tracking_type & t, int /*version*/){
        ...
        if(geofeatures_boost::archive::library_version_type(6) < lvt){
            int_least8_t x=0;
            * this->This() >> x;
            t = geofeatures_boost::archive::tracking_type(x);
        }
        else{
            bool x=0;
            * this->This() >> x;
    ...
    void load_override(class_id_type & t){
        library_version_type lvt = this->get_library_version();
        if(geofeatures_boost::archive::library_version_type(7) < lvt){
            this->detail_common_iarchive::load_override(t);
        }
        else
        if(geofeatures_boost::archive::library_version_type(6) < lvt){
            int_least16_t x=0;
            * this->This() >> x;
            t = geofeatures_boost::archive::class_id_type(x);
        }
        else{
            int x=0;
            * this->This() >> x;
    ...
    void load_override(version_type & t){
        ...
        if(geofeatures_boost::archive::library_version_type(6) < lvt){
            uint_least8_t x=0;
            * this->This() >> x;
            t = geofeatures_boost::archive::version_type(x);
        }
        else
        if(geofeatures_boost::archive::library_version_type(5) < lvt){
            uint_least16_t x=0;
            * this->This() >> x;
            t = geofeatures_boost::archive::version_type(x);
        }
        else
        if(geofeatures_boost::archive::library_version_type(2) < lvt){
            // upto 255 versions
            unsigned char x=0;
            * this->This() >> x;
            t = version_type(x);
    ...
    void load_override(geofeatures_boost::serialization::item_version_type & t){
        library_version_type lvt = this->get_library_version();
//        if(geofeatures_boost::archive::library_version_type(7) < lvt){
        if(geofeatures_boost::archive::library_version_type(6) < lvt){
            this->detail_common_iarchive::load_override(t);
        ...
        if(geofeatures_boost::archive::library_version_type(6) < lvt){
            uint_least16_t x=0;
            * this->This() >> x;
            t = geofeatures_boost::serialization::item_version_type(x);
        }
        else{
            unsigned int x=0;
            * this->This() >> x;
    ...
    void load_override(serialization::collection_size_type & t){
        if(geofeatures_boost::archive::library_version_type(5) < this->get_library_version()){
            this->detail_common_iarchive::load_override(t);
        }
        else{
            unsigned int x=0;
