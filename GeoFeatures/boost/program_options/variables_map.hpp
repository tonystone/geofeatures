...
#   pragma warning (push)
#   pragma warning (disable:4251) // 'geofeatures_boost::program_options::variable_value::v' : class 'geofeatures_boost::any' needs to have dll-interface to be used by clients of class 'geofeatures_boost::program_options::variable_value
#endif
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace program_options {
    ...
    */
    ...
    public:
        ...
        variable_value(const geofeatures_boost::any& xv, bool xdefaulted)
        : v(xv), m_defaulted(xdefaulted)
        {}

        /** If stored value if of type T, returns that value. Otherwise,
            throws geofeatures_boost::bad_any_cast exception. */
       template<class T>
       const T& as() const {
           return geofeatures_boost::any_cast<const T&>(v);
       }
       /** @overload */
       template<class T>
       T& as() {
           return geofeatures_boost::any_cast<T&>(v);
       }
        ...
        const geofeatures_boost::any& value() const;

        /** Returns the contained value. */
        geofeatures_boost::any& value();
    private:
        geofeatures_boost::any v;
        bool m_defaulted;
