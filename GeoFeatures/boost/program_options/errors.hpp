...
#   pragma warning (push)
#   pragma warning (disable:4275) // non dll-interface class 'std::logic_error' used as base for dll-interface class 'geofeatures_boost::program_options::error'
#   pragma warning (disable:4251) // class 'std::vector<_Ty>' needs to have dll-interface to be used by clients of class 'geofeatures_boost::program_options::ambiguous_option'
#endif
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace program_options {
    ...
    */
     ...
     *      Poor man's version of geofeatures_boost::format
     *  
