...
#   pragma warning (push)
#   pragma warning (disable:4251) // class 'std::vector<_Ty>' needs to have dll-interface to be used by clients of class 'geofeatures_boost::program_options::positional_options_description'
#endif

namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace program_options { namespace detail {
    ...
    */
    ...
    public:
        ...
        typedef ::geofeatures_boost::program_options::command_line_style::style_t style_t;
