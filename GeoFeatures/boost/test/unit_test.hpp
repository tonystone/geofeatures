...
#  define BOOST_LIB_NAME geofeatures_boost_unit_test_framework
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace unit_test {
...
{
    return ::geofeatures_boost::unit_test::unit_test_main( &init_unit_test, argc, argv );
}
