...
geofeatures_boost::unit_test::make_test_case( geofeatures_boost::function<void ()>(test_function), \
                                  BOOST_TEST_STRINGIZE( test_function ),   \
                                  __FILE__, __LINE__ )
#define BOOST_CLASS_TEST_CASE( test_function, tc_instance )                \
geofeatures_boost::unit_test::make_test_case( (test_function),                         \
                                  BOOST_TEST_STRINGIZE( test_function ),   \
...
( new geofeatures_boost::unit_test::test_suite( testsuite_name, __FILE__, __LINE__ ) )
...
#define BOOST_AUTO_TEST_SUITE_NO_DECOR( suite_name )                    \
    BOOST_AUTO_TEST_SUITE_WITH_DECOR(                                   \
        suite_name,                                                     \
        geofeatures_boost::unit_test::decorator::collector::instance() )            \
/**/
...
BOOST_TEST_DECORATOR( * geofeatures_boost::unit_test::expected_failures( n ) )      \
/**/
...
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    geofeatures_boost::unit_test::make_test_case(                                   \
...
struct BOOST_AUTO_TC_INVOKER( test_name ) {                             \
    ...
    static void run( geofeatures_boost::type<TestType>* = 0 )                       \
    {                                                                   \
        BOOST_TEST_CHECKPOINT('"' << #test_name <<"\" fixture entry."); \
        ...
        BOOST_TEST_CHECKPOINT('"' << #test_name << "\" exit.");         \
                                                                        ...
                                                                        \
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    geofeatures_boost::unit_test::ut_detail::template_test_case_gen<                \
...
#define BOOST_TEST_CASE_TEMPLATE( name, typelist )                      \
    geofeatures_boost::unit_test::ut_detail::template_test_case_gen<name,typelist>( \
...
template<typename type_name>                                            \
void BOOST_JOIN( name, _impl )( geofeatures_boost::type<type_name>* );              \
                                                                        \
struct name {                                                           \
    template<typename TestType>                                         \
    static void run( geofeatures_boost::type<TestType>* frwrd = 0 )                 \
    {                                                                   \
...
static geofeatures_boost::unit_test::ut_detail::global_fixture_impl<F> BOOST_JOIN( gf_, F ) \
/**/
...
static geofeatures_boost::unit_test::decorator::collector const&                    \
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace unit_test { namespace ut_detail {
...
typedef ::geofeatures_boost::unit_test::ut_detail::nil_t BOOST_AUTO_TEST_CASE_FIXTURE;
...
static geofeatures_boost::unit_test::ut_detail::auto_test_unit_registrar    \
...
bool init_unit_test()                   {
#else
::geofeatures_boost::unit_test::test_suite*
init_unit_test_suite( int, char* [] )   {
#endif

#ifdef BOOST_TEST_MODULE
    using namespace ::geofeatures_boost::unit_test;
