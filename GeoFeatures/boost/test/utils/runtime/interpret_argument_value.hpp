...
struct interpret_argument_value_impl {
    static bool _( cstring source, geofeatures_boost::optional<T>& res )
    {
...
struct interpret_argument_value_impl<dstring> {
    static bool _( cstring source, geofeatures_boost::optional<dstring>& res )
    {
...
struct interpret_argument_value_impl<cstring> {
    static bool _( cstring source, geofeatures_boost::optional<cstring>& res )
    {
...
struct interpret_argument_value_impl<bool> {
    static bool _( cstring source, geofeatures_boost::optional<bool>& res )
    {
...
template<typename T>
inline bool
interpret_argument_value( cstring source, geofeatures_boost::optional<T>& res, long )
{
...
template<typename T>
inline bool
interpret_argument_value( cstring source, geofeatures_boost::optional<std::list<T> >& res, int )
{
