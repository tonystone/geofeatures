...
#define BOOST_RTTI_SWITCH( type_id_ ) if( ::geofeatures_boost::rtti::id_t switch_by_id = type_id_ )
#define BOOST_RTTI_CASE( type )       if( switch_by_id == ::geofeatures_boost::rtti::type_id<type>() )
