...
/// - confirmation report (geofeatures_boost::unit_test::CONFIRMATION_REPORT). This report level only produces short confirmation
///   message about test module pass/fail status
/// - short report (geofeatures_boost::unit_test::SHORT_REPORT). This report level produces short summary report for failed/passed
///   assertions and test units.
/// - detailed report (geofeatures_boost::unit_test::DETAILED_REPORT). This report level produces detailed report per test unit for
///   passed/failed assertions and uncaught exceptions
/// - no report (geofeatures_boost::unit_test::NO_REPORT). This report level produces no results report. This is used for test modules
...
/// - plain human readable format (geofeatures_boost::unit_test::OF_CLF)
/// - XML format (geofeatures_boost::unit_test::OF_XML)
