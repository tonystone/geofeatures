...
test_case::test_case( const_string name, geofeatures_boost::function<void ()> const& test_func )
...
test_case::test_case( const_string name, const_string file_name, std::size_t line_num, geofeatures_boost::function<void ()> const& test_func )
