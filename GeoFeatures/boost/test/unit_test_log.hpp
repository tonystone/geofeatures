...
#define BOOST_TEST_LOG_ENTRY( ll )                                                  \
    (::geofeatures_boost::unit_test::unit_test_log                                              \
        << ::geofeatures_boost::unit_test::log::begin( BOOST_TEST_L(__FILE__), __LINE__ ))(ll)  \
/**/
...
#define BOOST_TEST_MESSAGE( M )                                 \
    BOOST_TEST_LOG_ENTRY( ::geofeatures_boost::unit_test::log_messages )    \
...
#define BOOST_TEST_PASSPOINT()                                  \
    ::geofeatures_boost::unit_test::unit_test_log.set_checkpoint(           \
...
#define BOOST_TEST_CHECKPOINT( M )                              \
    ::geofeatures_boost::unit_test::unit_test_log.set_checkpoint(           \
        BOOST_TEST_L(__FILE__),                                 \
        static_cast<std::size_t>(__LINE__),                     \
        (::geofeatures_boost::wrap_stringstream().ref() << M).str() )       \
/**/
