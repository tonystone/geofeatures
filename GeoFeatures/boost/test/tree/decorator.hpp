...
class base;
typedef geofeatures_boost::shared_ptr<base> base_ptr;
...
inline fixture_t
fixture( geofeatures_boost::function<void()> const& setup, geofeatures_boost::function<void()> const& teardown = geofeatures_boost::function<void()>() )
{
...
public:
    typedef geofeatures_boost::function<test_tools::assertion_result (test_unit_id)>   predicate_t;
