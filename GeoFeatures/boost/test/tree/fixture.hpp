...
public:
    // Constructor
    function_based_fixture( geofeatures_boost::function<void ()> const& setup_, geofeatures_boost::function<void ()> const& teardown_ )
    : m_setup( setup_ )
...
private:
    ...
    // Data members
    geofeatures_boost::function<void ()>    m_setup;
    geofeatures_boost::function<void ()>    m_teardown;
};
