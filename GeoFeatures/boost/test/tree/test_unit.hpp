...
//
/// @file
/// Defines @ref geofeatures_boost::unit_test::test_unit "test_unit", @ref geofeatures_boost::unit_test::test_case "test_case",
/// @ref geofeatures_boost::unit_test::test_suite "test_suite" and @ref geofeatures_boost::unit_test::master_test_suite_t "master_test_suite_t"
// ***************************************************************************
...
public:
    ...
    typedef geofeatures_boost::function<test_tools::assertion_result (test_unit_id)>    precondition_t;
...
public:
    ...
    // Constructor
    test_case( const_string tc_name, geofeatures_boost::function<void ()> const& test_func );
    test_case( const_string tc_name, const_string tc_file, std::size_t tc_line, geofeatures_boost::function<void ()> const& test_func );

    // Public property
    typedef BOOST_READONLY_PROPERTY(geofeatures_boost::function<void ()>,(test_case))  test_func;
...
inline test_case*
make_test_case( geofeatures_boost::function<void ()> const& test_func, const_string tc_name, const_string tc_file, std::size_t tc_line )
{
...
make_test_case( void (UserTestCase::*           test_method )(),
                ...
                std::size_t                     tc_line,
                geofeatures_boost::shared_ptr<InstanceType> user_test_case )
{
