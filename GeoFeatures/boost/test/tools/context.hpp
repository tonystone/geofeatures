...
struct BOOST_TEST_DECL context_frame {
    explicit    context_frame( ::geofeatures_boost::unit_test::lazy_ostream const& context_descr );
    ~context_frame();
...
#define BOOST_TEST_INFO( context_descr )                                                        \
    ::geofeatures_boost::unit_test::framework::add_context( BOOST_TEST_LAZY_MSG( context_descr ) , false )  \
/**/

//____________________________________________________________________________//

#define BOOST_TEST_CONTEXT( context_descr )                                                     \
    if( ::geofeatures_boost::test_tools::tt_detail::context_frame BOOST_JOIN( context_frame_, __LINE__ ) =  \
        ::geofeatures_boost::test_tools::tt_detail::context_frame( BOOST_TEST_LAZY_MSG( context_descr ) ) ) \
/**/
