...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace test_tools { namespace assertion {  \
template<>                                                      \
...
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, geofeatures_boost::type<op::EQ<L, R> >*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, geofeatures_boost::type<op::EQ<L, R> >*, mpl::false_ )
{
    return lhs == rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, geofeatures_boost::type<op::NE<L, R> >*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, geofeatures_boost::type<op::NE<L, R> >*, mpl::false_ )
{
    return lhs != rhs;
}
...
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, geofeatures_boost::type<OP>* tp, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, geofeatures_boost::type<op::LT<L, R> >* tp, mpl::false_ )
{
    return lhs < rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, geofeatures_boost::type<op::LE<L, R> >* tp, mpl::false_ )
{
    return lhs <= rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, geofeatures_boost::type<op::GT<L, R> >* tp, mpl::false_ )
{
    return lhs > rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, geofeatures_boost::type<op::GE<L, R> >* tp, mpl::false_ )
{
    return lhs >= rhs;
}
...
template<typename Lhs,typename Rhs>                                 \
struct name<Lhs,Rhs,typename geofeatures_boost::enable_if_c<                    \
...
public:                                                             \
    ...
    {                                                               \
        return assertion::op::compare_collections( lhs, rhs,        \
            (geofeatures_boost::type<elem_op>*)0,                               \
            is_specialized() );                                     \
    }                                                               \
                                                                    \
