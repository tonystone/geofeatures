...
//  struct is_evenly_divisible_by : public geofeatures_boost::mpl::bool_ < ratio_divide<R1, R2>::type::den == 1 >
//  {};
  template <class R1, class R2>
  struct is_evenly_divisible_by : public geofeatures_boost::ratio_detail::is_evenly_divisible_by<R1, R2>
  {};
