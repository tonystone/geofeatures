...
class mapped_region
{
   ...
   {
      mapped_region tmp(geofeatures_boost::move(other));
      this->swap(tmp);
      return *this;
   }
   ...
   (offset_t mapping_size, offset_t offset, offset_t page_offset, std::size_t &size)
{
   ...
   if(mapping_size < offset ||
      geofeatures_boost::uintmax_t(mapping_size - (offset - page_offset)) >
         geofeatures_boost::uintmax_t(std::size_t(-1))){
...
{
   ::geofeatures_boost::adl_move_swap(this->m_base, other.m_base);
   ::geofeatures_boost::adl_move_swap(this->m_size, other.m_size);
   ::geofeatures_boost::adl_move_swap(this->m_page_offset, other.m_page_offset);
   ::geofeatures_boost::adl_move_swap(this->m_mode,  other.m_mode);
   #if defined (BOOST_INTERPROCESS_WINDOWS)
   ::geofeatures_boost::adl_move_swap(this->m_file_or_mapping_hnd, other.m_file_or_mapping_hnd);
   #else
   ::geofeatures_boost::adl_move_swap(this->m_is_xsi, other.m_is_xsi);
   #endif
}
