...
inline typename geofeatures_boost::intrusive::pointer_traits<Pointer>::element_type*
to_raw_pointer(const Pointer &p)
{  return geofeatures_boost::interprocess::ipcdetail::to_raw_pointer(p.operator->());  }
