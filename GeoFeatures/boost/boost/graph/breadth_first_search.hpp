...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost {
     ...
     Buffer& Q, BFSVisitor vis, ColorMap color)
  {
    ...
    while (! Q.empty()) {
      ...
      for (geofeatures_boost::tie(ei, ei_end) = out_edges(u, g); ei != ei_end; ++ei) {
     ...
     Buffer& Q, BFSVisitor vis, ColorMap color)
  {
    ...
    typedef typename property_traits<ColorMap>::value_type ColorValue;
    typedef color_traits<ColorValue> Color;
    typename geofeatures_boost::graph_traits<VertexListGraph>::vertex_iterator i, i_end;
    for (geofeatures_boost::tie(i, i_end) = vertices(g); i != i_end; ++i) {
  ...
  public:
    ...
    {
      invoke_visitors(m_vis, u, g, ::geofeatures_boost::on_initialize_vertex());
    ...
    {
      invoke_visitors(m_vis, u, g, ::geofeatures_boost::on_discover_vertex());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, u, g, ::geofeatures_boost::on_examine_vertex());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::geofeatures_boost::on_examine_edge());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::geofeatures_boost::on_tree_edge());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::geofeatures_boost::on_non_tree_edge());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::geofeatures_boost::on_gray_target());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::geofeatures_boost::on_black_target());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, u, g, ::geofeatures_boost::on_finish_vertex());
      return graph::bfs_visitor_event_not_overridden();
    }
  ...
  namespace detail {
       ...
       geofeatures_boost::mpl::false_)
    {
      ...
      typedef geofeatures_boost::queue<Vertex> queue_t;
      queue_t Q;
      breadth_first_search
        (g, s,
         choose_param(get_param(params, buffer_param_t()), geofeatures_boost::ref(Q)).get(),
         vis, color);
    }
        ...
        bfs_helper
          (g, s, color,
           ...
           geofeatures_boost::mpl::bool_<
             geofeatures_boost::is_base_and_derived<
     ...
     const bgl_named_params<P, T, R>& params)
  {
    ...
    typedef geofeatures_boost::queue<vertex_descriptor> queue_t;
    queue_t Q;
    ...
    namespace detail {
      ...
      struct breadth_first_search_impl {
        ...
        void operator()(const Graph& g, const Source& source, const ArgPack& arg_pack) {
          using namespace geofeatures_boost::graph::keywords;
          typename geofeatures_boost::graph_traits<Graph>::vertex_descriptor sources[1] = {source};
          geofeatures_boost::queue<typename geofeatures_boost::graph_traits<Graph>::vertex_descriptor> Q;
          geofeatures_boost::breadth_first_search(g,
                                      &sources[0],
                                      &sources[1], 
                                      geofeatures_boost::unwrap_ref(arg_pack[_buffer | geofeatures_boost::ref(Q)]),
                                      arg_pack[_visitor | make_bfs_visitor(null_visitor())],
                                      geofeatures_boost::detail::make_color_map_from_arg_pack(g, arg_pack));
        }
      };
    }
