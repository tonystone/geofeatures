 ...
 struct parallel_dijkstra_bfs_visitor : bfs_visitor<>
{
  ...
  void examine_edge(Edge e, Graph& g) {
    ...
    geofeatures_boost::parallel::caching_property_map<PredecessorMap> c_pred(m_predecessor);
    geofeatures_boost::parallel::caching_property_map<DistanceMap> c_dist(m_distance);
