...
#undef BOOST_DEF_PROPERTY
  ...
  namespace detail {
    ...
    struct property_kind_from_graph<G, R T::*> {
      typedef typename geofeatures_boost::mpl::if_<
                geofeatures_boost::is_base_of<T, typename vertex_bundle_type<G>::type>,
                vertex_property_tag,
                typename geofeatures_boost::mpl::if_<
                  geofeatures_boost::is_base_of<T, typename edge_bundle_type<G>::type>,
                  edge_property_tag,
                  typename geofeatures_boost::mpl::if_<
                    geofeatures_boost::is_base_of<T, typename graph_bundle_type<G>::type>,
                    graph_property_tag,
  ...
  public:
    typedef typename property_value<
      typename geofeatures_boost::graph_property_type<Graph>::type, Property
    >::type type;
  };
