...
RealType generate_canonical_impl(URNG& g, geofeatures_boost::mpl::true_ /*is_integral*/)
{
    using std::pow;
...
template<class RealType, std::size_t bits, class URNG>
RealType generate_canonical_impl(URNG& g, geofeatures_boost::mpl::false_ /*is_integral*/)
{
    using std::pow;
    using std::floor;
...
RealType generate_canonical(URNG& g)
{
    RealType result = detail::generate_canonical_impl<RealType, bits>(
        g, geofeatures_boost::is_integral<typename URNG::result_type>());
