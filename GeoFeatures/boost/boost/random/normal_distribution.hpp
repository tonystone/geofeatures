...
inline typename geofeatures_boost::make_unsigned<typename Engine::result_type>::type
generate_one_digit(Engine& eng, std::size_t bits)
{
    typedef typename Engine::result_type base_result;
    typedef typename geofeatures_boost::make_unsigned<base_result>::type base_unsigned;
...
std::pair<RealType, int> generate_int_float_pair(Engine& eng, geofeatures_boost::mpl::true_)
{
    typedef typename Engine::result_type base_result;
    typedef typename geofeatures_boost::make_unsigned<base_result>::type base_unsigned;
...
template<class RealType, std::size_t w, class Engine>
inline std::pair<RealType, int> generate_int_float_pair(Engine& eng, geofeatures_boost::mpl::false_)
{
...
inline std::pair<RealType, int> generate_int_float_pair(Engine& eng)
{
    ...
    return generate_int_float_pair<RealType, w>(eng,
        geofeatures_boost::is_integral<base_result>());
}
...
struct unit_normal_distribution
{
    ...
    RealType generate_tail(Engine& eng) {
        geofeatures_boost::random::exponential_distribution<RealType> exponential;
