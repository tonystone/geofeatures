...
rbegin( C& c )
{
    return BOOST_DEDUCED_TYPENAME range_reverse_iterator<C>::type( geofeatures_boost::end( c ) );
}
...
rbegin( C& c )
{
    typedef BOOST_DEDUCED_TYPENAME range_reverse_iterator<C>::type
        iter_type;
    return iter_type( geofeatures_boost::end( c ) );
}
...
{
    return geofeatures_boost::rbegin( r );
}
