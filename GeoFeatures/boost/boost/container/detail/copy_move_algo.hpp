...
template<class It>
struct are_elements_contiguous< ::geofeatures_boost::move_iterator<It> >
...
template<class Pointer>
struct are_elements_contiguous<geofeatures_boost::container::container_detail::vector_iterator<Pointer> >
{
   static const bool value = true;
};

template<class Pointer>
struct are_elements_contiguous<geofeatures_boost::container::container_detail::vector_const_iterator<Pointer> >
{
   static const bool value = true;
};
...
template <class PointedType, class DifferenceType, class OffsetType, std::size_t OffsetAlignment>
struct are_elements_contiguous< ::geofeatures_boost::interprocess::offset_ptr<PointedType, DifferenceType, OffsetType, OffsetAlignment> >
{
   static const bool value = true;
};
...
struct are_contiguous_and_same
   : geofeatures_boost::move_detail::and_
      ...
      , is_same< typename remove_const< typename ::geofeatures_boost::container::iterator_traits<I>::value_type >::type
               , typename ::geofeatures_boost::container::iterator_traits<O>::value_type
               >
      >
{};
...
struct is_memtransfer_copy_assignable
   : geofeatures_boost::move_detail::and_
      ...
      , container_detail::is_trivially_copy_assignable< typename ::geofeatures_boost::container::iterator_traits<I>::value_type >
      >
{};
...
struct is_memtransfer_copy_constructible
   : geofeatures_boost::move_detail::and_
      < are_contiguous_and_same<I, O>
      , container_detail::is_trivially_copy_constructible< typename ::geofeatures_boost::container::iterator_traits<I>::value_type >
      >
{};
...
{
   typedef typename geofeatures_boost::container::iterator_traits<I>::value_type value_type;
   typename geofeatures_boost::container::iterator_traits<I>::difference_type n = geofeatures_boost::container::iterator_distance(f, l);
   if(n){
      std::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
      geofeatures_boost::container::iterator_advance(r, n);
   }
   return r;
}
...
template
   <typename I, // I models InputIterator
    typename F> // F models ForwardIterator
F memmove_n(I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r) BOOST_NOEXCEPT_OR_NOTHROW
{
   typedef typename geofeatures_boost::container::iterator_traits<I>::value_type value_type;
   if(n){
      std::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
...
template
   <typename I, // I models InputIterator
    typename F> // F models ForwardIterator
I memmove_n_source(I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r) BOOST_NOEXCEPT_OR_NOTHROW
{
   if(n){
      typedef typename geofeatures_boost::container::iterator_traits<I>::value_type value_type;
      std::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
      geofeatures_boost::container::iterator_advance(f, n);
   }
   return f;
}
...
template
   <typename I, // I models InputIterator
    typename F> // F models ForwardIterator
I memmove_n_source_dest(I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F &r) BOOST_NOEXCEPT_OR_NOTHROW
{
   typedef typename geofeatures_boost::container::iterator_traits<I>::value_type value_type;
   if(n){
      std::memmove((iterator_to_raw_pointer)(r), (iterator_to_raw_pointer)(f), sizeof(value_type)*n);
...
{
   typedef typename ::geofeatures_boost::container::iterator_traits<O>::value_type value_type;
...
struct enable_if_trivially_destructible
   : enable_if_c < false/*container_detail::is_trivially_destructible
                  <typename geofeatures_boost::container::iterator_traits<I>::value_type>::value*/
               , R>
{};
...
//!   \code
//!   for (; f != l; ++r, ++f)
//!      allocator_traits::construct(a, &*r, geofeatures_boost::move(*f));
//!   \endcode
//!
//! <b>Returns</b>: r
template
   ...
   uninitialized_move_alloc(Allocator &a, I f, I l, F r)
{
   ...
   BOOST_TRY{
      while (f != l) {
         allocator_traits<Allocator>::construct(a, container_detail::iterator_to_raw_pointer(r), geofeatures_boost::move(*f));
         ++f; ++r;
      }
   }
   BOOST_CATCH(...){
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_move_alloc_n(Allocator &a, I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r)
{
   F back = r;
   BOOST_TRY{
      while (n--) {
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_move_alloc_n(Allocator &, I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r) BOOST_NOEXCEPT_OR_NOTHROW
...
inline typename container_detail::disable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_move_alloc_n_source(Allocator &a, I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r)
{
   F back = r;
   BOOST_TRY{
      while (n--) {
...
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_move_alloc_n_source(Allocator &, I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r) BOOST_NOEXCEPT_OR_NOTHROW
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_copy_alloc_n(Allocator &a, I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r)
{
   F back = r;
   BOOST_TRY{
      while (n--) {
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_copy_alloc_n(Allocator &, I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r) BOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n(f, n, r); }
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_copy_alloc_n_source(Allocator &a, I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r)
{
   F back = r;
   BOOST_TRY{
      while (n--) {
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_copy_alloc_n_source(Allocator &, I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r) BOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n_source(f, n, r); }
...
{
   typedef typename geofeatures_boost::container::iterator_traits<F>::value_type value_type;
...
typename F>   // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_assignable<I, F, F>::type
   copy_n(I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r)
{
   while (n--) {
      *r = *f;
      ++f; ++r;
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   copy_n(I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r) BOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n(f, n, r); }
...
inline typename container_detail::disable_if_memtransfer_copy_assignable<I, F, I>::type
   copy_n_source(I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r)
{
   while (n--) {
      *r = *f;
      ++f; ++r;
...
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   copy_n_source(I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r) BOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n_source(f, n, r); }
...
typename F>   // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_assignable<I, F, I>::type
   copy_n_source_dest(I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F &r)
{
   while (n--) {
      *r = *f;
      ++f; ++r;
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   copy_n_source_dest(I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F &r) BOOST_NOEXCEPT_OR_NOTHROW
...
typename F>   // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_assignable<I, F, F>::type
   move_n(I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r)
{
   while (n--) {
      *r = ::geofeatures_boost::move(*f);
      ++f; ++r;
...
typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, F>::type
   move_n(I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r) BOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n(f, n, r); }
...
{
   typedef typename geofeatures_boost::container::iterator_traits<I>::value_type value_type;
   const typename geofeatures_boost::container::iterator_traits<I>::difference_type n = geofeatures_boost::container::iterator_distance(f, l);
   r -= n;
...
,typename F>   // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_assignable<I, F, I>::type
   move_n_source_dest(I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F &r)
{
   while (n--) {
      *r = ::geofeatures_boost::move(*f);
      ++f; ++r;
...
,typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   move_n_source_dest(I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F &r) BOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n_source_dest(f, n, r); }
...
,typename F>   // F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_assignable<I, F, I>::type
   move_n_source(I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r)
{
   while (n--) {
      *r = ::geofeatures_boost::move(*f);
      ++f; ++r;
...
,typename F>   // F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_assignable<I, F, I>::type
   move_n_source(I f, typename geofeatures_boost::container::iterator_traits<I>::difference_type n, F r) BOOST_NOEXCEPT_OR_NOTHROW
{  return container_detail::memmove_n_source(f, n, r); }
                    ...
                    , G large_range_f, typename allocator_traits<Allocator>::size_type n_j)
{
   ...
   for (; n != n_i ; ++short_range_f, ++large_range_f, ++n){
      geofeatures_boost::adl_move_swap(*short_range_f, *large_range_f);
   }
   geofeatures_boost::container::uninitialized_move_alloc_n(a, large_range_f, n_j - n_i, short_range_f);  // may throw
   geofeatures_boost::container::destroy_alloc_n(a, large_range_f, n_j - n_i);
}
                    ...
                    , G large_range_f, typename allocator_traits<Allocator>::size_type n_j)
{
   ...
   geofeatures_boost::container::iterator_advance(large_range_f, n_i);
   geofeatures_boost::container::iterator_advance(short_range_f, n_i);
   geofeatures_boost::container::uninitialized_move_alloc_n(a, large_range_f, n_j - n_i, short_range_f);  // may throw
   geofeatures_boost::container::destroy_alloc_n(a, large_range_f, n_j - n_i);
}
...
{
   if (n_o < n_i){
      inp_start = geofeatures_boost::container::copy_n_source_dest(inp_start, n_o, out_start);     // may throw
      geofeatures_boost::container::uninitialized_copy_alloc_n(a, inp_start, n_i - n_o, out_start);// may throw
   }
   else{
      out_start = geofeatures_boost::container::copy_n(inp_start, n_i, out_start);  // may throw
      geofeatures_boost::container::destroy_alloc_n(a, out_start, n_o - n_i);
   }
}
...
{
   if (n_o < n_i){
      inp_start = geofeatures_boost::container::move_n_source_dest(inp_start, n_o, out_start);  // may throw
      geofeatures_boost::container::uninitialized_move_alloc_n(a, inp_start, n_i - n_o, out_start);  // may throw
   }
   else{
      out_start = geofeatures_boost::container::move_n(inp_start, n_i, out_start);  // may throw
      geofeatures_boost::container::destroy_alloc_n(a, out_start, n_o - n_i);
   }
}
