...
public:
  ...
  packed_iarchive(MPI_Comm const & comm, buffer_type & b, unsigned int flags = geofeatures_boost::archive::no_header, int position = 0)
...
BOOST_SERIALIZATION_REGISTER_ARCHIVE(geofeatures_boost::mpi::packed_iarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(geofeatures_boost::mpi::packed_iarchive)
