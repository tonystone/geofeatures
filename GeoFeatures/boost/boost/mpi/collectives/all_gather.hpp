...
namespace detail {
  ...
  {
    MPI_Datatype type = geofeatures_boost::mpi::get_mpi_datatype<T>(*in_values);
           ...
           std::vector<T>& out_values)
{
  ...
  ::geofeatures_boost::mpi::all_gather(comm, &in_value, 1, &out_values[0]);
}
           ...
           std::vector<T>& out_values)
{
  ...
  ::geofeatures_boost::mpi::all_gather(comm, in_values, n, &out_values[0]);
}
