...
struct default_result_converter
{
    ...
    struct apply
    {
        typedef typename mpl::if_<
          ...
          , geofeatures_boost::python::to_python_value<
...
{
    typedef geofeatures_boost::python::to_python_value<char const*const&> type;
};

template <>
struct default_result_converter::apply<PyObject*>
{
    typedef geofeatures_boost::python::to_python_value<PyObject*const&> type;
};
