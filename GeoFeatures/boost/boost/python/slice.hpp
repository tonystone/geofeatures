...
namespace detail
{
  class BOOST_PYTHON_DECL slice_base : public object
  {
   public:
      ...
      // equal to a default-constructed geofeatures_boost::python::object.
...
class slice : public detail::slice_base
{
 ...
 public:
        ...
        const RandomAccessIterator& end) const
    {
        ...
        difference_type max_dist = geofeatures_boost::detail::distance(begin, end);
        ...
        typename iterator_difference<RandomAccessIterator>::type final_dist = 
            geofeatures_boost::detail::distance( ret.start, ret.stop);
