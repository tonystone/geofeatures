...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace polygon { namespace detail { namespace simplify_detail {
  ...
  {
    using namespace geofeatures_boost::polygon;
