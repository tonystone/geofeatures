...
struct pointer_traits
{
      ...
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT
         ( geofeatures_boost::intrusive::detail::, Ptr, element_type
         , geofeatures_boost::intrusive::detail::first_param<Ptr>)                        element_type;
      //
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT
         (geofeatures_boost::intrusive::detail::, Ptr, difference_type, std::ptrdiff_t)   difference_type;

      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT
         (geofeatures_boost::intrusive::detail::, Ptr, reference, typename geofeatures_boost::intrusive::detail::unvoid_ref<element_type>::type)   reference;
      //
      template <class U> struct rebind_pointer
      {
         typedef typename geofeatures_boost::intrusive::pointer_rebind<Ptr, U>::type  type;
      };

      #if !defined(BOOST_NO_CXX11_TEMPLATE_ALIASES)
         template <class U> using rebind = typename geofeatures_boost::intrusive::pointer_rebind<Ptr, U>::type;
      #endif
   ...
   static pointer pointer_to(reference r)
   {
      ...
      const bool value = geofeatures_boost::intrusive::detail::
         has_member_function_callable_with_pointer_to
            <Ptr, Ptr (*)(reference)>::value;
      geofeatures_boost::intrusive::detail::bool_<value> flag;
   ...
   static pointer static_cast_from(const UPtr &uptr)
   {
      ...
      const bool value = geofeatures_boost::intrusive::detail::
         ...
         || geofeatures_boost::intrusive::detail::
               has_member_function_callable_with_static_cast_from
                  <pointer, pointer(*)(UPtr)>::value;
      return pointer_traits::priv_static_cast_from(geofeatures_boost::intrusive::detail::bool_<value>(), uptr);
   }
   ...
   static pointer const_cast_from(const UPtr &uptr)
   {
      ...
      const bool value = geofeatures_boost::intrusive::detail::
         ...
         || geofeatures_boost::intrusive::detail::
               has_member_function_callable_with_const_cast_from
                  <pointer, pointer(*)(UPtr)>::value;
      return pointer_traits::priv_const_cast_from(geofeatures_boost::intrusive::detail::bool_<value>(), uptr);
   }
   ...
   static pointer dynamic_cast_from(const UPtr &uptr)
   {
      ...
      const bool value = geofeatures_boost::intrusive::detail::
         ...
         || geofeatures_boost::intrusive::detail::
               has_member_function_callable_with_dynamic_cast_from
                  <pointer, pointer(*)(UPtr)>::value;
      return pointer_traits::priv_dynamic_cast_from(geofeatures_boost::intrusive::detail::bool_<value>(), uptr);
   }
   ...
   //priv_pointer_to
   static pointer priv_pointer_to(geofeatures_boost::intrusive::detail::true_, reference r)
   { return Ptr::pointer_to(r); }

   static pointer priv_pointer_to(geofeatures_boost::intrusive::detail::false_, reference r)
   { return pointer(geofeatures_boost::intrusive::detail::addressof(r)); }

   //priv_static_cast_from
   template<class UPtr>
   static pointer priv_static_cast_from(geofeatures_boost::intrusive::detail::true_, const UPtr &uptr)
   { return Ptr::static_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_static_cast_from(geofeatures_boost::intrusive::detail::false_, const UPtr &uptr)
   {  return pointer_to(*static_cast<element_type*>(to_raw_pointer(uptr)));  }

   //priv_const_cast_from
   template<class UPtr>
   static pointer priv_const_cast_from(geofeatures_boost::intrusive::detail::true_, const UPtr &uptr)
   { return Ptr::const_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_const_cast_from(geofeatures_boost::intrusive::detail::false_, const UPtr &uptr)
   {  return pointer_to(const_cast<element_type&>(*uptr));  }

   //priv_dynamic_cast_from
   template<class UPtr>
   static pointer priv_dynamic_cast_from(geofeatures_boost::intrusive::detail::true_, const UPtr &uptr)
   { return Ptr::dynamic_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_dynamic_cast_from(geofeatures_boost::intrusive::detail::false_, const UPtr &uptr)
   {
...
struct pointer_traits<T*>
{
   ...
   #else
      typedef typename geofeatures_boost::intrusive::detail::unvoid_ref<element_type>::type reference;
      #if !defined(BOOST_NO_CXX11_TEMPLATE_ALIASES)
         template <class U> using rebind = U*;
      #endif
   #endif
   ...
   //!
   static pointer pointer_to(reference r)
   { return geofeatures_boost::intrusive::detail::addressof(r); }
