...
#pragma warning(disable:4512) //assignment operator could not be generated
    ...
    public:
        ...
        typedef typename geofeatures_boost::call_traits<S>::param_type      param_t;
        typedef typename geofeatures_boost::call_traits<S>::const_reference return_t;
        typedef S                                               subject_t;
    ...
    public:
        ...
        typedef BaseT                                           base_t;
        typedef typename geofeatures_boost::call_traits<A>::param_type      left_param_t;
        typedef typename geofeatures_boost::call_traits<A>::const_reference left_return_t;
        typedef typename geofeatures_boost::call_traits<B>::param_type      right_param_t;
        typedef typename geofeatures_boost::call_traits<B>::const_reference right_return_t;
        typedef A                                               left_t;
    ...
    private:
        ...
        geofeatures_boost::compressed_pair<left_embed_t, right_embed_t> subj;
    };
