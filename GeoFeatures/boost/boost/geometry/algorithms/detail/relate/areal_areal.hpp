...
public:
    ...
    bool operator()(Areal const& areal)
    {
        ...
        point_type pt;
        bool const ok = geofeatures_boost::geometry::point_on_border(pt, areal);
        ...
        if ( pig > 0 )
        {
                    ...
                    ++ring_id.ring_index )
            {
                ...
                if ( geofeatures_boost::empty(range_ref) )
                {
...
// THIS IS ALSO TRUE FOR OTHER ANALYSERS! in L/L and L/A
    ...
    private:
        ...
        static inline void for_following_rings(Analyser & analyser, Turn const& turn)
        {
            ...
            signed_size_type
                count = geofeatures_boost::numeric_cast<signed_size_type>(
