...
struct equals_by_collection
{
    ...
    static inline bool apply(Geometry1 const& geometry1, Geometry2 const& geometry2)
    {
        ...
        if (geofeatures_boost::size(c1) != geofeatures_boost::size(c2))
        {
            return false;
        }
...
struct equals<geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Geometry2>
{
...
struct equals<Geometry1, geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{
    struct visitor: static_visitor<bool>
    {
...
>
{
    ...
    static inline bool apply(
        geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T1)> const& geometry1,
