...
struct compute_pythagoras
{
    ...
    {
        T const c1 = geofeatures_boost::numeric_cast<T>(get<I-1>(p1));
        T const c2 = geofeatures_boost::numeric_cast<T>(get<I-1>(p2));
        T const d = c1 - c2;
...
struct compute_pythagoras<0, T>
{
    ...
    {
        return geofeatures_boost::numeric_cast<T>(0);
    }
};
...
public :
    ...
    */
    ...
    apply(P1 const& p1, P2 const& p2)
    {
        ...
        return math::sqrt
            (
                 geofeatures_boost::numeric_cast<typename calculation_type<P1, P2>::type>
                    (
