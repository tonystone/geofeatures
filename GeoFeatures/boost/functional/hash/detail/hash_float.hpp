...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_impl(Float v,
            BOOST_DEDUCED_TYPENAME geofeatures_boost::enable_if_c<
        ...
        {
            geofeatures_boost::hash_detail::call_frexp<T> frexp;
            geofeatures_boost::hash_detail::call_ldexp<T> ldexp;
            ...
            std::size_t const length
                = (limits<T>::digits *
                        geofeatures_boost::static_log2<limits<T>::radix>::value
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_value(T v)
        {
            return geofeatures_boost::hash_detail::is_zero(v) ? 0 : float_hash_impl(v, 0);
        }
    }
}
