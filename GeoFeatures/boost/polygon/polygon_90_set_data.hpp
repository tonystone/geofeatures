...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace polygon{
  ...
  public:
    ...
    shrink2(typename coordinate_traits<coordinate_type>::unsigned_area_type west_shrinking,
      ...
      ::geofeatures_boost::polygon::bloat(externalBoundary, 10); //bloat by diferential ammount
  ...
  private:
    ...
    void get_fracture(output_container& container, bool fracture_holes, concept_type tag) const {
      clean();
      ::geofeatures_boost::polygon::get_polygons(container, data_.begin(), data_.end(), orient_, fracture_holes, tag);
    }
    ...
    void get_fracture(output_container& container, bool fracture_holes, concept_type tag,
      size_t vthreshold) const {
      clean();
      ::geofeatures_boost::polygon::get_polygons(container, data_.begin(), data_.end(), orient_, fracture_holes, tag, vthreshold);
    }
  };
