...
struct bstbase3
{
   ...
   typedef geofeatures_boost::intrusive::reverse_iterator<iterator>                                         reverse_iterator;
   typedef geofeatures_boost::intrusive::reverse_iterator<const_iterator>                                   const_reverse_iterator;
   ...
   typedef typename geofeatures_boost::intrusive::value_traits_pointers
...
{
   typedef ::geofeatures_boost::intrusive::detail::identity<T> type;
};
   ...
   :  public bstbase<ValueTraits, VoidOrKeyOfValue, VoidOrKeyComp, ConstantTimeSize, SizeType, AlgoType, HeaderHolder>
{
   ...
   typedef BOOST_INTRUSIVE_IMPDEF(geofeatures_boost::intrusive::reverse_iterator<iterator>)                 reverse_iterator;
   typedef BOOST_INTRUSIVE_IMPDEF(geofeatures_boost::intrusive::reverse_iterator<const_iterator>)           const_reverse_iterator;
   ...
   bstree_impl(BOOST_RV_REF(bstree_impl) x)
      : data_type(::geofeatures_boost::move(x.comp()), ::geofeatures_boost::move(x.get_value_traits()))
   {
      this->swap(x);
   }
   ...
   {
      //This can throw
      ::geofeatures_boost::adl_move_swap(this->comp(), this->comp());
      //These can't throw
   ...
   friend bool operator==(const bstree_impl &x, const bstree_impl &y)
   {
      ...
      return geofeatures_boost::intrusive::algo_equal(x.cbegin(), x.cend(), y.cbegin(), y.cend());
   }
   ...
   friend bool operator<(const bstree_impl &x, const bstree_impl &y)
   {  return ::geofeatures_boost::intrusive::algo_lexicographical_compare(x.begin(), x.end(), y.begin(), y.end());  }
