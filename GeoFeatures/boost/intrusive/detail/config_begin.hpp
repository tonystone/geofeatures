...
#include <boost/config.hpp>
   ...
   #pragma warning (disable : 4541) //'typeid' used on polymorphic type 'geofeatures_boost::exception' with /GR-
   #pragma warning (disable : 4512) //'typeid' used on polymorphic type 'geofeatures_boost::exception' with /GR-
#endif
