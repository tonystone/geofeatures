...
{
   typedef typename geofeatures_boost::intrusive::detail::first_param<Ptr>::type type;
};
...
{
   typedef typename ::geofeatures_boost::intrusive::detail::pointer_element_impl<Ptr>::type type;
};
