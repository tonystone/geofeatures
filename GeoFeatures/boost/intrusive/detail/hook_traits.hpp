...
struct mhtraits
{
   ...
   static pointer to_value_ptr(const node_ptr & n)
   {
      return pointer_traits<pointer>::pointer_to
         (*detail::parent_from_member<T, Hook>
            (static_cast<Hook*>(geofeatures_boost::intrusive::detail::to_raw_pointer(n)), P));
   }
   ...
   static const_pointer to_value_ptr(const const_node_ptr & n)
   {
      return pointer_traits<const_pointer>::pointer_to
         (*detail::parent_from_member<T, Hook>
            (static_cast<const Hook*>(geofeatures_boost::intrusive::detail::to_raw_pointer(n)), P));
   }
};
...
struct fhtraits
{
   ...
   static node_ptr to_node_ptr(reference value)
   {  return static_cast<node*>(geofeatures_boost::intrusive::detail::to_raw_pointer(Functor::to_hook_ptr(value)));  }

   static const_node_ptr to_node_ptr(const_reference value)
   {  return static_cast<const node*>(geofeatures_boost::intrusive::detail::to_raw_pointer(Functor::to_hook_ptr(value)));  }
