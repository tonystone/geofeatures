...
struct make_initializer_node
{
    ...
    private: // helpers, for metafunction result (below)
        ...
        private: // helpers, for static functions (below)
            ...
            typedef geofeatures_boost::is_reference<public_T> 
                is_reference_content_t;

            typedef typename geofeatures_boost::mpl::if_<is_reference_content_t, public_T, const public_T& >::type 
                param_T;

            template <class T> struct disable_overload{};

            typedef typename geofeatures_boost::mpl::if_<is_reference_content_t, disable_overload<public_T>, public_T&& >::type 
                param2_T;
#else
        ...
        public: // static functions
            ...
            {
                typedef typename geofeatures_boost::detail::make_reference_content<
                      recursive_enabled_T
                    >::type internal_T;
            ...
            static int initialize(void* dest, param2_T operand)
            {
                ...
                typedef typename geofeatures_boost::mpl::if_<is_reference_content_t, param2_T, recursive_enabled_T>::type value_T;
                new(dest) value_T( geofeatures_boost::detail::variant::move(operand) );
                return BOOST_MPL_AUX_VALUE_WKND(index)::value; // which
            }
#endif
        };
...
#define BOOST_VARIANT_AUX_INITIALIZER_T( mpl_seq, typename_base ) \
    ::geofeatures_boost::mpl::iter_fold< \
          mpl_seq \
        , ::geofeatures_boost::mpl::pair< \
              ::geofeatures_boost::detail::variant::initializer_root \
            , ::geofeatures_boost::mpl::int_<0> \
            > \
        , ::geofeatures_boost::mpl::protect< \
              ::geofeatures_boost::detail::variant::make_initializer_node \
            > \
        >::type::first \
    /**/
...
#define BOOST_VARIANT_AUX_INITIALIZER_T( mpl_seq, typename_base ) \
    ::geofeatures_boost::detail::variant::preprocessor_list_initializer< \
          BOOST_VARIANT_ENUM_PARAMS(typename_base) \
        > \
    /**/
