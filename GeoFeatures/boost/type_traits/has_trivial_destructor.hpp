...
#else
   BOOST_STATIC_CONSTANT(bool, value = ::geofeatures_boost::is_pod<T>::value);
#endif
};

} // namespace detail

BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_destructor,T,::geofeatures_boost::detail::has_trivial_dtor_impl<T>::value)
