...
struct is_class_or_union
{
   BOOST_STATIC_CONSTANT(bool, value =
      (::geofeatures_boost::type_traits::ice_or<
         ...
         , ::geofeatures_boost::is_union<T>::value
      >::value));
};
...
# else
    template <class U> static ::geofeatures_boost::type_traits::yes_type is_class_or_union_tester(void(U::*)(void));

#  if BOOST_WORKAROUND(__MWERKS__, <= 0x3000) // no SFINAE
    static ::geofeatures_boost::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester(0)) == sizeof(::geofeatures_boost::type_traits::yes_type));
#  else
    template <class U>
    static ::geofeatures_boost::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester<T>(0)) == sizeof(::geofeatures_boost::type_traits::yes_type));
#  endif
# endif
};
#endif
...
{
    template <typename T> struct type
       : public ::geofeatures_boost::is_convertible<typename geofeatures_boost::add_reference<T>::type,::geofeatures_boost::detail::int_convertible>
    {
    };
};
...
{
   //typedef ::geofeatures_boost::add_reference<T> ar_t;
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
      (::geofeatures_boost::type_traits::ice_or<
           ::geofeatures_boost::is_arithmetic<T>::value
         , ::geofeatures_boost::is_reference<T>::value
         , ::geofeatures_boost::is_function<T>::value
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
    ...
    typedef ::geofeatures_boost::detail::is_enum_helper<
          ::geofeatures_boost::detail::is_enum_impl<T>::selector
        > se_t;
#else
    typedef ::geofeatures_boost::detail::is_enum_helper<selector> se_t;
#endif
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_enum,T,::geofeatures_boost::detail::is_enum_impl<T>::value)
