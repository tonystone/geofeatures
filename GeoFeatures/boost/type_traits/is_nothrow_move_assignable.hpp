...
struct false_or_cpp11_noexcept_move_assignable: public ::geofeatures_boost::false_type {};

template <class T>
struct false_or_cpp11_noexcept_move_assignable <
        T,
        typename ::geofeatures_boost::enable_if_c<sizeof(T) && BOOST_NOEXCEPT_EXPR(::geofeatures_boost::declval<T&>() = ::geofeatures_boost::declval<T>())>::type
    > : public ::geofeatures_boost::integral_constant<bool, BOOST_NOEXCEPT_EXPR(::geofeatures_boost::declval<T&>() = ::geofeatures_boost::declval<T>())>
{};

template <class T>
struct is_nothrow_move_assignable_imp{
    BOOST_STATIC_CONSTANT(bool, value = ::geofeatures_boost::detail::false_or_cpp11_noexcept_move_assignable<T>::value);
};

template <class T>
struct is_nothrow_move_assignable_imp<T const> : public ::geofeatures_boost::false_type {};
template <class T>
struct is_nothrow_move_assignable_imp<T volatile> : public ::geofeatures_boost::false_type{};
template <class T>
struct is_nothrow_move_assignable_imp<T const volatile> : public ::geofeatures_boost::false_type{};
template <class T>
struct is_nothrow_move_assignable_imp<T&> : public ::geofeatures_boost::false_type{};
    ...
    BOOST_STATIC_CONSTANT(bool, value = (
        ::geofeatures_boost::type_traits::ice_and<
            ::geofeatures_boost::type_traits::ice_or<
                ::geofeatures_boost::has_trivial_move_assign<T>::value,
                ::geofeatures_boost::has_nothrow_assign<T>::value
            >::value,
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_nothrow_move_assignable,T,::geofeatures_boost::detail::is_nothrow_move_assignable_imp<T>::value)
