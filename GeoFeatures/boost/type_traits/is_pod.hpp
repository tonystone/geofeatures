...
{ 
    BOOST_STATIC_CONSTANT(
        ...
        (::geofeatures_boost::type_traits::ice_or<
            ::geofeatures_boost::is_scalar<T>::value,
            ::geofeatures_boost::is_void<T>::value,
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_pod,T,::geofeatures_boost::detail::is_pod_impl<T>::value)
// is_POD is the old depricated name for this trait, do not use this as it may
// be removed in future without warning!!
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_POD,T,::geofeatures_boost::is_pod<T>::value)
