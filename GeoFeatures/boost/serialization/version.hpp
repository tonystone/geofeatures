...
struct version
{
    ...
    typedef
        typename mpl::eval_if<
            is_base_and_derived<geofeatures_boost::serialization::basic_traits,T>,
...
{                                                                      \
    ...
    BOOST_STATIC_CONSTANT(int, value = version::type::value);          \
    BOOST_MPL_ASSERT((                                                 \
        geofeatures_boost::mpl::less<                                              \
            geofeatures_boost::mpl::int_<N>,                                       \
            geofeatures_boost::mpl::int_<256>                                      \
        >                                                              \
    ));                                                                \
    /*                                                                 \
    BOOST_MPL_ASSERT((                                                 \
