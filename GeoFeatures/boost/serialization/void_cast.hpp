    ...
    private geofeatures_boost::noncopyable
{
    ...
    friend 
    BOOST_SERIALIZATION_DECL void const *
    geofeatures_boost::serialization::void_downcast(
        extended_type_info const & derived,
        extended_type_info const & base,
        void const * const
    );
    ...
    public void_caster
{
    virtual void const * downcast(void const * const t) const {
        const Derived * d = 
            geofeatures_boost::serialization::smart_cast<const Derived *, const Base *>(
    ...
    virtual void const * upcast(void const * const t) const {
        const Base * b = 
            geofeatures_boost::serialization::smart_cast<const Base *, const Derived *>(
...
{
    typedef
        typename mpl::eval_if<geofeatures_boost::is_virtual_base_of<Base,Derived>,
            mpl::identity<
