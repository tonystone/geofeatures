...
/**/
    ...
    BOOST_SERIALIZATION_COLLECTION_TRAITS_HELPER(geofeatures_boost::long_long_type, C)  \
    BOOST_SERIALIZATION_COLLECTION_TRAITS_HELPER(geofeatures_boost::ulong_long_type, C) \
    /**/
#else
    #define BOOST_SERIALIZATION_COLLECTION_TRAITS_HELPER_INT64(C)
#endif
