...
public:
    ...
    is_less_than(const geofeatures_boost::serialization::extended_type_info &rhs) const ;
    virtual BOOST_SERIALIZATION_DECL bool
    is_equal(const geofeatures_boost::serialization::extended_type_info &rhs) const ;
};
...
public:
    ...
    get_derived_extended_type_info(const T & t) const {
        ...
        BOOST_STATIC_WARNING(geofeatures_boost::is_polymorphic< T >::value);
        const char * derived_key = t.get_key();
        BOOST_ASSERT(NULL != derived_key);
        return geofeatures_boost::serialization::extended_type_info::find(derived_key);
    }
    ...
    virtual void * construct(unsigned int count, ...) const{
        ...
        switch(count){
        case 0:
            return factory<typename geofeatures_boost::remove_const< T >::type, 0>(ap);
        case 1:
            return factory<typename geofeatures_boost::remove_const< T >::type, 1>(ap);
        case 2:
            return factory<typename geofeatures_boost::remove_const< T >::type, 2>(ap);
        case 3:
            return factory<typename geofeatures_boost::remove_const< T >::type, 3>(ap);
        case 4:
            return factory<typename geofeatures_boost::remove_const< T >::type, 4>(ap);
        default:
    ...
    virtual void destroy(void const * const p) const{
        geofeatures_boost::serialization::access::destroy(
...
// before any of the other headers.
    ...
    struct extended_type_info_impl {
        typedef typename 
            geofeatures_boost::serialization::extended_type_info_no_rtti< T > type;
    };
    } // namespace serialization
    } // namespace geofeatures_boost
#endif
