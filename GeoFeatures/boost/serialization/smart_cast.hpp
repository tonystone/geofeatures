...
namespace smart_cast_impl {
    ...
    struct reference {
        ...
        static T cast(U & u){
            typedef typename mpl::eval_if<
                geofeatures_boost::is_polymorphic<U>,
...
T smart_cast(U u) {
    typedef
        typename mpl::eval_if<
            typename mpl::or_<
                geofeatures_boost::is_same<void *, U>,
                geofeatures_boost::is_same<void *, T>,
                geofeatures_boost::is_same<const void *, U>,
                geofeatures_boost::is_same<const void *, T>
            >,
            mpl::identity<smart_cast_impl::void_pointer< T > >,
        // else
        typename mpl::eval_if<geofeatures_boost::is_pointer<U>,
            mpl::identity<smart_cast_impl::pointer< T > >,
        // else
        typename mpl::eval_if<geofeatures_boost::is_reference<U>,
