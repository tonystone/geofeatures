    ...
    collection_size_type count)
{
    ...
    #if 0
        geofeatures_boost::archive::library_version_type library_version(
    ...
    while(count-- > 0){
        ...
        geofeatures_boost::serialization::save_construct_data_adl(
            ar, 
            &(*it), 
            item_version
        );
        ar << geofeatures_boost::serialization::make_nvp("item", *it++);
    }
}
