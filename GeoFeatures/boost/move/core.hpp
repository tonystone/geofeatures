...
//used to detect noncopyable types for other Boost libraries.
   ...
   template <class T>
   class rv
      : public ::geofeatures_boost::move_detail::if_c
         < ::geofeatures_boost::move_detail::is_class<T>::value
         , T
         , ::geofeatures_boost::move_detail::nat
         >::type
   {
      rv();
      ~rv() throw();
   ...
   struct is_rv
      ...
      : integral_constant<bool, ::geofeatures_boost::move_detail::is_rv_impl<T>::value >
   {};
   ...
   struct has_move_emulation_enabled
      : ::geofeatures_boost::move_detail::has_move_emulation_enabled_impl<T>
   {};

   template<class T>
   struct has_move_emulation_disabled
   {
      static const bool value = !::geofeatures_boost::move_detail::has_move_emulation_enabled_impl<T>::value;
   };

   }  //namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost {

   #define BOOST_RV_REF(TYPE)\
      ::geofeatures_boost::rv< TYPE >& \
   //

   #define BOOST_RV_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      ::geofeatures_boost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_RV_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      ::geofeatures_boost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //

   #define BOOST_RV_REF_BEG\
      ::geofeatures_boost::rv<   \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF(TYPE)\
      const ::geofeatures_boost::rv< TYPE >& \
   //

   #define BOOST_COPY_ASSIGN_REF_BEG \
      const ::geofeatures_boost::rv<  \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      const ::geofeatures_boost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_COPY_ASSIGN_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      const ::geofeatures_boost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   inline typename ::geofeatures_boost::move_detail::enable_if_c
      <  ::geofeatures_boost::move_detail::is_lvalue_reference<Ret>::value ||
        !::geofeatures_boost::has_move_emulation_enabled<T>::value
      , T&>::type
   ...
   inline typename ::geofeatures_boost::move_detail::enable_if_c
      < !::geofeatures_boost::move_detail::is_lvalue_reference<Ret>::value &&
         ::geofeatures_boost::has_move_emulation_enabled<T>::value
      , ::geofeatures_boost::rv<T>&>::type
         move_return(::geofeatures_boost::rv<T>& x) BOOST_NOEXCEPT
   {
      return x;
   }
   ...
   #define BOOST_MOVE_RET(RET_TYPE, REF)\
      geofeatures_boost::move_detail::move_return< RET_TYPE >(REF)
   //

   #define BOOST_MOVE_BASE(BASE_TYPE, ARG) \
      ::geofeatures_boost::move((BASE_TYPE&)(ARG))
   //
   ...
   #define BOOST_MOVABLE_BUT_NOT_COPYABLE(TYPE)\
      ...
      public:\
      operator ::geofeatures_boost::rv<TYPE>&() \
      {  return *BOOST_MOVE_TO_RV_CAST(::geofeatures_boost::rv<TYPE>*, this);  }\
      operator const ::geofeatures_boost::rv<TYPE>&() const \
      {  return *BOOST_MOVE_TO_RV_CAST(const ::geofeatures_boost::rv<TYPE>*, this);  }\
      private:\
   //
   ...
   template< class T>
   struct forward_type< geofeatures_boost::rv<T> >
   { typedef T type; };
   ...
   //!cast to the base type before calling `::geofeatures_boost::move()` due to rvalue reference limitations.
   //!
