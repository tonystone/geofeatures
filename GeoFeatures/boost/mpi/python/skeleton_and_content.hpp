 ...
 */
class content : public geofeatures_boost::mpi::content
{
  typedef geofeatures_boost::mpi::content inherited;

 public:
  content(const inherited& base, geofeatures_boost::python::object object) 
    : inherited(base), object(object) { }

  inherited&       base()       { return *this; }
  const inherited& base() const { return *this; }

  geofeatures_boost::python::object object;
};
...
{
public:
  skeleton_proxy_base(const geofeatures_boost::python::object& object) : object(object) { }
...
{
 public:
  skeleton_proxy(const geofeatures_boost::python::object& object) 
    : skeleton_proxy_base(object) { }
};

namespace detail {
  using geofeatures_boost::python::object;
  using geofeatures_boost::python::extract;
   
  extern BOOST_MPI_DECL geofeatures_boost::python::object skeleton_proxy_base_type;
  ...
  struct do_get_content
  {
    content operator()(object value_obj) {
      ...
      return content(geofeatures_boost::mpi::get_content(value), value_obj);
    }
  };
...
{
  using geofeatures_boost::python::detail::direct_serialization_table;
  using geofeatures_boost::python::detail::get_direct_serialization_table;
  using namespace geofeatures_boost::python;
  ...
  {
    geofeatures_boost::python::scope proxy_scope(detail::skeleton_proxy_base_type);
