...
/**
 *  @brief Similar to geofeatures_boost::mpi::gather with the difference that the number
...
/**
 *  @brief Similar to geofeatures_boost::mpi::scatter with the difference that the number
