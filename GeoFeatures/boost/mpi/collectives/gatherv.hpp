...
gatherv(const communicator& comm, const std::vector<T>& in_values,
        ...
        int root)
{
  ::geofeatures_boost::mpi::gatherv(comm, &in_values[0], in_values.size(), out_values, sizes, displs, root);
}
        ...
        T* out_values, const std::vector<int>& sizes, int root)
{
  ...
  ::geofeatures_boost::mpi::gatherv(comm, in_values, in_size, out_values, sizes, displs, root);
}
...
gatherv(const communicator& comm, const std::vector<T>& in_values,
        T* out_values, const std::vector<int>& sizes, int root)
{
  ::geofeatures_boost::mpi::gatherv(comm, &in_values[0], in_values.size(), out_values, sizes, root);
}
