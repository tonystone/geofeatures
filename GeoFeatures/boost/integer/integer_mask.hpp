...
#include <boost/integer.hpp>  // for geofeatures_boost::uint_t
...
};  // geofeatures_boost::high_bit_mask_t
...
};  // geofeatures_boost::low_bits_mask_t
...
#ifdef BOOST_MSVC
#pragma warning(push)
#pragma warning(disable:4245)  // 'initializing' : conversion from 'int' to 'const geofeatures_boost::low_bits_mask_t<8>::least', signed/unsigned mismatch
#endif
...
BOOST_LOW_BITS_MASK_SPECIALIZE( unsigned long );
    ...
    BOOST_LOW_BITS_MASK_SPECIALIZE( geofeatures_boost::ulong_long_type );
    #endif
