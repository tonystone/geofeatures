...
struct Requires_ : ::geofeatures_boost::ccheck_aux::unaryfunptr_arg_type<Result>
{
};

# if BOOST_WORKAROUND(BOOST_INTEL_WIN, BOOST_TESTED_AT(1010))
#  define BOOST_CONCEPT_REQUIRES_(r,data,t) | (::geofeatures_boost::_requires_<void(*)t>::value)
# else 
#  define BOOST_CONCEPT_REQUIRES_(r,data,t) + (::geofeatures_boost::_requires_<void(*)t>::value)
# endif
...
# define BOOST_CONCEPT_REQUIRES(models, result)                                    \
    typename ::geofeatures_boost::ccheck_aux::unaryfunptr_arg_type<void(*)result>::type

#elif BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x564))

// Same thing as below without the initial typename
# define BOOST_CONCEPT_REQUIRES(models, result)                                \
    ::geofeatures_boost::Requires_<                                                        \
      (0 BOOST_PP_SEQ_FOR_EACH(BOOST_CONCEPT_REQUIRES_, ~, models)),           \
      ::geofeatures_boost::ccheck_aux::unaryfunptr_arg_type<void(*)result>          \
                     >::type
...
# define BOOST_CONCEPT_REQUIRES(models, result)                                        \
    typename ::geofeatures_boost::Requires_<                                                       \
      (0 BOOST_PP_SEQ_FOR_EACH(BOOST_CONCEPT_REQUIRES_, ~, models)),                   \
      void(*)result                                                                 \
    >::type
...
} // namespace geofeatures_boost::concept_check
