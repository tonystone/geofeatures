...
struct select_most_precise<geofeatures_boost::rational<T1>, geofeatures_boost::rational<T2> >
{
    typedef typename geofeatures_boost::rational
        <
...
template <typename T>
struct select_most_precise<geofeatures_boost::rational<T>, double>
{
    typedef typename geofeatures_boost::rational<T> type;
};
...
// Specializes geofeatures_boost::rational to geofeatures_boost::numeric::bounds
...
}} // namespace geofeatures_boost::numeric


// Support for geofeatures_boost::numeric_cast to int and to double (necessary for SVG-mapper)
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace numeric
{
