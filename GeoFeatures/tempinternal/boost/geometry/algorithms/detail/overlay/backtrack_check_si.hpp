...
{
    typedef typename geofeatures_boost::range_value<Turns>::type tp_type;

    for (typename geofeatures_boost::range_iterator<Turns>::type
        it = geofeatures_boost::begin(turns);
        it != geofeatures_boost::end(turns);
        ++it)
    {
        for (typename geofeatures_boost::range_iterator
            <
                typename tp_type::container_type
            >::type op_it = geofeatures_boost::begin(it->operations);
...
public :
                ...
                )
    {
        ...
        geometry::traits::clear<typename geofeatures_boost::range_value<Rings>::type>::apply(ring);
...
public :
    ...
    static inline void apply(std::size_t size_at_start,
                Rings& rings, typename geofeatures_boost::range_value<Rings>::type& ring,
                Turns& turns, Operation& operation,
