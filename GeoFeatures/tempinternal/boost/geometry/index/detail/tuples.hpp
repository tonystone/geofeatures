...
struct find_index
{
    static const size_t value =
        find_index_impl<
            ...
            El,
            N,
            typename geofeatures_boost::tuples::element<N - 1, Tuple>::type
        >::value;
};
...
struct has<Tuple, El, 1>
{
    static const bool value
        = geofeatures_boost::is_same<
            typename geofeatures_boost::tuples::element<0, Tuple>::type,
            El
        >::value;
};
...
struct add<geofeatures_boost::tuple<T1>, T>
{
    typedef geofeatures_boost::tuple<T1, T> type;
};

template <typename T1, typename T2, typename T>
struct add<geofeatures_boost::tuple<T1, T2>, T>
{
    typedef geofeatures_boost::tuple<T1, T2, T> type;
};
...
template <typename Tuple,
          typename T,
          size_t I = 0,
          size_t N = geofeatures_boost::tuples::length<Tuple>::value>
struct push_back
{
    typedef
    geofeatures_boost::tuples::cons<
        typename geofeatures_boost::tuples::element<I, Tuple>::type,
...
{
    typedef geofeatures_boost::tuples::cons<T, geofeatures_boost::tuples::null_type> type;

    static type apply(Tuple const&, T const& t)
    {
        return type(t, geofeatures_boost::tuples::null_type());
    }
};
