...
{
    typedef typename geofeatures_boost::range_iterator<Range>::type type;
};
...
struct range_iterator_begin
{
    ...
    apply(Range& range)
    {
        return geofeatures_boost::begin(range);
    }
};
...
struct range_iterator_end
{
    ...
    apply(Range& range)
    {
        return geofeatures_boost::end(range);
    }
};
        ...
        >
{
    ...
    {
        return geofeatures_boost::size(r) < ((closure<Range>::value == open) ? 1u : 2u);
    }
...
public:
        ...
        : m_it(other.m_it)
    {
        ...
        static const bool are_conv
            = geofeatures_boost::is_convertible<other_iterator_type, iterator_type>::value;
