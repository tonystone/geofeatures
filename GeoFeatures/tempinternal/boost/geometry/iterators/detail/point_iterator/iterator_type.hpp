...
{
    typedef typename geofeatures_boost::range_iterator<Linestring>::type type;
};
...
{
    typedef typename geofeatures_boost::range_iterator<Ring>::type type;
};
...
public:
    typedef concatenate_iterator
        <
            typename geofeatures_boost::range_iterator<inner_range>::type,
            flatten_iterator
                <
                    typename geofeatures_boost::range_iterator
                        <
...
{
    typedef typename geofeatures_boost::range_iterator<MultiPoint>::type type;
};
...
public:
    typedef flatten_iterator
        <
            typename geofeatures_boost::range_iterator<MultiLinestring>::type,
            typename iterator_type<inner_range>::type,
