...
//!based on geofeatures_boost::interprocess synchronization objects.
struct mutex_family
{
   typedef geofeatures_boost::interprocess::interprocess_mutex                 mutex_type;
   typedef geofeatures_boost::interprocess::interprocess_recursive_mutex       recursive_mutex_type;
};
...
{
   typedef geofeatures_boost::interprocess::null_mutex                   mutex_type;
   typedef geofeatures_boost::interprocess::null_mutex                   recursive_mutex_type;
};
