...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace numeric { namespace convdetail
{
...
} } } // namespace geofeatures_boost::numeric::convdetail
