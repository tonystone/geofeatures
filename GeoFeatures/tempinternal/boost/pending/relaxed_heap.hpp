...
private:
  ...
  struct group {
     ...
     *  element). Note that the use of geofeatures_boost::optional increases the
     ...
     */
    ::geofeatures_boost::optional<value_type> value;
...
private:
   ...
   *  smaller.
   */
  std::vector< ::geofeatures_boost::optional<value_type> > groups;
