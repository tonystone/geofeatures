...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::geofeatures_boost::mpl::aux::yes_tag operator|( \
      ::geofeatures_boost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::geofeatures_boost::mpl::aux::no_tag operator|( \
      ::geofeatures_boost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::geofeatures_boost::mpl::na) >* \
    ); \
/**/
...
::geofeatures_boost::mpl::aux::yes_tag operator|( \
      ::geofeatures_boost::mpl::aux::has_rebind_tag<int> \
    , ::geofeatures_boost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
