...
struct static_warning_test{
    typename geofeatures_boost::mpl::eval_if_c<
        ...
        typename geofeatures_boost::mpl::identity<
            geofeatures_boost::mpl::print<
...
#define BOOST_SERIALIZATION_BSW(B, L) \
    typedef geofeatures_boost::serialization::BOOST_SERIALIZATION_SS< \
        sizeof( geofeatures_boost::serialization::static_warning_test< B, L > ) \
