...
public:
    ...
    virtual void save(const geofeatures_boost::long_long_type t) = 0;
    virtual void save(const geofeatures_boost::ulong_long_type t) = 0;
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(geofeatures_boost::archive::polymorphic_oarchive)
