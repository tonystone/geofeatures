...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace program_options {
    ...
    */
    ...
    public:
        ...
        */
        virtual void parse(geofeatures_boost::any& value_store, 
        ...
        /** Called to assign default value to 'value_store'. Returns
            ...
            value exists. */
        virtual bool apply_default(geofeatures_boost::any& value_store) const = 0;
                                   
        /** Called when final value of an option is determined. 
        */
        virtual void notify(const geofeatures_boost::any& value_store) const = 0;
    ...
    */
    ...
    private: // base overrides
        void parse(geofeatures_boost::any& value_store, 
                   const std::vector<std::string>& new_tokens,
                   bool utf8) const;
    protected: // interface for derived classes.
        virtual void xparse(geofeatures_boost::any& value_store, 
                            const std::vector<std::string>& new_tokens) 
            const = 0;
    };
    ...
    */
    ...
    public:
        ...
        /** If 'value_store' is already initialized, or new_tokens
            ...
            any modifications.
         */
        void xparse(geofeatures_boost::any& value_store,
                    const std::vector<std::string>& new_tokens) const;

        /** Does nothing. */
        bool apply_default(geofeatures_boost::any&) const { return false; }

        /** Does nothing. */
        void notify(const geofeatures_boost::any&) const {}        
    private:
        bool m_zero_tokens;
    };
    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            m_default_value = geofeatures_boost::any(v);
            m_default_value_as_text = geofeatures_boost::lexical_cast<std::string>(v);
            return this;
        }
        ...
        */
        ...
        {
            m_implicit_value = geofeatures_boost::any(v);
            m_implicit_value_as_text =
                geofeatures_boost::lexical_cast<std::string>(v);
            return this;
        }
    ...
    public: // value semantic overrides
        ...
        */
        virtual bool apply_default(geofeatures_boost::any& value_store) const
        {
        ...
        /** If an address of variable to store value was specified
            ...
            does nothing. */
        void notify(const geofeatures_boost::any& value_store) const;
    ...
    private:
        ...
        // Default value is stored as geofeatures_boost::any and not
        // as geofeatures_boost::optional to avoid unnecessary instantiations.
        std::string m_value_name;
        geofeatures_boost::any m_default_value;
        std::string m_default_value_as_text;
        geofeatures_boost::any m_implicit_value;
        std::string m_implicit_value_as_text;
        bool m_composing, m_implicit, m_multitoken, m_zero_tokens, m_required;
        geofeatures_boost::function1<void, const T&> m_notifier;
    };
