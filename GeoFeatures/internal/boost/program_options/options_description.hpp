...
#   pragma warning (push)
#   pragma warning (disable:4251) // class 'geofeatures_boost::shared_ptr<T>' needs to have dll-interface to be used by clients of class 'geofeatures_boost::program_options::option_description'
#endif
