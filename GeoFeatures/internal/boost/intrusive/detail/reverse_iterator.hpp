...
{
   public:
   typedef typename geofeatures_boost::intrusive::iterator_traits<It>::pointer             pointer;
   typedef typename geofeatures_boost::intrusive::iterator_traits<It>::reference           reference;
   typedef typename geofeatures_boost::intrusive::iterator_traits<It>::difference_type     difference_type;
   typedef typename geofeatures_boost::intrusive::iterator_traits<It>::iterator_category   iterator_category;
   typedef typename geofeatures_boost::intrusive::iterator_traits<It>::value_type          value_type;
   ...
   reverse_iterator( const reverse_iterator<OtherIt>& r
                   , typename geofeatures_boost::intrusive::detail::enable_if_convertible<OtherIt, It>::type* =0
                   )
      : m_current(r.base())
   {}

   template<class OtherIt>
   typename geofeatures_boost::intrusive::detail::enable_if_convertible<OtherIt, It, reverse_iterator &>::type
