...
using geofeatures_boost::movelib::iterator_traits;
...
struct iterator_enable_if_tag
   : ::geofeatures_boost::move_detail::enable_if_c
      < ::geofeatures_boost::move_detail::is_same
         < typename geofeatures_boost::intrusive::iterator_traits<I>::iterator_category 
         , Tag
         >::value
         , R>
{};
...
struct iterator_enable_if_tag_difference_type
   : iterator_enable_if_tag<I, Tag, typename geofeatures_boost::intrusive::iterator_traits<I>::difference_type>
{};

template<class I, class Tag>
struct iterator_disable_if_tag_difference_type
   : iterator_disable_if_tag<I, Tag, typename geofeatures_boost::intrusive::iterator_traits<I>::difference_type>
{};
