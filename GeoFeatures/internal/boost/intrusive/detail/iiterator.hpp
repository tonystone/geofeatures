...
struct value_traits_pointers
{
   typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT
      ...
      , typename geofeatures_boost::intrusive::pointer_traits<typename ValueTraits::node_traits::node_ptr>::template
         rebind_pointer<ValueTraits>::type)   value_traits_ptr;

   typedef typename geofeatures_boost::intrusive::pointer_traits<value_traits_ptr>::template
...
struct iiterator
{
   ...
   typedef ::geofeatures_boost::intrusive::pointer_traits<node_ptr>        nodepointer_traits_t;
