...
namespace geofeatures_boost_intrusive_hmfcw {
...
BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEG
   ...
   {
      template<class U>
      static decltype(geofeatures_boost::move_detail::declval<U>().
         BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME(::geofeatures_boost::move_detail::declval<Args>()...)
            , geofeatures_boost_intrusive_hmfcw::yes_type()) Test(U* f);
      template<class U>
      static geofeatures_boost_intrusive_hmfcw::no_type Test(...);
      static const bool value = sizeof(Test<Fun>((Fun*)0)) == sizeof(geofeatures_boost_intrusive_hmfcw::yes_type);
   };
   ...
   /////////////////////////////////////////////////////////
      ...
      struct FunWrapTmpl : Fun
      {
         ...
         geofeatures_boost_intrusive_hmfcw::private_type BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME(DontCares...) const;
      };
      ...
      {
         typedef FunWrapTmpl<typename geofeatures_boost_intrusive_hmfcw::make_dontcare<Args>::type...> FunWrap;

         static bool const value = (sizeof(geofeatures_boost_intrusive_hmfcw::no_type) ==
                                    sizeof(geofeatures_boost_intrusive_hmfcw::is_private_type
                                             ( (::geofeatures_boost::move_detail::declval< FunWrap<Fun> >().
                                                   BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME(::geofeatures_boost::move_detail::declval<Args>()...), 0) )
                                          )
                                    );
      };
      ...
      class BOOST_MOVE_CAT(has_member_function_named_, BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME)
      {
         ...
         struct Base : public geofeatures_boost_intrusive_hmfcw::remove_cv<Type>::type, public BaseMixin {};
         template <typename T, T t> class Helper{};

         template <typename U>
         static geofeatures_boost_intrusive_hmfcw::no_type  deduce
            (U*, Helper<void (BaseMixin::*)(), &U::BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME>* = 0);
         static geofeatures_boost_intrusive_hmfcw::yes_type deduce(...);

         public:
         static const bool value = sizeof(geofeatures_boost_intrusive_hmfcw::yes_type) == sizeof(deduce((Base*)0));
      };
         ...
         <Fun, false BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_COMMA_IF BOOST_MOVE_CAT(BOOST_MOVE_TARG,BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_MAX)>
      {
         ...
         //0 arg specialization when BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME is present
            ...
            {
               template<class U>
               static decltype(geofeatures_boost::move_detail::declval<U>().BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME()
                  , geofeatures_boost_intrusive_hmfcw::yes_type()) Test(U* f);
            ...
            template<class F, std::size_t N = sizeof(geofeatures_boost::move_detail::declval<F>().BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME(), 0)>
            struct BOOST_MOVE_CAT(zeroarg_checker_, BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME)
            {  geofeatures_boost_intrusive_hmfcw::yes_type dummy[N ? 1 : 2];   };
            ...
            struct BOOST_MOVE_CAT(has_member_function_callable_with_impl_, BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME)<Fun, true>
            {
               ...
               template<class U> static geofeatures_boost_intrusive_hmfcw::no_type Test(...);
               static const bool value = sizeof(Test< Fun >(0)) == sizeof(geofeatures_boost_intrusive_hmfcw::yes_type);
            };
         ...
         //1 to N arg specialization when BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME is present
            ...
            {\
               using Fun::BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME;\
               geofeatures_boost_intrusive_hmfcw::private_type BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME\
                  (BOOST_MOVE_REPEAT##N(geofeatures_boost_intrusive_hmfcw::dont_care)) const;\
            };\
            \
            ...
            {\
               static bool const value = (sizeof(geofeatures_boost_intrusive_hmfcw::no_type) == sizeof(geofeatures_boost_intrusive_hmfcw::is_private_type\
                                                   ( (::geofeatures_boost::move_detail::declval\
