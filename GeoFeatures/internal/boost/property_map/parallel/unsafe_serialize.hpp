...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost {
  typedef mpl::if_c<(sizeof(int) == sizeof(void*)), 
                    ...
                    mpl::if_c<(sizeof(long) == sizeof(void*)),
                              long,
                              mpl::if_c<(sizeof(void*) <= sizeof(geofeatures_boost::intmax_t)),
                                        geofeatures_boost::intmax_t,
                                        void>::type
                              >::type
                    >::type ptr_serialize_type;

  BOOST_STATIC_ASSERT ((!geofeatures_boost::is_void<ptr_serialize_type>::value));
