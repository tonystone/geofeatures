...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost {
  ...
  struct property_traits :
    geofeatures_boost::mpl::if_<is_property_map<PA>,
  ...
  struct property_traits<T*> {
    // BOOST_STATIC_ASSERT(geofeatures_boost::is_same<T, T*>::value && !"Using pointers as property maps is deprecated");
  ...
  // do geofeatures_boost::get() anyways, and the using clause
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost {
  ...
  struct ReadablePropertyMapConcept
  {
    ...
    typedef geofeatures_boost::readable_property_map_tag ReadableTag;
    void constraints() {
  ...
  struct WritablePropertyMapConcept
  {
    typedef typename property_traits<PMap>::key_type key_type;
    typedef typename property_traits<PMap>::category Category;
    typedef geofeatures_boost::writable_property_map_tag WritableTag;
    void constraints() {
  ...
  {
    typedef typename property_traits<PMap>::category Category;
    typedef geofeatures_boost::read_write_property_map_tag ReadWriteTag;
    void constraints() {
  ...
  {
    typedef typename property_traits<PMap>::category Category;
    typedef geofeatures_boost::lvalue_property_map_tag LvalueTag;
    typedef typename property_traits<PMap>::reference reference;
    ...
    void constraints() {
      ...
      BOOST_MPL_ASSERT((geofeatures_boost::mpl::or_<
                          geofeatures_boost::is_same<const value_type&, reference>,
                          geofeatures_boost::is_same<value_type&, reference> >));
  ...
  struct Mutable_LvaluePropertyMapConcept
  {
    ...
    typedef typename property_traits<PMap>::reference reference;
    void constraints() { 
      geofeatures_boost::function_requires< ReadWritePropertyMapConcept<PMap, Key> >();
      geofeatures_boost::function_requires<ConvertibleConcept<Category, LvalueTag> >();
      
      typedef typename property_traits<PMap>::value_type value_type;
      BOOST_MPL_ASSERT((geofeatures_boost::is_same<value_type&, reference>));
  ...
  class iterator_property_map
    : public geofeatures_boost::put_get_helper< R, 
  ...
  inline safe_iterator_property_map<
    RAIter, ID,
    typename geofeatures_boost::detail::iterator_traits<RAIter>::value_type,
    typename geofeatures_boost::detail::iterator_traits<RAIter>::reference>
  make_safe_iterator_property_map(RAIter iter, std::size_t n, ID id) {
    function_requires< RandomAccessIteratorConcept<RAIter> >();
    typedef safe_iterator_property_map<
      RAIter, ID,
      typename geofeatures_boost::detail::iterator_traits<RAIter>::value_type,
      typename geofeatures_boost::detail::iterator_traits<RAIter>::reference> PA;
    return PA(iter, n, id);
  }
  template <class RAIter, class Value, class ID>
  ...
  class static_property_map :
      public
  geofeatures_boost::put_get_helper<ValueType,static_property_map<ValueType> >
  { 
    ValueType value;
  public:
  ...
  class ref_property_map :
    public
      geofeatures_boost::put_get_helper<ValueType&,ref_property_map<KeyType,ValueType> >
  { 
    ValueType* value;
  public:
    typedef KeyType key_type;
  ...
  template <typename T>
  struct typed_identity_property_map
    : public geofeatures_boost::put_get_helper<T, typed_identity_property_map<T> >
  {
    typedef T key_type;
    typedef T value_type;
    typedef T reference;
...
//=========================================================================
  ...
  class dummy_property_map 
    : public geofeatures_boost::put_get_helper<detail::dummy_pmap_reference,
        dummy_property_map  > 
  {
  public:
    ...
    typedef geofeatures_boost::read_write_property_map_tag category;
