...
class multi_index_container:
  private ::geofeatures_boost::base_from_member<
    typename geofeatures_boost::detail::allocator::rebind_to<
      Allocator,
...
private:
  ...
  typedef typename
  geofeatures_boost::detail::allocator::rebind_to<
    Allocator,
    typename super::node_type
  >::type                                         node_allocator;
  typedef ::geofeatures_boost::base_from_member<
...
BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
    ...
    BOOST_TRY{
      ...
      BOOST_TRY{
        ...
        if(res==x){
          ...
          geofeatures_boost::detail::allocator::destroy(&x->value());
          deallocate_node(x);
          return std::pair<node_type*,bool>(res,false);
        }
      }
  ...
  friend class geofeatures_boost::serialization::access;
...
>
typename ::geofeatures_boost::multi_index::index<
  ...
  multi_index_container<Value,IndexSpecifierList,Allocator>& m)BOOST_NOEXCEPT
{
  typedef multi_index_container<
    Value,IndexSpecifierList,Allocator>         multi_index_type;
  typedef typename ::geofeatures_boost::multi_index::index<
    multi_index_container<
      Value,IndexSpecifierList,Allocator>,
    Tag
  >::type                                       index_type;
...
template<
  typename Tag,typename Value,typename IndexSpecifierList,typename Allocator
>
const typename ::geofeatures_boost::multi_index::index<
  multi_index_container<Value,IndexSpecifierList,Allocator>,Tag>::type&
get(
  const multi_index_container<Value,IndexSpecifierList,Allocator>& m
)BOOST_NOEXCEPT
 ...
 * geofeatures_boost::serialization::collection_size_type.
...
template<typename Value,typename IndexSpecifierList,typename Allocator>
struct version<
  geofeatures_boost::multi_index_container<Value,IndexSpecifierList,Allocator>
>
{
...
/* Associated global functions are promoted to namespace geofeatures_boost, except
