                                       ...
                                       Factor& factor)
{
    ...
    typedef typename promote_floating_point
        ...
        >::type num_type;
    num_type const diff = geofeatures_boost::numeric_cast<num_type>(detail::get_max_size(box));
    ...
    if (math::equals(diff, num_type())
        || diff >= range
        || ! geofeatures_boost::math::isfinite(diff))
    {
        factor = 1;
    }
    else
    {
        factor = geofeatures_boost::numeric_cast<num_type>(
            geofeatures_boost::numeric_cast<geofeatures_boost::long_long_type>(half + range / diff));
    ...
    geofeatures_boost::long_long_type const min_coordinate
        = geofeatures_boost::numeric_cast<geofeatures_boost::long_long_type>(-range / two);
...
struct rescale_policy_type
    ...
    <
        ...
        false
#else
        geofeatures_boost::is_floating_point
        <
            typename geometry::coordinate_type<Point>::type
        >::type::value
#endif
