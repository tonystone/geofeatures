...
struct svg_map<multi_tag, Multi>
{
    ...
    {
        for (typename geofeatures_boost::range_iterator<Multi const>::type it
            = geofeatures_boost::begin(multi);
        ...
        <
            typename tag_cast
                <
                    ...
                    multi_tag
                >::type,
            typename geofeatures_boost::remove_const<Geometry>::type
...
class svg_mapper : geofeatures_boost::noncopyable
{
    ...
    geofeatures_boost::scoped_ptr<transformer_type> m_matrix;
    ...
    */
                ...
                int offset_x = 0, int offset_y = 0, int lineheight = 10)
    {
        ...
        else
        {
            ...
            geofeatures_boost::split(splitted, s, geofeatures_boost::is_any_of("\n"));
