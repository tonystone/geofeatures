...
struct compute_pythagoras_point_box
{
    ...
    {
        T const p_coord = geofeatures_boost::numeric_cast<T>(geometry::get<I-1>(point));
        T const b_min_coord =
            geofeatures_boost::numeric_cast<T>(geometry::get<min_corner, I-1>(box));
        T const b_max_coord =
            geofeatures_boost::numeric_cast<T>(geometry::get<max_corner, I-1>(box));
