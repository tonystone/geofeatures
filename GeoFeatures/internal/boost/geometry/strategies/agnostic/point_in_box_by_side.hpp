...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace geometry { namespace strategy
{
...
}}} // namespace geofeatures_boost::geometry::strategy
