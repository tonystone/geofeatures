    ...
    */
    ...
    public :
                                    ...
                                    distance_type max_distance) const
        {
            ...
            std::vector<dp_point_type> ref_candidates(geofeatures_boost::begin(range),
            ...
            consider(geofeatures_boost::begin(ref_candidates), geofeatures_boost::end(ref_candidates), max_distance, n, strategy);

            // Copy included elements to the output
            for(typename std::vector<dp_point_type>::const_iterator it
                            = geofeatures_boost::begin(ref_candidates);
                it != geofeatures_boost::end(ref_candidates);
                ++it)
            {
                if (it->included)
                {
