...
class get_turns_in_sections
{
            ...
            signed_size_type index1, signed_size_type index2)
    {
        ...
        geofeatures_boost::ignore_unused_variable_warning(index1);
        geofeatures_boost::ignore_unused_variable_warning(index2);

        return geofeatures_boost::is_same
                    <
                        typename tag_cast
                            <
...
public :
    ...
    {
        geofeatures_boost::ignore_unused_variable_warning(interrupt_policy);
        ...
        range1_iterator begin_range_1 = geofeatures_boost::begin(view1);
        range1_iterator end_range_1 = geofeatures_boost::end(view1);

        range2_iterator begin_range_2 = geofeatures_boost::begin(view2);
        range2_iterator end_range_2 = geofeatures_boost::end(view2);
            ...
            ++prev1, ++it1, ++index1, ++next1, ++ndi1)
        {
                ...
                ++prev2, ++it2, ++index2, ++next2, ++ndi2)
            {
                ...
                if (! skip)
                {
                    ...
                    typedef typename geofeatures_boost::range_value<Turns>::type turn_info;
                    ...
                    std::size_t const size_before = geofeatures_boost::size(turns);
...
private :
    ...
    static inline void get_start_point_iterator(Section & section,
            Range const& range,
            typename geofeatures_boost::range_iterator<Range const>::type& it,
            typename geofeatures_boost::range_iterator<Range const>::type& prev,
            typename geofeatures_boost::range_iterator<Range const>::type& end,
            signed_size_type& index, signed_size_type& ndi,
            int dir, Box const& other_bounding_box, RobustPolicy const& robust_policy)
    {
        it = geofeatures_boost::begin(range) + section.begin_index;
        end = geofeatures_boost::begin(range) + section.end_index + 1;
...
public:
            ...
            InterruptPolicy& interrupt_policy)
    {
        ...
        typedef typename geofeatures_boost::range_value<Turns>::type ip_type;
        ...
        typedef geofeatures_boost::mpl::vector_c<std::size_t, 0, 1> dimensions;
...
struct get_turns_cs
{
                ...
                signed_size_type ring_index = -1)
    {
        ...
        geofeatures_boost::array<box_point_type,4> bp;
        assign_box_corners_oriented<ReverseBox>(box, bp);

        cview_type cview(range);
        view_type view(cview);

        typedef typename geofeatures_boost::range_size<view_type>::type size_type;
        size_type segments_count1 = geofeatures_boost::size(view) - 1;

        iterator_type it = geofeatures_boost::begin(view);

        ever_circling_iterator<iterator_type> next(
                geofeatures_boost::begin(view), geofeatures_boost::end(view), it, true);
        next++;
        next++;
...
struct get_turns_polygon_cs
{
            ...
            signed_size_type multi_index = -1)
    {
        ...
        for (typename detail::interior_iterator<Polygon const>::type
                it = geofeatures_boost::begin(rings); it != geofeatures_boost::end(rings); ++it, ++i)
        {
            intersector_type::apply(
                    source_id1, *it,
                    source_id2, box,
...
struct get_turns_multi_polygon_cs
{
            ...
            Turns& turns, InterruptPolicy& interrupt_policy)
    {
        ...
        signed_size_type i = 0;
        for (iterator_type it = geofeatures_boost::begin(multi);
             ...
             ++it, ++i)
        {
            ...
            get_turns_polygon_cs
                <
                    typename geofeatures_boost::range_value<Multi>::type, Box,
                    Reverse, ReverseBox,
                    TurnPolicy
