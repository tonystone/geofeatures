...
public:
                                    ...
                                    bool check_intersection = true)
    {
        ...
        comparable_strategy cstrategy =
            strategy::distance::services::get_comparable
                <
                    Strategy
                >::apply(strategy);
        geofeatures_boost::ignore_unused(cstrategy);
        ...
        geofeatures_boost::ignore_unused(pb_cstrategy);
...
private:
    ...
    struct cast_to_result
    {
        ...
        {
            return geofeatures_boost::numeric_cast<Result>(t);
        }
    };
    ...
    struct right_of_box
    {
        ...
        {
            geofeatures_boost::ignore_unused(pp_strategy, ps_strategy);
    ...
    struct above_of_box
    {
        static inline ReturnType apply(SegmentPoint const& p0,
                                       ...
                                       PSStrategy const& ps_strategy)
        {
            geofeatures_boost::ignore_unused(ps_strategy);
