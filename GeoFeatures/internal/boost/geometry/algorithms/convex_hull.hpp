...
struct convex_hull<geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{
    template <typename OutputGeometry, typename Strategy>
    ...
    apply(geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& geometry,
          ...
          Strategy const& strategy)
    {
        geofeatures_boost::apply_visitor(visitor<OutputGeometry, Strategy>(out, strategy), geometry);
    }
};
...
template <BOOST_VARIANT_ENUM_PARAMS(typename T)>
struct convex_hull_insert<geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{
    template <typename OutputIterator, typename Strategy>
    struct visitor: geofeatures_boost::static_visitor<OutputIterator>
    {
    ...
    apply(geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& geometry,
          ...
          Strategy const& strategy)
    {
        return geofeatures_boost::apply_visitor(visitor<OutputIterator, Strategy>(out, strategy), geometry);
    }
};
