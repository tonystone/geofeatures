...
namespace foreach
{
    ...
    ///////////////////////////////////////////////////////////////////////////////
    // geofeatures_boost::foreach::is_lightweight_proxy
    ...
    struct is_lightweight_proxy
      : geofeatures_boost::mpl::false_
    {
    };

    ///////////////////////////////////////////////////////////////////////////////
    // geofeatures_boost::foreach::is_noncopyable
    ...
    struct is_noncopyable
      ...
      : geofeatures_boost::mpl::or_<
            geofeatures_boost::is_abstract<T>
          , geofeatures_boost::is_base_and_derived<geofeatures_boost::noncopyable, T>
        >
...
#else
# define BOOST_FOREACH_TAG_DEFAULT geofeatures_boost::foreach::tag
#endif
...
template<typename T>
inline geofeatures_boost::foreach::is_lightweight_proxy<T> *
boost_foreach_is_lightweight_proxy(T *&, BOOST_FOREACH_TAG_DEFAULT) { return 0; }

template<typename T>
inline geofeatures_boost::mpl::true_ *
boost_foreach_is_lightweight_proxy(std::pair<T, T> *&, geofeatures_boost::foreach::tag) { return 0; }

template<typename T>
inline geofeatures_boost::mpl::true_ *
boost_foreach_is_lightweight_proxy(geofeatures_boost::iterator_range<T> *&, geofeatures_boost::foreach::tag) { return 0; }

template<typename T>
inline geofeatures_boost::mpl::true_ *
boost_foreach_is_lightweight_proxy(geofeatures_boost::sub_range<T> *&, geofeatures_boost::foreach::tag) { return 0; }

template<typename T>
inline geofeatures_boost::mpl::true_ *
boost_foreach_is_lightweight_proxy(T **&, geofeatures_boost::foreach::tag) { return 0; }
...
//   at the global namespace for your type.
template<typename T>
inline geofeatures_boost::foreach::is_noncopyable<T> *
...
inline geofeatures_boost::mpl::and_<Bool1, Bool2> *and_(Bool1 *, Bool2 *) { return 0; }

template<typename Bool1, typename Bool2, typename Bool3>
inline geofeatures_boost::mpl::and_<Bool1, Bool2, Bool3> *and_(Bool1 *, Bool2 *, Bool3 *) { return 0; }

template<typename Bool1, typename Bool2>
inline geofeatures_boost::mpl::or_<Bool1, Bool2> *or_(Bool1 *, Bool2 *) { return 0; }

template<typename Bool1, typename Bool2, typename Bool3>
inline geofeatures_boost::mpl::or_<Bool1, Bool2, Bool3> *or_(Bool1 *, Bool2 *, Bool3 *) { return 0; }

template<typename Bool1>
inline geofeatures_boost::mpl::not_<Bool1> *not_(Bool1 *) { return 0; }

template<typename T>
inline geofeatures_boost::is_array<T> *is_array_(T const &) { return 0; }

template<typename T>
inline geofeatures_boost::is_const<T> *is_const_(T &) { return 0; }

#ifndef BOOST_FOREACH_NO_RVALUE_DETECTION
template<typename T>
inline geofeatures_boost::mpl::true_ *is_const_(T const &) { return 0; }
#endif

#ifdef BOOST_NO_CXX11_RVALUE_REFERENCES
template<typename T>
inline geofeatures_boost::mpl::false_ *is_rvalue_(T &, int) { return 0; }

template<typename T>
inline geofeatures_boost::mpl::true_ *is_rvalue_(T const &, ...) { return 0; }
#else
template<typename T>
inline geofeatures_boost::is_rvalue_reference<T &&> *is_rvalue_(T &&, int) { return 0; }
#endif
...
inline BOOST_DEDUCED_TYPENAME geofeatures_boost::mpl::if_<C, T const, T>::type &auto_any_cast(auto_any_t a)
{
    return static_cast<auto_any<T> const &>(a).item;
}

typedef geofeatures_boost::mpl::true_ const_;

///////////////////////////////////////////////////////////////////////////////
// type2type
//
template<typename T, typename C = geofeatures_boost::mpl::false_>
struct type2type
  : geofeatures_boost::mpl::if_<C, T const, T>
{
};
...
struct foreach_iterator
{
    ...
    //
    // To treat the container as an array, use geofeatures_boost::as_array() in <boost/range/as_array.hpp>,
    // as in BOOST_FOREACH( char ch, geofeatures_boost::as_array("hello") ) ...
    ...
    typedef BOOST_DEDUCED_TYPENAME geofeatures_boost::mpl::eval_if<
        C
...
//
template<typename T>
inline type2type<T> *encode_type(T &, geofeatures_boost::false_type*) { return 0; }

template<typename T>
inline type2type<T, const_> *encode_type(T const &, geofeatures_boost::true_type*) { return 0; }

template<typename T>
inline type2type<T> *encode_type(T &, geofeatures_boost::mpl::false_*) { return 0; }

template<typename T>
inline type2type<T, const_> *encode_type(T const &, geofeatures_boost::mpl::true_*) { return 0; }
...
# define BOOST_FOREACH_DEREFOF(T) geofeatures_boost::foreach_detail_::derefof(*T)
#else
...
# define BOOST_FOREACH_IS_RVALUE(COL)                                                           \
    geofeatures_boost::foreach_detail_::is_rvalue_((COL), 0)
...
struct rvalue_probe
{
    ...
    typedef BOOST_DEDUCED_TYPENAME geofeatures_boost::mpl::if_<
        geofeatures_boost::mpl::or_<geofeatures_boost::is_abstract<T>, geofeatures_boost::is_array<T> >, private_type_, T
    >::type value_type;
...
# define BOOST_FOREACH_IS_RVALUE(COL)                                                           \
    geofeatures_boost::foreach_detail_::and_(                                                               \
        geofeatures_boost::foreach_detail_::not_(geofeatures_boost::foreach_detail_::is_array_(COL))                    \
      , (true ? 0 : geofeatures_boost::foreach_detail_::is_rvalue_(                                         \
            (true ? geofeatures_boost::foreach_detail_::make_probe(COL) : (COL)), 0)))
...
struct rvalue_probe
{
    ...
    typedef BOOST_DEDUCED_TYPENAME geofeatures_boost::mpl::if_<
        geofeatures_boost::is_array<T>, private_type_, T
    >::type value_type;
    #else
    typedef BOOST_DEDUCED_TYPENAME geofeatures_boost::mpl::if_<
        geofeatures_boost::mpl::or_<geofeatures_boost::is_abstract<T>, geofeatures_boost::is_array<T> >, private_type_, T
...
inline BOOST_DEDUCED_TYPENAME geofeatures_boost::enable_if<geofeatures_boost::mpl::or_<LValue, IsProxy>, IsProxy>::type *
...
inline bool *
should_copy_impl(geofeatures_boost::mpl::false_ *, geofeatures_boost::mpl::false_ *, bool *is_rvalue)
{
    return is_rvalue;
}
...
//
template<typename T>
inline auto_any<T> contain(T const &t, geofeatures_boost::mpl::true_ *) // rvalue
{
    return auto_any<T>(t);
}

template<typename T>
inline auto_any<T *> contain(T &t, geofeatures_boost::mpl::false_ *) // lvalue
{
    // Cannot seem to get sunpro to handle addressof() with array types.
    #if BOOST_WORKAROUND(__SUNPRO_CC, BOOST_TESTED_AT(0x570))
    return auto_any<T *>(&t);
    #else
    return auto_any<T *>(geofeatures_boost::addressof(t));
    #endif
}
...
begin(auto_any_t col, type2type<T, C> *, geofeatures_boost::mpl::true_ *) // rvalue
{
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type>(
        geofeatures_boost::begin(auto_any_cast<T, C>(col)));
}

template<typename T, typename C>
inline auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type>
begin(auto_any_t col, type2type<T, C> *, geofeatures_boost::mpl::false_ *) // lvalue
{
    typedef BOOST_DEDUCED_TYPENAME type2type<T, C>::type type;
    typedef BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type iterator;
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type>(
        iterator(geofeatures_boost::begin(BOOST_FOREACH_DEREFOF((auto_any_cast<type *, geofeatures_boost::mpl::false_>(col))))));
}
...
begin(auto_any_t col, type2type<T, const_> *, bool *)
{
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, const_>::type>(
        geofeatures_boost::begin(*auto_any_cast<simple_variant<T>, geofeatures_boost::mpl::false_>(col).get()));
}
#endif
...
template<typename T, typename C>
inline auto_any<T *>
begin(auto_any_t col, type2type<T *, C> *, geofeatures_boost::mpl::true_ *) // null-terminated C-style strings
{
    return auto_any<T *>(auto_any_cast<T *, geofeatures_boost::mpl::false_>(col));
}
#endif
...
template<typename T, typename C>
inline auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type>
end(auto_any_t col, type2type<T, C> *, geofeatures_boost::mpl::true_ *) // rvalue
{
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type>(
        geofeatures_boost::end(auto_any_cast<T, C>(col)));
}

template<typename T, typename C>
inline auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type>
end(auto_any_t col, type2type<T, C> *, geofeatures_boost::mpl::false_ *) // lvalue
{
    typedef BOOST_DEDUCED_TYPENAME type2type<T, C>::type type;
    typedef BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type iterator;
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type>(
        iterator(geofeatures_boost::end(BOOST_FOREACH_DEREFOF((auto_any_cast<type *, geofeatures_boost::mpl::false_>(col))))));
}
...
{
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, const_>::type>(
        geofeatures_boost::end(*auto_any_cast<simple_variant<T>, geofeatures_boost::mpl::false_>(col).get()));
}
#endif
...
template<typename T, typename C>
inline auto_any<int>
end(auto_any_t, type2type<T *, C> *, geofeatures_boost::mpl::true_ *) // null-terminated C-style strings
{
...
inline bool done(auto_any_t cur, auto_any_t end, type2type<T, C> *)
{
    ...
    return auto_any_cast<iter_t, geofeatures_boost::mpl::false_>(cur) == auto_any_cast<iter_t, geofeatures_boost::mpl::false_>(end);
}
...
{
    return ! *auto_any_cast<T *, geofeatures_boost::mpl::false_>(cur);
}
#endif
...
{
    typedef BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type iter_t;
    ++auto_any_cast<iter_t, geofeatures_boost::mpl::false_>(cur);
}
...
{
    typedef BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type iter_t;
    return *auto_any_cast<iter_t, geofeatures_boost::mpl::false_>(cur);
}
...
rbegin(auto_any_t col, type2type<T, C> *, geofeatures_boost::mpl::true_ *) // rvalue
{
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type>(
        geofeatures_boost::rbegin(auto_any_cast<T, C>(col)));
}

template<typename T, typename C>
inline auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type>
rbegin(auto_any_t col, type2type<T, C> *, geofeatures_boost::mpl::false_ *) // lvalue
{
    typedef BOOST_DEDUCED_TYPENAME type2type<T, C>::type type;
    typedef BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type iterator;
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type>(
        iterator(geofeatures_boost::rbegin(BOOST_FOREACH_DEREFOF((auto_any_cast<type *, geofeatures_boost::mpl::false_>(col))))));
}
...
rbegin(auto_any_t col, type2type<T, const_> *, bool *)
{
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, const_>::type>(
        geofeatures_boost::rbegin(*auto_any_cast<simple_variant<T>, geofeatures_boost::mpl::false_>(col).get()));
}
#endif
...
rbegin(auto_any_t col, type2type<T *, C> *, geofeatures_boost::mpl::true_ *) // null-terminated C-style strings
{
    T *p = auto_any_cast<T *, geofeatures_boost::mpl::false_>(col);
    while(0 != *p)
        ++p;
...
template<typename T, typename C>
inline auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type>
rend(auto_any_t col, type2type<T, C> *, geofeatures_boost::mpl::true_ *) // rvalue
{
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type>(
        geofeatures_boost::rend(auto_any_cast<T, C>(col)));
}

template<typename T, typename C>
inline auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type>
rend(auto_any_t col, type2type<T, C> *, geofeatures_boost::mpl::false_ *) // lvalue
{
    typedef BOOST_DEDUCED_TYPENAME type2type<T, C>::type type;
    typedef BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type iterator;
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type>(
        iterator(geofeatures_boost::rend(BOOST_FOREACH_DEREFOF((auto_any_cast<type *, geofeatures_boost::mpl::false_>(col))))));
}
...
{
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, const_>::type>(
        geofeatures_boost::rend(*auto_any_cast<simple_variant<T>, geofeatures_boost::mpl::false_>(col).get()));
}
#endif
...
template<typename T, typename C>
inline auto_any<reverse_iterator<T *> >
rend(auto_any_t col, type2type<T *, C> *, geofeatures_boost::mpl::true_ *) // null-terminated C-style strings
{
    return auto_any<reverse_iterator<T *> >(
        reverse_iterator<T *>(auto_any_cast<T *, geofeatures_boost::mpl::false_>(col)));
}
#endif
...
#define BOOST_FOREACH_TYPEOF(COL)                                                               \
    (true ? 0 : geofeatures_boost::foreach_detail_::encode_type(COL, geofeatures_boost::foreach_detail_::is_const_(COL)))

// returns true_* if the type is noncopyable
#define BOOST_FOREACH_IS_NONCOPYABLE(COL)                                                       \
    boost_foreach_is_noncopyable(                                                               \
        geofeatures_boost::foreach_detail_::to_ptr(COL)                                                     \
...
#define BOOST_FOREACH_IS_LIGHTWEIGHT_PROXY(COL)                                                 \
    geofeatures_boost::foreach_detail_::and_(                                                               \
        geofeatures_boost::foreach_detail_::not_(BOOST_FOREACH_IS_NONCOPYABLE(COL))                         \
      , boost_foreach_is_lightweight_proxy(                                                     \
            geofeatures_boost::foreach_detail_::to_ptr(COL)                                                 \
          , boost_foreach_argument_dependent_lookup_hack_value))
...
# define BOOST_FOREACH_SHOULD_COPY(COL)                                                         \
    (true ? 0 : geofeatures_boost::foreach_detail_::or_(                                                    \
...
# define BOOST_FOREACH_EVALUATE(COL)                                                            \
    (true ? geofeatures_boost::foreach_detail_::make_probe((COL), BOOST_FOREACH_ID(_foreach_is_rvalue)) : (COL))
...
# define BOOST_FOREACH_SHOULD_COPY(COL)                                                         \
    (geofeatures_boost::foreach_detail_::should_copy_impl(                                                  \
        true ? 0 : geofeatures_boost::foreach_detail_::or_(                                                 \
            geofeatures_boost::foreach_detail_::is_array_(COL)                                              \
          , BOOST_FOREACH_IS_NONCOPYABLE(COL)                                                   \
          , geofeatures_boost::foreach_detail_::not_(geofeatures_boost::foreach_detail_::is_const_(COL)))               \
...
#define BOOST_FOREACH_CONTAIN(COL)                                                              \
    geofeatures_boost::foreach_detail_::contain(                                                            \
        BOOST_FOREACH_EVALUATE(COL)                                                             \
      , BOOST_FOREACH_SHOULD_COPY(COL))

#define BOOST_FOREACH_BEGIN(COL)                                                                \
    geofeatures_boost::foreach_detail_::begin(                                                              \
        BOOST_FOREACH_ID(_foreach_col)                                                          \
      , BOOST_FOREACH_TYPEOF(COL)                                                               \
      , BOOST_FOREACH_SHOULD_COPY(COL))

#define BOOST_FOREACH_END(COL)                                                                  \
    geofeatures_boost::foreach_detail_::end(                                                                \
        BOOST_FOREACH_ID(_foreach_col)                                                          \
      , BOOST_FOREACH_TYPEOF(COL)                                                               \
      , BOOST_FOREACH_SHOULD_COPY(COL))

#define BOOST_FOREACH_DONE(COL)                                                                 \
    geofeatures_boost::foreach_detail_::done(                                                               \
        BOOST_FOREACH_ID(_foreach_cur)                                                          \
      , BOOST_FOREACH_ID(_foreach_end)                                                          \
      , BOOST_FOREACH_TYPEOF(COL))

#define BOOST_FOREACH_NEXT(COL)                                                                 \
    geofeatures_boost::foreach_detail_::next(                                                               \
        BOOST_FOREACH_ID(_foreach_cur)                                                          \
      , BOOST_FOREACH_TYPEOF(COL))

#define BOOST_FOREACH_DEREF(COL)                                                                \
    geofeatures_boost::foreach_detail_::deref(                                                              \
        BOOST_FOREACH_ID(_foreach_cur)                                                          \
      , BOOST_FOREACH_TYPEOF(COL))

#define BOOST_FOREACH_RBEGIN(COL)                                                               \
    geofeatures_boost::foreach_detail_::rbegin(                                                             \
        BOOST_FOREACH_ID(_foreach_col)                                                          \
      , BOOST_FOREACH_TYPEOF(COL)                                                               \
      , BOOST_FOREACH_SHOULD_COPY(COL))

#define BOOST_FOREACH_REND(COL)                                                                 \
    geofeatures_boost::foreach_detail_::rend(                                                               \
        BOOST_FOREACH_ID(_foreach_col)                                                          \
      , BOOST_FOREACH_TYPEOF(COL)                                                               \
      , BOOST_FOREACH_SHOULD_COPY(COL))

#define BOOST_FOREACH_RDONE(COL)                                                                \
    geofeatures_boost::foreach_detail_::rdone(                                                              \
        BOOST_FOREACH_ID(_foreach_cur)                                                          \
      , BOOST_FOREACH_ID(_foreach_end)                                                          \
      , BOOST_FOREACH_TYPEOF(COL))

#define BOOST_FOREACH_RNEXT(COL)                                                                \
    geofeatures_boost::foreach_detail_::rnext(                                                              \
        BOOST_FOREACH_ID(_foreach_cur)                                                          \
      , BOOST_FOREACH_TYPEOF(COL))

#define BOOST_FOREACH_RDEREF(COL)                                                               \
    geofeatures_boost::foreach_detail_::rderef(                                                             \
        BOOST_FOREACH_ID(_foreach_cur)                                                          \
      , BOOST_FOREACH_TYPEOF(COL))
...
#define BOOST_FOREACH(VAR, COL)                                                                                   \
    ...
    if (geofeatures_boost::foreach_detail_::auto_any_t BOOST_FOREACH_ID(_foreach_col) = BOOST_FOREACH_CONTAIN(COL)) {} else   \
    if (geofeatures_boost::foreach_detail_::auto_any_t BOOST_FOREACH_ID(_foreach_cur) = BOOST_FOREACH_BEGIN(COL)) {} else     \
    if (geofeatures_boost::foreach_detail_::auto_any_t BOOST_FOREACH_ID(_foreach_end) = BOOST_FOREACH_END(COL)) {} else       \
    for (bool BOOST_FOREACH_ID(_foreach_continue) = true;                                                         \
              BOOST_FOREACH_ID(_foreach_continue) && !BOOST_FOREACH_DONE(COL);                                    \
              BOOST_FOREACH_ID(_foreach_continue) ? BOOST_FOREACH_NEXT(COL) : (void)0)                            \
        if  (geofeatures_boost::foreach_detail_::set_false(BOOST_FOREACH_ID(_foreach_continue))) {} else                      \
...
#define BOOST_REVERSE_FOREACH(VAR, COL)                                                                           \
    BOOST_FOREACH_PREAMBLE()                                                                                      \
    if (geofeatures_boost::foreach_detail_::auto_any_t BOOST_FOREACH_ID(_foreach_col) = BOOST_FOREACH_CONTAIN(COL)) {} else   \
    if (geofeatures_boost::foreach_detail_::auto_any_t BOOST_FOREACH_ID(_foreach_cur) = BOOST_FOREACH_RBEGIN(COL)) {} else    \
    if (geofeatures_boost::foreach_detail_::auto_any_t BOOST_FOREACH_ID(_foreach_end) = BOOST_FOREACH_REND(COL)) {} else      \
    for (bool BOOST_FOREACH_ID(_foreach_continue) = true;                                                         \
