...
//!\file
//!Describes index adaptor of geofeatures_boost::intrusive::set container, to use it
...
//!Index type based in geofeatures_boost::intrusive::set.
//!Just derives from geofeatures_boost::intrusive::set
...
struct is_intrusive_index
   <geofeatures_boost::interprocess::iset_index<MapConfig> >
{
