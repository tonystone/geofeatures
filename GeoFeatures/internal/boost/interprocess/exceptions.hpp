...
//!thrown by geofeatures_boost::interprocess
      ...
      :  m_err(err_info)
   {
      try{
         if(m_err.get_native_error() != 0){
            ...
            m_str = "geofeatures_boost::interprocess_exception::library_error";
         }
      }
      catch(...){}
   }
...
class BOOST_SYMBOL_VISIBLE lock_exception : public interprocess_exception
{
   ...
   virtual const char* what() const throw()
   {  return "geofeatures_boost::interprocess::lock_exception";  }
};
...
{
 public:
   bad_alloc() : interprocess_exception("::geofeatures_boost::interprocess::bad_alloc"){}
   virtual const char* what() const throw()
      {  return "geofeatures_boost::interprocess::bad_alloc";  }
};
