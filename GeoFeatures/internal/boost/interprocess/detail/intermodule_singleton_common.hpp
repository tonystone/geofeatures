...
class intermodule_singleton_common
{
   ...
   static const ::geofeatures_boost::uint32_t Uninitialized       = 0u;
   static const ::geofeatures_boost::uint32_t Initializing        = 1u;
   static const ::geofeatures_boost::uint32_t Initialized         = 2u;
   static const ::geofeatures_boost::uint32_t Broken              = 3u;
   static const ::geofeatures_boost::uint32_t Destroyed           = 4u;
   ...
   static void initialize_singleton_logic
      (void *&ptr, volatile geofeatures_boost::uint32_t &this_module_singleton_initialized, singleton_constructor_t constructor, bool phoenix)
   {
      ...
      if(atomic_read32(&this_module_singleton_initialized) != Initialized){
         ...
         ::geofeatures_boost::uint32_t previous_module_singleton_initialized = atomic_cas32
         ...
         //trying to initialize the singleton.
            ...
            throw interprocess_exception("geofeatures_boost::interprocess::intermodule_singleton initialization failed");
         }
      }
      BOOST_ASSERT(ptr != 0);
   }

   static void finalize_singleton_logic(void *&ptr, volatile geofeatures_boost::uint32_t &this_module_singleton_initialized, singleton_destructor_t destructor)
   {
   ...
   static void initialize_global_map_handle()
   {
      ...
      while(1){
         ...
         ::geofeatures_boost::uint32_t tmp = atomic_cas32(&this_module_map_initialized, Initializing, Uninitialized);
   ...
   static volatile geofeatures_boost::uint32_t this_module_singleton_count;
   ...
   static volatile geofeatures_boost::uint32_t this_module_map_initialized;

   //Raw memory to construct the global map manager
   static union mem_holder_t
   {
      unsigned char map_mem [sizeof(ThreadSafeGlobalMap)];
      ::geofeatures_boost::container::container_detail::max_align_t aligner;
   } mem_holder;
};

template<class ThreadSafeGlobalMap>
volatile geofeatures_boost::uint32_t intermodule_singleton_common<ThreadSafeGlobalMap>::this_module_singleton_count;

template<class ThreadSafeGlobalMap>
volatile geofeatures_boost::uint32_t intermodule_singleton_common<ThreadSafeGlobalMap>::this_module_map_initialized;
...
class intermodule_singleton_impl
{
   ...
   //singleton.
   static volatile geofeatures_boost::uint32_t   this_module_singleton_initialized;
...
template <typename C, bool L, bool P, class ThreadSafeGlobalMap>
volatile geofeatures_boost::uint32_t intermodule_singleton_impl<C, L, P, ThreadSafeGlobalMap>::this_module_singleton_initialized = 0;
