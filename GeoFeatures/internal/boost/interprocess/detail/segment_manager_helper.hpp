...
struct block_header
{
   ...
   size_type total_size_with_header() const
   {
      return get_rounded_size
            ...
            , size_type(::geofeatures_boost::container::container_detail::alignment_of<block_header<size_type> >::value))
           + total_size();
   }
   ...
   {  return block_header_from_value(value, sizeof(T), ::geofeatures_boost::container::container_detail::alignment_of<T>::value);  }
   ...
   :  public Hook
{
   ...
   enum  {  BlockHdrAlignment = ::geofeatures_boost::container::container_detail::alignment_of<block_header<size_type> >::value  };
...
struct index_key
{
   ...
   typedef CharT                                         char_type;
   typedef typename geofeatures_boost::intrusive::pointer_traits<const_char_ptr_t>::difference_type difference_type;
   typedef typename geofeatures_boost::move_detail::make_unsigned<difference_type>::type size_type;
