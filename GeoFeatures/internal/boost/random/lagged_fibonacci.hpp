...
public:
    ...
    BOOST_RANDOM_DETAIL_ARITHMETIC_SEED(lagged_fibonacci_engine,
        UIntType, value)
    {
        minstd_rand0 intgen(static_cast<geofeatures_boost::uint32_t>(value));
    ...
    void discard(geofeatures_boost::uintmax_t z)
    {
        for(geofeatures_boost::uintmax_t j = 0; j < z; ++j) {
            (*this)();
        }
    }
...
public:
    ...
    BOOST_STATIC_CONSTANT(geofeatures_boost::uint32_t, default_seed = 331u);
     ...
     */
    BOOST_RANDOM_DETAIL_ARITHMETIC_SEED(lagged_fibonacci_01_engine, geofeatures_boost::uint32_t, value)
    {
...
template<class RealType, int w, unsigned int p, unsigned int q>
const geofeatures_boost::uint32_t lagged_fibonacci_01_engine<RealType,w,p,q>::default_seed;
#endif
...
public:
    lagged_fibonacci_01() {}
    BOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(lagged_fibonacci_01, geofeatures_boost::uint32_t, val)
    { this->seed(val); }
...
/** @copydoc geofeatures_boost::random::detail::lagged_fibonacci_doc */
