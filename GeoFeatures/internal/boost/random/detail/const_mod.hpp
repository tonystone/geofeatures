...
public:
  ...
  static IntType pow(IntType a, geofeatures_boost::uintmax_t exponent)
  {
      IntType result = 1;
      while(exponent != 0) {
          if(exponent % 2 == 1) {
...
private:
  ...
  static IntType mult_general(IntType a, IntType b)
  {
    ...
    if(::geofeatures_boost::uintmax_t(modulus) <=
        (::std::numeric_limits< ::geofeatures_boost::uintmax_t>::max)() / modulus)
    {
      return static_cast<IntType>(geofeatures_boost::uintmax_t(a) * b % modulus);
    } else {
