...
public:
    ...
    result_type operator()(Engine& eng) const
    {
        ...
        return generate(eng, geofeatures_boost::is_integral<base_result>());
    }
...
private:
    ...
    // \cond show_private
    template<class Engine>
    result_type generate(Engine& eng, geofeatures_boost::mpl::true_) const
    {
        ...
        typedef typename geofeatures_boost::make_unsigned<result_type>::type range_type;
        ...
        if(range >= base_range) {
            return geofeatures_boost::random::detail::add<range_type, result_type>()(
    ...
    template<class Engine>
    result_type generate(Engine& eng, geofeatures_boost::mpl::false_) const
    {
        typedef typename Engine::result_type base_result;
        typedef typename geofeatures_boost::make_unsigned<result_type>::type range_type;
        range_type range = random::detail::subtract<result_type>()(_max, _min);
        base_result val = geofeatures_boost::uniform_01<base_result>()(eng);
        ...
        return geofeatures_boost::random::detail::add<range_type, result_type>()(offset , _min);
    }
    // \endcond
