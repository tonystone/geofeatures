   ...
   // is_classified functor
            ...
            */
            ...
            private:
                ...
                typedef typename ::geofeatures_boost::remove_const<CharT>::type set_value_type;
            ...
            public:     
                ...
                is_any_ofF( const RangeT& Range ) : m_Size(0)
                {
                    ...
                    std::size_t Size=::geofeatures_boost::distance(Range);
                    m_Size=Size;
                    ...
                    // Use fixed storage
                    ::std::copy(::geofeatures_boost::begin(Range), ::geofeatures_boost::end(Range), Storage);
