...
{
#if BOOST_WORKAROUND(BOOST_MSVC, < 1400)
   BOOST_STATIC_CONSTANT(bool, value = ::geofeatures_boost::detail::cv_traits_imp<typename geofeatures_boost::remove_bounds<T>::type*>::is_volatile);
#else
   BOOST_STATIC_CONSTANT(bool, value = ::geofeatures_boost::detail::cv_traits_imp<BOOST_TT_AUX_CV_TRAITS_IMPL_PARAM(T)>::is_volatile);
#endif
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_volatile,T,::geofeatures_boost::detail::is_volatile_rval_filter<T>::value)
