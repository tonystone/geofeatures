...
{ 
   BOOST_STATIC_CONSTANT(bool, value =
      (::geofeatures_boost::type_traits::ice_or<
         ...
         ::geofeatures_boost::is_enum<T>::value,
         ::geofeatures_boost::is_pointer<T>::value,
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_scalar,T,::geofeatures_boost::detail::is_scalar_impl<T>::value)
