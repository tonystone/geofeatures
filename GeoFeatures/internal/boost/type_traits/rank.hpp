...
{
   BOOST_STATIC_CONSTANT(std::size_t, value = (::geofeatures_boost::detail::rank_imp<T, N+1>::value));
};
...
#else
BOOST_TT_AUX_SIZE_T_TRAIT_DEF1(rank,T,(::geofeatures_boost::detail::rank_imp<T,0>::value))
#endif
