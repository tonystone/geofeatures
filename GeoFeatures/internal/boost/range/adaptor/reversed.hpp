...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost
{
    namespace range_detail
    {
        ...
        struct reversed_range : 
            public geofeatures_boost::iterator_range< 
                      geofeatures_boost::reverse_iterator<
        ...
        public:
            typedef geofeatures_boost::reverse_iterator<BOOST_DEDUCED_TYPENAME range_iterator<R>::type> iterator;

            explicit reversed_range( R& r ) 
                : base( iterator(geofeatures_boost::end(r)), iterator(geofeatures_boost::begin(r)) )
            { }
        };
