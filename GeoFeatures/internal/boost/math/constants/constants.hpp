  ...
  namespace constants
  {
   ...
   public:
      typedef typename mpl::if_<
         mpl::and_<geofeatures_boost::is_convertible<float, Real>, mpl::bool_< t1::value <= t2::value>, mpl::bool_<0 != t1::value> >,
         mpl::int_<construct_from_float>,
         typename mpl::if_<
            mpl::and_<geofeatures_boost::is_convertible<double, Real>, mpl::bool_< t1::value <= t3::value>, mpl::bool_<0 != t1::value> >,
            mpl::int_<construct_from_double>,
            typename mpl::if_<
               mpl::and_<geofeatures_boost::is_convertible<long double, Real>, mpl::bool_< t1::value <= t4::value>, mpl::bool_<0 != t1::value> >,
               mpl::int_<construct_from_long_double>,
#ifdef BOOST_MATH_USE_FLOAT128
               typename mpl::if_<
               mpl::and_<geofeatures_boost::is_convertible<BOOST_MATH_FLOAT128_TYPE, Real>, mpl::bool_< t1::value <= t5::value>, mpl::bool_<0 != t1::value> >,
...
#define BOOST_MATH_CONSTANT_THREAD_HELPER(name, prefix) \
      geofeatures_boost::once_flag f = BOOST_ONCE_INIT;\
      geofeatures_boost::call_once(f, &BOOST_JOIN(BOOST_JOIN(string_, get_), name)<T>);
#else
#define BOOST_MATH_CONSTANT_THREAD_HELPER(name, prefix)
#endif
   ...
   namespace detail{
      ...
      template <class Real, class Policy = geofeatures_boost::math::policies::policy<> >
...
#else
         return geofeatures_boost::lexical_cast<Real>(p);
#endif
      }
      template <class Real>
...
#define BOOST_DEFINE_MATH_CONSTANT(name, x, y)\
   ...
   {\
      typedef mpl::bool_<geofeatures_boost::is_convertible<const char*, T>::value || geofeatures_boost::math::constants::is_explicitly_convertible_from_string<T>::value> tag_type;\
   ...
   { return name<T, geofeatures_boost::math::policies::policy<> >(); }\
   \
   \
