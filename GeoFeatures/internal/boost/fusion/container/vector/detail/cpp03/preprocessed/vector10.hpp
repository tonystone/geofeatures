...
==============================================================================*/
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace fusion
{
    struct vector_tag;
...
# endif
        ...
        vector_data1(U0 && arg0
          , typename geofeatures_boost::enable_if<is_convertible<U0, T0> >::type* = 0
        )
...
# endif
        ...
        vector1(
            Sequence const& seq
          , typename geofeatures_boost::enable_if<traits::is_sequence<Sequence> >::type* = 0
          , typename geofeatures_boost::disable_if<is_convertible<Sequence, T0> >::type* = 0
            )
...
# endif
        ...
        template <typename Sequence>
        BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED
        typename geofeatures_boost::disable_if<is_convertible<Sequence, T0>, this_type&>::type
