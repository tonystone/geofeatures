...
namespace posix_time {
  ...
  inline
  ptime 
  operator+(const ptime& t, const geofeatures_boost::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const geofeatures_boost::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+(const ptime& t, const geofeatures_boost::gregorian::years& y)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const geofeatures_boost::gregorian::years& y)
  {
    return t += y.get_offset(t.date());
  }
