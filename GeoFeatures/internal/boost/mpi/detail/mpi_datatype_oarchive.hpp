...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace mpi { namespace detail {
...
public:
    ...
    {
      save_enum(t,geofeatures_boost::is_enum<T>());
    }
    ...
    void save_enum(T const& t, mpl::true_)
    {
      ...
      typedef typename geofeatures_boost::uint_t<8*sizeof(T)>::least int_type;
...
} } } // end namespace geofeatures_boost::mpi::detail

// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(geofeatures_boost::mpi::detail::mpi_datatype_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(geofeatures_boost::mpi::detail::ignore_skeleton_oarchive<geofeatures_boost::mpi::detail::mpi_datatype_oarchive>)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(geofeatures_boost::mpi::detail::mpi_datatype_oarchive)
