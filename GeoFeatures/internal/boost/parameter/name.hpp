...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace parameter { namespace aux {
...
}}} // namespace geofeatures_boost::parameter::aux
...
}} // namespace geofeatures_boost::mpl
...
# define BOOST_PARAMETER_BASIC_NAME(tag_namespace, tag, name)       \
      ...
      {                                                             \
          ...
          {                                                         \
              return BOOST_PP_STRINGIZE(tag);                       \
                                                                    ...
                                                                    \
          typedef geofeatures_boost::parameter::value_type<                     \
              geofeatures_boost::mpl::_2, tag, geofeatures_boost::parameter::void_          \
          > _;                                                      \
                                                                    \
          typedef geofeatures_boost::parameter::value_type<                     \
              geofeatures_boost::mpl::_2, tag, geofeatures_boost::parameter::void_          \
    ...
    namespace                                                       \
    {                                                               \
       ::geofeatures_boost::parameter::keyword<tag_namespace::tag> const& name  \
       = ::geofeatures_boost::parameter::keyword<tag_namespace::tag>::instance; \
    }
...
# define BOOST_PARAMETER_TEMPLATE_KEYWORD(name)                     \
    ...
    template <class T>                                              \
    struct name                                                     \
      : geofeatures_boost::parameter::template_keyword<tag::name, T>            \
    {};                                                             \
/**/
