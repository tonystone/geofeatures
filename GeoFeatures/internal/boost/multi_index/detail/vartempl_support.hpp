 ...
 *
 * which fill the extra args with geofeatures_boost::multi_index::detail::noarg's.
 * geofeatures_boost::multi_index::detail::vartempl_placement_new works the opposite
...
geofeatures_boost::forward<BOOST_PP_CAT(T,n)>(BOOST_PP_CAT(t,n))
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost{namespace multi_index{namespace detail{
struct noarg{};
}}}
...
BOOST_PP_ENUM_PARAMS(                                                \
  BOOST_MULTI_INDEX_LIMIT_VARTEMPL_ARGS,                             \
  geofeatures_boost::multi_index::detail::noarg() BOOST_PP_INTERCEPT)
