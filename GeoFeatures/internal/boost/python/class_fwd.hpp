...
template <
    ...
    , class X1 = ::geofeatures_boost::python::detail::not_specified
    , class X2 = ::geofeatures_boost::python::detail::not_specified
    , class X3 = ::geofeatures_boost::python::detail::not_specified
    >
class class_;
