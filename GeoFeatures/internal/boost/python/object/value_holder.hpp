...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace python { namespace objects { 
...
{
    if (void* wrapped = holds_wrapped(dst_t, geofeatures_boost::addressof(m_held), geofeatures_boost::addressof(m_held)))
        return wrapped;
    
    type_info src_t = python::type_id<Value>();
    return src_t == dst_t ? geofeatures_boost::addressof(m_held)
        : find_static_type(geofeatures_boost::addressof(m_held), src_t, dst_t);
}
...
}}} // namespace geofeatures_boost::python::objects
...
# endif
    ...
    {
        python::detail::initialize_wrapper(self, geofeatures_boost::addressof(this->m_held));
    }
