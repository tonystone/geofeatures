...
//
// It is needed in order to allow us to write using geofeatures_boost::vertices as
...
typename T::ThereReallyIsNoMemberByThisNameInT vertices(T const&);
        ...
        : Graph<G>
    {
        ...
        BOOST_STATIC_ASSERT((geofeatures_boost::mpl::not_<geofeatures_boost::is_same<out_edge_iterator, void> >::value));
        BOOST_STATIC_ASSERT((geofeatures_boost::mpl::not_<geofeatures_boost::is_same<degree_size_type, void> >::value));
        ...
        : IncidenceGraph<G>
    {
        ...
        BOOST_STATIC_ASSERT((geofeatures_boost::mpl::not_<geofeatures_boost::is_same<in_edge_iterator, void> >::value));
        ...
        : Graph<G>
    {
        ...
        BOOST_STATIC_ASSERT((geofeatures_boost::mpl::not_<geofeatures_boost::is_same<adjacency_iterator, void> >::value));
        ...
        : Graph<G>
    {
        ...
        BOOST_STATIC_ASSERT((geofeatures_boost::mpl::not_<geofeatures_boost::is_same<vertex_iterator, void> >::value));
        BOOST_STATIC_ASSERT((geofeatures_boost::mpl::not_<geofeatures_boost::is_same<vertices_size_type, void> >::value));
        ...
        // redesign involving specializing a template with a static
        // member function is in order :(
        using geofeatures_boost::vertices;
#endif
        p = vertices(g);
        v = *p.first;
        const_constraints(g);
        ...
        : Graph<G>
    {
        ...
        BOOST_STATIC_ASSERT((geofeatures_boost::mpl::not_<geofeatures_boost::is_same<edge_iterator, void> >::value));
        BOOST_STATIC_ASSERT((geofeatures_boost::mpl::not_<geofeatures_boost::is_same<edges_size_type, void> >::value));
        ...
        : MutableGraph<G>
    {
        ...
        typename geofeatures_boost::graph_traits<G>::vertex_descriptor u;
        typename geofeatures_boost::graph_traits<G>::out_edge_iterator iter;
    };
...
using geofeatures_boost::concepts::MultiPassInputIteratorConcept;

// Graph concepts
using geofeatures_boost::concepts::GraphConcept;
using geofeatures_boost::concepts::IncidenceGraphConcept;
using geofeatures_boost::concepts::BidirectionalGraphConcept;
using geofeatures_boost::concepts::AdjacencyGraphConcept;
using geofeatures_boost::concepts::VertexListGraphConcept;
using geofeatures_boost::concepts::EdgeListGraphConcept;
using geofeatures_boost::concepts::VertexAndEdgeListGraphConcept;
using geofeatures_boost::concepts::EdgeMutableGraphConcept;
using geofeatures_boost::concepts::VertexMutableGraphConcept;
using geofeatures_boost::concepts::MutableGraphConcept;
using geofeatures_boost::concepts::MutableIncidenceGraphConcept;
using geofeatures_boost::concepts::MutableBidirectionalGraphConcept;
using geofeatures_boost::concepts::MutableEdgeListGraphConcept;
using geofeatures_boost::concepts::VertexMutablePropertyGraphConcept;
using geofeatures_boost::concepts::EdgeMutablePropertyGraphConcept;
using geofeatures_boost::concepts::AdjacencyMatrixConcept;
using geofeatures_boost::concepts::ReadablePropertyGraphConcept;
using geofeatures_boost::concepts::PropertyGraphConcept;
using geofeatures_boost::concepts::LvaluePropertyGraphConcept;
using geofeatures_boost::concepts::VertexIndexGraphConcept;
using geofeatures_boost::concepts::EdgeIndexGraphConcept;

// Utility concepts
using geofeatures_boost::concepts::ColorValueConcept;
using geofeatures_boost::concepts::BasicMatrixConcept;
using geofeatures_boost::concepts::NumericValueConcept;
using geofeatures_boost::concepts::DistanceMeasureConcept;
using geofeatures_boost::concepts::DegreeMeasureConcept;
