...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace graph { namespace parallel {
...
} } } // end namespace geofeatures_boost::graph::parallel 
