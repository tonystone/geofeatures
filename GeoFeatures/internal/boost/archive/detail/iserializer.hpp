...
private:
    virtual void destroy(/*const*/ void *address) const {
        geofeatures_boost::serialization::access::destroy(static_cast<T *>(address));
    }
protected:
    // protected constructor since it's always created by singleton
    explicit iserializer() :
        basic_iserializer(
            geofeatures_boost::serialization::singleton<
                typename 
                geofeatures_boost::serialization::type_info_implementation< T >::type
            >::get_const_instance()
        )
    {}
public:
    ...
    virtual bool class_info() const {
        return geofeatures_boost::serialization::implementation_level< T >::value 
            >= geofeatures_boost::serialization::object_class_info;
    }
    virtual bool tracking(const unsigned int /* flags */) const {
        return geofeatures_boost::serialization::tracking_level< T >::value 
                == geofeatures_boost::serialization::track_always
            || ( geofeatures_boost::serialization::tracking_level< T >::value 
                == geofeatures_boost::serialization::track_selectively
                && serialized_as_pointer());
    }
    virtual version_type version() const {
        return version_type(::geofeatures_boost::serialization::version< T >::value);
    }
    virtual bool is_polymorphic() const {
        return geofeatures_boost::is_polymorphic< T >::value;
    }
    virtual ~iserializer(){};
};
...
BOOST_DLLEXPORT void iserializer<Archive, T>::load_object_data(
    ...
    if(file_version > static_cast<const unsigned int>(version()))
        geofeatures_boost::serialization::throw_exception(
            archive::archive_exception(
                geofeatures_boost::archive::archive_exception::unsupported_class_version,
                get_debug_info()
            )
        );
    #endif
    ...
    geofeatures_boost::serialization::serialize_adl(
        geofeatures_boost::serialization::smart_cast_reference<Archive &>(ar),
        * static_cast<T *>(x), 
        file_version
    );
}
...
struct heap_allocation {
    // geofeatures_boost::has_new_operator< T > doesn't work on these compilers
    #if DONT_USE_HAS_NEW_OPERATOR
        ...
        static T * invoke_new() {
            typedef typename
                mpl::eval_if<
                    geofeatures_boost::has_new_operator< T >,
...
private:
    ...
    virtual const basic_iserializer & get_basic_serializer() const {
        return geofeatures_boost::serialization::singleton<
...
) const
{
    ...
    BOOST_TRY {
        ...
        geofeatures_boost::serialization::load_construct_data_adl<Archive, T>(
            ar_impl,
            static_cast<T *>(t),
            file_version
        );
    ...
    ar_impl >> geofeatures_boost::serialization::make_nvp(NULL, * static_cast<T *>(t));
}
...
struct load_non_pointer_type {
    ...
    struct load_only {
        ...
        static void invoke(Archive & ar, const T & t){
            ...
            geofeatures_boost::serialization::serialize_adl(
                ar, 
                const_cast<T &>(t), 
                geofeatures_boost::serialization::version< T >::value
            );
        }
    };
    ...
    static void invoke(Archive & ar, T &t){
        typedef typename mpl::eval_if<
                // if its primitive
                mpl::equal_to<
                    geofeatures_boost::serialization::implementation_level< T >,
                    mpl::int_<geofeatures_boost::serialization::primitive_type>
                >,
            ...
            mpl::greater_equal<
                        geofeatures_boost::serialization::implementation_level< T >,
                        mpl::int_<geofeatures_boost::serialization::object_class_info>
                    >,
            // do standard load
        ...
        typename mpl::eval_if<
            // no tracking
                    mpl::equal_to<
                        geofeatures_boost::serialization::tracking_level< T >,
                        mpl::int_<geofeatures_boost::serialization::track_never>
                >,
                // do a fast load
...
struct load_pointer_type {
    struct abstract
    {
        ...
        static const basic_pointer_iserializer * register_type(Archive & /* ar */){
            ...
            BOOST_STATIC_ASSERT(geofeatures_boost::is_polymorphic< T >::value);
    ...
    static const basic_pointer_iserializer * register_type(Archive &ar, const T & /*t*/){
        ...
        typedef typename
            mpl::eval_if<
                geofeatures_boost::serialization::is_abstract<const T>,
                geofeatures_boost::mpl::identity<abstract>,
                geofeatures_boost::mpl::identity<non_abstract>  
            >::type typex;
    ...
    static T * pointer_tweak(
        const geofeatures_boost::serialization::extended_type_info & eti,
        void const * const t,
        const T &
    ) {
        // tweak the pointer back to the base class
        void * upcast = const_cast<void *>(
            geofeatures_boost::serialization::void_upcast(
                eti,
                geofeatures_boost::serialization::singleton<
                    typename 
                    geofeatures_boost::serialization::type_info_implementation< T >::type
    ...
    find(const geofeatures_boost::serialization::extended_type_info & type){
...
struct load_enum_type {
    ...
    static void invoke(Archive &ar, T &t){
        ...
        int i;
        ar >> geofeatures_boost::serialization::make_nvp(NULL, i);
        t = static_cast< T >(i);
    }
};
...
struct load_array_type {
    ...
    static void invoke(Archive &ar, T &t){
        ...
        geofeatures_boost::serialization::collection_size_type count;
        ar >> BOOST_SERIALIZATION_NVP(count);
        if(static_cast<std::size_t>(count) > current_count)
            geofeatures_boost::serialization::throw_exception(
                archive::archive_exception(
                    geofeatures_boost::archive::archive_exception::array_size_too_short
                )
            );
