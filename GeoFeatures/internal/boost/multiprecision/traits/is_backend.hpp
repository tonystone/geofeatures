...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost{ namespace multiprecision{  namespace detail{
   ...
   {
      typedef typename geofeatures_boost::conditional<
         geofeatures_boost::is_same<number<Backend>, number<Backend, et_on> >::value,
   ...
   {
      typedef typename geofeatures_boost::conditional <
         geofeatures_boost::is_convertible<V, number<B> >::value,
         number<B>,
