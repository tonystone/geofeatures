...
inline Integer eval_integer_modulus(const Backend& x, Integer val)
{
   ...
   typedef typename geofeatures_boost::multiprecision::detail::canonical<Integer, Backend>::type int_type;
   Backend t;
...
void eval_powm(Backend& result, const Backend& a, const Backend& p, const Backend& c)
{
   ...
   typedef typename geofeatures_boost::multiprecision::detail::canonical<unsigned char, double_type>::type ui_type;
...
void eval_powm(Backend& result, const Backend& a, const Backend& p, Integer c)
{
   typedef typename double_precision_type<Backend>::type double_type;
   typedef typename geofeatures_boost::multiprecision::detail::canonical<unsigned char, double_type>::type ui_type;
   typedef typename geofeatures_boost::multiprecision::detail::canonical<Integer, double_type>::type i1_type;
   typedef typename geofeatures_boost::multiprecision::detail::canonical<Integer, Backend>::type i2_type;
...
typename enable_if<is_unsigned<Integer1> >::type eval_powm(Backend& result, const Backend& a, Integer1 b, Integer2 c)
{
   typedef typename double_precision_type<Backend>::type double_type;
   typedef typename geofeatures_boost::multiprecision::detail::canonical<unsigned char, double_type>::type ui_type;
   typedef typename geofeatures_boost::multiprecision::detail::canonical<Integer1, double_type>::type i1_type;
   typedef typename geofeatures_boost::multiprecision::detail::canonical<Integer2, Backend>::type i2_type;
