...
BOOST_FORCEINLINE unsigned find_lsb(geofeatures_boost::ulong_long_type mask, mpl::int_<3> const&)
{
...
BOOST_FORCEINLINE unsigned find_msb(geofeatures_boost::ulong_long_type mask, mpl::int_<3> const&)
{
   return sizeof(geofeatures_boost::ulong_long_type) * CHAR_BIT - 1 - __builtin_clzll(mask);
}
...
BOOST_FORCEINLINE unsigned find_lsb(Unsigned mask)
{
   ...
   typedef typename mpl::if_c<
      ...
      typename mpl::if_c<
         ...
         mpl::int_<2>,
         typename mpl::if_c<
            sizeof(Unsigned) <= sizeof(geofeatures_boost::ulong_long_type),
            mpl::int_<3>,
            mpl::int_<0>
         >::type
      >::type
