...
namespace mp = geofeatures_boost::multiprecision;

namespace cpp_int_detail{

using namespace geofeatures_boost::multiprecision;
using namespace geofeatures_boost::multiprecision::backends;

template <class T>
struct is_binary_archive : public mpl::false_ {};
template <>
struct is_binary_archive<geofeatures_boost::archive::binary_oarchive> : public mpl::true_ {};
template <>
struct is_binary_archive<geofeatures_boost::archive::binary_iarchive> : public mpl::true_ {};
