...
{
   if(o < 0)
      eval_subtract(result, static_cast<limb_type>(geofeatures_boost::multiprecision::detail::unsigned_abs(o)));
   else if(o > 0)
...
{
   if(o < 0)
      eval_subtract(result, a, static_cast<limb_type>(geofeatures_boost::multiprecision::detail::unsigned_abs(o)));
   else if(o > 0)
      ...
      const signed_limb_type& o) BOOST_MP_NOEXCEPT_IF((is_non_throwing_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1> >::value))
{
   ...
   {
      if(o < 0)
         eval_add(result, static_cast<limb_type>(geofeatures_boost::multiprecision::detail::unsigned_abs(o)));
      else
      ...
      const signed_limb_type& o) BOOST_MP_NOEXCEPT_IF((is_non_throwing_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1> >::value))
{
   ...
   {
      if(o < 0)
         eval_add(result, a, static_cast<limb_type>(geofeatures_boost::multiprecision::detail::unsigned_abs(o)));
      else
