...
namespace assign_detail
{
    ...
    struct assign_decay
    {
        ...
        typedef BOOST_DEDUCED_TYPENAME mpl::eval_if<
            ::geofeatures_boost::is_array<T>,
            ::geofeatures_boost::decay<const T>,
            ::geofeatures_boost::decay<T> >::type type;
    };
...
// old Dinkumware doesn't support iterator type as template
    ...
    {
        return ::geofeatures_boost::iterator_range_detail::equal( l, r );
    }
    ...
    inline bool operator<( const converter<T,I>& l, const Range& r )
    {
        return ::geofeatures_boost::iterator_range_detail::less_than( l, r );
    }
    ...
    {
        return Os << ::geofeatures_boost::make_iterator_range( r.begin(), r.end() );
    }
...
#include BOOST_PP_LOCAL_ITERATE()
        ...
        {
            return range( geofeatures_boost::begin(r), geofeatures_boost::end(r) );
        }
