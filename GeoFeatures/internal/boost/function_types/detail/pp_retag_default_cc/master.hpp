...
#   include BOOST_PP_ASSIGN_SLOT(1)
    ...
    BOOST_STATIC_CONSTANT(bits_t, value = (
        (::geofeatures_boost::function_types::detail::bits<Tag>::value & BOOST_FT_default_cc) 
      | (::geofeatures_boost::function_types::detail::bits<RefTag>::value & BOOST_PP_SLOT(1))
    ));
  };
  ...
  template<class Tag, class RefTag> struct retag_default_cc
    : detail::compound_tag
      < Tag, detail::default_cc_tag< 
          ::geofeatures_boost::function_types::detail::selector_bits<Tag,RefTag>::value > >
  { };
