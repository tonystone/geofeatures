...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(geofeatures_boost::archive::binary_oarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(geofeatures_boost::archive::binary_oarchive)
