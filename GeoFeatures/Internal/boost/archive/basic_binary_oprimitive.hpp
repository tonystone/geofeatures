...
public:
    ...
    geofeatures_boost::scoped_ptr<codecvt_null<Elem> > codecvt_facet;
    geofeatures_boost::scoped_ptr<std::locale> archive_locale;
...
public:
    ...
    struct use_array_optimization {
        template <class T>  
            ...
            struct apply {  
                typedef typename geofeatures_boost::serialization::is_bitwise_serializable< T >::type type;  
            };
        #else
            struct apply : public geofeatures_boost::serialization::is_bitwise_serializable< T > {};  
        #endif
    };
    ...
    void save_array(geofeatures_boost::serialization::array<ValueType> const& a, unsigned int)
    {
...
basic_binary_oprimitive<Archive, Elem, Tr>::save_binary(
    ...
    count = ( count + sizeof(Elem) - 1) 
        / sizeof(Elem);
    BOOST_ASSERT(count <= std::size_t(geofeatures_boost::integer_traits<std::streamsize>::const_max));
