...
private:
    ...
    typedef typename geofeatures_boost::spirit::classic::chset<CharType> chset_t;
    typedef typename geofeatures_boost::spirit::classic::chlit<CharType> chlit_t;
    typedef typename geofeatures_boost::spirit::classic::scanner<
        typename  std::basic_string<CharType>::iterator
    > scanner_t;
    typedef typename geofeatures_boost::spirit::classic::rule<scanner_t> rule_t;
