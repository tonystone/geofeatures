...
class BOOST_SYMBOL_VISIBLE basic_iarchive :
    ...
    public geofeatures_boost::archive::detail::helper_collection
{
    friend class basic_iarchive_impl;
    // hide implementation of this class to minimize header conclusion
    geofeatures_boost::scoped_ptr<basic_iarchive_impl> pimpl;
...
protected:
    ...
    geofeatures_boost::archive::detail::helper_collection &
