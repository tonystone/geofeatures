...
namespace aux {
  ...
  template< typename T1, geofeatures_boost::intmax_t n1, bool n1_is_0
                          , typename T2, geofeatures_boost::intmax_t n2, bool n2_is_0 >
      struct lcm_aux
      ...
      template <typename T1, geofeatures_boost::intmax_t n1, typename T2, geofeatures_boost::intmax_t n2>
      struct lcm_aux<T1, n1, false, T2, n2, true> : integral_c<T2, 0>
      {};

      template <typename T1, geofeatures_boost::intmax_t n1, typename T2, geofeatures_boost::intmax_t n2, bool C>
