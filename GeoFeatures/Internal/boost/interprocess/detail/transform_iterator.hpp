...
{
   public:
   typedef typename ::geofeatures_boost::container::iterator_traits<Iterator>::iterator_category         iterator_category;
   typedef typename ipcdetail::remove_reference<typename UnaryFunction::result_type>::type   value_type;
   typedef typename ::geofeatures_boost::container::iterator_traits<Iterator>::difference_type           difference_type;
   ...
   {  ::geofeatures_boost::container::iterator_advance(m_it, n); }

   difference_type distance_to(const transform_iterator &other)const
   {  return ::geofeatures_boost::container::iterator_distance(other.m_it, m_it); }
};
