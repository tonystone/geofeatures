...
class null_mutex
{
   ...
   //!Equivalent to "return true;"
   bool timed_lock(const geofeatures_boost::posix_time::ptime &)
   {  return true;   }
   ...
   //!Equivalent to "return true;"
   bool timed_lock_sharable(const geofeatures_boost::posix_time::ptime &)
   {  return true;   }
   ...
   //!Equivalent to "return true;"
   bool timed_lock_upgradable(const geofeatures_boost::posix_time::ptime &)
   {  return true;   }
   ...
   //!Equivalent to "return true;"
   bool timed_unlock_upgradable_and_lock(const geofeatures_boost::posix_time::ptime &)
   {  return true;   }
