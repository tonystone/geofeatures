 ...
 * geofeatures_boost::geometric_distribution.  A backwards compatible
 * wrapper is provided in namespace geofeatures_boost.
 * @endxmlwarning
 */
...
public:
    ...
    result_type operator()(Engine& eng) const
    {
        using std::log;
        using std::floor;
        RealType x = RealType(1) - geofeatures_boost::uniform_01<RealType>()(eng);
