...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace type_of {
    ...
    struct encode_size_t : push_back<
        V,
        geofeatures_boost::mpl::size_t<pack<n, false>::value>
    >
    {};
    ...
    struct encode_size_t<V, n, true> : push_back<typename push_back<
        V,
        geofeatures_boost::mpl::size_t<pack<n % 0x3ffffffe, true>::value> >::type,
        geofeatures_boost::mpl::size_t<n / 0x3ffffffe>
    >
    {};
