...
#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace { namespace geofeatures_boost_typeof {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER geofeatures_boost_typeof

#else

#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace type_of {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER geofeatures_boost::type_of
