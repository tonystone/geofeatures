...
public:
    ...
    inline std::size_t hash_code() const BOOST_NOEXCEPT {
        ...
        return geofeatures_boost::hash_range(name_raw, name_raw + std::strlen(name_raw));
    }
...
protected:
    ...
    /// geofeatures_boost::typeindex::type_id() will call this method, if Derived has same type as geofeatures_boost::typeindex::type_index.
    ///
    ...
    /// This is a factory method that is used to create instances of Derived classes.
    /// geofeatures_boost::typeindex::type_id_with_cvr() will call this method, if Derived has same type as geofeatures_boost::typeindex::type_index.
    ///
    /// \b Override: This function \b may be redefined and made public in Derived class. Overrides \b must not throw. 
    ...
    /// This is a factory method that is used to create instances of Derived classes.
    /// geofeatures_boost::typeindex::type_id_runtime(const T&) will call this method, if Derived has same type as geofeatures_boost::typeindex::type_index.
    ///
