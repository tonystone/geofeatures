 ...
 *
 * struct geofeatures_boost::common_type<T,U>
 *
...
{
    typedef geofeatures_boost::mpl::vector8<
...
struct common_type_impl
    : public common_type_dispatch_on_rvalueness<T,U, sizeof( ::geofeatures_boost::detail_type_traits_common_type::rvalue_test(
