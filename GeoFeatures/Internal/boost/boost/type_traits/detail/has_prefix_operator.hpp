...
struct operator_returns_void {
   ...
   BOOST_STATIC_CONSTANT(bool, value = (sizeof(::geofeatures_boost::type_traits::yes_type)==sizeof(returns_void((BOOST_TT_TRAIT_OP make<Rhs>(),returns_void_t())))));
};
...
struct operator_returns_Ret < Rhs, Ret, false > {
   ...
   BOOST_STATIC_CONSTANT(bool, value = (sizeof(is_convertible_to_Ret(BOOST_TT_TRAIT_OP make<Rhs>()))==sizeof(::geofeatures_boost::type_traits::yes_type)));
};
...
struct operator_exists {
   ...
   BOOST_STATIC_CONSTANT(bool, value = (sizeof(s_check(((BOOST_TT_TRAIT_OP make<Rhs>()),make<has_operator>())))==sizeof(::geofeatures_boost::type_traits::yes_type)));
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(BOOST_TT_TRAIT_NAME, Rhs, Ret=::geofeatures_boost::detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME,_impl)::dont_care, (::geofeatures_boost::detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME,_impl)::trait_impl < Rhs, Ret >::value))
