...
struct has_nothrow_assign_imp{
   ...
   BOOST_STATIC_CONSTANT(bool, value = ::geofeatures_boost::has_trivial_assign<T>::value);
#else
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_nothrow_assign,T,::geofeatures_boost::detail::has_nothrow_assign_imp<T>::value)
