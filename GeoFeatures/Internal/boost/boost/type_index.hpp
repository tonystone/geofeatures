...
/// as a geofeatures_boost::typeindex::type_index and geofeatures_boost::typeindex::type_info.
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace typeindex {

#if defined(BOOST_TYPE_INDEX_DOXYGEN_INVOKED)

/// \def BOOST_TYPE_INDEX_FUNCTION_SIGNATURE
/// BOOST_TYPE_INDEX_FUNCTION_SIGNATURE is used by geofeatures_boost::typeindex::ctti_type_index class to
/// deduce the name of a type. If your compiler is not recognized
/// by the TypeIndex library and you wish to work with geofeatures_boost::typeindex::ctti_type_index, you may
...
/// then a compile-time error will arise at any attempt to use geofeatures_boost::typeindex::ctti_type_index classes.
///
...
/// \code geofeatures_boost::typeindex::ctti_type_index::type_id<int>().pretty_name() \endcode
/// returns the following string:
/// \code "static const char *geofeatures_boost::detail::ctti<int>::n() [T = int]" \endcode
/// and \code geofeatures_boost::typeindex::ctti_type_index::type_id<short>().pretty_name() \endcode returns the following:
/// \code "static const char *geofeatures_boost::detail::ctti<short>::n() [T = short]" \endcode
///
/// As we may see first 39 characters are "static const char *geofeatures_boost::detail::ctti<" and they do not depend on
...
/// for `geofeatures_boost::typeindex::ctti_type_index::type_id<int>().pretty_name()` and \code "short>::n() [T = short" \endcode
/// for `geofeatures_boost::typeindex::ctti_type_index::type_id<short>().pretty_name()`.
///
...
#define BOOST_TYPE_INDEX_CTTI_USER_DEFINED_PARSING (0, 0, false, "")
    ...
    /// as a default geofeatures_boost::typeindex::type_index.
    ///
    /// Could be a geofeatures_boost::typeindex::stl_type_index, geofeatures_boost::typeindex::ctti_type_index or 
    /// user defined type_index class.
    ///
    /// \b See geofeatures_boost::typeindex::type_index_facade for a full description of type_index functions.
    typedef platform_specific type_index;
#elif defined(BOOST_TYPE_INDEX_USER_TYPEINDEX)
    // Nothing to do
#elif (!defined(BOOST_NO_RTTI) && !defined(BOOST_TYPE_INDEX_FORCE_NO_RTTI_COMPATIBILITY)) || defined(BOOST_MSVC)
    typedef geofeatures_boost::typeindex::stl_type_index type_index;
#else 
    typedef geofeatures_boost::typeindex::ctti_type_index type_index;
#endif

/// Depending on a compiler flags, optimal implementation of type_info will be used 
/// as a default geofeatures_boost::typeindex::type_info.
///
/// Could be a std::type_info, geofeatures_boost::typeindex::detail::ctti_data or 
...
/// C c1;
/// A* pc1 = &c1;
/// assert(geofeatures_boost::typeindex::type_id<C>() == geofeatures_boost::typeindex::type_id_runtime(*pc1));
/// \endcode
...
/// Function to get geofeatures_boost::typeindex::type_index for a type T.
...
/// \throw Nothing.
/// \return geofeatures_boost::typeindex::type_index with information about the specified type T.
template <class T>
inline type_index type_id() BOOST_NOEXCEPT {
    return type_index::type_id<T>();
}

/// Function for constructing geofeatures_boost::typeindex::type_index instance for type T. 
...
/// Function that works exactly like C++ typeid(rtti_val) call, but returns geofeatures_boost::type_index.
///
...
/// \throw Nothing.
/// \return geofeatures_boost::typeindex::type_index with information about the specified variable.
template <class T>
inline type_index type_id_runtime(const T& runtime_val) BOOST_NOEXCEPT {
    return type_index::type_id_runtime(runtime_val);
}

}} // namespace geofeatures_boost::typeindex
