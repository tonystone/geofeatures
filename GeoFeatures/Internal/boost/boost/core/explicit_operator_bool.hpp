...
#define BOOST_EXPLICIT_OPERATOR_BOOL()\
    BOOST_FORCEINLINE operator geofeatures_boost::detail::unspecified_bool_type () const\
    {\
        return (!this->operator! () ? &geofeatures_boost::detail::unspecified_bool::true_value : (geofeatures_boost::detail::unspecified_bool_type)0);\
    }

#define BOOST_EXPLICIT_OPERATOR_BOOL_NOEXCEPT()\
    BOOST_FORCEINLINE operator geofeatures_boost::detail::unspecified_bool_type () const BOOST_NOEXCEPT\
    {\
        return (!this->operator! () ? &geofeatures_boost::detail::unspecified_bool::true_value : (geofeatures_boost::detail::unspecified_bool_type)0);\
    }

#define BOOST_CONSTEXPR_EXPLICIT_OPERATOR_BOOL()\
    BOOST_FORCEINLINE BOOST_CONSTEXPR operator geofeatures_boost::detail::unspecified_bool_type () const BOOST_NOEXCEPT\
    {\
        return (!this->operator! () ? &geofeatures_boost::detail::unspecified_bool::true_value : (geofeatures_boost::detail::unspecified_bool_type)0);\
    }
