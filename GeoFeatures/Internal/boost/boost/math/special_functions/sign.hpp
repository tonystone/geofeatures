...
namespace detail {
  ...
  // signbit
    ...
    {
       return (geofeatures_boost::math::signbit)(static_cast<double>(x));
    }
    ...
    inline long double (changesign_impl)(long double x, generic_tag<true> const&)
    {
       ...
       pd[0] = geofeatures_boost::math::changesign(pd[0]);
       pd[1] = geofeatures_boost::math::changesign(pd[1]);
       return x;
    }
...
{
   return (z == 0) ? 0 : (geofeatures_boost::math::signbit)(z) ? -1 : 1;
}
   ...
   copysign BOOST_NO_MACRO_EXPAND(const T& x, const U& y)
{
   ...
   return (geofeatures_boost::math::signbit)(static_cast<result_type>(x)) != (geofeatures_boost::math::signbit)(static_cast<result_type>(y)) 
      ? (geofeatures_boost::math::changesign)(static_cast<result_type>(x)) : static_cast<result_type>(x);
}
