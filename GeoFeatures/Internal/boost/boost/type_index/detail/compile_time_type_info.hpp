...
/// \brief Contains helper macros and implementation details of geofeatures_boost::typeindex::ctti_type_index.
...
#define BOOST_TYPE_INDEX_REGISTER_CTTI_PARSING_PARAMS(begin_skip, end_skip, runtime_skip, runtime_skip_until)   \
    namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace typeindex { namespace detail {                                                  \
    ...
    }}} /* namespace geofeatures_boost::typeindex::detail */                                                                \
    /**/  
/// @endcond
...
#   include <boost/preprocessor/facilities/expand.hpp>
    ...
    // sizeof("const char *__cdecl geofeatures_boost::detail::ctti<") - 1, sizeof(">::n(void)") - 1
    ...
    // sizeof("static const char *geofeatures_boost::detail::ctti<") - 1, sizeof("]") - 1, true, "???????????>::n() [T = int"
    ...
    // sizeof("static const char *geofeatures_boost::detail::ctti<") - 1, sizeof(">::n()") - 1
    // note: checked on 3.0
    BOOST_TYPE_INDEX_REGISTER_CTTI_PARSING_PARAMS(39, 6, false, "")
#elif defined(__clang__) && __clang_major__ == 3 && __clang_minor__ > 0
    // sizeof("static const char *geofeatures_boost::detail::ctti<") - 1, sizeof("]") - 1, true, "int>::n() [T = int"
    // note: checked on 3.1, 3.4
    BOOST_TYPE_INDEX_REGISTER_CTTI_PARSING_PARAMS(39, 1, true, "T = ")
#elif defined(__GNUC__)
    // sizeof("static const char* geofeatures_boost::detail::ctti<T>::n() [with T = ") - 1, sizeof("]") - 1
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace typeindex { namespace detail { 
    ...
    inline const char* skip_begining_runtime(const char* begin, geofeatures_boost::mpl::false_) BOOST_NOEXCEPT {
        return begin;
    }

    template <std::size_t ArrayLength>
    inline const char* skip_begining_runtime(const char* begin, geofeatures_boost::mpl::true_) BOOST_NOEXCEPT {
    ...
    inline const char* skip_begining(const char* begin) BOOST_NOEXCEPT {
        ...
        return skip_begining_runtime<ArrayLength - ctti_skip_size_at_begin>(
            ...
            geofeatures_boost::mpl::bool_<ctti_skip_more_at_runtime>()
        );
    }
}}} // namespace geofeatures_boost::typeindex::detail

namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace detail {
...
struct ctti {
    ...
    static const char* n() BOOST_NOEXCEPT {
        ...
        return geofeatures_boost::typeindex::detail::skip_begining< sizeof(BOOST_TYPE_INDEX_FUNCTION_SIGNATURE >(BOOST_TYPE_INDEX_FUNCTION_SIGNATURE);
    #elif defined(__FUNCSIG__)
        return geofeatures_boost::typeindex::detail::skip_begining< sizeof(__FUNCSIG__) >(__FUNCSIG__);
        ...
        return geofeatures_boost::typeindex::detail::skip_begining< sizeof(__PRETTY_FUNCTION__) >(__PRETTY_FUNCTION__);
    #else
        BOOST_STATIC_ASSERT_MSG(
            sizeof(T) && false,
...
}} // namespace geofeatures_boost::detail
