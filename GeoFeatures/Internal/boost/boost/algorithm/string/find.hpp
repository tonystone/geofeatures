...
//  Generic find -----------------------------------------------//
        ...
        */
            ...
            const FinderT& Finder)
        {
            ...
            return Finder(::geofeatures_boost::begin(lit_input),::geofeatures_boost::end(lit_input));
        }
...
//  find_first  -----------------------------------------------//
        ...
        */
        ...
        {
            return ::geofeatures_boost::algorithm::find(Input, ::geofeatures_boost::algorithm::first_finder(Search));
        }
        ...
        */
        ...
        {
            return ::geofeatures_boost::algorithm::find(Input, ::geofeatures_boost::algorithm::first_finder(Search,is_iequal(Loc)));
        }
...
//  find_last  -----------------------------------------------//
        ...
        */
        ...
        find_last( 
            ...
            const Range2T& Search)
        {
            return ::geofeatures_boost::algorithm::find(Input, ::geofeatures_boost::algorithm::last_finder(Search));
        }
        ...
        */
        ...
        ifind_last( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::geofeatures_boost::algorithm::find(Input, ::geofeatures_boost::algorithm::last_finder(Search, is_iequal(Loc)));
        }
...
//  find_nth ----------------------------------------------------------------------//
        ...
        */
        ...
        find_nth( 
            ...
            int Nth)
        {
            return ::geofeatures_boost::algorithm::find(Input, ::geofeatures_boost::algorithm::nth_finder(Search,Nth));
        }
        ...
        */
        ...
        ifind_nth( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::geofeatures_boost::algorithm::find(Input, ::geofeatures_boost::algorithm::nth_finder(Search,Nth,is_iequal(Loc)));
        }
...
//  find_head ----------------------------------------------------------------------//
        ...
        */
        ...
        find_head( 
            ...
            int N)
        {
            return ::geofeatures_boost::algorithm::find(Input, ::geofeatures_boost::algorithm::head_finder(N));
        }
...
//  find_tail ----------------------------------------------------------------------//
        ...
        */
        ...
        find_tail( 
            ...
            int N)
        {
            return ::geofeatures_boost::algorithm::find(Input, ::geofeatures_boost::algorithm::tail_finder(N));
        }
...
//  find_token --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::geofeatures_boost::algorithm::find(Input, ::geofeatures_boost::algorithm::token_finder(Pred, eCompress));
        }
