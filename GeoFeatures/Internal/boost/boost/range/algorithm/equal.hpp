...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost
{
    ...
    namespace range
    {
        ...
        inline bool equal( const SinglePassRange1& rng1, const SinglePassRange2& rng2 )
        {
            ...
            return ::geofeatures_boost::range_detail::equal(
                ::geofeatures_boost::begin(rng1), ::geofeatures_boost::end(rng1),
                ::geofeatures_boost::begin(rng2), ::geofeatures_boost::end(rng2) );
        }
    ...
    using ::geofeatures_boost::range::equal;
