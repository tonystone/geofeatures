    ...
    namespace detail
    {
            ...
            , const CharT opening_brace, const CharT closing_brace) BOOST_NOEXCEPT
        {
            ...
            if (lc_iequal(begin, lc_nan, lc_NAN, 3)) {
                ...
                else value = (geofeatures_boost::math::changesign) (std::numeric_limits<T>::quiet_NaN());
                return true;
            } else if (
                ( /* 'INF' or 'inf' */
             ...
             )
            {
                ...
                else value = (geofeatures_boost::math::changesign) (std::numeric_limits<T>::infinity());
                return true;
            }
                         ...
                         , const CharT* lc_infinity) BOOST_NOEXCEPT
        {
            using namespace std;
            const CharT minus = lcast_char_constants<CharT>::minus;
            if ((geofeatures_boost::math::isnan)(value)) {
                if ((geofeatures_boost::math::signbit)(value)) {
                    *begin = minus;
                    ++ begin;
                }
                ...
                return true;
            } else if ((geofeatures_boost::math::isinf)(value)) {
                if ((geofeatures_boost::math::signbit)(value)) {
                    *begin = minus;
                    ++ begin;
                }
