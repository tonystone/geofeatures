...
#  define BOOST_BIND_VISIT_EACH geofeatures_boost::visit_each
#else
...
public:
    ...
    A1 operator[] (geofeatures_boost::arg<1>) const { return base_type::a1_; }
...
public:
    ...
    A1 operator[] (geofeatures_boost::arg<1>) const { return base_type::a1_; }
    A2 operator[] (geofeatures_boost::arg<2>) const { return base_type::a2_; }
...
public:
    ...
    A1 operator[] (geofeatures_boost::arg<1>) const { return base_type::a1_; }
    A2 operator[] (geofeatures_boost::arg<2>) const { return base_type::a2_; }
    A3 operator[] (geofeatures_boost::arg<3>) const { return base_type::a3_; }
...
public:
    ...
    A2 operator[] (geofeatures_boost::arg<2>) const { return base_type::a2_; }
    A3 operator[] (geofeatures_boost::arg<3>) const { return base_type::a3_; }
    A4 operator[] (geofeatures_boost::arg<4>) const { return base_type::a4_; }
...
public:
    ...
    A3 operator[] (geofeatures_boost::arg<3>) const { return base_type::a3_; }
    A4 operator[] (geofeatures_boost::arg<4>) const { return base_type::a4_; }
    A5 operator[] (geofeatures_boost::arg<5>) const { return base_type::a5_; }
...
public:
    ...
    A4 operator[] (geofeatures_boost::arg<4>) const { return base_type::a4_; }
    A5 operator[] (geofeatures_boost::arg<5>) const { return base_type::a5_; }
    A6 operator[] (geofeatures_boost::arg<6>) const { return base_type::a6_; }
...
public:
    ...
    A5 operator[] (geofeatures_boost::arg<5>) const { return base_type::a5_; }
    A6 operator[] (geofeatures_boost::arg<6>) const { return base_type::a6_; }
    A7 operator[] (geofeatures_boost::arg<7>) const { return base_type::a7_; }
...
public:
    ...
    A6 operator[] (geofeatures_boost::arg<6>) const { return base_type::a6_; }
    A7 operator[] (geofeatures_boost::arg<7>) const { return base_type::a7_; }
    A8 operator[] (geofeatures_boost::arg<8>) const { return base_type::a8_; }
...
public:
    ...
    A7 operator[] (geofeatures_boost::arg<7>) const { return base_type::a7_; }
    A8 operator[] (geofeatures_boost::arg<8>) const { return base_type::a8_; }
    A9 operator[] (geofeatures_boost::arg<9>) const { return base_type::a9_; }
...
public:
    ...
    template<class V> void accept( V & v ) const
    {
        ...
        using geofeatures_boost::visit_each;
#endif
...
{
    typedef geofeatures_boost::arg<I> type;
};
...
template<class T> struct add_value
{
    typedef typename add_value_2< T, geofeatures_boost::is_placeholder< T >::value >::type type;
};
...
template<class R, class F>
    _bi::bind_t<R, F, _bi::list0>
    BOOST_BIND(geofeatures_boost::type<R>, F f)
{
    typedef _bi::list0 list_type;
    return _bi::bind_t<R, F, list_type> (f, list_type());
}
...
template<class R, class F, class A1>
    _bi::bind_t<R, F, typename _bi::list_av_1<A1>::type>
    BOOST_BIND(geofeatures_boost::type<R>, F f, A1 a1)
{
    typedef typename _bi::list_av_1<A1>::type list_type;
    return _bi::bind_t<R, F, list_type> (f, list_type(a1));
}
...
template<class R, class F, class A1, class A2>
    _bi::bind_t<R, F, typename _bi::list_av_2<A1, A2>::type>
    BOOST_BIND(geofeatures_boost::type<R>, F f, A1 a1, A2 a2)
{
    typedef typename _bi::list_av_2<A1, A2>::type list_type;
    return _bi::bind_t<R, F, list_type> (f, list_type(a1, a2));
}
...
template<class R, class F, class A1, class A2, class A3>
    _bi::bind_t<R, F, typename _bi::list_av_3<A1, A2, A3>::type>
    BOOST_BIND(geofeatures_boost::type<R>, F f, A1 a1, A2 a2, A3 a3)
{
    typedef typename _bi::list_av_3<A1, A2, A3>::type list_type;
    return _bi::bind_t<R, F, list_type>(f, list_type(a1, a2, a3));
}
...
template<class R, class F, class A1, class A2, class A3, class A4>
    _bi::bind_t<R, F, typename _bi::list_av_4<A1, A2, A3, A4>::type>
    BOOST_BIND(geofeatures_boost::type<R>, F f, A1 a1, A2 a2, A3 a3, A4 a4)
{
    typedef typename _bi::list_av_4<A1, A2, A3, A4>::type list_type;
    return _bi::bind_t<R, F, list_type>(f, list_type(a1, a2, a3, a4));
}
...
template<class R, class F, class A1, class A2, class A3, class A4, class A5>
    _bi::bind_t<R, F, typename _bi::list_av_5<A1, A2, A3, A4, A5>::type>
    BOOST_BIND(geofeatures_boost::type<R>, F f, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5)
{
    typedef typename _bi::list_av_5<A1, A2, A3, A4, A5>::type list_type;
    return _bi::bind_t<R, F, list_type>(f, list_type(a1, a2, a3, a4, a5));
}
...
template<class R, class F, class A1, class A2, class A3, class A4, class A5, class A6>
    _bi::bind_t<R, F, typename _bi::list_av_6<A1, A2, A3, A4, A5, A6>::type>
    BOOST_BIND(geofeatures_boost::type<R>, F f, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6)
{
    typedef typename _bi::list_av_6<A1, A2, A3, A4, A5, A6>::type list_type;
    return _bi::bind_t<R, F, list_type>(f, list_type(a1, a2, a3, a4, a5, a6));
}
...
template<class R, class F, class A1, class A2, class A3, class A4, class A5, class A6, class A7>
    _bi::bind_t<R, F, typename _bi::list_av_7<A1, A2, A3, A4, A5, A6, A7>::type>
    BOOST_BIND(geofeatures_boost::type<R>, F f, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7)
{
    typedef typename _bi::list_av_7<A1, A2, A3, A4, A5, A6, A7>::type list_type;
    return _bi::bind_t<R, F, list_type>(f, list_type(a1, a2, a3, a4, a5, a6, a7));
}
...
template<class R, class F, class A1, class A2, class A3, class A4, class A5, class A6, class A7, class A8>
    _bi::bind_t<R, F, typename _bi::list_av_8<A1, A2, A3, A4, A5, A6, A7, A8>::type>
    BOOST_BIND(geofeatures_boost::type<R>, F f, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8)
{
    typedef typename _bi::list_av_8<A1, A2, A3, A4, A5, A6, A7, A8>::type list_type;
    return _bi::bind_t<R, F, list_type>(f, list_type(a1, a2, a3, a4, a5, a6, a7, a8));
}
...
template<class R, class F, class A1, class A2, class A3, class A4, class A5, class A6, class A7, class A8, class A9>
    _bi::bind_t<R, F, typename _bi::list_av_9<A1, A2, A3, A4, A5, A6, A7, A8, A9>::type>
    BOOST_BIND(geofeatures_boost::type<R>, F f, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9)
{
    typedef typename _bi::list_av_9<A1, A2, A3, A4, A5, A6, A7, A8, A9>::type list_type;
    return _bi::bind_t<R, F, list_type>(f, list_type(a1, a2, a3, a4, a5, a6, a7, a8, a9));
}
