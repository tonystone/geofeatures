...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost {
    namespace detail {
        typedef geofeatures_boost::true_type  ms_is_trivial;
        typedef geofeatures_boost::false_type ms_no_trivial;
        ...
        inline void ms_destroy(T* memory, std::size_t size) {
            geofeatures_boost::has_trivial_destructor<T> trivial;
        ...
        inline void ms_init(T* memory, std::size_t size) {
            geofeatures_boost::has_trivial_default_constructor<T> trivial;
