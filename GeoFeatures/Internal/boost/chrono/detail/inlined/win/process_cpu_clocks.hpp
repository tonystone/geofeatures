...
process_user_cpu_clock::time_point process_user_cpu_clock::now() BOOST_NOEXCEPT
{
    ...
    if ( geofeatures_boost::detail::winapi::GetProcessTimes(
            geofeatures_boost::detail::winapi::GetCurrentProcess(), &creation, &exit,
        ...
        system::error_code & ec)
{
    ...
    {
        geofeatures_boost::detail::winapi::DWORD_ cause = geofeatures_boost::detail::winapi::GetLastError();
        if (BOOST_CHRONO_IS_THROWS(ec))
        {
            geofeatures_boost::throw_exception(
                    system::system_error(
