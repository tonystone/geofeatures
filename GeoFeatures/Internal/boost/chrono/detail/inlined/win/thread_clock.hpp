...
thread_clock::time_point thread_clock::now( system::error_code & ec )
{
    ...
    geofeatures_boost::detail::winapi::FILETIME_ creation, exit, user_time, system_time;

    if ( geofeatures_boost::detail::winapi::GetThreadTimes(
            geofeatures_boost::detail::winapi::GetCurrentThread (), &creation, &exit,
    ...
    else
    {
        ...
        {
            ec.assign( geofeatures_boost::detail::winapi::GetLastError(), BOOST_CHRONO_SYSTEM_CATEGORY );
