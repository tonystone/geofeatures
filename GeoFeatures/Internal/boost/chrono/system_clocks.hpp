...
# define BOOST_SYSTEM_CLOCK_DURATION geofeatures_boost::chrono::duration<geofeatures_boost::int_least64_t, ratio<BOOST_RATIO_INTMAX_C(1), BOOST_RATIO_INTMAX_C(10000000)> >
#else
# define BOOST_SYSTEM_CLOCK_DURATION geofeatures_boost::chrono::nanoseconds
#endif
