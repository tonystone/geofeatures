...
public:
  ...
  typedef typename
    geofeatures_boost::reverse_iterator<iterator>                 reverse_iterator;
  typedef typename
    geofeatures_boost::reverse_iterator<const_iterator>           const_reverse_iterator;
...
public:
  ...
  reverse_iterator
    rbegin()BOOST_NOEXCEPT{return geofeatures_boost::make_reverse_iterator(end());}
  const_reverse_iterator
    rbegin()const BOOST_NOEXCEPT{return geofeatures_boost::make_reverse_iterator(end());}
  reverse_iterator
    rend()BOOST_NOEXCEPT{return geofeatures_boost::make_reverse_iterator(begin());}
  const_reverse_iterator
    rend()const BOOST_NOEXCEPT{return geofeatures_boost::make_reverse_iterator(begin());}
  const_iterator
  ...
  std::pair<iterator,bool> push_front(BOOST_RV_REF(value_type) x)
                             {return insert(begin(),geofeatures_boost::move(x));}
  ...
  std::pair<iterator,bool> push_back(BOOST_RV_REF(value_type) x)
                             {return insert(end(),geofeatures_boost::move(x));}
  ...
  void remove(value_param_type value)
  {
    sequenced_index_remove(
      *this,
      ::geofeatures_boost::bind(std::equal_to<value_type>(),::geofeatures_boost::arg<1>(),value));
  }
...
BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
  ...
  {
    lm.load(
      ::geofeatures_boost::bind(
        &sequenced_index::rearranger,this,::geofeatures_boost::arg<1>(),::geofeatures_boost::arg<2>()),
      ar,version);
  ...
  /* This forwarding function eases things for the geofeatures_boost::mem_fn construct
...
template<typename SuperMeta,typename TagList>
inline geofeatures_boost::mpl::true_* boost_foreach_is_noncopyable(
  geofeatures_boost::multi_index::detail::sequenced_index<SuperMeta,TagList>*&,
  geofeatures_boost::foreach::tag)
{
  return 0;
}
