...
struct range_is_empty
{
    ...
    {
        return geofeatures_boost::empty(range);
    }
};
...
class polygon_is_empty
{
    ...
    static inline bool check_interior_rings(InteriorRings const& interior_rings)
    {
        return check_iterator_range
            ...
            >::apply(geofeatures_boost::begin(interior_rings), geofeatures_boost::end(interior_rings));
    }
...
public:
    ...
    {
        return geofeatures_boost::empty(exterior_ring(polygon))
...
struct multi_is_empty
{
    ...
    static inline bool apply(MultiGeometry const& multigeometry)
    {
        return check_iterator_range
            ...
            >::apply(geofeatures_boost::begin(multigeometry), geofeatures_boost::end(multigeometry));
    }
...
struct is_empty<geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{
