...
struct intersection_multi_linestring_multi_linestring_point
{
            ...
            Strategy const& strategy)
    {
        ...
        for (typename geofeatures_boost::range_iterator
                ...
                >::type it1 = geofeatures_boost::begin(ml1);
            it1 != geofeatures_boost::end(ml1);
            ++it1)
        {
            for (typename geofeatures_boost::range_iterator
                    <
                        MultiLinestring2 const
                    >::type it2 = geofeatures_boost::begin(ml2);
                it2 != geofeatures_boost::end(ml2);
                ++it2)
            {
...
struct intersection_linestring_multi_linestring_point
{
            ...
            Strategy const& strategy)
    {
        for (typename geofeatures_boost::range_iterator
                ...
                >::type it = geofeatures_boost::begin(ml);
            it != geofeatures_boost::end(ml);
            ++it)
        {
            out = intersection_linestring_linestring_point<PointOut>
...
struct clip_multi_linestring
{
            ...
            OutputIterator out, Strategy const& )
    {
        ...
        for (typename geofeatures_boost::range_iterator<MultiLinestring const>::type it
            = geofeatures_boost::begin(multi_linestring);
            it != geofeatures_boost::end(multi_linestring); ++it)
        {
