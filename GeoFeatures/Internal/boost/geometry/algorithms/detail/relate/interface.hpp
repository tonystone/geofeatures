...
struct is_supported_by_generic
{
    static const bool value
        = geofeatures_boost::is_same<Tag, linestring_tag>::value
       || geofeatures_boost::is_same<Tag, multi_linestring_tag>::value
       || geofeatures_boost::is_same<Tag, ring_tag>::value
       || geofeatures_boost::is_same<Tag, polygon_tag>::value
       || geofeatures_boost::is_same<Tag, multi_polygon_tag>::value;
};
...
template <typename Geometry1,
          typename Geometry2,
          typename Result,
          bool IsSequence = geofeatures_boost::mpl::is_sequence<Result>::value>
...
struct result_handler_type<Geometry1, Geometry2, geofeatures_boost::tuples::cons<Head, Tail>, false>
{
    typedef mask_handler
        <
...
struct relate<geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Geometry2>
{
    template <typename Mask>
    ...
    apply(geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& geometry1,
          ...
          Mask const& mask)
    {
        return geofeatures_boost::apply_visitor(visitor<Mask>(geometry2, mask), geometry1);
    }
};

template <typename Geometry1, BOOST_VARIANT_ENUM_PARAMS(typename T)>
struct relate<Geometry1, geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{
    template <typename Mask>
    struct visitor : geofeatures_boost::static_visitor<bool>
    {
    ...
    apply(Geometry1 const& geometry1,
          ...
          Mask const& mask)
    {
        return geofeatures_boost::apply_visitor(visitor<Mask>(geometry1, mask), geometry2);
    }
};
...
>
struct relate<
    geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T1)>,
...
>
{
    ...
    apply(geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T1)> const& geometry1,
          ...
          Mask const& mask)
    {
        return geofeatures_boost::apply_visitor(visitor<Mask>(mask), geometry1, geometry2);
    }
};
