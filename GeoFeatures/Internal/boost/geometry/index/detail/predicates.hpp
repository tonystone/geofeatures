...
struct satisfies
    : satisfies_impl<Fun, ::geofeatures_boost::is_function<Fun>::value>
{
    typedef satisfies_impl<Fun, ::geofeatures_boost::is_function<Fun>::value> base;
...
//struct predicates_length< geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >
//{
//    static const unsigned value = geofeatures_boost::tuples::length< geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >::value;
//};

template <typename Head, typename Tail>
struct predicates_length< geofeatures_boost::tuples::cons<Head, Tail> >
{
    static const unsigned value = geofeatures_boost::tuples::length< geofeatures_boost::tuples::cons<Head, Tail> >::value;
};
...
//struct predicates_element< I, geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >
//{
//    typedef geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> predicate_type;
//
//    typedef typename geofeatures_boost::tuples::element<I, predicate_type>::type type;
//    static type const& get(predicate_type const& p) { return geofeatures_boost::get<I>(p); }
//};

template <unsigned I, typename Head, typename Tail>
struct predicates_element< I, geofeatures_boost::tuples::cons<Head, Tail> >
{
    typedef geofeatures_boost::tuples::cons<Head, Tail> predicate_type;
...
struct predicates_check_tuple
{
    ...
    static inline bool apply(TuplePredicates const& p, Value const& v, Indexable const& i)
    {
        return
        predicate_check<
            typename geofeatures_boost::tuples::element<First, TuplePredicates>::type,
            Tag
        >::apply(geofeatures_boost::get<First>(p), v, i) &&
...
//>
//struct predicates_check_impl<
//    geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>,
//    Tag, First, Last
//>
//{
//    typedef geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> predicates_type;
//
//    static const unsigned pred_len = geofeatures_boost::tuples::length<predicates_type>::value;
...
struct predicates_check_impl<
    geofeatures_boost::tuples::cons<Head, Tail>,
    Tag, First, Last
>
{
    typedef geofeatures_boost::tuples::cons<Head, Tail> predicates_type;
...
struct predicates_count_distance_tuple
{
    static const unsigned value =
        predicates_is_distance<typename geofeatures_boost::tuples::element<N-1, Tuple>::type>::value
...
{
    static const unsigned value =
        predicates_is_distance<typename geofeatures_boost::tuples::element<0, Tuple>::type>::value;
};

//template <typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9>
//struct predicates_count_distance< geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >
//{
//    static const unsigned value = predicates_count_distance_tuple<
//        geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>,
//        geofeatures_boost::tuples::length< geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >::value
//    >::value;
//};

template <typename Head, typename Tail>
struct predicates_count_distance< geofeatures_boost::tuples::cons<Head, Tail> >
{
    static const unsigned value = predicates_count_distance_tuple<
        geofeatures_boost::tuples::cons<Head, Tail>,
        geofeatures_boost::tuples::length< geofeatures_boost::tuples::cons<Head, Tail> >::value
    >::value;
};
...
struct predicates_find_distance_tuple
{
    ...
    static const unsigned value = predicates_find_distance_tuple<Tuple, N-1>::is_found ?
        ...
        (predicates_is_distance<typename geofeatures_boost::tuples::element<N-1, Tuple>::type>::value ?
            N-1 : geofeatures_boost::tuples::length<Tuple>::value);
};

template <typename Tuple>
struct predicates_find_distance_tuple<Tuple, 1>
{
    static const bool is_found = predicates_is_distance<typename geofeatures_boost::tuples::element<0, Tuple>::type>::value;
    static const unsigned value = is_found ? 0 : geofeatures_boost::tuples::length<Tuple>::value;
};

//template <typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9>
//struct predicates_find_distance< geofeatures_boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >
//{
...
template <typename Head, typename Tail>
struct predicates_find_distance< geofeatures_boost::tuples::cons<Head, Tail> >
{
    static const unsigned value = predicates_find_distance_tuple<
        geofeatures_boost::tuples::cons<Head, Tail>,
        geofeatures_boost::tuples::length< geofeatures_boost::tuples::cons<Head, Tail> >::value
