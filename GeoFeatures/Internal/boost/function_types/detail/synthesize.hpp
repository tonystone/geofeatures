...
struct synthesize_impl
  : detail::synthesize_impl_o
    < ::geofeatures_boost::function_types::detail::decode_bits<Bits>::flags
    , ::geofeatures_boost::function_types::detail::decode_bits<Bits>::cc_id
    , ::geofeatures_boost::mpl::size<Seq>::value
    >
...
struct synthesize_func
  : detail::synthesize_impl
    < Seq
    , ::geofeatures_boost::function_types::detail::bits
