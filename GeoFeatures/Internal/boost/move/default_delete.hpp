...
namespace bmupmu = ::geofeatures_boost::move_upmu;
...
namespace bmupd = geofeatures_boost::move_upd;
namespace bmupmu = ::geofeatures_boost::move_upmu;
...
struct default_delete
{
      ...
      ) BOOST_NOEXCEPT
   {
      ...
      BOOST_STATIC_ASSERT(( !::geofeatures_boost::move_upmu::missing_virtual_destructor<default_delete, U>::value ));
   }
