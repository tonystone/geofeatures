...
namespace detail {
  ...
  class BOOST_MPI_DECL mpi_datatype_holder : public geofeatures_boost::noncopyable
  {
  public:
    mpi_datatype_holder()
     : is_committed(false)
...
private:
  geofeatures_boost::shared_ptr<detail::mpi_datatype_holder> holder;
};
...
public:
  ...
  packed_skeleton_iarchive(MPI_Comm const & comm,
                           unsigned int flags =  geofeatures_boost::archive::no_header)
  ...
  explicit packed_skeleton_iarchive(packed_iarchive & archive)
         ...
         , skeleton_archive_(MPI_COMM_WORLD, geofeatures_boost::archive::no_header)
        {}
...
namespace detail {
  typedef geofeatures_boost::mpi::detail::forward_skeleton_oarchive<geofeatures_boost::mpi::packed_skeleton_oarchive,geofeatures_boost::mpi::packed_oarchive> type1;
  typedef geofeatures_boost::mpi::detail::forward_skeleton_iarchive<geofeatures_boost::mpi::packed_skeleton_iarchive,geofeatures_boost::mpi::packed_iarchive> type2;
}
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(geofeatures_boost::mpi::packed_skeleton_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(geofeatures_boost::mpi::packed_skeleton_iarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(geofeatures_boost::mpi::detail::type1)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(geofeatures_boost::mpi::detail::type2)

BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(geofeatures_boost::mpi::packed_skeleton_oarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(geofeatures_boost::mpi::packed_skeleton_iarchive)
