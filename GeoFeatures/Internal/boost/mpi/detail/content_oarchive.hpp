...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(geofeatures_boost::mpi::detail::content_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(geofeatures_boost::mpi::detail::ignore_skeleton_oarchive<geofeatures_boost::mpi::detail::content_oarchive>)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(geofeatures_boost::mpi::detail::content_oarchive)
