...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace python { namespace api {    \
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace python { namespace detail {                 \
template<>                                                              \
...
namespace detail {
  ...
  {
  public:
    typedef geofeatures_boost::function3<void, OArchiver&, const object&, const unsigned int>
      saver_t;
    typedef geofeatures_boost::function3<void, IArchiver&, object&, const unsigned int>
      loader_t;
...
void 
save_impl(Archiver& ar, const geofeatures_boost::python::object& obj, 
          const unsigned int /*version*/,
          mpl::false_ /*has_direct_serialization*/)
{
  geofeatures_boost::python::str py_string = geofeatures_boost::python::pickle::dumps(obj);
  int len = geofeatures_boost::python::extract<int>(py_string.attr("__len__")());
  const char* string = geofeatures_boost::python::extract<const char*>(py_string);
  ar << len << geofeatures_boost::serialization::make_array(string, len);
}
...
template<typename Archiver>
void 
load_impl(Archiver& ar, geofeatures_boost::python::object& obj, 
          const unsigned int /*version*/, 
          mpl::false_ /*has_direct_serialization*/)
{
  int len;
  ...
  ar >> geofeatures_boost::serialization::make_array(string.get(), len);
  geofeatures_boost::python::str py_string(string.get(), len);
  obj = geofeatures_boost::python::pickle::loads(py_string);
}
...
template<typename Archiver>
void 
save(Archiver& ar, const geofeatures_boost::python::object& obj, 
     const unsigned int version)
{
  typedef Archiver OArchiver;
  typedef typename input_archiver<OArchiver>::type IArchiver;
...
template<typename Archiver>
void 
load(Archiver& ar, geofeatures_boost::python::object& obj, 
     const unsigned int version)
{
  typedef Archiver IArchiver;
  typedef typename output_archiver<IArchiver>::type OArchiver;
...
inline void 
serialize(Archive& ar, geofeatures_boost::python::object& obj, const unsigned int version)
{
  geofeatures_boost::serialization::split_free(ar, obj, version);
}

} } // end namespace geofeatures_boost::python
...
BOOST_PYTHON_DIRECT_SERIALIZATION_ARCHIVE(
  ::geofeatures_boost::mpi::packed_iarchive,
  ::geofeatures_boost::mpi::packed_oarchive)

namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace mpi { namespace python {

template<typename T>
void
register_serialized(const T& value, PyTypeObject* type)
{
  using geofeatures_boost::python::register_serialized;
  register_serialized<packed_iarchive, packed_oarchive>(value, type);
}

} } } // end namespace geofeatures_boost::mpi::python
