...
unit_test_main( init_unit_test_func init_func, int argc, char* argv[] )
{
    ...
    BOOST_TEST_IMPL_TRY {
        ...
        if( runtime_config::list_content() != unit_test::OF_INVALID ) {
            ...
            return geofeatures_boost::exit_success;
        }
...
main( int argc, char* argv[] )
{
    ...
    geofeatures_boost::unit_test::init_unit_test_func init_func = &init_unit_test;
#else
    extern ::geofeatures_boost::unit_test::test_suite* init_unit_test_suite( int argc, char* argv[] );

    geofeatures_boost::unit_test::init_unit_test_func init_func = &init_unit_test_suite;
#endif

    return ::geofeatures_boost::unit_test::unit_test_main( init_func, argc, argv );
}
