...
namespace rt  = geofeatures_boost::runtime;
...
retrieve_parameter( const_string parameter_name, cla::parser const& s_cla_parser, T const& default_value = T(), T const& optional_value = T() )
{
    ...
    geofeatures_boost::optional<T> v;
...
detect_memory_leaks()
{
    ...
    if( runtime::interpret_argument_value_impl<bool>::_( value, bool_val ) )
        ...
        BOOST_TEST_IMPL_TRY {
            ...
            s_value = geofeatures_boost::lexical_cast<long>( value );
        }
        BOOST_TEST_IMPL_CATCH0( geofeatures_boost::bad_lexical_cast ) {
