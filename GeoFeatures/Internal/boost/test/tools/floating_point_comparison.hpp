...
template<typename FPT>
struct fpt_limits : geofeatures_boost::conditional<std::numeric_limits<FPT>::is_specialized,
 ...
 * by the @ref geofeatures_boost::math::fpc::strength given at construction.
 */
template<typename FPT>
 ...
 *
 * Serves the same purpose as geofeatures_boost::math::fpc::close_at_tolerance, but used when one
