...
template<typename T>
struct is_named_params : public geofeatures_boost::mpl::false_ {};

template<typename T, typename unique_id, typename ReferenceType>
struct is_named_params<named_parameter<T,unique_id,ReferenceType> > : public geofeatures_boost::mpl::true_ {};

template<typename NP, typename Rest>
struct is_named_params<nfp_detail::named_parameter_combine<NP,Rest> > : public geofeatures_boost::mpl::true_ {};
...
struct param_type<named_parameter<T,unique_id,ReferenceType>,keyword<unique_id,required>,DefaultType> {
    typedef typename geofeatures_boost::remove_cv<T>::type type;
};
