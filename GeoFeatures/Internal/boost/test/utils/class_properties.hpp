...
public:
    ...
    // access methods
    arrow_res_t     operator->() const      { return geofeatures_boost::addressof( base_prop::value ); }
};
...
#define BOOST_READONLY_PROPERTY( property_type, friends ) geofeatures_boost::unit_test::readwrite_property<property_type >
...
: public geofeatures_boost::unit_test::readonly_property<property_type > {                      \
    typedef geofeatures_boost::unit_test::readonly_property<property_type > base_prop;          \
...
public:
    ...
    arrow_res_t     operator->()            { return geofeatures_boost::addressof( base_prop::value ); }
    const_arrow_res_t operator->() const    { return geofeatures_boost::addressof( base_prop::value ); }
