...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace python { namespace numeric {
...
} // namespace geofeatures_boost::python::numeric
