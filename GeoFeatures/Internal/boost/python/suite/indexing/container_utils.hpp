...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace python { namespace container_utils {
    ...
    extend_container(Container& container, object l)
    {
        ...
        BOOST_FOREACH(object elem,
            std::make_pair(
              geofeatures_boost::python::stl_input_iterator<object>(l),
              geofeatures_boost::python::stl_input_iterator<object>()
              ))
        {
...
}}} // namespace geofeatures_boost::python::container_utils
