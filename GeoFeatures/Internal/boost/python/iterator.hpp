...
namespace detail
{
  ...
  )
  {
      return objects::make_iterator_function<Target>(
          geofeatures_boost::protect(geofeatures_boost::bind(get_start, _1))
        , geofeatures_boost::protect(geofeatures_boost::bind(get_finish, _1))
        , next_policies
      );
  }
...
object range(Accessor1 start, Accessor2 finish, NextPolicies* = 0, geofeatures_boost::type<Target>* = 0)
{
