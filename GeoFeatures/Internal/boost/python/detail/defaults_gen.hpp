...
#define BOOST_PYTHON_TYPEDEF_GEN(z, index, data)                                \
    typedef typename ::geofeatures_boost::mpl::next<BOOST_PP_CAT(iter, index)>::type        \
        BOOST_PP_CAT(iter, BOOST_PP_INC(index));                                \
    typedef typename ::geofeatures_boost::mpl::deref<BOOST_PP_CAT(iter, index)>::type       \
...
#define BOOST_PYTHON_GEN_FUNCTION(fname, fstubs_name, n_args, n_dflts, ret)     \
    ...
    {                                                                           \
        ...
        struct gen                                                              \
        {                                                                       \
            typedef typename ::geofeatures_boost::mpl::begin<SigT>::type rt_iter;           \
            typedef typename ::geofeatures_boost::mpl::deref<rt_iter>::type RT;             \
            typedef typename ::geofeatures_boost::mpl::next<rt_iter>::type iter0;           \
                                                                                \
            BOOST_PP_REPEAT_2ND(                                                \
                n_args,                                                         \
...
#define BOOST_PYTHON_GEN_MEM_FUNCTION(fname, fstubs_name, n_args, n_dflts, ret) \
    ...
    {                                                                           \
        ...
        {                                                                       \
            ...
            typedef typename ::geofeatures_boost::mpl::deref<rt_iter>::type RT;             \
                                                                                \
            typedef typename ::geofeatures_boost::mpl::next<rt_iter>::type class_iter;      \
            typedef typename ::geofeatures_boost::mpl::deref<class_iter>::type ClassT;      \
            typedef typename ::geofeatures_boost::mpl::next<class_iter>::type iter0;        \
                                                                                \
            BOOST_PP_REPEAT_2ND(                                                \
                n_args,                                                         \
                BOOST_PYTHON_TYPEDEF_GEN,                                       \
...
#define BOOST_PYTHON_OVERLOAD_CONSTRUCTORS(fstubs_name, n_args, n_dflts)                    \
    fstubs_name(char const* doc = 0)                                                        \
        : ::geofeatures_boost::python::detail::overloads_common<fstubs_name>(doc) {}                    \
    template <std::size_t N>                                                                \
    fstubs_name(char const* doc, ::geofeatures_boost::python::detail::keywords<N> const& keywords)      \
        : ::geofeatures_boost::python::detail::overloads_common<fstubs_name>(                           \
            doc, keywords.range())                                                          \
    {                                                                                       \
        typedef typename ::geofeatures_boost::python::detail::                                          \
            error::more_keywords_than_function_arguments<                                   \
                N,n_args>::too_many_keywords assertion;                                     \
    }                                                                                       \
    template <std::size_t N>                                                                \
    fstubs_name(::geofeatures_boost::python::detail::keywords<N> const& keywords, char const* doc = 0)  \
        : ::geofeatures_boost::python::detail::overloads_common<fstubs_name>(                           \
            doc, keywords.range())                                                          \
    {                                                                                       \
        typedef typename ::geofeatures_boost::python::detail::                                          \
...
#  define BOOST_PYTHON_GEN_FUNCTION_STUB(fname, fstubs_name, n_args, n_dflts)   \
    struct fstubs_name                                                          \
        : public ::geofeatures_boost::python::detail::overloads_common<fstubs_name>         \
    {                                                                           \
...
//          : public geofeatures_boost::python::detail::overloads_common<foo_overloads>
//      {
...
//             : geofeatures_boost::python::detail::overloads_common<foo_overloads>(doc) {}
//      };
//
