...
# else
#  define BOOST_PYTHON_BEGIN_CONVERSION_NAMESPACE namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace python {
#  define BOOST_PYTHON_END_CONVERSION_NAMESPACE }} // namespace geofeatures_boost::python
#  define BOOST_PYTHON_CONVERSION geofeatures_boost::python
...
//
#define BOOST_LIB_NAME geofeatures_boost_python
//
