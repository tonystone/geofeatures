...
namespace geofeatures_boost_132 {
...
public:
    ...
    friend void geofeatures_boost::serialization::load(
        Archive & ar,
        SPT< U > &t,
        const unsigned int file_version
    );
    ...
    std::list<geofeatures_boost_132::shared_ptr<const void> > * m_pointers_132;
    BOOST_ARCHIVE_DECL void
    append(const geofeatures_boost_132::shared_ptr<const void> & t){
        if(NULL == m_pointers_132)
            m_pointers_132 = new std::list<geofeatures_boost_132::shared_ptr<const void> >;
    ...
    struct non_polymorphic {
        template<class U>
        static const geofeatures_boost::serialization::extended_type_info * 
        get_object_type(U & ){
            return & geofeatures_boost::serialization::singleton<
                typename 
                geofeatures_boost::serialization::type_info_implementation< U >::type
            >::get_const_instance();
        }
    };
    struct polymorphic {
...
public:
    ...
    void reset(SPT< T > & s, T * t){
        ...
        const geofeatures_boost::serialization::extended_type_info * this_type
        ...
        if(NULL == true_type)
            geofeatures_boost::serialization::throw_exception(
                geofeatures_boost::archive::archive_exception(
                    geofeatures_boost::archive::archive_exception::unregistered_class,
        ...
        if(NULL == oid)
            geofeatures_boost::serialization::throw_exception(
                geofeatures_boost::archive::archive_exception(
                    geofeatures_boost::archive::archive_exception::unregistered_cast,
