...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace unordered { namespace detail {

    ////////////////////////////////////////////////////////////////////////////
    // Bits and pieces for implementing traits

    template <typename T> typename geofeatures_boost::add_lvalue_reference<T>::type make();
...
#define BOOST_UNORDERED_EMPLACE_FORWARD geofeatures_boost::forward<Args>(args)...
...
#define BOOST_UNORDERED_CALL_FORWARD(z, i, a) \
    geofeatures_boost::forward<BOOST_PP_CAT(A,i)>(BOOST_PP_CAT(a,i))
...
#define BOOST_UNORDERED_EARGS_INIT(z, n, _)                                 \
    BOOST_PP_CAT(a, n)(                                                     \
        geofeatures_boost::forward<BOOST_PP_CAT(A,n)>(BOOST_PP_CAT(b, n)))

#else

#define BOOST_UNORDERED_EARGS_MEMBER(z, n, _)                               \
    typedef typename geofeatures_boost::add_lvalue_reference<BOOST_PP_CAT(A, n)>::type  \
        BOOST_PP_CAT(Arg, n);                                               \
    BOOST_PP_CAT(Arg, n) BOOST_PP_CAT(a, n);
...
// 2 = geofeatures_boost::container::allocator_traits
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace unordered { namespace detail {
    ...
    typedef geofeatures_boost::unordered::detail::integral_constant<bool, true> true_type;
    typedef geofeatures_boost::unordered::detail::integral_constant<bool, false> false_type;
...
#   define BOOST_UNORDERED_CHECK_EXPRESSION(count, result, expression)      \
        template <typename U>                                               \
        static typename geofeatures_boost::unordered::detail::expr_test<                \
...
#   define BOOST_UNORDERED_HAS_FUNCTION(name, thing, args, _)               \
    ...
    {                                                                       \
        ...
        BOOST_UNORDERED_CHECK_EXPRESSION(1, 1,                              \
            geofeatures_boost::unordered::detail::make< thing >().name args);           \
...
#   define BOOST_UNORDERED_CHECK_MEMBER(count, result, name, member)        \
                                                                            \
    typedef typename geofeatures_boost::unordered::detail::identity<member>::type       \
...
#       define BOOST_UNORDERED_DEFAULT_TYPE_TMPLT(tname)                    \
    ...
    struct default_type_ ## tname {                                         \
        ...
        enum { value = (1 == sizeof(test<Tp>(choose()))) };                 \
                                                                            \
        typedef typename geofeatures_boost::detail::if_true<value>::                    \
...
#       define BOOST_UNORDERED_DEFAULT_TYPE_TMPLT(tname)                    \
    ...
    struct default_type_ ## tname {                                         \
                                                                            \
        template <typename X>                                               \
        static typename geofeatures_boost::unordered::detail::sfinae<                   \
...
#       if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
    ...
    BOOST_UNORDERED_HAS_FUNCTION(
    construct, U, (
        geofeatures_boost::unordered::detail::make<ValueType*>(),
        geofeatures_boost::unordered::detail::make<Args const>()...), 2
    );
...
#       else
    ...
    construct, U, (
        geofeatures_boost::unordered::detail::make<ValueType*>(),
        geofeatures_boost::unordered::detail::make<ValueType const>()), 2
    );
...
#       endif
    ...
    template <typename T, typename ValueType>
    BOOST_UNORDERED_HAS_FUNCTION(
        destroy, U, (geofeatures_boost::unordered::detail::make<ValueType*>()), 1
    );
...
#   endif
    ...
    inline Alloc call_select_on_container_copy_construction(const Alloc& rhs,
        typename geofeatures_boost::enable_if_c<
            geofeatures_boost::unordered::detail::
    ...
    template <typename Alloc>
    inline Alloc call_select_on_container_copy_construction(const Alloc& rhs,
        typename geofeatures_boost::disable_if_c<
            geofeatures_boost::unordered::detail::
            has_select_on_container_copy_construction<Alloc>::value, void*
        >::type = 0)
    {
    ...
    inline SizeType call_max_size(const Alloc& a,
        typename geofeatures_boost::enable_if_c<
            geofeatures_boost::unordered::detail::has_max_size<Alloc>::value, void*
        >::type = 0)
    {
        return a.max_size();
    }
    ...
    template <typename SizeType, typename Alloc>
    inline SizeType call_max_size(const Alloc&, typename geofeatures_boost::disable_if_c<
            geofeatures_boost::unordered::detail::has_max_size<Alloc>::value, void*
        >::type = 0)
    {
    ...
    struct allocator_traits
    {
        ...
        template <typename T>
        struct pointer_to_other : geofeatures_boost::pointer_to_other<pointer, T> {};
...
#   if BOOST_UNORDERED_DETAIL_FULL_CONSTRUCT
        ...
        static typename geofeatures_boost::enable_if_c<
                geofeatures_boost::unordered::detail::has_construct<Alloc, T, Args...>
                ::value>::type
            construct(Alloc& a, T* p, BOOST_FWD_REF(Args)... x)
        {
            a.construct(p, geofeatures_boost::forward<Args>(x)...);
        }

        template <typename T, typename... Args>
        static typename geofeatures_boost::disable_if_c<
                geofeatures_boost::unordered::detail::has_construct<Alloc, T, Args...>
                ::value>::type
            construct(Alloc&, T* p, BOOST_FWD_REF(Args)... x)
        {
            new ((void*) p) T(geofeatures_boost::forward<Args>(x)...);
        }

        template <typename T>
        static typename geofeatures_boost::enable_if_c<
                geofeatures_boost::unordered::detail::has_destroy<Alloc, T>::value>::type
            destroy(Alloc& a, T* p)
        {
            a.destroy(p);
        }
        ...
        static typename geofeatures_boost::disable_if_c<
            ...
            destroy(Alloc&, T* p)
        {
            geofeatures_boost::unordered::detail::func::destroy(p);
        }
...
#   elif !defined(BOOST_NO_SFINAE_EXPR)
        ...
        template <typename T>
        static typename geofeatures_boost::enable_if_c<
                geofeatures_boost::unordered::detail::has_construct<Alloc, T>::value>::type
...
#   else
        ...
        static void construct(Alloc& a, T* p, T const& x,
            typename geofeatures_boost::enable_if_c<
                    geofeatures_boost::unordered::detail::has_construct<Alloc, T>::value &&
                    geofeatures_boost::is_same<T, value_type>::value,
                    void*>::type = 0)
        {
            a.construct(p, x);
        }
        ...
        static void destroy(Alloc& a, T* p,
            typename geofeatures_boost::enable_if_c<
                geofeatures_boost::unordered::detail::has_destroy<Alloc, T>::value &&
                geofeatures_boost::is_same<T, value_type>::value,
                void*>::type = 0)
        {
            a.destroy(p);
...
#   endif
        ...
        {
            return geofeatures_boost::unordered::detail::func::
...
////////////////////////////////////////////////////////////////////////////////
//
// geofeatures_boost::container::allocator_traits
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace unordered { namespace detail {
    ...
    template <typename Alloc>
    struct allocator_traits :
        geofeatures_boost::container::allocator_traits<Alloc> {};
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace unordered { namespace detail { namespace func {
...
#   if BOOST_UNORDERED_DETAIL_FULL_CONSTRUCT
    ...
    {
        geofeatures_boost::unordered::detail::allocator_traits<Alloc>::construct(alloc,
            address, geofeatures_boost::forward<Args>(args)...);
    }

    template <typename Alloc, typename T>
    inline void destroy_value_impl(Alloc& alloc, T* x) {
        geofeatures_boost::unordered::detail::allocator_traits<Alloc>::destroy(alloc, x);
    }
...
#   else
    ...
    inline void call_construct(Alloc&, T* address,
        BOOST_FWD_REF(Args)... args)
    {
        new((void*) address) T(geofeatures_boost::forward<Args>(args)...);
    }

    template <typename Alloc, typename T>
    inline void destroy_value_impl(Alloc&, T* x) {
        geofeatures_boost::unordered::detail::func::destroy(x);
    }
...
#   define BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(n, namespace_)              \
    ...
    {                                                                       \
        geofeatures_boost::unordered::detail::func::call_construct(alloc, ptr);         \
    }                                                                       \
                                                                            \
...
#   define BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(n, namespace_)              \
    ...
    void construct_from_tuple_impl(                                         \
            geofeatures_boost::unordered::detail::func::length<0>, Alloc&, T* ptr,      \
            namespace_ tuple<>)                                             \
    {                                                                       \
        new ((void*) ptr) T();                                              \
    }                                                                       \
...
#   define BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE_IMPL(z, n, namespace_)      \
    template<typename Alloc, typename T,                                    \
        BOOST_PP_ENUM_PARAMS_Z(z, n, typename A)>                           \
    void construct_from_tuple_impl(                                         \
            geofeatures_boost::unordered::detail::func::length<n>, Alloc&, T* ptr,      \
            namespace_ tuple<BOOST_PP_ENUM_PARAMS_Z(z, n, A)> const& x)     \
    {                                                                       \
        new ((void*) ptr) T(                                                \
            BOOST_PP_ENUM_##z(n, BOOST_UNORDERED_GET_TUPLE_ARG, namespace_) \
...
BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(10, geofeatures_boost::)
...
#undef BOOST_UNORDERED_GET_TUPLE_ARG
    ...
    void construct_from_tuple(Alloc& alloc, T* ptr, Tuple const& x)
    {
        construct_from_tuple_impl(
            geofeatures_boost::unordered::detail::func::length<
                geofeatures_boost::tuples::length<Tuple>::value>(),
            alloc, ptr, x);
    }
    ...
    struct use_piecewise {
        static choice1::type test(choice1,
            geofeatures_boost::unordered::piecewise_construct_t);

        static choice2::type test(choice2, ...);

        enum { value = sizeof(choice1::type) ==
            sizeof(test(choose(), geofeatures_boost::unordered::detail::make<A0>())) };
    };
    ...
    inline void construct_value_impl(Alloc& alloc, T* address,
        BOOST_FWD_REF(Args)... args)
    {
        geofeatures_boost::unordered::detail::func::call_construct(alloc,
            address, geofeatures_boost::forward<Args>(args)...);
    }
    ...
    {
        geofeatures_boost::unordered::detail::func::construct_from_tuple(alloc,
            geofeatures_boost::addressof(address->first), geofeatures_boost::forward<A1>(a1));
        geofeatures_boost::unordered::detail::func::construct_from_tuple(alloc,
            geofeatures_boost::addressof(address->second), geofeatures_boost::forward<A2>(a2));
    }
...
// Construct from emplace_args
    ...
    {
        new((void*) address) T(geofeatures_boost::forward<A0>(args.a0));
    }
    ...
    {
        new((void*) address) T(
            geofeatures_boost::forward<A0>(args.a0),
            geofeatures_boost::forward<A1>(args.a1)
        );
    }
            ...
            emplace_args3<A0, A1, A2> const& args)
    {
        new((void*) address) T(
            geofeatures_boost::forward<A0>(args.a0),
            geofeatures_boost::forward<A1>(args.a1),
            geofeatures_boost::forward<A2>(args.a2)
        );
    }
...
#define BOOST_UNORDERED_CONSTRUCT_IMPL(z, num_params, _)                    \
    ...
    >                                                                       \
    inline void construct_value_impl(Alloc&, T* address,                    \
        geofeatures_boost::unordered::detail::BOOST_PP_CAT(emplace_args,num_params) <   \
...
#undef BOOST_UNORDERED_CONSTRUCT_IMPL
    ...
    inline void construct_value_impl(Alloc& alloc, std::pair<A, B>* address,
            geofeatures_boost::unordered::detail::emplace_args3<A0, A1, A2> const& args,
            typename enable_if<use_piecewise<A0>, void*>::type = 0)
    {
        geofeatures_boost::unordered::detail::func::construct_from_tuple(alloc,
            geofeatures_boost::addressof(address->first), args.a1);
        geofeatures_boost::unordered::detail::func::construct_from_tuple(alloc,
            geofeatures_boost::addressof(address->second), args.a2);
    }
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace unordered { namespace detail {
    ...
    {
        typedef geofeatures_boost::unordered::detail::allocator_traits<Allocator> traits;
        ...
        ~array_constructor() {
            if (ptr_) {
                for(pointer p = ptr_; p != constructed_; ++p) {
                    geofeatures_boost::unordered::detail::func::destroy(
                            geofeatures_boost::addressof(*p));
                }
        ...
        void construct(V const& v, std::size_t l)
        {
            ...
            for(constructed_ = ptr_; constructed_ != end; ++constructed_) {
                new ((void*) geofeatures_boost::addressof(*constructed_)) V(v);
            }
        }
