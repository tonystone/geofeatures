...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace unordered { namespace detail {
    ...
    struct grouped_node :
        geofeatures_boost::unordered::detail::value_base<T>
    {
        typedef typename ::geofeatures_boost::unordered::detail::rebind_wrap<
            A, grouped_node<A, T> >::type allocator;
        typedef typename ::geofeatures_boost::unordered::detail::
    ...
    struct grouped_ptr_node :
        geofeatures_boost::unordered::detail::ptr_bucket
    {
        typedef T value_type;
        typedef geofeatures_boost::unordered::detail::ptr_bucket bucket_base;
        typedef grouped_ptr_node<T>* node_pointer;
        typedef ptr_bucket* link_pointer;

        node_pointer group_prev_;
        std::size_t hash_;
        geofeatures_boost::unordered::detail::value_base<T> value_base_;
    ...
    {
        typedef geofeatures_boost::unordered::detail::grouped_node<A, T> node;

        typedef typename geofeatures_boost::unordered::detail::allocator_traits<
            typename geofeatures_boost::unordered::detail::rebind_wrap<A, node>::type
        >::pointer node_pointer;

        typedef geofeatures_boost::unordered::detail::bucket<node_pointer> bucket;
        typedef node_pointer link_pointer;
    };

    template <typename A, typename T>
    struct pick_grouped_node2<A, T,
        geofeatures_boost::unordered::detail::grouped_ptr_node<T>*,
        geofeatures_boost::unordered::detail::ptr_bucket*>
    {
        typedef geofeatures_boost::unordered::detail::grouped_ptr_node<T> node;
        typedef geofeatures_boost::unordered::detail::ptr_bucket bucket;
    ...
    {
        typedef geofeatures_boost::unordered::detail::allocator_traits<
            typename geofeatures_boost::unordered::detail::rebind_wrap<A,
                geofeatures_boost::unordered::detail::grouped_ptr_node<T> >::type
        > tentative_node_traits;

        typedef geofeatures_boost::unordered::detail::allocator_traits<
            typename geofeatures_boost::unordered::detail::rebind_wrap<A,
                geofeatures_boost::unordered::detail::ptr_bucket >::type
    ...
    struct multiset
    {
        typedef geofeatures_boost::unordered::detail::multiset<A, T, H, P> types;
        ...
        typedef geofeatures_boost::unordered::detail::pick_grouped_node<allocator,
            value_type> pick;
        typedef typename pick::node node;
        typedef typename pick::bucket bucket;
        typedef typename pick::link_pointer link_pointer;

        typedef geofeatures_boost::unordered::detail::grouped_table_impl<types> table;
        typedef geofeatures_boost::unordered::detail::set_extractor<value_type> extractor;

        typedef typename geofeatures_boost::unordered::detail::pick_policy<T>::type policy;
    };

    template <typename A, typename K, typename M, typename H, typename P>
    struct multimap
    {
        typedef geofeatures_boost::unordered::detail::multimap<A, K, M, H, P> types;
        ...
        typedef geofeatures_boost::unordered::detail::grouped_table_impl<types> table;
        typedef geofeatures_boost::unordered::detail::map_extractor<key_type, value_type>
            extractor;

        typedef typename geofeatures_boost::unordered::detail::pick_policy<K>::type policy;
    };

    template <typename Types>
    struct grouped_table_impl : geofeatures_boost::unordered::detail::table<Types>
    {
        typedef geofeatures_boost::unordered::detail::table<Types> table;
        ...
        grouped_table_impl(grouped_table_impl& x,
                geofeatures_boost::unordered::detail::move_tag m)
          : table(x, m)
        {}
...
#   if defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
        iterator emplace(geofeatures_boost::unordered::detail::emplace_args1<
                geofeatures_boost::unordered::detail::please_ignore_this_overload> const&)
        {
            BOOST_ASSERT(false);
            return iterator();
        }
...
#   endif
        ...
        template <class I>
        typename geofeatures_boost::unordered::detail::enable_if_forward<I, void>::type
            insert_range(I i, I j)
        {
            if(i == j) return;

            std::size_t distance = geofeatures_boost::unordered::detail::distance(i, j);
            if(distance == 1) {
                node_constructor a(this->node_alloc());
        ...
        template <class I>
        typename geofeatures_boost::unordered::detail::disable_if_forward<I, void>::type
            insert_range(I i, I j)
        {
            node_constructor a(this->node_alloc());
            for (; i != j; ++i) {
        ...
        static link_pointer split_groups(node_pointer i, node_pointer j)
        {
            ...
            if (j) {
                ...
                geofeatures_boost::swap(first->group_prev_, j->group_prev_);
            ...
            if (prev) {
                ...
                geofeatures_boost::swap(first->group_prev_, i->group_prev_);
            }
