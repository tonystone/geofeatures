...
namespace unordered
{
    ...
    private:
        ...
        typedef geofeatures_boost::unordered::detail::map<A, K, T, H, P> types;
    ...
    public:
        ...
        explicit unordered_map(
                size_type = geofeatures_boost::unordered::detail::default_bucket_count,
                const hasher& = hasher(),
        ...
        unordered_map(BOOST_RV_REF(unordered_map) other)
            ...
            : table_(other.table_, geofeatures_boost::unordered::detail::move_tag())
        {
        }
        ...
        {
            return table_.emplace(geofeatures_boost::forward<Args>(args)...);
        }

        template <class... Args>
        iterator emplace_hint(const_iterator, BOOST_FWD_REF(Args)... args)
        {
            return table_.emplace(geofeatures_boost::forward<Args>(args)...).first;
        }
#else
        ...
        std::pair<iterator, bool> emplace(
                geofeatures_boost::unordered::detail::empty_emplace
                    = geofeatures_boost::unordered::detail::empty_emplace(),
                value_type v = value_type())
        {
            return this->emplace(geofeatures_boost::move(v));
        }
        ...
        {
            return this->emplace_hint(hint, geofeatures_boost::move(v));
        }
        ...
        std::pair<iterator, bool> emplace(BOOST_FWD_REF(A0) a0)
        {
            return table_.emplace(
                geofeatures_boost::unordered::detail::create_emplace_args(
                    geofeatures_boost::forward<A0>(a0))
            );
        }
            ...
            BOOST_FWD_REF(A1) a1)
        {
            return table_.emplace(
                geofeatures_boost::unordered::detail::create_emplace_args(
                    geofeatures_boost::forward<A0>(a0),
                    geofeatures_boost::forward<A1>(a1))
            );
        }
            ...
            BOOST_FWD_REF(A2) a2)
        {
            return table_.emplace(
                geofeatures_boost::unordered::detail::create_emplace_args(
                    geofeatures_boost::forward<A0>(a0),
                    geofeatures_boost::forward<A1>(a1),
                    geofeatures_boost::forward<A2>(a2))
            );
        }
...
#undef BOOST_UNORDERED_EMPLACE
        ...
        {
            return this->emplace(geofeatures_boost::move(x));
        }
        ...
        {
            return this->emplace_hint(hint, geofeatures_boost::move(x));
        }
    ...
    private:
        ...
        typedef geofeatures_boost::unordered::detail::multimap<A, K, T, H, P> types;
        typedef typename types::traits allocator_traits;
        typedef typename types::table table;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    unordered_map<K,T,H,P,A>::unordered_map(allocator_type const& a)
      : table_(geofeatures_boost::unordered::detail::default_bucket_count,
            hasher(), key_equal(), a)
    {
    }
    ...
    unordered_map<K,T,H,P,A>::unordered_map(InputIt f, InputIt l)
      : table_(geofeatures_boost::unordered::detail::initial_size(f, l),
    ...
    unordered_map<K,T,H,P,A>::unordered_map(
            ...
            const hasher &hf,
            const key_equal &eql)
      : table_(geofeatures_boost::unordered::detail::initial_size(f, l, n),
    ...
    unordered_map<K,T,H,P,A>::unordered_map(
            ...
            const key_equal &eql,
            const allocator_type &a)
      : table_(geofeatures_boost::unordered::detail::initial_size(f, l, n), hf, eql, a)
    {
        table_.insert_range(f, l);
    }
    ...
    unordered_map<K,T,H,P,A>::unordered_map(
      ...
      : table_(other.table_, a, geofeatures_boost::unordered::detail::move_tag())
    {
    }
    ...
    unordered_map<K,T,H,P,A>::unordered_map(
      ...
      : table_(
            geofeatures_boost::unordered::detail::initial_size(
