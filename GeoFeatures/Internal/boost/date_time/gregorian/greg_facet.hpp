...
namespace gregorian {
  ...
  {
    typedef geofeatures_boost::gregorian::greg_month month_type;
    typedef geofeatures_boost::date_time::special_values special_value_enum;
    typedef geofeatures_boost::gregorian::months_of_year month_enum;
    typedef geofeatures_boost::date_time::weekdays weekday_enum;
  };

#if defined(USE_DATE_TIME_PRE_1_33_FACET_IO)
  //! Create the base facet type for gregorian::date
  typedef geofeatures_boost::date_time::date_names_put<greg_facet_config> greg_base_facet;
  ...
  {
    typedef geofeatures_boost::date_time::date_names_put<greg_facet_config, charT> facet_def;
    typedef geofeatures_boost::date_time::ostream_date_formatter<date, facet_def, charT> greg_ostream_formatter;
  ...
  {
    typedef geofeatures_boost::date_time::date_names_put<greg_facet_config, charT> facet_def;
    typedef geofeatures_boost::date_time::ostream_month_formatter<facet_def, charT> greg_month_formatter;
  ...
  {
    typedef geofeatures_boost::date_time::date_names_put<greg_facet_config, charT> facet_def;
    typedef geofeatures_boost::date_time::ostream_weekday_formatter<greg_weekday, facet_def, charT> greg_weekday_formatter;
    std::locale locale = os.getloc();
    if (std::has_facet<facet_def>(locale)) {
      const facet_def& f = std::use_facet<facet_def>(locale);
  ...
  BOOST_DATE_TIME_DECL geofeatures_boost::date_time::all_date_names_put<greg_facet_config, char>* create_facet_def(char type);
  ...
  /* Necessary in the event an exception is thrown from op>> for 
   * weekday or month. See comments in those functions for more info */
  BOOST_DATE_TIME_DECL geofeatures_boost::date_time::all_date_names_put<greg_facet_config, wchar_t>* create_facet_def(wchar_t type);
  ...
  {
    typedef geofeatures_boost::date_time::all_date_names_put<greg_facet_config, charT> facet_def;
