...
public struct LinearRing<CoordinateType : protocol<Coordinate, TupleConvertable>> : Geometry {
    ...
    // Note: these should be part of the extension below "extension LinearRing where CoordinateType : TupleConvertable" but Swift crashes so until that is fixed, they will need to stay here
