...
/*
    NOTE: This file was auto generated by gyb from file GeometryCollection.swift.gyb using the following command.
        ...
        ~/gyb --line-directive '' -DSelf=MultiLineString -DElement=LineString  -o MultiLineString.swift MultiCollection.swift.gyb
...
extension MultiLineString : Collection {
    ...
    public mutating func insert(newElement: Element, atIndex index: Int) {
        guard ((index >= 0) && (index < _storage.value)) else { preconditionFailure("Index out of range, can't insert LineString.") }
    ...
    public mutating func removeAtIndex(index: Int) -> Element {
        guard ((index >= 0) && (index < _storage.value)) else { preconditionFailure("Index out of range, can't remove LineString.") }
    ...
    public mutating func removeLast() -> Element {
        guard count > 0 else { preconditionFailure("can't removeLast from an empty MultiLineString.") }
