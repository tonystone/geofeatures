...
extension GeometryCollection : Collection {
    ...
    public mutating func insert(newElement: Element, atIndex index: Int) {
        guard ((index >= 0) && (index < _storage.value)) else { preconditionFailure("Index out of range, can't insert Geometry.") }
    ...
    public mutating func removeAtIndex(index: Int) -> Element {
        guard ((index >= 0) && (index < _storage.value)) else { preconditionFailure("Index out of range, can't remove Geometry.") }
    ...
    public mutating func removeLast() -> Element {
        guard count > 0 else { preconditionFailure("can't removeLast from an empty GeometryCollection.") }
