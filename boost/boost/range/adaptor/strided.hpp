...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost
{
    namespace range_detail
    {
        ...
        public:
            ...
            typedef typename super_t::reference reference;
            typedef BaseIterator base_iterator;
            typedef typename geofeatures_boost::make_unsigned<difference_type>::type
                        size_type;
            ...
            forward_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                forward_traversal_tag
            >(geofeatures_boost::begin(rng), geofeatures_boost::end(rng), stride);
        }
            ...
            forward_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                forward_traversal_tag
            >(geofeatures_boost::end(rng), geofeatures_boost::end(rng), stride);
        }
            ...
            bidirectional_traversal_tag)
        {
            ...
            return strided_iterator<
                typename range_iterator<Rng>::type,
                bidirectional_traversal_tag
            >(geofeatures_boost::begin(rng), difference_type(), stride);
        }
            ...
            bidirectional_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                bidirectional_traversal_tag
            >(geofeatures_boost::end(rng), geofeatures_boost::size(rng), stride);
        }
            ...
            random_access_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                random_access_traversal_tag
            >(geofeatures_boost::begin(rng), geofeatures_boost::begin(rng), stride);
        }
