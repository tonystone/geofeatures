...
#define BOOST_SERIALIZATION_NVP(name)                              \
    geofeatures_boost::serialization::make_nvp(BOOST_PP_STRINGIZE(name), name)
/**/

#define BOOST_SERIALIZATION_BASE_OBJECT_NVP(name)                  \
    geofeatures_boost::serialization::make_nvp(                                \
        BOOST_PP_STRINGIZE(name),                                  \
        geofeatures_boost::serialization::base_object<name >(*this)            \
    )
/**/
