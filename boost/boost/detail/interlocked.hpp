...
# define BOOST_INTERLOCKED_INCREMENT ::geofeatures_boost::detail::InterlockedIncrement
# define BOOST_INTERLOCKED_DECREMENT ::geofeatures_boost::detail::InterlockedDecrement
# define BOOST_INTERLOCKED_COMPARE_EXCHANGE ::geofeatures_boost::detail::InterlockedCompareExchange
# define BOOST_INTERLOCKED_EXCHANGE ::geofeatures_boost::detail::InterlockedExchange
# define BOOST_INTERLOCKED_EXCHANGE_ADD ::geofeatures_boost::detail::InterlockedExchangeAdd

# if defined(_M_IA64) || defined(_M_AMD64)
#  define BOOST_INTERLOCKED_COMPARE_EXCHANGE_POINTER ::geofeatures_boost::detail::InterlockedCompareExchangePointer
#  define BOOST_INTERLOCKED_EXCHANGE_POINTER ::geofeatures_boost::detail::InterlockedExchangePointer
# else
#  define BOOST_INTERLOCKED_COMPARE_EXCHANGE_POINTER(dest,exchange,compare) \
    ((void*)BOOST_INTERLOCKED_COMPARE_EXCHANGE((long volatile*)(dest),(long)(exchange),(long)(compare)))
#  define BOOST_INTERLOCKED_EXCHANGE_POINTER(dest,exchange) \
