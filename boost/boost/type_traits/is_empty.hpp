    ...
    BOOST_STATIC_CONSTANT(
        bool, value = (
            ::geofeatures_boost::type_traits::ice_or<
              ::geofeatures_boost::detail::empty_helper<cvt,::geofeatures_boost::is_class<T>::value>::value
...
struct is_empty_impl
{
   ...
   BOOST_STATIC_CONSTANT(
       bool, value = (
           ::geofeatures_boost::type_traits::ice_or<
              ::geofeatures_boost::detail::empty_helper<
                  cvt
                , ::geofeatures_boost::is_class<T>::value
                , ::geofeatures_boost::is_convertible< r_type,int>::value
              >::value
              , BOOST_INTERNAL_IS_EMPTY(cvt)
           >::value));
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_empty,T,::geofeatures_boost::detail::is_empty_impl<T>::value)
