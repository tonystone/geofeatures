...
struct disjoint_no_intersections_policy<Geometry1, Geometry2, Tag1, multi_tag>
{
    static inline bool apply(Geometry1 const& g1, Geometry2 const& g2)
    {
        ...
        typedef typename geofeatures_boost::range_iterator<Geometry1 const>::type iterator;
        for ( iterator it = geofeatures_boost::begin(g1) ; it != geofeatures_boost::end(g1) ; ++it )
        {
            typedef typename geofeatures_boost::range_value<Geometry1 const>::type value_type;
...
private:
    ...
    {
        typedef typename geofeatures_boost::range_value<InteriorRings>::type ring_type;
        ...
        return check_iterator_range
            <
                unary_predicate_type
            >::apply(geofeatures_boost::begin(interior_rings),
                     geofeatures_boost::end(interior_rings),
