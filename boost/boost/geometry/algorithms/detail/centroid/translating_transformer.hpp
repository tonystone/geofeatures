...
struct translating_transformer
{
    ...
    typedef geofeatures_boost::reference_wrapper<point_type const> result_type;
...
struct translating_transformer<Geometry, areal_tag, cartesian_tag>
{
        ...
        : m_origin(NULL)
    {
        ...
        {
            m_origin = geofeatures_boost::addressof(*pt_it);
        }
    }

    explicit translating_transformer(point_type const& origin)
        : m_origin(geofeatures_boost::addressof(origin))
    {}
