    ...
    struct checker
    {
        ...
        static void apply(ApplyMethod)
        {
            ...
            static const bool is_correct_strategy_tag =
                geofeatures_boost::is_same<tag, strategy_tag_distance_point_point>::value
                || geofeatures_boost::is_same<tag, strategy_tag_distance_point_box>::value
                || geofeatures_boost::is_same<tag, strategy_tag_distance_box_box>::value;
            ...
            geofeatures_boost::ignore_unused<tag>();
            geofeatures_boost::ignore_unused(str, c, r);
        }
    };
...
private :
    ...
    struct checker
    {
        ...
        static void apply(ApplyMethod)
        {
            ...
            geofeatures_boost::ignore_unused(str, r, cstrategy);
        }
    };
