...
<
    ...
    bool IsConst = geofeatures_boost::is_const<Geometry>::type::value
>
...
struct checker<geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{};

template <BOOST_VARIANT_ENUM_PARAMS(typename T)>
struct checker<geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const>
{};
