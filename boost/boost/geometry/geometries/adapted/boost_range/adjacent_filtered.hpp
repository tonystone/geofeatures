...
struct tag<geofeatures_boost::adjacent_filtered_range<Filter, Geometry, DefaultPass> >
#else
struct tag<geofeatures_boost::range_detail::adjacent_filter_range<Filter, Geometry, DefaultPass> >
#endif
{
