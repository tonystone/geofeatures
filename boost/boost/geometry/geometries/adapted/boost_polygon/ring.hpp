...
// geofeatures_boost::polygon::polygon_data -> geofeatures_boost::geometry::ring
...
struct tag<geofeatures_boost::polygon::polygon_data<CoordinateType> >
{
    typedef ring_tag type;
};

template <typename CoordinateType>
struct clear<geofeatures_boost::polygon::polygon_data<CoordinateType> >
{
    static inline void apply(geofeatures_boost::polygon::polygon_data<CoordinateType>& data)
    {
        // There is no "clear" function but we can assign
        // a newly (and therefore empty) constructed polygon
        geofeatures_boost::polygon::assign(data, geofeatures_boost::polygon::polygon_data<CoordinateType>());
    }
};

template <typename CoordinateType>
struct push_back<geofeatures_boost::polygon::polygon_data<CoordinateType> >
{
         ...
         point_type const& point)
    {
        ...
        std::vector<point_type> temporary_vector
            (
                geofeatures_boost::polygon::begin_points(data),
                geofeatures_boost::polygon::end_points(data)
            );
...
template <typename CoordinateType>
struct resize<geofeatures_boost::polygon::polygon_data<CoordinateType> >
{
    typedef geofeatures_boost::polygon::point_data<CoordinateType> point_type;
...
{
    template<typename CoordinateType>
    struct range_mutable_iterator<geofeatures_boost::polygon::polygon_data<CoordinateType> >
    {
        typedef typename geofeatures_boost::polygon::polygon_traits
            <
                geofeatures_boost::polygon::polygon_data<CoordinateType>
            >::iterator_type type;
    };

    template<typename CoordinateType>
    struct range_const_iterator<geofeatures_boost::polygon::polygon_data<CoordinateType> >
    {
        typedef typename geofeatures_boost::polygon::polygon_traits
            <
                geofeatures_boost::polygon::polygon_data<CoordinateType>
    ...
    template<typename CoordinateType>
    struct range_size<geofeatures_boost::polygon::polygon_data<CoordinateType> >
    {
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace polygon
{
