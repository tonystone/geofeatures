...
struct tag<geofeatures_boost::array<CoordinateType, DimensionCount> >
    : detail::boost_array_tag<geofeatures_boost::is_arithmetic<CoordinateType>::value> {};


template <typename CoordinateType, std::size_t DimensionCount>
struct coordinate_type<geofeatures_boost::array<CoordinateType, DimensionCount> >
{
...
template <typename CoordinateType, std::size_t DimensionCount>
struct dimension<geofeatures_boost::array<CoordinateType, DimensionCount> >: geofeatures_boost::mpl::int_<DimensionCount> {};


template <typename CoordinateType, std::size_t DimensionCount, std::size_t Dimension>
struct access<geofeatures_boost::array<CoordinateType, DimensionCount>, Dimension>
{
    static inline CoordinateType get(geofeatures_boost::array<CoordinateType, DimensionCount> const& a)
    {
        return a[Dimension];
    }

    static inline void set(geofeatures_boost::array<CoordinateType, DimensionCount>& a,
...
#define BOOST_GEOMETRY_REGISTER_BOOST_ARRAY_CS(CoordinateSystem) \
    ...
    struct coordinate_system<geofeatures_boost::array<T, N> > \
    { \
