...
#endif
# define BOOST_THROW_EXCEPTION(x) ::geofeatures_boost::exception_detail::throw_exception_(x,BOOST_THROW_EXCEPTION_CURRENT_FUNCTION,__FILE__,__LINE__)
#else
# define BOOST_THROW_EXCEPTION(x) ::geofeatures_boost::throw_exception(x)
#endif
