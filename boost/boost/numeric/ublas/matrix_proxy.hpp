...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        typedef typename geofeatures_boost::mpl::if_<geofeatures_boost::is_const<M>,
    ...
    public:
        ...
        public:
            ...
            BOOST_STATIC_ASSERT ((geofeatures_boost::is_same<typename M::const_iterator1::iterator_category, typename M::const_iterator2::iterator_category>::value ));
     ...
     * - \c geofeatures_boost::numeric::ublas::indirect_array<A> where \c A can be \c int, \c size_t, \c long, etc...
     * - \c geofeatures_boost::numeric::ublas::matrix<int> can work too (\c int can be replaced by another integer type)
     * - etc...
     *
