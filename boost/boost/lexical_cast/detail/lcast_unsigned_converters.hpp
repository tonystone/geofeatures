...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost 
{
    namespace detail // lcast_to_unsigned
    {
        template<class T>
        inline
        BOOST_DEDUCED_TYPENAME geofeatures_boost::make_unsigned<T>::type lcast_to_unsigned(const T value) BOOST_NOEXCEPT {
            typedef BOOST_DEDUCED_TYPENAME geofeatures_boost::make_unsigned<T>::type result_type;
            return value < 0 
    ...
    namespace detail // lcast_put_unsigned
    {
        ...
        class lcast_put_unsigned: geofeatures_boost::noncopyable {
            typedef BOOST_DEDUCED_TYPENAME Traits::int_type int_type;
            BOOST_DEDUCED_TYPENAME geofeatures_boost::mpl::if_c<
    ...
    {
        template <class Traits, class T, class CharT>
        class lcast_ret_unsigned: geofeatures_boost::noncopyable {
        ...
        public:
                ...
                : m_multiplier_overflowed(false), m_multiplier(1), m_value(value), m_begin(begin), m_end(end)
            {
                ...
                BOOST_STATIC_ASSERT_MSG(std::numeric_limits<T>::is_specialized,
                    "std::numeric_limits are not specialized for integral type passed to geofeatures_boost::lexical_cast"
                );
#endif
            }
