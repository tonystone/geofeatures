...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace function_types { 
...
namespace detail 
{
  ...
  template<bits_t Value> struct constant 
    : geofeatures_boost::integral_constant<bits_t,Value> 
  { };
  ...
  template<bits_t Bits, bits_t CCID> struct encode_bits
    : constant< 
        ::geofeatures_boost::function_types::detail::encode_bits_impl<Bits,CCID>::value 
      >
  { };
  ...
  {
    typedef constant<
      ::geofeatures_boost::function_types::detail::tag_ice
        < ::geofeatures_boost::function_types::detail::bits<LHS>::value
        , ::geofeatures_boost::function_types::detail::mask<LHS>::value
        , ::geofeatures_boost::function_types::detail::bits<RHS>::value
        , ::geofeatures_boost::function_types::detail::mask<RHS>::value
        >::combined_bits 
    > bits;
  ...
  template<class Tag, class QueryTag> struct represents_impl
    : geofeatures_boost::integral_constant<bool,
        ::geofeatures_boost::function_types::detail::tag_ice
          < ::geofeatures_boost::function_types::detail::bits<Tag>::value
          , ::geofeatures_boost::function_types::detail::mask<Tag>::value
          , ::geofeatures_boost::function_types::detail::bits<QueryTag>::value
          , ::geofeatures_boost::function_types::detail::mask<QueryTag>::value
          >::match
      >
  { };
...
} } // namespace ::geofeatures_boost::function_types
