...
/*! \file
    ...
    or \c std::list<geofeatures_boost::iterator_range<std::string::iterator>>
*/
...
//  find_all  ------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::geofeatures_boost::algorithm::iter_find(
                Result,
                Input,
...
//  tokenize  -------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::geofeatures_boost::algorithm::iter_split(
                Result,
                Input,
                ::geofeatures_boost::algorithm::token_finder( Pred, eCompress ) );         
        }
