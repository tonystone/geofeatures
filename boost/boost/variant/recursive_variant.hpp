...
template <
    ...
    >
struct substitute<
      ::geofeatures_boost::variant<
          recursive_flag< T0 >
        , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
        >
    , RecursiveVariant
    , ::geofeatures_boost::recursive_variant_
...
struct substitute<
      ::geofeatures_boost::variant<
          ::geofeatures_boost::detail::variant::over_sequence< T0 >
        , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
        >
    , RecursiveVariant
    , ::geofeatures_boost::recursive_variant_
...
public:
    ...
    typedef typename mpl::if_<
          mpl::equal<initial_types, types, ::geofeatures_boost::is_same<mpl::_1, mpl::_2> >
        , ::geofeatures_boost::variant<
              ::geofeatures_boost::detail::variant::over_sequence< T0 >
            , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
            >
        , ::geofeatures_boost::variant< over_sequence<types> >
        >::type type;
};
...
public: // metafunction result
    ...
    typedef ::geofeatures_boost::variant< BOOST_VARIANT_ENUM_PARAMS(wknd_T) > type;
