...
class constant_iterator
  : public ::geofeatures_boost::container::iterator
      ...
      <std::random_access_iterator_tag, T, Difference, const T*, const T &>
{
   ...
   //constructed until ::geofeatures_boost::container::construct_in_place is called.
...
struct emplace_functor
{
   ...
   void inplace_impl(Allocator &a, T* ptr, const container_detail::index_tuple<IdxPack...>&)
   {
      allocator_traits<Allocator>::construct
         (a, ptr, ::geofeatures_boost::forward<Args>(container_detail::get<IdxPack>(args_))...);
   }
...
struct iiterator_types
{
   ...
   typedef typename geofeatures_boost::container::iterator_traits<IIterator>::pointer         it_pointer;
   typedef typename geofeatures_boost::container::iterator_traits<IIterator>::difference_type difference_type;
   typedef typename ::geofeatures_boost::intrusive::pointer_traits<it_pointer>::
...
{
   typedef typename ::geofeatures_boost::container::iterator
...
using ::geofeatures_boost::intrusive::reverse_iterator;
