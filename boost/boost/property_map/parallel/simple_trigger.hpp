...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace graph { namespace parallel { using geofeatures_boost::parallel::simple_trigger; } } }
