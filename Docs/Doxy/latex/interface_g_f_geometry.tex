...
\end{DoxyReturn}
\hypertarget{interface_g_f_geometry_ace87d1a855e679bc7dad8efe01de05d9}{}\index{G\+F\+Geometry@{G\+F\+Geometry}!area\+:@{area\+:}}
\index{area\+:@{area\+:}!G\+F\+Geometry@{G\+F\+Geometry}}
\subsubsection[{area\+:(\+N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable error)}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (double) area\+: 
\begin{DoxyParamCaption}
\item[{(N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable)}]{error}
\end{DoxyParamCaption}
}\label{interface_g_f_geometry_ace87d1a855e679bc7dad8efe01de05d9}
The area algorithm calculates the surface area of all geometries having a surface, namely box, polygon, ring, multipolygon. The units are the square of the units used for the points defining the surface. If subject geometry is defined in meters, then area is calculated in square meters
...
\end{DoxyReturn}
\hypertarget{interface_g_f_geometry_a85cbb192882c5bcf6eede5caa0d3083e}{}\index{G\+F\+Geometry@{G\+F\+Geometry}!length\+:@{length\+:}}
\index{length\+:@{length\+:}!G\+F\+Geometry@{G\+F\+Geometry}}
\subsubsection[{length\+:(\+N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable error)}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (double) length\+: 
\begin{DoxyParamCaption}
\item[{(N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable)}]{error}
\end{DoxyParamCaption}
}\label{interface_g_f_geometry_a85cbb192882c5bcf6eede5caa0d3083e}
The length method calculates the length (the sum of distances between consecutive points) of a geometry.
...
\end{DoxyReturn}
\hypertarget{interface_g_f_geometry_a746be63604d2e7563d17c1728c8fb8bf}{}\index{G\+F\+Geometry@{G\+F\+Geometry}!perimeter\+:@{perimeter\+:}}
\index{perimeter\+:@{perimeter\+:}!G\+F\+Geometry@{G\+F\+Geometry}}
\subsubsection[{perimeter\+:(\+N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable error)}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (double) perimeter\+: 
\begin{DoxyParamCaption}
\item[{(N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable)}]{error}
\end{DoxyParamCaption}
}\label{interface_g_f_geometry_a746be63604d2e7563d17c1728c8fb8bf}
Calculates the perimeter of a geometry
...
\end{DoxyReturn}
\hypertarget{interface_g_f_geometry_a2c72f4e2f67d3cf79514e47f0973c10c}{}\index{G\+F\+Geometry@{G\+F\+Geometry}!centroid\+:@{centroid\+:}}
\index{centroid\+:@{centroid\+:}!G\+F\+Geometry@{G\+F\+Geometry}}
\subsubsection[{centroid\+:(\+N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable error)}]{\setlength{\rightskip}{0pt plus 5cm}-\/ ({\bf G\+F\+Point} $\ast$) centroid\+: 
\begin{DoxyParamCaption}
\item[{(N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable)}]{error}
\end{DoxyParamCaption}
}\label{interface_g_f_geometry_a2c72f4e2f67d3cf79514e47f0973c10c}
The centroid method calculates the geometric center (or\+: center of mass) of a geometry.
...
\end{DoxyReturn}
\hypertarget{interface_g_f_geometry_a845ecba0fb20deca5dcaf3350329bf94}{}\index{G\+F\+Geometry@{G\+F\+Geometry}!bounding\+Box\+:@{bounding\+Box\+:}}
\index{bounding\+Box\+:@{bounding\+Box\+:}!G\+F\+Geometry@{G\+F\+Geometry}}
\subsubsection[{bounding\+Box\+:(\+N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable error)}]{\setlength{\rightskip}{0pt plus 5cm}-\/ ({\bf G\+F\+Box} $\ast$) bounding\+Box\+: 
\begin{DoxyParamCaption}
\item[{(N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable)}]{error}
\end{DoxyParamCaption}
}\label{interface_g_f_geometry_a845ecba0fb20deca5dcaf3350329bf94}
The bounding\+Box method calculates the bounding\+Box (also known as axis aligned bounding box, aabb, or minimum bounding rectangle, mbr) of a geometry.
...
\end{DoxyReturn}
\hypertarget{interface_g_f_geometry_a472aa2dddf6c10eec974d9851d186c06}{}\index{G\+F\+Geometry@{G\+F\+Geometry}!within\+:error\+:@{within\+:error\+:}}
\index{within\+:error\+:@{within\+:error\+:}!G\+F\+Geometry@{G\+F\+Geometry}}
\subsubsection[{within\+:error\+:(\+G\+F\+Geometry $\ast$other,[error] N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable error)}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (B\+O\+O\+L) {\bf within\+:} 
\begin{DoxyParamCaption}
\item[{({\bf G\+F\+Geometry} $\ast$)}]{other}
\item[{error:(N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable)}]{error}
\end{DoxyParamCaption}
}\label{interface_g_f_geometry_a472aa2dddf6c10eec974d9851d186c06}
Checks if the geometry is completely inside the other geometry.
...
\end{DoxyReturn}
\hypertarget{interface_g_f_geometry_ac17c7387894066850c7cca9d3545be61}{}\index{G\+F\+Geometry@{G\+F\+Geometry}!intersects\+\_\+\+:@{intersects\+\_\+\+:}}
\index{intersects\+\_\+\+:@{intersects\+\_\+\+:}!G\+F\+Geometry@{G\+F\+Geometry}}
\subsubsection[{intersects\+\_\+\+:(\+N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable error)}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (B\+O\+O\+L) intersects\+\_\+\+: 
\begin{DoxyParamCaption}
\item[{(N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable)}]{error}
\end{DoxyParamCaption}
}\label{interface_g_f_geometry_ac17c7387894066850c7cca9d3545be61}
Checks if self has at least one intersection.
...
\end{DoxyReturn}
\hypertarget{interface_g_f_geometry_a836e4a35ecadb3a35c4f0bd8fb3a6740}{}\index{G\+F\+Geometry@{G\+F\+Geometry}!intersects\+:error\+:@{intersects\+:error\+:}}
\index{intersects\+:error\+:@{intersects\+:error\+:}!G\+F\+Geometry@{G\+F\+Geometry}}
\subsubsection[{intersects\+:error\+:(\+G\+F\+Geometry $\ast$other,[error] N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable error)}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (B\+O\+O\+L) {\bf intersects\+:} 
\begin{DoxyParamCaption}
\item[{({\bf G\+F\+Geometry} $\ast$)}]{other}
\item[{error:(N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable)}]{error}
\end{DoxyParamCaption}
}\label{interface_g_f_geometry_a836e4a35ecadb3a35c4f0bd8fb3a6740}
Checks if self has at least one intersection with the other geometry.
...
\hline
\end{DoxyExceptions}
\hypertarget{interface_g_f_geometry_a3b071da06cde8e37681d8dec934ca62d}{}\index{G\+F\+Geometry@{G\+F\+Geometry}!intersection\+:error\+:@{intersection\+:error\+:}}
\index{intersection\+:error\+:@{intersection\+:error\+:}!G\+F\+Geometry@{G\+F\+Geometry}}
\subsubsection[{intersection\+:error\+:(\+G\+F\+Geometry $\ast$other,[error] N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable error)}]{\setlength{\rightskip}{0pt plus 5cm}-\/ ({\bf G\+F\+Geometry} $\ast$) {\bf intersection\+:} 
\begin{DoxyParamCaption}
\item[{({\bf G\+F\+Geometry} $\ast$)}]{other}
\item[{error:(N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable)}]{error}
\end{DoxyParamCaption}
}\label{interface_g_f_geometry_a3b071da06cde8e37681d8dec934ca62d}
Calculates the point set intersection of this geometry with other.
...
\hline
\end{DoxyExceptions}
\hypertarget{interface_g_f_geometry_ad84c62d6fee6b0169128bae069e84f53}{}\index{G\+F\+Geometry@{G\+F\+Geometry}!difference\+:error\+:@{difference\+:error\+:}}
\index{difference\+:error\+:@{difference\+:error\+:}!G\+F\+Geometry@{G\+F\+Geometry}}
\subsubsection[{difference\+:error\+:(\+G\+F\+Geometry $\ast$other,[error] N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable error)}]{\setlength{\rightskip}{0pt plus 5cm}-\/ ({\bf G\+F\+Geometry} $\ast$) {\bf difference\+:} 
\begin{DoxyParamCaption}
\item[{({\bf G\+F\+Geometry} $\ast$)}]{other}
\item[{error:(N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable)}]{error}
\end{DoxyParamCaption}
}\label{interface_g_f_geometry_ad84c62d6fee6b0169128bae069e84f53}
Calculate the difference of two geometries.
...
\hline
\end{DoxyExceptions}
\hypertarget{interface_g_f_geometry_af05f89e6df33df7c59c99b57cf2c35f2}{}\index{G\+F\+Geometry@{G\+F\+Geometry}!union\+\_\+\+:error\+:@{union\+\_\+\+:error\+:}}
\index{union\+\_\+\+:error\+:@{union\+\_\+\+:error\+:}!G\+F\+Geometry@{G\+F\+Geometry}}
\subsubsection[{union\+\_\+\+:error\+:(\+G\+F\+Geometry $\ast$other,[error] N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable error)}]{\setlength{\rightskip}{0pt plus 5cm}-\/ ({\bf G\+F\+Geometry} $\ast$) {\bf union\+\_\+\+:} 
\begin{DoxyParamCaption}
\item[{({\bf G\+F\+Geometry} $\ast$)}]{other}
\item[{error:(N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable)}]{error}
\end{DoxyParamCaption}
}\label{interface_g_f_geometry_af05f89e6df33df7c59c99b57cf2c35f2}
Combines the other geometry with self. The union calculates the spatial set theoretic union of the two geometries.
...
\hypertarget{interface_g_f_geometry_a9517f77b573e92c5f1f76ce63ec53a89}{}\index{G\+F\+Geometry@{G\+F\+Geometry}!geometry\+With\+W\+K\+T\+:error\+:@{geometry\+With\+W\+K\+T\+:error\+:}}
\index{geometry\+With\+W\+K\+T\+:error\+:@{geometry\+With\+W\+K\+T\+:error\+:}!G\+F\+Geometry@{G\+F\+Geometry}}
\subsubsection[{geometry\+With\+W\+K\+T\+:error\+:(\+N\+S\+String $\ast$wkt,[error] N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable error)}]{\setlength{\rightskip}{0pt plus 5cm}+ (instancetype) {\bf geometry\+With\+W\+K\+T\+:} 
\begin{DoxyParamCaption}
\item[{(N\+S\+String $\ast$)}]{wkt}
\item[{error:(N\+S\+Error $\ast$\+\_\+\+\_\+autoreleasing $\ast$\+\_\+\+Nullable)}]{error}
\end{DoxyParamCaption}
}\label{interface_g_f_geometry_a9517f77b573e92c5f1f76ce63ec53a89}
Create a \hyperlink{interface_g_f_geometry}{G\+F\+Geometry} instance from the W\+K\+T string.
...
Provided by category \hyperlink{category_g_f_geometry_07_w_k_t_08_a9517f77b573e92c5f1f76ce63ec53a89}{G\+F\+Geometry(\+W\+K\+T)}.
