/*
*   MultiPointCoordinate2DFloatingPrecisionTests.swift
 *
...
/*
    ...
    ~/gyb --line-directive '' -DCoordinateType=Coordinate2D -D"TestTuple0=(x: 1.0, y: 1.0)" -D"TestTuple1=(x: 2.0, y: 2.0)" -D"ExpectedTuple0=(x: 1.0, y: 1.0)" -D"ExpectedTuple1=(x: 2.0, y: 2.0)" -D"Precision=FloatingPrecision()" -o MultiPointCoordinate2DFloatingPrecisionTests.swift MultiPointTests.swift.gyb

    Do NOT edit this file directly as it will be regenerated automatically when needed.
*/

class MultiPointCoordinate2DFloatingPrecisionTests : XCTestCase {
    ...
    func testEquals () {
        XCTAssertEqual(MultiPoint<Coordinate2D>(elements: [Point(coordinate: (x: 1.0, y: 1.0)),Point(coordinate: (x: 2.0, y: 2.0))], precision: FloatingPrecision()).equals(MultiPoint<Coordinate2D>(elements: [Point(coordinate: (x: 1.0, y: 1.0)),Point(coordinate: (x: 2.0, y: 2.0))], precision: FloatingPrecision())), true)
    }
