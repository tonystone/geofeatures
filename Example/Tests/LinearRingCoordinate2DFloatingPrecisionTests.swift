...
class LinearRingCoordinate2DFloatingPrecisionTests : XCTestCase {
    ...
    func testSubscript_Get () {
        let lineString = LinearRing<Coordinate2D>(elements: [(x: 1.0, y: 1.0),(x: 2.0, y: 2.0)], precision: FloatingPrecision())
        
        XCTAssertEqual(lineString[1] == Coordinate2D(tuple: (x: 2.0, y: 2.0)), true)
    }
    
    func testSubscript_Set () {
        var lineString = LinearRing<Coordinate2D>(elements: [(x: 1.0, y: 1.0),(x: 2.0, y: 2.0)], precision: FloatingPrecision())
    ...
    func testAppendContentsOf_LineString () {
        ...
        let lineString1 = LinearRing<Coordinate2D>(elements: [(x: 1.0, y: 1.0),(x: 2.0, y: 2.0)], precision: FloatingPrecision())
        var lineString2 = LinearRing<Coordinate2D>(precision: FloatingPrecision())
    ...
    func testEquals () {
        XCTAssertEqual(LinearRing<Coordinate2D>(elements: [Coordinate2D(tuple: (x: 1.0, y: 1.0)), Coordinate2D(tuple: (x: 2.0, y: 2.0))], precision: FloatingPrecision()).equals(LinearRing<Coordinate2D>(elements: [Coordinate2D(tuple: (x: 1.0, y: 1.0)), Coordinate2D(tuple: (x: 2.0, y: 2.0))])), true)
    }
    ...
    func testAppend () {
        var lineString = LinearRing<Coordinate2D>(precision: FloatingPrecision())
