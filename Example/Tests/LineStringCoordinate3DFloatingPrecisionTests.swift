...
class LineStringCoordinate3DFloatingPrecisionTests : XCTestCase {
    ...
    func testSubscript_Get () {
        let geometry = LineString<Coordinate3D>(elements: [(x: 1.0, y: 1.0, z: 1.0),(x: 2.0, y: 2.0, z: 2.0)], precision: FloatingPrecision())
        
        XCTAssertEqual(geometry[1] == Coordinate3D(tuple: (x: 2.0, y: 2.0, z: 2.0)), true)
    }
    
    func testSubscript_Set () {
        var geometry = LineString<Coordinate3D>(elements: [(x: 1.0, y: 1.0, z: 1.0),(x: 2.0, y: 2.0, z: 2.0)], precision: FloatingPrecision())
    ...
    func testEquals () {
        XCTAssertEqual(LineString<Coordinate3D>(elements: [Coordinate3D(tuple: (x: 1.0, y: 1.0, z: 1.0)), Coordinate3D(tuple: (x: 2.0, y: 2.0, z: 2.0))], precision: FloatingPrecision()).equals(LineString<Coordinate3D>(elements: [Coordinate3D(tuple: (x: 1.0, y: 1.0, z: 1.0)), Coordinate3D(tuple: (x: 2.0, y: 2.0, z: 2.0))], precision: FloatingPrecision())), true)
    }
