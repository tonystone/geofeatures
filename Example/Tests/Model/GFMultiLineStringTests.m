...
@implementation GFMultiLineStringTests
    ...
    - (void) testCopy {
        XCTAssertEqualObjects([[[GFMultiLineString geometryWithWKT: @"MULTILINESTRING((100 0,101 1),(102 2,103 3))"] copy] toWKTString], @"MULTILINESTRING((100 0,101 1),(102 2,103 3))");
    }
