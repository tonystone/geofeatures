...
private let geoetryDimension = 1    // LineString are always 1 dimension
...
class LineString_Geometry_Coordinate2D_FloatingPrecision_Cartesian_Tests : XCTestCase {
    ...
    func testDimension ()   {
        XCTAssertEqual(LineString<Coordinate2D>(precision: precision, coordinateReferenceSystem: crs).dimension, geoetryDimension)
    }
}
...
class LineString_Geometry_Coordinate2DM_FloatingPrecision_Cartesian_Tests : XCTestCase {
    ...
    func testDimension ()   {
        XCTAssertEqual(LineString<Coordinate2DM>(precision: precision, coordinateReferenceSystem: crs).dimension, geoetryDimension)
    }
}
...
class LineString_Geometry_Coordinate3D_FloatingPrecision_Cartesian_Tests : XCTestCase {
    ...
    func testDimension ()   {
        XCTAssertEqual(LineString<Coordinate3D>(precision: precision, coordinateReferenceSystem: crs).dimension, geoetryDimension)
    }
}
...
class LineString_Geometry_Coordinate3DM_FloatingPrecision_Cartesian_Tests : XCTestCase {
    ...
    func testDimension ()   {
        XCTAssertEqual(LineString<Coordinate3DM>(precision: precision, coordinateReferenceSystem: crs).dimension, geoetryDimension)
    }
}
