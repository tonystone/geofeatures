...
class MultiPointCoordinate2DMFixedPrecisionTests : XCTestCase {
    ...
    func testInit_Tuple () {
        ...
        XCTAssertEqual(
            (MultiPoint<Coordinate2DM>(elements: [Point(coordinate: (x: 1.001, y: 1.001, m: 1.001)),Point(coordinate: (x: 2.002, y: 2.002, m: 2.002))], precision: FloatingPrecision()).elementsEqual([Point(coordinate: (x: 1.0, y: 1.0, m: 1.0)),Point(coordinate: (x: 2.0, y: 2.0, m: 2.0))])
    ...
    func testSubscript_Get () {
        let geometry = MultiPoint<Coordinate2DM>(elements: [Point(coordinate: (x: 1.001, y: 1.001, m: 1.001)),Point(coordinate: (x: 2.002, y: 2.002, m: 2.002))], precision: FloatingPrecision())
        
        XCTAssertEqual(geometry[1] == Point<Coordinate2DM>(coordinate: (x: 2.0, y: 2.0, m: 2.0)), true)
    }
    
    func testSubscript_Set () {
        var geometry = MultiPoint<Coordinate2DM>(elements: [Point(coordinate: (x: 1.001, y: 1.001, m: 1.001)),Point(coordinate: (x: 2.002, y: 2.002, m: 2.002))], precision: FloatingPrecision())
    ...
    func testAppendContentsOf_MultiPoint () {
        ...
        let geometry1 = MultiPoint<Coordinate2DM>(elements: [Point(coordinate: (x: 1.001, y: 1.001, m: 1.001)),Point(coordinate: (x: 2.002, y: 2.002, m: 2.002))], precision: FloatingPrecision())
    ...
    func testIsEmpty_False() {
        XCTAssertEqual(MultiPoint<Coordinate2DM>(elements: [Point(coordinate: (x: 1.001, y: 1.001, m: 1.001)),Point(coordinate: (x: 2.002, y: 2.002, m: 2.002))], precision: FloatingPrecision()).isEmpty(), false)
    }
    
    func testCount () {
        XCTAssertEqual(MultiPoint<Coordinate2DM>(elements: [Point(coordinate: (x: 1.001, y: 1.001, m: 1.001)),Point(coordinate: (x: 2.002, y: 2.002, m: 2.002))], precision: FloatingPrecision()).count, 2)
    }
