...
@implementation GFMultiPoint
    ...
    - (id)initWithWKT:(NSString *)wkt {
        ...
        try {
            climate::gf::MultiPoint multiPoint;
    ...
    - (NSDictionary *)toGeoJSONGeometry {
        ...
        try {
            const climate::gf::MultiPoint & multiPoint = boost::polymorphic_strict_get<climate::gf::MultiPoint>([self cppGeometryConstReference]);

            for (climate::gf::MultiPoint::vector::const_iterator it = multiPoint.begin();  it != multiPoint.end(); ++it ) {
    ...
    - (NSArray *)mkMapOverlays {
        ...
        try {
            ...
            for (climate::gf::MultiPoint::vector::const_iterator it = multiPoint.vector::begin();  it != multiPoint.vector::end(); ++it ) {
