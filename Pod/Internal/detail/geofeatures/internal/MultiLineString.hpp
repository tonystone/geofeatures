...
namespace geofeatures {
    namespace internal {
        ...
        */
        typedef std::vector<geofeatures::internal::LineString> MultiLineStringBaseType;
...
namespace geofeatures_boost {
        namespace geometry {
            ...
            {
                template<>
                struct tag<geofeatures::internal::MultiLineString> {
        ...
        template<>
        struct range_iterator<geofeatures::internal::MultiLineString>
        { typedef geofeatures::internal::MultiLineStringBaseType::iterator type; };

        template<>
        struct range_const_iterator<geofeatures::internal::MultiLineString>
        { typedef geofeatures::internal::MultiLineStringBaseType::const_iterator type; };
