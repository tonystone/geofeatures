...
namespace geofeatures {
    namespace internal {
        ...
        */
        typedef std::vector<geofeatures::internal::Point> MultiPointBaseType;
...
namespace geofeatures_boost {
    namespace geometry {
        ...
        {
            template<>
            struct tag<geofeatures::internal::MultiPoint> {
    ...
    template<>
    struct range_iterator<geofeatures::internal::MultiPoint>
    { typedef geofeatures::internal::MultiPointBaseType::iterator type; };

    template<>
    struct range_const_iterator<geofeatures::internal::MultiPoint>
    { typedef geofeatures::internal::MultiPointBaseType::const_iterator type; };
