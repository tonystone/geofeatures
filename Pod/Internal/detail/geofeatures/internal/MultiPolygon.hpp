...
namespace geofeatures {
    namespace internal {
        ...
        */
        typedef std::vector<geofeatures::internal::Polygon> MultiPolygonBaseType;
...
namespace geofeatures_boost {
    namespace geometry {
        ...
        {
            template<>
            struct tag<geofeatures::internal::MultiPolygon> {
    ...
    template<>
    struct range_iterator<geofeatures::internal::MultiPolygon>
    { typedef geofeatures::internal::MultiPolygonBaseType::iterator type; };

    template<>
    struct range_const_iterator<geofeatures::internal::MultiPolygon>
    { typedef geofeatures::internal::MultiPolygonBaseType::const_iterator type; };
