...
namespace geofeatures_boost {
    namespace geometry {
        namespace traits {
            // Adapt geofeatures::internal::Box to Boost.Geometry

            template <> struct tag<geofeatures::internal::Box>
            {  typedef box_tag type; };

            template <> struct point_type<geofeatures::internal::Box>
            { typedef geofeatures::internal::Point type; };

            template <std::size_t Dimension>
            struct indexed_access<geofeatures::internal::Box, min_corner, Dimension>
            {
                typedef typename geometry::coordinate_type<geofeatures::internal::Point>::type coordinate_type;

                static inline coordinate_type get(geofeatures::internal::Box const& b)
                {
                    return geometry::get<Dimension>(b.minCorner());
                }

                static inline void set(geofeatures::internal::Box& b, coordinate_type const& value)
                {
            ...
            template <std::size_t Dimension>
            struct indexed_access<geofeatures::internal::Box, max_corner, Dimension>
            {
                typedef typename geometry::coordinate_type<geofeatures::internal::Point>::type coordinate_type;
