                                   ...
                                   const interval<T, Policies>& y)
{
  ...
  const T& yl = y.lower();
  const T& yu = y.upper();
  if (::geofeatures_boost::numeric::interval_lib::user::is_neg(xu))
    if (::geofeatures_boost::numeric::interval_lib::user::is_neg(yu))
      return I(rnd.div_down(xu, yl), rnd.div_up(xl, yu), true);
    else
      return I(rnd.div_down(xl, yl), rnd.div_up(xu, yu), true);
  else if (::geofeatures_boost::numeric::interval_lib::user::is_neg(xl))
    if (::geofeatures_boost::numeric::interval_lib::user::is_neg(yu))
...
interval<T, Policies> div_non_zero(const T& x, const interval<T, Policies>& y)
{
  ...
  const T& yl = y.lower();
  const T& yu = y.upper();
  if (::geofeatures_boost::numeric::interval_lib::user::is_neg(x))
...
{
  // assert(::geofeatures_boost::numeric::interval_lib::user::is_pos(yu));
  if (::geofeatures_boost::numeric::interval_lib::user::is_zero(x.lower()) &&
      ::geofeatures_boost::numeric::interval_lib::user::is_zero(x.upper()))
    return x;
  typename Policies::rounding rnd;
  typedef interval<T, Policies> I;
  const T& xl = x.lower();
...
interval<T, Policies> div_positive(const T& x, const T& yu)
{
  // assert(::geofeatures_boost::numeric::interval_lib::user::is_pos(yu));
  typedef interval<T, Policies> I;
  if (::geofeatures_boost::numeric::interval_lib::user::is_zero(x))
...
{
  // assert(::geofeatures_boost::numeric::interval_lib::user::is_neg(yl));
  if (::geofeatures_boost::numeric::interval_lib::user::is_zero(x.lower()) &&
      ::geofeatures_boost::numeric::interval_lib::user::is_zero(x.upper()))
    return x;
  typename Policies::rounding rnd;
...
{
  // assert(::geofeatures_boost::numeric::interval_lib::user::is_neg(y.lower()) && ::geofeatures_boost::numeric::interval_lib::user::is_pos(y.upper()));
  if (::geofeatures_boost::numeric::interval_lib::user::is_zero(x.lower()) && ::geofeatures_boost::numeric::interval_lib::user::is_zero(x.upper()))
    { b = false; return x; }
  typename Policies::rounding rnd;
  typedef interval<T, Policies> I;
  const T& xl = x.lower();
...
interval<T, Policies> div_zero_part2(const interval<T, Policies>& x,
                                     const interval<T, Policies>& y)
{
  // assert(::geofeatures_boost::numeric::interval_lib::user::is_neg(y.lower()) && ::geofeatures_boost::numeric::interval_lib::user::is_pos(y.upper()) && (div_zero_part1(x, y, b), b));
  typename Policies::rounding rnd;
  typedef interval<T, Policies> I;
  typedef typename Policies::checking checking;
  if (::geofeatures_boost::numeric::interval_lib::user::is_neg(x.upper()))
