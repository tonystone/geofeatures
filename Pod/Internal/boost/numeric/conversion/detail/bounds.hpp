...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace numeric { namespace boundsdetail
{
  template<class N>
  class Integral
  {
...
} } } // namespace geofeatures_boost::numeric::boundsdetail.
