...
//             geofeatures_boost::detail::type to boost/type.hpp. Made it compile with
...
#  define BOOST_EXPLICIT_DEFAULT_TARGET , ::geofeatures_boost::type<Target>* = 0
# else
...
//  numeric_cast  ------------------------------------------------------------//
    ...
    namespace detail
    {
      ...
      // Move to namespace geofeatures_boost in utility.hpp?
...
# ifdef BOOST_HAS_LONG_LONG
      ...
      template <>
      struct fixed_numeric_limits_base< ::geofeatures_boost::long_long_type, false>
      {
          BOOST_STATIC_CONSTANT(bool, is_specialized = true);
          BOOST_STATIC_CONSTANT(bool, is_signed = true);
          static  ::geofeatures_boost::long_long_type max BOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef LONGLONG_MAX
              return LONGLONG_MAX;
#  else
...
#  endif
          ...
          static  ::geofeatures_boost::long_long_type min BOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef LONGLONG_MIN
              return LONGLONG_MIN;
#  else
...
#  endif
      ...
      template <>
      struct fixed_numeric_limits_base< ::geofeatures_boost::ulong_long_type, false>
      {
          BOOST_STATIC_CONSTANT(bool, is_specialized = true);
          BOOST_STATIC_CONSTANT(bool, is_signed = false);
          static  ::geofeatures_boost::ulong_long_type max BOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef ULONGLONG_MAX
...
#  endif
          ...
          static  ::geofeatures_boost::ulong_long_type min BOOST_PREVENT_MACRO_SUBSTITUTION () { return 0; }
      };
# endif
    } // namespace detail
