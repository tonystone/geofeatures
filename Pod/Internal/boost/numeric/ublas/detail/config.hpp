...
namespace std {
    template<class V>
    inline
    void swap (geofeatures_boost::numeric::ublas::index_pair<V> i1, geofeatures_boost::numeric::ublas::index_pair<V> i2) {
        i1.swap (i2);
    }
    template<class M>
    inline
    void swap (geofeatures_boost::numeric::ublas::index_triple<M> i1, geofeatures_boost::numeric::ublas::index_triple<M> i2) {
        i1.swap (i2);
    }
    // iter_swap also needed for ICC on Itanium?
    template<class C, class IC>
    inline
    void iter_swap (geofeatures_boost::numeric::ublas::indexed_iterator<C, IC> it1,
                    geofeatures_boost::numeric::ublas::indexed_iterator<C, IC> it2) {
        swap (*it1, *it2);
    }
}
#endif
