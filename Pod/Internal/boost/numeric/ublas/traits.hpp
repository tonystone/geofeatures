...
template<typename T>
inline typename geofeatures_boost::disable_if<
    geofeatures_boost::is_unsigned<T>, T >::type
...
template<typename T>
inline typename geofeatures_boost::enable_if<
    geofeatures_boost::is_unsigned<T>, T >::type
    boost_numeric_ublas_abs (const T &t ) {
        return t;
    }
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace numeric { namespace ublas {
    ...
    typename geofeatures_boost::enable_if<
      mpl::and_<
        geofeatures_boost::is_float<R>,
        geofeatures_boost::is_integral<I>
        >,
    ...
    template<>
    struct type_traits<geofeatures_boost::numeric::interval<float> > : scalar_traits<geofeatures_boost::numeric::interval<float> > {
        typedef type_traits<geofeatures_boost::numeric::interval<float> > self_type;
        typedef geofeatures_boost::numeric::interval<float> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef geofeatures_boost::numeric::interval<double> precision_type;

    };
    template<>
    struct type_traits<geofeatures_boost::numeric::interval<double> > : scalar_traits<geofeatures_boost::numeric::interval<double> > {
        typedef type_traits<geofeatures_boost::numeric::interval<double> > self_type;
        typedef geofeatures_boost::numeric::interval<double> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef geofeatures_boost::numeric::interval<long double> precision_type;
    };
    template<>
    struct type_traits<geofeatures_boost::numeric::interval<long double> > : scalar_traits<geofeatures_boost::numeric::interval<long double> > {
        typedef type_traits<geofeatures_boost::numeric::interval<long double> > self_type;
        typedef geofeatures_boost::numeric::interval<long double> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef value_type precision_type;
    ...
    namespace detail {
        ...
        template<typename T>
        struct has_trivial_constructor : public geofeatures_boost::has_trivial_constructor<T> {};

        template<typename T>
        struct has_trivial_destructor : public geofeatures_boost::has_trivial_destructor<T> {};
