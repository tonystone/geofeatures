...
#else
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace numeric { namespace ublas { namespace raw {
}}}}
#endif
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace numeric { namespace ublas {
    ...
    struct scalar_binary_assign_functor {
        ...
        typedef typename type_traits<typename geofeatures_boost::remove_reference<T1>::type>::reference argument1_type;
        typedef typename type_traits<T2>::const_reference argument2_type;
    };
    ...
    struct scalar_binary_swap_functor {
        typedef typename type_traits<typename geofeatures_boost::remove_reference<T1>::type>::reference argument1_type;
        typedef typename type_traits<typename geofeatures_boost::remove_reference<T2>::type>::reference argument2_type;
    };
    ...
    struct vector_inner_prod:
        ...
        result_type apply (const vector_container<C1> &c1,
            ...
            return geofeatures_boost::numeric::bindings::atlas::dot (c1 (), c2 ());
#else
    ...
    struct matrix_vector_prod1:
        ...
        result_type apply (const matrix_container<C1> &c1,
            ...
            return t;
#elif defined(BOOST_UBLAS_HAVE_BINDINGS)
            return geofeatures_boost::numeric::bindings::atlas::dot (c1 ().row (i), c2 ());
#else
    ...
    struct matrix_vector_prod2:
        ...
        result_type apply (const vector_container<C1> &c1,
            ...
            return t;
#elif defined(BOOST_UBLAS_HAVE_BINDINGS)
            return geofeatures_boost::numeric::bindings::atlas::dot (c1 (), c2 ().column (i));
#else
    ...
    struct matrix_matrix_prod:
        ...
        result_type apply (const matrix_container<C1> &c1,
            ...
            return t;
#elif defined(BOOST_UBLAS_HAVE_BINDINGS)
            return geofeatures_boost::numeric::bindings::atlas::dot (c1 ().row (i), c2 ().column (j));
#else
            geofeatures_boost::ignore_unused(j);
