...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        typedef typename geofeatures_boost::mpl::if_<geofeatures_boost::is_const<E>,
    ...
    class matrix_unary2:
        ...
        typedef typename geofeatures_boost::mpl::if_<geofeatures_boost::is_same<F, scalar_identity<typename E::value_type> >,
                                          E,
                                          const E>::type expression_type;
        typedef F functor_type;
    public:
        typedef typename geofeatures_boost::mpl::if_<geofeatures_boost::is_const<expression_type>,
    ...
    public:
        ...
        typedef typename F::result_type value_type;
        typedef value_type const_reference;
        typedef typename geofeatures_boost::mpl::if_<geofeatures_boost::is_same<F, scalar_identity<value_type> >,
                                          typename E::reference,
                                          value_type>::type reference;

        typedef const self_type const_closure_type;
        typedef self_type closure_type;
        typedef typename geofeatures_boost::mpl::if_<geofeatures_boost::is_same<typename E::orientation_category,
                                                         row_major_tag>,
                                          column_major_tag,
                typename geofeatures_boost::mpl::if_<geofeatures_boost::is_same<typename E::orientation_category,
                                                         column_major_tag>,
                                          row_major_tag,
    ...
    public:
        ...
        BOOST_UBLAS_INLINE
        reference operator () (size_type i, size_type j) {
            BOOST_STATIC_ASSERT ((geofeatures_boost::is_same<functor_type, scalar_identity<value_type > >::value));
            return e_ (j, i);
        }
...
#else
                return functor_type::apply (geofeatures_boost::numeric::ublas::begin (it1_, iterator1_tag ()),
                                        geofeatures_boost::numeric::ublas::end (it1_, iterator1_tag ()),
                                        mvb.expression2 ().begin (), mvb.expression2 ().end ());
#endif
#endif
            }
    ...
    public:
        ...
        private:
...
#else
                return functor_type::apply (mvb.expression1 ().begin (), mvb.expression1 ().end (),
                                        geofeatures_boost::numeric::ublas::begin (it2_, iterator2_tag ()),
                                        geofeatures_boost::numeric::ublas::end (it2_, iterator2_tag ()));
#endif
#endif
            }
            ...
            value_type dereference (sparse_bidirectional_iterator_tag) const {
                ...
                return functor_type::apply (mvb.expression1 ().begin (), mvb.expression1 ().end (),
                                        geofeatures_boost::numeric::ublas::begin (it2_, iterator2_tag ()),
                                        geofeatures_boost::numeric::ublas::end (it2_, iterator2_tag ()), sparse_bidirectional_iterator_tag ());
#endif
#endif
            }
        ...
        private:
            ...
            value_type dereference (packed_random_access_iterator_tag) const {
                ...
                return functor_type::apply (geofeatures_boost::numeric::ublas::begin (it1_, iterator1_tag ()),
                                        geofeatures_boost::numeric::ublas::end (it1_, iterator1_tag ()),
                                        geofeatures_boost::numeric::ublas::begin (it2_, iterator2_tag ()),
                                        geofeatures_boost::numeric::ublas::end (it2_, iterator2_tag ()), packed_random_access_iterator_tag ());
#endif
#endif
            }
