...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        typedef typename geofeatures_boost::mpl::if_<geofeatures_boost::is_const<V>,
     ...
     * - \c geofeatures_boost::numeric::ublas::vector<int> can work too (\c int can be replaced by another integer type)
     * - etc...
     *
