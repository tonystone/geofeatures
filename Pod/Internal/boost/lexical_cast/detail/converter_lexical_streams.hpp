...
#       error "geofeatures_boost::lexical_cast to use only 'C' locale during conversions."
#   endif
#endif
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost {
    ...
    namespace detail // optimized stream wrappers
    {
        template< class CharT // a result of widest_char transformation
                ...
                >
        class lexical_istream_limited_src: geofeatures_boost::noncopyable {
...
/************************************ HELPER FUNCTIONS FOR OPERATORS << ( ... ) ********************************/
            ...
            bool shl_char(T ch) {
                BOOST_STATIC_ASSERT_MSG(( sizeof(T) <= sizeof(CharT)) ,
                    "geofeatures_boost::lexical_cast does not support narrowing of char types."
                    "Use geofeatures_boost::locale instead" );
#ifndef BOOST_LEXICAL_CAST_ASSUME_C_LOCALE
                std::locale loc;
            ...
            bool shl_input_streamable(InputStreamable& input) {
                ...
                BOOST_STATIC_ASSERT((geofeatures_boost::is_same<char, CharT>::value));
#endif
            ...
            inline bool shl_signed(const T n) {
                CharT* tmp_finish = buffer + CharacterBufferSize;
                typedef BOOST_DEDUCED_TYPENAME geofeatures_boost::make_unsigned<T>::type utype;
            ...
            bool shl_real_type(float val, char* begin) {
                ...
                finish = start +
                    ...
                    sprintf(begin, 
#endif
                    "%.*g", static_cast<int>(geofeatures_boost::detail::lcast_get_precision<float>()), val_as_double);
                return finish > start;
            }
            ...
            bool shl_real_type(double val, char* begin) {
                ...
                finish = start +
                    ...
                    sprintf(begin, 
#endif
                    "%.*g", static_cast<int>(geofeatures_boost::detail::lcast_get_precision<double>()), val);
                return finish > start;
            }
            ...
            bool shl_real_type(long double val, char* begin) {
                ...
                finish = start +
                    ...
                    sprintf(begin, 
#endif
                    "%.*Lg", static_cast<int>(geofeatures_boost::detail::lcast_get_precision<long double>()), val );
                return finish > start;
            }
#endif
            ...
            bool shl_real_type(float val, wchar_t* begin) {
                ...
                finish = start + swprintf(begin, CharacterBufferSize,
                                       L"%.*g",
                                       static_cast<int>(geofeatures_boost::detail::lcast_get_precision<float >()),
                                       val_as_double );
                return finish > start;
            }
            ...
            bool shl_real_type(double val, wchar_t* begin) {
                using namespace std;
                finish = start + swprintf(begin, CharacterBufferSize,
                                          L"%.*g", static_cast<int>(geofeatures_boost::detail::lcast_get_precision<double >()), val );
                return finish > start;
            }
            ...
            bool shl_real_type(long double val, wchar_t* begin) {
                using namespace std;
                finish = start + swprintf(begin, CharacterBufferSize,
                                          L"%.*Lg", static_cast<int>(geofeatures_boost::detail::lcast_get_precision<long double >()), val );
                return finish > start;
            }
#endif
            template <class T>
...
/************************************ OPERATORS << ( ... ) ********************************/
        public:
            ...
            template<class Alloc>
            bool operator<<(geofeatures_boost::container::basic_string<CharT,Traits,Alloc> const& str) BOOST_NOEXCEPT {
                start = str.data();
                finish = start + str.length();
                return true;
            }
            ...
            template <class C>
            BOOST_DEDUCED_TYPENAME geofeatures_boost::disable_if<geofeatures_boost::is_const<C>, bool>::type 
            ...
            bool operator<<(geofeatures_boost::ulong_long_type n)   { return shl_unsigned(n); }
            bool operator<<(geofeatures_boost::long_long_type n)    { return shl_signed(n); }
            ...
            bool operator<<(const geofeatures_boost::uint128_type& n)   { return shl_unsigned(n); }
            bool operator<<(const geofeatures_boost::int128_type& n)    { return shl_signed(n); }
#endif
            ...
            BOOST_DEDUCED_TYPENAME geofeatures_boost::disable_if<geofeatures_boost::is_const<C>, bool>::type
            operator<<(geofeatures_boost::array<C, N> const& input) BOOST_NOEXCEPT { 
                BOOST_STATIC_ASSERT_MSG(
                    (sizeof(geofeatures_boost::array<const C, N>) == sizeof(geofeatures_boost::array<C, N>)),
                    "geofeatures_boost::array<C, N> and geofeatures_boost::array<const C, N> must have exactly the same layout."
                );
                return ((*this) << reinterpret_cast<geofeatures_boost::array<const C, N> const& >(input)); 
            }

            template <std::size_t N>
            bool operator<<(geofeatures_boost::array<const CharT, N> const& input) BOOST_NOEXCEPT { 
                return shl_char_array_limited(input.begin(), N); 
            }

            template <std::size_t N>
            bool operator<<(geofeatures_boost::array<const unsigned char, N> const& input) BOOST_NOEXCEPT { 
                return ((*this) << reinterpret_cast<geofeatures_boost::array<const char, N> const& >(input)); 
            }

            template <std::size_t N>
            bool operator<<(geofeatures_boost::array<const signed char, N> const& input) BOOST_NOEXCEPT { 
                return ((*this) << reinterpret_cast<geofeatures_boost::array<const char, N> const& >(input)); 
            }
            ...
            bool operator<<(std::array<C, N> const& input) BOOST_NOEXCEPT { 
                BOOST_STATIC_ASSERT_MSG(
                    (sizeof(std::array<C, N>) == sizeof(geofeatures_boost::array<C, N>)),
                    "std::array and geofeatures_boost::array must have exactly the same layout. "
                    "Bug in implementation of std::array or geofeatures_boost::array."
                );
                return ((*this) << reinterpret_cast<geofeatures_boost::array<C, N> const& >(input)); 
            }
#endif
        ...
        template <class CharT, class Traits>
        class lexical_ostream_limited_src: geofeatures_boost::noncopyable {
...
/************************************ HELPER FUNCTIONS FOR OPERATORS >> ( ... ) ********************************/
        private:
            ...
            {
                BOOST_STATIC_ASSERT_MSG(
                    (!geofeatures_boost::is_pointer<InputStreamable>::value),
                    "geofeatures_boost::lexical_cast can not convert to pointers"
                );

#if defined(BOOST_NO_STRINGSTREAM) || defined(BOOST_NO_STD_LOCALE)
                BOOST_STATIC_ASSERT_MSG((geofeatures_boost::is_same<char, CharT>::value),
                    "geofeatures_boost::lexical_cast can not convert, because your STL library does not "
            ...
            inline bool shr_xchar(T& output) BOOST_NOEXCEPT {
                BOOST_STATIC_ASSERT_MSG(( sizeof(CharT) == sizeof(T) ),
                    "geofeatures_boost::lexical_cast does not support narrowing of character types."
                    "Use geofeatures_boost::locale instead" );
...
/************************************ OPERATORS >> ( ... ) ********************************/
        public:
...
#if defined(BOOST_HAS_LONG_LONG)
            bool operator>>(geofeatures_boost::ulong_long_type& output)     { return shr_unsigned(output); }
            bool operator>>(geofeatures_boost::long_long_type& output)      { return shr_signed(output); }
#elif defined(BOOST_HAS_MS_INT64)
...
#ifdef BOOST_HAS_INT128
            bool operator>>(geofeatures_boost::uint128_type& output)        { return shr_unsigned(output); }
            bool operator>>(geofeatures_boost::int128_type& output)         { return shr_signed(output); }
#endif
            ...
            template<class Alloc>
            bool operator>>(geofeatures_boost::container::basic_string<CharT,Traits,Alloc>& str) { 
                str.assign(start, finish); return true; 
            }

            template <std::size_t N>
            bool operator>>(geofeatures_boost::array<CharT, N>& output) BOOST_NOEXCEPT { 
                return shr_std_array<N>(output); 
            }

            template <std::size_t N>
            bool operator>>(geofeatures_boost::array<unsigned char, N>& output) BOOST_NOEXCEPT { 
                return ((*this) >> reinterpret_cast<geofeatures_boost::array<char, N>& >(output)); 
            }

            template <std::size_t N>
            bool operator>>(geofeatures_boost::array<signed char, N>& output) BOOST_NOEXCEPT { 
                return ((*this) >> reinterpret_cast<geofeatures_boost::array<char, N>& >(output)); 
            }
            ...
            bool operator>>(std::array<C, N>& output) BOOST_NOEXCEPT { 
                BOOST_STATIC_ASSERT_MSG(
                    (sizeof(geofeatures_boost::array<C, N>) == sizeof(geofeatures_boost::array<C, N>)),
                    "std::array<C, N> and geofeatures_boost::array<C, N> must have exactly the same layout."
                );
                return ((*this) >> reinterpret_cast<geofeatures_boost::array<C, N>& >(output));
            }
#endif
