...
namespace geofeatures_boost_optional_detail
{
...
class aligned_storage
{
    ...
    dummy_u
    {
        ...
        BOOST_DEDUCED_TYPENAME type_with_alignment<
          ::geofeatures_boost::alignment_of<T>::value >::type aligner_;
    } dummy_ ;
...
#else
  static rval_reference_type move(reference_type r) { return geofeatures_boost::move(r); }
#endif
#endif
...
void prevent_binding_rvalue_ref_to_optional_lvalue_ref()
{
  ...
  BOOST_STATIC_ASSERT_MSG(
    !geofeatures_boost::is_lvalue_reference<To>::value || !geofeatures_boost::is_rvalue_reference<From>::value, 
...
class optional_base : public optional_tag
{
...
#endif
    ::geofeatures_boost::detail::make_reference_content<T>::type internal_type ;
  ...
  protected:
    ...
    optional_base ( rval_reference_type val )
      ...
      m_initialized(false)
    {
      construct( geofeatures_boost::move(val) );
    }
#endif
    ...
    {
      if ( rhs.is_initialized() )
        construct( geofeatures_boost::move(rhs.get_impl()) );
    }
#endif
    ...
    explicit optional_base ( Expr&& expr, PtrExpr const* tag )
      ...
      m_initialized(false)
    {
      construct(geofeatures_boost::forward<Expr>(expr),tag);
    }
    ...
    void assign ( optional_base&& rhs )
    {
      ...
      {
        if ( rhs.is_initialized() )
             assign_value(geofeatures_boost::move(rhs.get_impl()), is_reference_predicate() );
        else destroy();
      }
      else
      {
    ...
    {
      if (is_initialized())
           assign_value( geofeatures_boost::move(val), is_reference_predicate() );
      else construct( geofeatures_boost::move(val) );
    }
#endif
    ...
    {
      if (is_initialized())
        assign_expr_to_initialized(geofeatures_boost::forward<Expr>(expr),tag);
      else construct(geofeatures_boost::forward<Expr>(expr),tag);
    }
#else
    template<class Expr>
  ...
  protected :
    ...
    void emplace_assign ( Args&&... args )
     {
       destroy();
       ::new (m_storage.address()) internal_type( geofeatures_boost::forward<Args>(args)... );
       m_initialized = true ;
     }
    ...
    void emplace_assign ( Arg&& arg )
     {
       destroy();
       ::new (m_storage.address()) internal_type( geofeatures_boost::forward<Arg>(arg) );
       m_initialized = true ;
     }
    ...
    void construct ( Expr&& factory, in_place_factory_base const* )
     {
       BOOST_STATIC_ASSERT ( ::geofeatures_boost::mpl::not_<is_reference_predicate>::value ) ;
       geofeatures_boost_optional_detail::construct<value_type>(factory, m_storage.address());
       m_initialized = true ;
     }
    ...
    {
      new (m_storage.address()) internal_type(geofeatures_boost::forward<Expr>(expr)) ;
      m_initialized = true ;
    }
    ...
    {
      assign_value(geofeatures_boost::forward<Expr>(expr), is_reference_predicate());
    }
#else
    // Constructs using any expression implicitly convertible to the single argument
    // of a one-argument T constructor.
...
class optional : public optional_detail::optional_base<T>
{
  ...
  public :
    ...
    // Can throw if T::T(T &&) does
    optional ( rval_reference_type val ) : base( geofeatures_boost::forward<T>(val) ) 
    ...
    {
      if ( rhs.is_initialized() )
        this->construct( geofeatures_boost::move(rhs.get()) );
    }
#endif
  ...
  explicit optional ( Expr&& expr, 
                      BOOST_DEDUCED_TYPENAME geofeatures_boost::disable_if_c<
                        (geofeatures_boost::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME geofeatures_boost::decay<Expr>::type>::value) || 
                        geofeatures_boost::is_same<BOOST_DEDUCED_TYPENAME geofeatures_boost::decay<Expr>::type, none_t>::value >::type* = 0 
  ) 
    : base(geofeatures_boost::forward<Expr>(expr),geofeatures_boost::addressof(expr)) 
    {optional_detail::prevent_binding_rvalue_ref_to_optional_lvalue_ref<T, Expr&&>();}

#else
    template<class Expr>
    explicit optional ( Expr const& expr ) : base(expr,geofeatures_boost::addressof(expr)) {}
	...
	optional ( optional && rhs ) 
	  BOOST_NOEXCEPT_IF(::geofeatures_boost::is_nothrow_move_constructible<T>::value)
	  : base( geofeatures_boost::move(rhs) ) 
	{}
   ...
   // No-throw (assuming T::~T() doesn't)
    ...
    BOOST_DEDUCED_TYPENAME geofeatures_boost::disable_if_c<
      geofeatures_boost::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME geofeatures_boost::decay<Expr>::type>::value || 
        geofeatures_boost::is_same<BOOST_DEDUCED_TYPENAME geofeatures_boost::decay<Expr>::type, none_t>::value,
      optional&
    >::type 
    operator= ( Expr&& expr )
      {
        optional_detail::prevent_binding_rvalue_ref_to_optional_lvalue_ref<T, Expr&&>();
        this->assign_expr(geofeatures_boost::forward<Expr>(expr),geofeatures_boost::addressof(expr));
        return *this ;
      }
    ...
    optional& operator= ( Expr const& expr )
      {
        this->assign_expr(expr,geofeatures_boost::addressof(expr));
        return *this ;
      }
#endif // !defined  BOOST_OPTIONAL_DETAIL_NO_RVALUE_REFERENCES
    ...
    optional& operator= ( optional<U> && rhs )
      {
        this->assign(geofeatures_boost::move(rhs));
        return *this ;
      }
#endif
    ...
    optional& operator= ( optional && rhs ) 
	  BOOST_NOEXCEPT_IF(::geofeatures_boost::is_nothrow_move_constructible<T>::value && ::geofeatures_boost::is_nothrow_move_assignable<T>::value)
      {
    ...
    optional& operator= ( rval_reference_type val )
      {
        optional_detail::prevent_binding_rvalue_ref_to_optional_lvalue_ref<T, rval_reference_type>();
        this->assign( geofeatures_boost::move(val) ) ;
        return *this ;
      }
#endif
    ...
    void emplace ( Args&&... args )
     {
       this->emplace_assign( geofeatures_boost::forward<Args>(args)... );
     }
#elif (!defined BOOST_OPTIONAL_DETAIL_NO_RVALUE_REFERENCES)
    template<class Arg>
    void emplace ( Arg&& arg )
     {
       this->emplace_assign( geofeatures_boost::forward<Arg>(arg) );
     }
    ...
    void swap( optional & arg )
	  BOOST_NOEXCEPT_IF(::geofeatures_boost::is_nothrow_move_constructible<T>::value && ::geofeatures_boost::is_nothrow_move_assignable<T>::value)
      {
        ...
        geofeatures_boost::swap(*this, arg);
      }
    ...
    value_type value_or ( U&& v ) const&
      { 
        if (this->is_initialized())
          ...
          return geofeatures_boost::forward<U>(v);
      }
...
{
  BOOST_STATIC_ASSERT_MSG(sizeof(CharType) == 0, "If you want to output geofeatures_boost::optional, include header <boost/optional/optional_io.hpp>");
  return os;  
}
...
struct swap_selector<true>
{
    ...
    static void optional_swap ( optional<T>& x, optional<T>& y )
    {
        ...
        geofeatures_boost::swap(x.get(),y.get());

        if( !hasX )
            y = geofeatures_boost::none ;
        else if( !hasY )
            x = geofeatures_boost::none ;
    }
};
...
struct swap_selector<false>
{
    template<class T>
    static void optional_swap ( optional<T>& x, optional<T>& y ) 
    //BOOST_NOEXCEPT_IF(::geofeatures_boost::is_nothrow_move_constructible<T>::value && BOOST_NOEXCEPT_EXPR(geofeatures_boost::swap(*x, *y)))
    {
        if(x)
        {
            if (y)
            {
                geofeatures_boost::swap(*x, *y);
            }
            else
            {
                y = geofeatures_boost::move(*x);
                x = geofeatures_boost::none;
            }
        }
        else
...
template<class T>
struct optional_swap_should_use_default_constructor : geofeatures_boost::false_type {} ;
