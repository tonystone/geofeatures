...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost{ namespace multiprecision{ namespace backends{ namespace detail{
...
{
   return checked_add_imp(a, b, geofeatures_boost::is_signed<A>());
}
template <class A>
...
{
   return checked_subtract_imp(a, b, geofeatures_boost::is_signed<A>());
}
template <class A>
...
template <class A>
inline A checked_left_shift(A a, geofeatures_boost::ulong_long_type shift, const mpl::int_<checked>&)
{
   if(a && shift)
   {
...
template <class A>
inline A checked_left_shift(A a, geofeatures_boost::ulong_long_type shift, const mpl::int_<unchecked>&)
{
