...
struct pack_values
{
   ...
   typedef typename geofeatures_boost::mpl::if_c<shift == 0,
...
struct signed_cpp_int_literal_result_type
{
   ...
   typedef geofeatures_boost::multiprecision::backends::cpp_int_backend<bits, bits, signed_magnitude, unchecked, void> backend_type;
...
{
   static constexpr unsigned bits = Digits * 4;
   typedef geofeatures_boost::multiprecision::backends::cpp_int_backend<bits, bits, unsigned_magnitude, unchecked, void> backend_type;
   typedef number<backend_type, et_off> number_type;
};
...
template <char... STR>
constexpr typename geofeatures_boost::multiprecision::literals::detail::signed_cpp_int_literal_result_type<(sizeof...(STR)) - 2>::number_type operator "" _cppi()
{
   typedef typename geofeatures_boost::multiprecision::literals::detail::make_packed_value_from_str<STR...>::type pt;
   return geofeatures_boost::multiprecision::literals::detail::make_backend_from_pack<pt, typename geofeatures_boost::multiprecision::literals::detail::signed_cpp_int_literal_result_type<(sizeof...(STR)) - 2>::backend_type>::value;
}

template <char... STR>
constexpr typename geofeatures_boost::multiprecision::literals::detail::unsigned_cpp_int_literal_result_type<(sizeof...(STR)) - 2>::number_type operator "" _cppui()
{
   typedef typename geofeatures_boost::multiprecision::literals::detail::make_packed_value_from_str<STR...>::type pt;
   return geofeatures_boost::multiprecision::literals::detail::make_backend_from_pack<pt, typename geofeatures_boost::multiprecision::literals::detail::unsigned_cpp_int_literal_result_type<(sizeof...(STR)) - 2>::backend_type>::value;
}

#define BOOST_MP_DEFINE_SIZED_CPP_INT_LITERAL(Bits)\
template <char... STR> \
constexpr geofeatures_boost::multiprecision::number<geofeatures_boost::multiprecision::backends::cpp_int_backend<Bits, Bits, geofeatures_boost::multiprecision::signed_magnitude, geofeatures_boost::multiprecision::unchecked, void> > operator "" BOOST_JOIN(_cppi, Bits)()\
{\
   typedef typename geofeatures_boost::multiprecision::literals::detail::make_packed_value_from_str<STR...>::type pt;\
   return geofeatures_boost::multiprecision::literals::detail::make_backend_from_pack<\
      pt, \
      geofeatures_boost::multiprecision::backends::cpp_int_backend<Bits, Bits, geofeatures_boost::multiprecision::signed_magnitude, geofeatures_boost::multiprecision::unchecked, void> \
   >::value;\
}\
template <char... STR> \
constexpr geofeatures_boost::multiprecision::number<geofeatures_boost::multiprecision::backends::cpp_int_backend<Bits, Bits, geofeatures_boost::multiprecision::unsigned_magnitude, geofeatures_boost::multiprecision::unchecked, void> > operator "" BOOST_JOIN(_cppui, Bits)()\
{\
   typedef typename geofeatures_boost::multiprecision::literals::detail::make_packed_value_from_str<STR...>::type pt;\
   return geofeatures_boost::multiprecision::literals::detail::make_backend_from_pack<\
      pt, \
      geofeatures_boost::multiprecision::backends::cpp_int_backend<Bits, Bits, geofeatures_boost::multiprecision::unsigned_magnitude, geofeatures_boost::multiprecision::unchecked, void>\
   >::value;\
}\
...
{
   return cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>(a.backend(), geofeatures_boost::multiprecision::literals::detail::make_negate_tag());
}
template <unsigned MinBits, cpp_int_check_type Checked>
constexpr number<cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>, et_off>
   operator - (number<cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>, et_off>&& a)
{
   return cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>(static_cast<const number<cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>, et_off>&>(a).backend(), geofeatures_boost::multiprecision::literals::detail::make_negate_tag());
}
