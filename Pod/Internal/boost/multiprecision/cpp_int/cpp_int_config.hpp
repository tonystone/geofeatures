...
// [unsigned] geofeatures_boost::long_long_type, long, int, which has the specified number
// of bits.  Note that intN_t and geofeatures_boost::int_t<N> find the first
...
struct largest_signed_type
{
   typedef typename mpl::if_c<
      1 + std::numeric_limits<geofeatures_boost::long_long_type>::digits == N,
      ...
      typename mpl::if_c<
         ...
         typename mpl::if_c<
            ...
            int,
            typename geofeatures_boost::int_t<N>::exact
         >::type
      >::type
   >::type type;
};
...
{
   typedef typename mpl::if_c<
      std::numeric_limits<geofeatures_boost::ulong_long_type>::digits == N,
      ...
      typename mpl::if_c<
         ...
         typename mpl::if_c<
            ...
            unsigned int,
            typename geofeatures_boost::uint_t<N>::exact
         >::type
      >::type
   >::type type;
};
...
typedef geofeatures_boost::uint128_type double_limb_type;
typedef geofeatures_boost::int128_type signed_double_limb_type;
