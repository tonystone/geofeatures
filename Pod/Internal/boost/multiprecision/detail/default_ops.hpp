...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost{ namespace multiprecision{ namespace default_ops{
...
inline void eval_convert_to(terminal<R>* result, const B& backend)
{
   ...
   //
   result->value = geofeatures_boost::lexical_cast<R>(backend.str(0, std::ios_base::fmtflags(0)));
}
...
{
   typedef typename geofeatures_boost::multiprecision::detail::canonical<A, T>::type canonical_type;
...
inline void eval_trunc(T& result, const T& a)
{
   ...
   {
      result = geofeatures_boost::math::policies::raise_rounding_error("geofeatures_boost::multiprecision::trunc<%1%>(%1%)", 0, number<T>(a), number<T>(a), geofeatures_boost::math::policies::policy<>()).backend();
      return;
   }
   if(eval_get_sign(a) < 0)
      eval_ceil(result, a);
...
inline void eval_round(T& result, const T& a)
{
   ...
   typedef typename geofeatures_boost::multiprecision::detail::canonical<float, T>::type fp_type;
   int c = eval_fpclassify(a);
   if((c == (int)FP_NAN) || (c == (int)FP_INFINITE))
   {
      result = geofeatures_boost::math::policies::raise_rounding_error("geofeatures_boost::multiprecision::round<%1%>(%1%)", 0, number<T>(a), number<T>(a), geofeatures_boost::math::policies::policy<>()).backend();
      return;
   }
   if(eval_get_sign(a) < 0)
   {
...
{
   typedef typename geofeatures_boost::multiprecision::detail::canonical<Arithmetic, T>::type si_type;
...
{
   typedef typename geofeatures_boost::multiprecision::detail::canonical<unsigned, T>::type ui_type;
...
void eval_integer_sqrt(B& s, B& r, const B& x)
{
   ...
   // at some point.
   //
   typedef typename geofeatures_boost::multiprecision::detail::canonical<unsigned char, B>::type ui_type;
...
{
   typedef typename geofeatures_boost::mpl::if_c<geofeatures_boost::is_same<geofeatures_boost::intmax_t, long>::value, geofeatures_boost::long_long_type, geofeatures_boost::intmax_t>::type max_t;
...
inline int itrunc(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   if((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !(geofeatures_boost::math::isfinite)(v))
      return geofeatures_boost::math::policies::raise_rounding_error("geofeatures_boost::multiprecision::itrunc<%1%>(%1%)", 0, number_type(v), 0, pol);
   return r.template convert_to<int>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline int itrunc(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return itrunc(v, geofeatures_boost::math::policies::policy<>());
}
template <class Backend, expression_template_option ExpressionTemplates, class Policy>
inline int itrunc(const number<Backend, ExpressionTemplates>& v, const Policy& pol)
{
   ...
   if((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !(geofeatures_boost::math::isfinite)(v))
      return geofeatures_boost::math::policies::raise_rounding_error("geofeatures_boost::multiprecision::itrunc<%1%>(%1%)", 0, v, 0, pol);
   return r.template convert_to<int>();
}
...
inline long ltrunc(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   typedef typename detail::expression<tag, A1, A2, A3, A4>::result_type number_type;
   number_type r = trunc(v, pol);
   if((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !(geofeatures_boost::math::isfinite)(v))
      return geofeatures_boost::math::policies::raise_rounding_error("geofeatures_boost::multiprecision::ltrunc<%1%>(%1%)", 0, number_type(v), 0L, pol);
   return r.template convert_to<long>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline long ltrunc(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return ltrunc(v, geofeatures_boost::math::policies::policy<>());
}
...
inline long ltrunc(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   ...
   if((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !(geofeatures_boost::math::isfinite)(v))
      return geofeatures_boost::math::policies::raise_rounding_error("geofeatures_boost::multiprecision::ltrunc<%1%>(%1%)", 0, v, 0L, pol);
   return r.template convert_to<long>();
}
...
template <class tag, class A1, class A2, class A3, class A4, class Policy>
inline geofeatures_boost::long_long_type lltrunc(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   typedef typename detail::expression<tag, A1, A2, A3, A4>::result_type number_type;
   number_type r = trunc(v, pol);
   if((r > (std::numeric_limits<geofeatures_boost::long_long_type>::max)()) || r < (std::numeric_limits<geofeatures_boost::long_long_type>::min)() || !(geofeatures_boost::math::isfinite)(v))
      return geofeatures_boost::math::policies::raise_rounding_error("geofeatures_boost::multiprecision::lltrunc<%1%>(%1%)", 0, number_type(v), 0LL, pol);
   return r.template convert_to<geofeatures_boost::long_long_type>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline geofeatures_boost::long_long_type lltrunc(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return lltrunc(v, geofeatures_boost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline geofeatures_boost::long_long_type lltrunc(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   number<T, ExpressionTemplates> r = trunc(v, pol);
   if((r > (std::numeric_limits<geofeatures_boost::long_long_type>::max)()) || r < (std::numeric_limits<geofeatures_boost::long_long_type>::min)() || !(geofeatures_boost::math::isfinite)(v))
      return geofeatures_boost::math::policies::raise_rounding_error("geofeatures_boost::multiprecision::lltrunc<%1%>(%1%)", 0, v, 0LL, pol);
   return r.template convert_to<geofeatures_boost::long_long_type>();
}
template <class T, expression_template_option ExpressionTemplates>
inline geofeatures_boost::long_long_type lltrunc(const number<T, ExpressionTemplates>& v)
{
   return lltrunc(v, geofeatures_boost::math::policies::policy<>());
}
#endif
...
inline int iround(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   if((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !(geofeatures_boost::math::isfinite)(v))
      return geofeatures_boost::math::policies::raise_rounding_error("geofeatures_boost::multiprecision::iround<%1%>(%1%)", 0, number_type(v), 0, pol);
   return r.template convert_to<int>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline int iround(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return iround(v, geofeatures_boost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline int iround(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   ...
   if((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !(geofeatures_boost::math::isfinite)(v))
      return geofeatures_boost::math::policies::raise_rounding_error("geofeatures_boost::multiprecision::iround<%1%>(%1%)", 0, v, 0, pol);
   return r.template convert_to<int>();
}
template <class T, expression_template_option ExpressionTemplates>
...
inline long lround(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   number_type r = round(v, pol);
   if((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !(geofeatures_boost::math::isfinite)(v))
      return geofeatures_boost::math::policies::raise_rounding_error("geofeatures_boost::multiprecision::lround<%1%>(%1%)", 0, number_type(v), 0L, pol);
   return r.template convert_to<long>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline long lround(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return lround(v, geofeatures_boost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline long lround(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   number<T, ExpressionTemplates> r = round(v, pol);
   if((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !(geofeatures_boost::math::isfinite)(v))
      return geofeatures_boost::math::policies::raise_rounding_error("geofeatures_boost::multiprecision::lround<%1%>(%1%)", 0, v, 0L, pol);
   return r.template convert_to<long>();
}
template <class T, expression_template_option ExpressionTemplates>
...
#ifndef BOOST_NO_LONG_LONG
template <class tag, class A1, class A2, class A3, class A4, class Policy>
inline geofeatures_boost::long_long_type llround(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   typedef typename detail::expression<tag, A1, A2, A3, A4>::result_type number_type;
   number_type r = round(v, pol);
   if((r > (std::numeric_limits<geofeatures_boost::long_long_type>::max)()) || r < (std::numeric_limits<geofeatures_boost::long_long_type>::min)() || !(geofeatures_boost::math::isfinite)(v))
      return geofeatures_boost::math::policies::raise_rounding_error("geofeatures_boost::multiprecision::iround<%1%>(%1%)", 0, number_type(v), 0LL, pol);
   return r.template convert_to<geofeatures_boost::long_long_type>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline geofeatures_boost::long_long_type llround(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return llround(v, geofeatures_boost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline geofeatures_boost::long_long_type llround(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   number<T, ExpressionTemplates> r = round(v, pol);
   if((r > (std::numeric_limits<geofeatures_boost::long_long_type>::max)()) || r < (std::numeric_limits<geofeatures_boost::long_long_type>::min)() || !(geofeatures_boost::math::isfinite)(v))
      return geofeatures_boost::math::policies::raise_rounding_error("geofeatures_boost::multiprecision::iround<%1%>(%1%)", 0, v, 0LL, pol);
   return r.template convert_to<geofeatures_boost::long_long_type>();
}
template <class T, expression_template_option ExpressionTemplates>
inline geofeatures_boost::long_long_type llround(const number<T, ExpressionTemplates>& v)
{
   return llround(v, geofeatures_boost::math::policies::policy<>());
}
#endif
...
template <class T, expression_template_option ExpressionTemplates>
inline typename enable_if_c<number_category<T>::value == number_kind_floating_point, number<T, ExpressionTemplates> >::type frexp(const number<T, ExpressionTemplates>& v, geofeatures_boost::long_long_type* pint)
{
   using default_ops::eval_frexp;
   number<T, ExpressionTemplates> result;
   eval_frexp(result.backend(), v.backend(), pint);
...
template <class tag, class A1, class A2, class A3, class A4>
inline typename enable_if_c<number_category<typename detail::expression<tag, A1, A2, A3, A4>::result_type>::value == number_kind_floating_point, typename detail::expression<tag, A1, A2, A3, A4>::result_type>::type
frexp(const detail::expression<tag, A1, A2, A3, A4>& v, geofeatures_boost::long_long_type* pint)
{
   typedef typename detail::expression<tag, A1, A2, A3, A4>::result_type number_type;
   return BOOST_MP_MOVE(frexp(static_cast<number_type>(v), pint));
}
...
template <class Backend> \
inline typename geofeatures_boost::enable_if_c<\
   geofeatures_boost::multiprecision::number_category<Backend>::value == category,\
...
HETERO_BINARY_OP_FUNCTOR_B(ldexp, geofeatures_boost::long_long_type, number_kind_floating_point)
//HETERO_BINARY_OP_FUNCTOR_B(frexp, geofeatures_boost::long_long_type*, number_kind_floating_point)
...
HETERO_BINARY_OP_FUNCTOR_B(scalbn, geofeatures_boost::long_long_type, number_kind_floating_point)
...
{
   return BOOST_MP_MOVE(geofeatures_boost::math::sinhc_pi(x));
}
