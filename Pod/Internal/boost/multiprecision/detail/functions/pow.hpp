...
inline void pow_imp(T& result, const T& t, const U& p, const mpl::false_&)
{
   ...
   typedef typename geofeatures_boost::multiprecision::detail::canonical<U, T>::type int_type;
...
{
   detail::pow_imp(result, t, p, geofeatures_boost::is_signed<U>());
}
...
void hyp0F0(T& H0F0, const T& x)
{
   ...
   BOOST_ASSERT(&H0F0 != &x);
   long tol = geofeatures_boost::multiprecision::detail::digits2<number<T, et_on> >::value;
   T t;
...
void hyp1F0(T& H1F0, const T& a, const T& x)
{
   ...
   typedef typename geofeatures_boost::multiprecision::detail::canonical<int, T>::type si_type;
   ...
   T lim;
   eval_ldexp(lim, H1F0, 1 - geofeatures_boost::multiprecision::detail::digits2<number<T, et_on> >::value);
   if(eval_get_sign(lim) < 0)
      lim.negate();
...
void eval_exp(T& result, const T& x)
{
   ...
   typedef typename geofeatures_boost::multiprecision::detail::canonical<exp_type, T>::type canonical_exp_type;
   ...
   typename geofeatures_boost::multiprecision::detail::canonical<geofeatures_boost::intmax_t, T>::type ll;
...
inline void eval_pow(T& result, const T& x, const T& a)
{
   ...
   typename geofeatures_boost::multiprecision::detail::canonical<geofeatures_boost::intmax_t, T>::type an;
   T fa;
   try
   {
   ...
   catch(const std::exception&)
   {
      ...
      an = (std::numeric_limits<geofeatures_boost::intmax_t>::max)();
   }

   if((eval_get_sign(x) < 0))
   {
      typename geofeatures_boost::multiprecision::detail::canonical<geofeatures_boost::uintmax_t, T>::type aun;
      try
      {
...
namespace detail{
   ...
   void small_sinh_series(T x, T& result)
   {
      ...
      T lim(x);
      eval_ldexp(lim, lim, 1 - geofeatures_boost::multiprecision::detail::digits2<number<T, et_on> >::value);
