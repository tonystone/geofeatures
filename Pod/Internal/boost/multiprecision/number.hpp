...
public:
   ...
   template <class V>
   BOOST_MP_FORCEINLINE number(const V& v, typename geofeatures_boost::enable_if_c<
            (geofeatures_boost::is_arithmetic<V>::value || is_same<std::string, V>::value || is_convertible<V, const char*>::value)
   ...
   template <class V>
   BOOST_MP_FORCEINLINE BOOST_CONSTEXPR number(const V& v, typename geofeatures_boost::enable_if_c<
            is_convertible<typename detail::canonical<V, Backend>::type, Backend>::value
            && !detail::is_restricted_conversion<typename detail::canonical<V, Backend>::type, Backend>::value
   >::type* = 0) 
#ifndef BOOST_INTEL
   ...
   template <class V>
   explicit BOOST_MP_FORCEINLINE number(const V& v, typename geofeatures_boost::enable_if_c<
            (geofeatures_boost::is_arithmetic<V>::value || is_same<std::string, V>::value || is_convertible<V, const char*>::value)
   ...
   template <class V>
   explicit BOOST_MP_FORCEINLINE BOOST_CONSTEXPR number(const V& v, typename geofeatures_boost::enable_if_c<
            detail::is_explicitly_convertible<typename detail::canonical<V, Backend>::type, Backend>::value
            && (detail::is_restricted_conversion<typename detail::canonical<V, Backend>::type, Backend>::value
                || !is_convertible<typename detail::canonical<V, Backend>::type, Backend>::value)
         >::type* = 0)
   ...
   //
   template <class V>
   number(V v, unsigned digits10, typename geofeatures_boost::enable_if<mpl::or_<geofeatures_boost::is_arithmetic<V>, is_same<std::string, V>, is_convertible<V, const char*> > >::type* dummy1 = 0)
   {
   ...
   */
   ...
   BOOST_MP_FORCEINLINE number(const number<Other, ET>& val,
         typename geofeatures_boost::enable_if_c<(geofeatures_boost::is_convertible<Other, Backend>::value && !detail::is_restricted_conversion<Other, Backend>::value)>::type* = 0)
      BOOST_MP_NOEXCEPT_IF(noexcept(Backend(std::declval<Other const&>())))
      : m_backend(val.backend()) {}

   template <class Other, expression_template_option ET>
   explicit number(const number<Other, ET>& val, typename geofeatures_boost::enable_if_c<
   ...
   template <class Other, expression_template_option ET>
   explicit BOOST_MP_FORCEINLINE number(const number<Other, ET>& val, typename geofeatures_boost::enable_if_c<
         (detail::is_explicitly_convertible<Other, Backend>::value
            && (detail::is_restricted_conversion<Other, Backend>::value || !geofeatures_boost::is_convertible<Other, Backend>::value))
         >::type* = 0) BOOST_MP_NOEXCEPT_IF(noexcept(Backend(std::declval<Other const&>())))
      : m_backend(val.backend()) {}

   template <class V>
   BOOST_MP_FORCEINLINE number(V v1, V v2, typename geofeatures_boost::enable_if<mpl::or_<geofeatures_boost::is_arithmetic<V>, is_same<std::string, V>, is_convertible<V, const char*> > >::type* = 0)
   {
      using default_ops::assign_components;
      assign_components(m_backend, canonical_value(v1), canonical_value(v2));
   }
   template <class Other, expression_template_option ET>
   BOOST_MP_FORCEINLINE number(const number<Other, ET>& v1, const number<Other, ET>& v2, typename geofeatures_boost::enable_if<geofeatures_boost::is_convertible<Other, Backend> >::type* = 0)
   {
      using default_ops::assign_components;
   ...
   typename geofeatures_boost::enable_if<is_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>, number&>::type operator=(const detail::expression<tag, Arg1, Arg2, Arg3, Arg4>& e)
   {
   ...
   template <class V>
   BOOST_MP_FORCEINLINE typename geofeatures_boost::enable_if<is_convertible<V, self_type>, number<Backend, ExpressionTemplates>& >::type
      operator=(const V& v)
   ...
   template <class Other, expression_template_option ET>
   typename geofeatures_boost::disable_if<geofeatures_boost::multiprecision::detail::is_explicitly_convertible<Other, Backend>, number<Backend, ExpressionTemplates>& >::type
   ...
   template <class tag, class Arg1, class Arg2, class Arg3, class Arg4>
   number(const detail::expression<tag, Arg1, Arg2, Arg3, Arg4>& e, typename geofeatures_boost::enable_if_c<is_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>::value>::type* = 0)
   {
      *this = e;
   }
   template <class tag, class Arg1, class Arg2, class Arg3, class Arg4>
   explicit number(const detail::expression<tag, Arg1, Arg2, Arg3, Arg4>& e,
      typename geofeatures_boost::enable_if_c<!is_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>::value
      && geofeatures_boost::multiprecision::detail::is_explicitly_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>::value>::type* = 0)
   {
      assign(e);
   }
   ...
   template <class V>
   typename geofeatures_boost::enable_if<geofeatures_boost::is_convertible<V, self_type>, number<Backend, ExpressionTemplates>& >::type
      operator+=(const V& v)
   {
   ...
   template <class V>
   BOOST_MP_FORCEINLINE typename geofeatures_boost::enable_if<is_integral<V>, number&>::type operator <<= (V val)
   {
   ...
   template <class V>
   BOOST_MP_FORCEINLINE typename geofeatures_boost::enable_if<geofeatures_boost::is_convertible<V, self_type>, number<Backend, ExpressionTemplates>& >::type
      operator/=(const V& v)
   {
...
#  if (defined(__GNUC__) && (__GNUC__ == 4) && (__GNUC_MINOR__ < 7)) || (defined(BOOST_INTEL) && (BOOST_INTEL <= 1500))
   ...
   // an arithmetic type:
   //
   template <class T, typename geofeatures_boost::enable_if<is_same<T, bool>, int>::type = 0>
   explicit operator T ()const
   {
      using default_ops::eval_is_zero;
      return !eval_is_zero(backend());
   }
   template <class T, typename geofeatures_boost::disable_if_c<is_same<T, bool>::value || is_void<T>::value, int>::type = 0>
   explicit operator T ()const
   {
...
#  endif
   ...
   template <class V>
   BOOST_MP_FORCEINLINE typename geofeatures_boost::enable_if<is_arithmetic<V>, int>::type compare(const V& o)const
   {
      using default_ops::eval_get_sign;
      if(o == 0)
         return eval_get_sign(m_backend);
...
private:
   ...
   //
   template <class Exp>
   typename geofeatures_boost::disable_if_c<geofeatures_boost::multiprecision::number_category<self_type>::value == geofeatures_boost::multiprecision::number_kind_integer || sizeof(Exp) == 1>::type 
...
public:
   ...
   template <class V>
   static BOOST_MP_FORCEINLINE BOOST_CONSTEXPR typename geofeatures_boost::disable_if<is_same<typename detail::canonical<V, Backend>::type, V>, typename detail::canonical<V, Backend>::type>::type
      canonical_value(const V& v) BOOST_NOEXCEPT {  return static_cast<typename detail::canonical<V, Backend>::type>(v);  }
   template <class V>
   static BOOST_MP_FORCEINLINE BOOST_CONSTEXPR typename geofeatures_boost::enable_if<is_same<typename detail::canonical<V, Backend>::type, V>, const V&>::type
...
typename geofeatures_boost::enable_if<geofeatures_boost::is_arithmetic<Arithmetic>, bool>::type operator == (const rational<multiprecision::number<T, ExpressionTemplates> >& a, const Arithmetic& b)
{
   return a == multiprecision::number<T, ExpressionTemplates>(b);
}

template <class T, multiprecision::expression_template_option ExpressionTemplates, class Arithmetic>
typename geofeatures_boost::enable_if<geofeatures_boost::is_arithmetic<Arithmetic>, bool>::type operator == (const Arithmetic& b, const rational<multiprecision::number<T, ExpressionTemplates> >& a)
{
   return a == multiprecision::number<T, ExpressionTemplates>(b);
}
...
template <class I>
struct component_type<geofeatures_boost::rational<I> >
{
   typedef I type;
};
