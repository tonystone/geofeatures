...
struct rational_adaptor
{
   ...
   typedef geofeatures_boost::rational<integer_type>        rational_type;
   ...
   explicit rational_adaptor(const U& u, 
      typename enable_if_c<
         geofeatures_boost::multiprecision::detail::is_explicitly_convertible<U, IntBackend>::value && !is_convertible<U, IntBackend>::value
      >::type* = 0) 
      : m_value(IntBackend(u)){}
   template <class U>
   typename enable_if_c<(geofeatures_boost::multiprecision::detail::is_explicitly_convertible<U, IntBackend>::value && !is_arithmetic<U>::value), rational_adaptor&>::type operator = (const U& u) 
   {
      m_value = IntBackend(u);
   }
...
inline typename enable_if_c<number_category<R>::value == number_kind_floating_point>::type eval_convert_to(R* result, const rational_adaptor<IntBackend>& backend)
{
   ...
   //
   ::geofeatures_boost::multiprecision::detail::generic_convert_rational_to_float(*result, backend);
}
...
using geofeatures_boost::multiprecision::backends::rational_adaptor;
...
template <class IntBackend, geofeatures_boost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<geofeatures_boost::multiprecision::number<geofeatures_boost::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> > : public std::numeric_limits<geofeatures_boost::multiprecision::number<IntBackend, ExpressionTemplates> >
{
   typedef std::numeric_limits<geofeatures_boost::multiprecision::number<IntBackend> > base_type;
   typedef geofeatures_boost::multiprecision::number<geofeatures_boost::multiprecision::rational_adaptor<IntBackend> > number_type;
public:
...
template <class IntBackend, geofeatures_boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<geofeatures_boost::multiprecision::number<geofeatures_boost::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> >::is_integer;
template <class IntBackend, geofeatures_boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<geofeatures_boost::multiprecision::number<geofeatures_boost::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> >::is_exact;
