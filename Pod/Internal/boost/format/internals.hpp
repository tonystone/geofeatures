...
//        stream_format_state(const basic_ios& os)     { set_by_stream(os); }
        ...
        void apply_on(basic_ios & os,            //- applies format_state to the stream
                      geofeatures_boost::io::detail::locale_t * loc_default = 0) const;
        template<class T> 
        ...
        geofeatures_boost::optional<geofeatures_boost::io::detail::locale_t>  loc_;
    };  
...
// -   stream_format_state:: -------------------------------------------------
    ...
    void stream_format_state<Ch,Tr>:: apply_on (basic_ios & os,
                      geofeatures_boost::io::detail::locale_t * loc_default) const {
...
} } } // namespaces geofeatures_boost :: io :: detail
