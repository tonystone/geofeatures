...
#error "geofeatures_boost::format uses a local macro that is already defined."
#endif
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace io { namespace detail {
#if ! defined(BOOST_NO_STD_LOCALE)
