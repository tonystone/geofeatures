...
// **** exceptions -----------------------------------------------
        ...
        public:
            ...
            virtual const char *what() const throw() {
                return "geofeatures_boost::format_error: "
        ...
        public:
            ...
            virtual const char *what() const throw() {
                return "geofeatures_boost::bad_format_string: format-string is ill-formed";
            }
        };
        ...
        public:
            ...
            virtual const char *what() const throw() {
                return "geofeatures_boost::too_few_args: "
        ...
        public:
            ...
            std::size_t get_expected() const { return expected_; }
            virtual const char *what() const throw() {
                return "geofeatures_boost::too_many_args: "
        ...
        public:
            ...
            virtual const char *what() const throw() {
                return "geofeatures_boost::out_of_range: "
