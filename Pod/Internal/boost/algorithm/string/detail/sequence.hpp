...
//  insert helpers  -------------------------------------------------//
            ...
            {
                ::geofeatures_boost::algorithm::detail::insert( Input, At, ::geofeatures_boost::begin(Insert), ::geofeatures_boost::end(Insert) );
            }
...
//  replace helper  -------------------------------------------------//
                ...
                const InsertT& Insert )
            {
                if(From!=To)
                {
                    ::geofeatures_boost::algorithm::detail::replace( Input, From, To, ::geofeatures_boost::begin(Insert), ::geofeatures_boost::end(Insert) );
                }
                else
                {
                    ::geofeatures_boost::algorithm::detail::insert( Input, From, ::geofeatures_boost::begin(Insert), ::geofeatures_boost::end(Insert) );
                }
            }
