        ...
        public:
            ...
            */
            ...
            find_iterator(
                ...
                detail::find_iterator_base<IteratorT>(Finder,0)
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::geofeatures_boost::as_literal(Col));
                m_Match=::geofeatures_boost::make_iterator_range(::geofeatures_boost::begin(lit_col), ::geofeatures_boost::begin(lit_col));
                m_End=::geofeatures_boost::end(lit_col);
        ...
        */
        ...
        public:
            ...
            */
            ...
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::geofeatures_boost::as_literal(Col));
                m_Match=make_iterator_range(::geofeatures_boost::begin(lit_col), ::geofeatures_boost::begin(lit_col));
                m_Next=::geofeatures_boost::begin(lit_col);
                m_End=::geofeatures_boost::end(lit_col);
