...
//  erase_range -------------------------------------------------------//
        ...
        */
        ...
        {
            return ::geofeatures_boost::algorithm::find_format_copy(
                Output,
                Input,
                ::geofeatures_boost::algorithm::range_finder(SearchRange),
                ::geofeatures_boost::algorithm::empty_formatter(Input) );
        }
        ...
        */
            ...
            const Range2T& Search )
        {
            return ::geofeatures_boost::algorithm::find_format_copy(
                Output,
                Input,
                ::geofeatures_boost::algorithm::first_finder(Search),
                ::geofeatures_boost::algorithm::empty_formatter(Input) );
        }
        ...
        */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::geofeatures_boost::algorithm::find_format_copy(
                Output,
                Input,
                ::geofeatures_boost::algorithm::first_finder(Search, is_iequal(Loc)),
                ::geofeatures_boost::algorithm::empty_formatter(Input) );
        }
        ...
        */
            ...
            const Range2T& Search )
        {
            return ::geofeatures_boost::algorithm::find_format_copy(
                Output,
                Input,
                ::geofeatures_boost::algorithm::last_finder(Search),
                ::geofeatures_boost::algorithm::empty_formatter(Input) );
        }
        ...
        */
            ...
            int Nth )
        {
            return ::geofeatures_boost::algorithm::find_format_copy(
                Output,
                Input,
                ::geofeatures_boost::algorithm::nth_finder(Search, Nth),
                ::geofeatures_boost::algorithm::empty_formatter(Input) );
        }
        ...
        */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::geofeatures_boost::algorithm::find_format_copy(
                Output,
                Input,
                ::geofeatures_boost::algorithm::nth_finder(Search, Nth, is_iequal(Loc)),
                ::geofeatures_boost::algorithm::empty_formatter(Input) );
        }
...
//  erase_all  --------------------------------------------------------//
        ...
        */
        ...
        inline OutputIteratorT erase_all_copy(
            ...
            const Range2T& Search )
        {
            return ::geofeatures_boost::algorithm::find_format_all_copy(
                Output,
                Input,
                ::geofeatures_boost::algorithm::first_finder(Search),
                ::geofeatures_boost::algorithm::empty_formatter(Input) );
        ...
        */
        ...
        inline void erase_all( 
            ...
            const RangeT& Search )
        {
            ::geofeatures_boost::algorithm::find_format_all( 
                Input, 
                ::geofeatures_boost::algorithm::first_finder(Search),
                ::geofeatures_boost::algorithm::empty_formatter(Input) );
        }
        ...
        */
            ...
            int N )
        {
            return ::geofeatures_boost::algorithm::find_format_copy(
                Output,
                Input,
                ::geofeatures_boost::algorithm::head_finder(N),
                ::geofeatures_boost::algorithm::empty_formatter( Input ) );
        }
        ...
        */
            ...
            int N )
        {
            return ::geofeatures_boost::algorithm::find_format_copy(
                Output,
                Input,
                ::geofeatures_boost::algorithm::tail_finder(N),
                ::geofeatures_boost::algorithm::empty_formatter( Input ) );
        }
