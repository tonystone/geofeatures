...
//  join --------------------------------------------------------------//
        ...
        */
            ...
            const Range1T& Separator)
        {
            ...
            // Parse input
            InputIteratorT itBegin=::geofeatures_boost::begin(Input);
            InputIteratorT itEnd=::geofeatures_boost::end(Input);
            ...
            if(itBegin!=itEnd)
            {
                detail::insert(Result, ::geofeatures_boost::end(Result), *itBegin);
                ++itBegin;
            }
            ...
            {
                // Add separator
                detail::insert(Result, ::geofeatures_boost::end(Result), ::geofeatures_boost::as_literal(Separator));
                // Add element
                detail::insert(Result, ::geofeatures_boost::end(Result), *itBegin);
            }
