...
class Polygon
{
    ...
    typedef typename geofeatures_boost::remove_const<PolygonType>::type polygon_type;
    ...
    //BOOST_CONCEPT_ASSERT( (geofeatures_boost::RandomAccessRangeConcept<interior_type>) );
    ...
    struct checker
    {
        static inline void apply()
        {
            ...
            geofeatures_boost::ignore_unused_variable_warning(e);
            geofeatures_boost::ignore_unused_variable_warning(i);
            geofeatures_boost::ignore_unused_variable_warning(ce);
            geofeatures_boost::ignore_unused_variable_warning(ci);
            geofeatures_boost::ignore_unused_variable_warning(poly);
            geofeatures_boost::ignore_unused_variable_warning(cpoly);
        }
    };
...
class ConstPolygon
{
    ...
    typedef typename geofeatures_boost::remove_const<PolygonType>::type const_polygon_type;
