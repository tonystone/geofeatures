...
\par Specializations should provide:
    - value (should be derived from geofeatures_boost::mpl::int_<D>
\ingroup traits
*/
...
inline void assert_dimension()
{
    BOOST_STATIC_ASSERT((
        ...
        <
            geofeatures_boost::mpl::int_<geometry::dimension<Geometry>::value>,
            geofeatures_boost::mpl::int_<Dimensions>
        >::type::value
        ));
}
