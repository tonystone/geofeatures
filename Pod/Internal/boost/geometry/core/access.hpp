...
struct indexed_access_pointer
{
    static inline CoordinateType get(Geometry const* geometry)
    {
        return traits::indexed_access<typename geofeatures_boost::remove_pointer<Geometry>::type, Index, Dimension>::get(*geometry);
    }
    static inline void set(Geometry* geometry, CoordinateType const& value)
    {
        traits::indexed_access<typename geofeatures_boost::remove_pointer<Geometry>::type, Index, Dimension>::set(*geometry, value);
    }
};
...
struct access<point_tag, Point, CoordinateType, Dimension, geofeatures_boost::false_type>
{
...
template <typename Point, typename CoordinateType, std::size_t Dimension>
struct access<point_tag, Point, CoordinateType, Dimension, geofeatures_boost::true_type>
{
    static inline CoordinateType get(Point const* point)
    {
        return traits::access<typename geofeatures_boost::remove_pointer<Point>::type, Dimension>::get(*point);
    }
    static inline void set(Point* p, CoordinateType const& value)
    {
        traits::access<typename geofeatures_boost::remove_pointer<Point>::type, Dimension>::set(*p, value);
    }
};
...
<
    ...
    std::size_t Dimension
>
struct indexed_access<box_tag, Box, CoordinateType, Index, Dimension, geofeatures_boost::false_type>
...
<
    ...
    std::size_t Dimension
>
struct indexed_access<box_tag, Box, CoordinateType, Index, Dimension, geofeatures_boost::true_type>
...
<
    ...
    std::size_t Dimension
>
struct indexed_access<segment_tag, Segment, CoordinateType, Index, Dimension, geofeatures_boost::false_type>
...
<
    ...
    std::size_t Dimension
>
struct indexed_access<segment_tag, Segment, CoordinateType, Index, Dimension, geofeatures_boost::true_type>
...
{
    geofeatures_boost::ignore_unused_variable_warning(dummy);
    ...
    typedef core_dispatch::access
        <
            ...
            Dimension,
            typename geofeatures_boost::is_pointer<Geometry>::type
        > coord_access_type;
