...
{
    typedef typename geofeatures_boost::remove_const<Polygon>::type nc_polygon_type;

    typedef typename geofeatures_boost::mpl::if_
        <
            geofeatures_boost::is_const<Polygon>,
    ...
    typedef typename ring_return_type
        <
            ...
            typename geofeatures_boost::mpl::if_
                <
                    geofeatures_boost::is_const<MultiLinestring>,
                    typename geofeatures_boost::range_value<MultiLinestring>::type const,
...
{
    typedef typename geofeatures_boost::remove_reference
        <
