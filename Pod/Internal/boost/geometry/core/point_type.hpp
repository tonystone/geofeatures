...
// Specializations for linestring/ring, via geofeatures_boost::range
template <typename Linestring>
struct point_type<linestring_tag, Linestring>
{
    typedef typename geofeatures_boost::range_value<Linestring>::type type;
};
...
{
    typedef typename geofeatures_boost::range_value<Ring>::type type;
};
...
{
    typedef typename geofeatures_boost::range_value
        <
            MultiPoint
        >::type type;
};
...
struct point_type
{
    typedef typename core_dispatch::point_type
        <
            ...
            typename geofeatures_boost::geometry::util::bare_type<Geometry>::type
        >::type type;
};
