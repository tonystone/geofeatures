...
template <typename GeometryTag> struct is_areal : geofeatures_boost::false_type {};

template <> struct is_areal<ring_tag> : geofeatures_boost::true_type {};
template <> struct is_areal<box_tag> : geofeatures_boost::true_type {};
template <> struct is_areal<polygon_tag> : geofeatures_boost::true_type {};
template <> struct is_areal<multi_polygon_tag> : geofeatures_boost::true_type {};
