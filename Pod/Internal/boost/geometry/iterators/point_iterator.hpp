...
struct points_begin<Linestring, linestring_tag>
{
    ...
    {
        return geofeatures_boost::begin(linestring);
    }
};
...
struct points_begin<Ring, ring_tag>
{
    ...
    apply(Ring& ring)
    {
        return geofeatures_boost::begin(ring);
    }
};
...
struct points_begin<Polygon, polygon_tag>
{
    ...
    static inline return_type apply(Polygon& polygon)
    {
        ...
        return return_type
            (geofeatures_boost::begin(geometry::exterior_ring(polygon)),
             geofeatures_boost::end(geometry::exterior_ring(polygon)),
             flatten_iterator(geofeatures_boost::begin(geometry::interior_rings(polygon)),
                              geofeatures_boost::end(geometry::interior_rings(polygon))
                              ),
             flatten_iterator(geofeatures_boost::begin(geometry::interior_rings(polygon)),
                              geofeatures_boost::end(geometry::interior_rings(polygon))
                              )
...
struct points_begin<MultiPoint, multi_point_tag>
{
    ...
    {
        return geofeatures_boost::begin(multipoint);
    }
};
...
struct points_begin<MultiLinestring, multi_linestring_tag>
{
    ...
    {
        return return_type(geofeatures_boost::begin(multilinestring),
...
struct points_begin<MultiPolygon, multi_polygon_tag>
{
    ...
    {
        return return_type(geofeatures_boost::begin(multipolygon),
...
struct points_end<Linestring, linestring_tag>
{
    ...
    apply(Linestring& linestring)
    {
        return geofeatures_boost::end(linestring);
    }
};
...
struct points_end<Ring, ring_tag>
{
    ...
    apply(Ring& ring)
    {
        return geofeatures_boost::end(ring);
    }
};
    ...
    static inline return_type apply(Polygon& polygon)
    {
        ...
        return return_type
            (geofeatures_boost::end(geometry::exterior_ring(polygon)),
             ...
             flatten_iterator( geofeatures_boost::end(geometry::interior_rings(polygon)) )
             );
    }
};
...
struct points_end<MultiPoint, multi_point_tag>
{
    ...
    apply(MultiPoint& multipoint)
    {
        return geofeatures_boost::end(multipoint);
    }
};
...
struct points_end<MultiLinestring, multi_linestring_tag>
{
    ...
    static inline return_type apply(MultiLinestring& multilinestring)
    {
        return return_type(geofeatures_boost::end(multilinestring));
    }
};
...
struct points_end<MultiPolygon, multi_polygon_tag>
{
    ...
    static inline return_type apply(MultiPolygon& multipolygon)
    {
        return return_type(geofeatures_boost::end(multipolygon));
    }
};
