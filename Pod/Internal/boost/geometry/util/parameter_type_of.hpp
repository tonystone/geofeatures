...
{
    typedef typename geofeatures_boost::function_types::parameter_types
        <
            Method
    ...
    typedef typename geofeatures_boost::mpl::if_
        <
            geofeatures_boost::function_types::is_member_function_pointer<Method>,
    ...
    typedef typename geofeatures_boost::mpl::if_c
        <
            Index == 0,
            base_index_type,
            typename geofeatures_boost::mpl::plus
                <
                    base_index_type,
                    geofeatures_boost::mpl::int_<Index>
                >::type
        >::type indexed_type;

    typedef typename geofeatures_boost::remove_reference
        <
            typename geofeatures_boost::mpl::at
                <
                    parameter_types,
                    indexed_type
                >::type
