...
struct select_most_precise<T1, T2, void>
{
    ...
    static const bool one_not_fundamental = !
        (geofeatures_boost::is_fundamental<T1>::type::value
          && geofeatures_boost::is_fundamental<T2>::type::value);

    static const bool both_same =
        geofeatures_boost::is_floating_point<T1>::type::value
        == geofeatures_boost::is_floating_point<T2>::type::value;
