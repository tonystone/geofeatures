...
{
    static const bool is_const = geofeatures_boost::is_const<Geometry>::value;
    ...
    typedef typename geofeatures_boost::range_iterator<closeable>::type iterator;
    typedef typename geofeatures_boost::range_const_iterator<closeable>::type const_iterator;

    inline const_iterator begin() const { return geofeatures_boost::begin(m_closeable); }
    inline const_iterator end() const { return geofeatures_boost::end(m_closeable); }

    inline iterator begin() { return geofeatures_boost::begin(m_closeable); }
    inline iterator end() { return geofeatures_boost::end(m_closeable); }
