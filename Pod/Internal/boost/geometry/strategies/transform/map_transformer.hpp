...
{
    typedef geofeatures_boost::numeric::ublas::matrix<CalculationType> M;
...
private :
        ...
        S const& scalex, S const& scaley)
    {
        ...
        this->m_matrix = geofeatures_boost::numeric::ublas::prod(s, t1);
        this->m_matrix = geofeatures_boost::numeric::ublas::prod(t2, this->m_matrix);
    }
                    ...
                    D const& width, D const& height)
    {
        ...
        W wdx = wx2 - wx1;
        W wdy = wy2 - wy1;
        type sx = (px2 - px1) / geofeatures_boost::numeric_cast<type>(wdx);
        type sy = (py2 - py1) / geofeatures_boost::numeric_cast<type>(wdy);
        ...
        if (Mirror)
        {
            ...
            // Calculate combination matrix in two steps
            this->m_matrix = geofeatures_boost::numeric::ublas::prod(m, this->m_matrix);
            this->m_matrix = geofeatures_boost::numeric::ublas::prod(y, this->m_matrix);
        }
    }
};
