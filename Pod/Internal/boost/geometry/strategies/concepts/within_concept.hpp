        ...
        static void apply(ApplyMethod const&, ResultMethod const& )
        {
            ...
            BOOST_MPL_ASSERT_MSG
                (
                    (geofeatures_boost::is_same
                        <
                            bool, typename geofeatures_boost::function_types::result_type<ApplyMethod>::type
                        >::type::value),
            ...
            BOOST_MPL_ASSERT_MSG
                (
                    (geofeatures_boost::is_same
                        <
                            int, typename geofeatures_boost::function_types::result_type<ResultMethod>::type
                        >::type::value),
            ...
            geofeatures_boost::ignore_unused_variable_warning(str);
        }
    };
            ...
            BOOST_MPL_ASSERT_MSG
                (
                    (geofeatures_boost::is_same
                        <
                            bool,
                            typename geofeatures_boost::function_types::result_type<ApplyMethod>::type
                        >::type::value),
                    WRONG_RETURN_TYPE
                    , (bool)
                );
...
// So now: geofeatures_boost::geometry::concept::within
namespace within
{
...
inline void check()
{
    ...
    geofeatures_boost::ignore_unused_variable_warning(c);
}


}}}} // namespace geofeatures_boost::geometry::concept::within
