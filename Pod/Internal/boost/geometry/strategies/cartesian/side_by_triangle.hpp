...
public :
    ...
    static inline int apply(P1 const& p1, P2 const& p2, P const& p)
    {
        ...
        bool const are_all_integral_coordinates =
            geofeatures_boost::is_integral<coordinate_type1>::value
            && geofeatures_boost::is_integral<coordinate_type2>::value
            && geofeatures_boost::is_integral<coordinate_type3>::value;
