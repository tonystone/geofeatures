...
struct covered_by<Point, Box, point_tag, box_tag>
{
    ...
    {
        ::geofeatures_boost::ignore_unused_variable_warning(strategy);
...
struct covered_by<geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Geometry2>
{
    template <typename Strategy>
...
struct covered_by<Geometry1, geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{
    template <typename Strategy>
    struct visitor: geofeatures_boost::static_visitor<bool>
    {
    ...
    apply(Geometry1 const& geometry1,
          ...
          Strategy const& strategy)
    {
        return geofeatures_boost::apply_visitor(visitor<Strategy>(geometry1, strategy), geometry2);
    }
};
...
>
{
    ...
    apply(geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T1)> const& geometry1,
          ...
          Strategy const& strategy)
    {
        return geofeatures_boost::apply_visitor(visitor<Strategy>(strategy), geometry1, geometry2);
    }
};
