    ...
    struct has_property_per_polygon
    {
                                 ...
                                 VisitPolicy& visitor)
        {
                 ...
                 ++it, ++multi_index)
            {
                ...
                typedef geofeatures_boost::filter_iterator
                    <
...
public:
                             ...
                             VisitPolicy& visitor)
    {
        ...
        if (BOOST_GEOMETRY_CONDITION(
                AllowEmptyMultiGeometries && geofeatures_boost::empty(multipolygon)))
        {
            return visitor.template apply<no_failure>();
        }
        ...
        if (! detail::check_iterator_range
                  ...
                  >::apply(geofeatures_boost::begin(multipolygon),
        ...
        if (! have_holes_inside(geofeatures_boost::begin(multipolygon),
                                geofeatures_boost::end(multipolygon),
                                turns.begin(),
                                turns.end(),
                                visitor))
        ...
        if (! have_connected_interior(geofeatures_boost::begin(multipolygon),
                                      geofeatures_boost::end(multipolygon),
                                      turns.begin(),
                                      turns.end(),
                                      visitor))
        ...
        debug_phase::apply(5);
        return are_polygon_interiors_disjoint(geofeatures_boost::begin(multipolygon),
                                              geofeatures_boost::end(multipolygon),
                                              turns.begin(),
                                              turns.end(),
                                              visitor);
