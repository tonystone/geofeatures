...
struct assign_loop
{
    ...
    static inline void apply(CoordinateType const& longitude,
                             ...
                             PointOut& point_out)
    {
        geometry::set<Dimension>(point_out, geofeatures_boost::numeric_cast
            <
...
struct assign_loop<0, DimensionCount>
{
    ...
    static inline void apply(CoordinateType const& longitude,
                             ...
                             PointOut& point_out)
    {
        geometry::set<0>(point_out, geofeatures_boost::numeric_cast
            <
                typename coordinate_type<PointOut>::type
            >(longitude));
...
struct assign_loop<1, DimensionCount>
{
    ...
    static inline void apply(CoordinateType const& longitude,
                             ...
                             PointOut& point_out)
    {
        geometry::set<1>(point_out, geofeatures_boost::numeric_cast
            <
                typename coordinate_type<PointOut>::type
            >(latitude));
