...
struct envelope_range_of_longitudes
{
                             ...
                             Longitude& lon_min, Longitude& lon_max)
    {
        ...
        if (! geofeatures_boost::empty(range))
        {
            lon_min = std::min_element(geofeatures_boost::begin(range),
                                       geofeatures_boost::end(range),
                                       longitude_less<0>())->template get<0>();
            lon_max = std::max_element(geofeatures_boost::begin(range),
                                       geofeatures_boost::end(range),
...
struct envelope_range_of_boxes_by_expansion
{
    ...
    {
        typedef typename geofeatures_boost::range_value<RangeOfBoxes>::type box_type;
        ...
        iterator_type it = geofeatures_boost::begin(range_of_boxes);
        for (++it; it != geofeatures_boost::end(range_of_boxes); ++it)
        {
...
struct envelope_range_of_boxes
{
    ...
    static inline void apply(RangeOfBoxes const& range_of_boxes, Box& mbr)
    {
        ...
        BOOST_GEOMETRY_ASSERT(! geofeatures_boost::empty(range_of_boxes));

        iterator_type it_min = std::min_element(geofeatures_boost::begin(range_of_boxes),
                                                geofeatures_boost::end(range_of_boxes),
                                                latitude_less<min_corner>());
        iterator_type it_max = std::max_element(geofeatures_boost::begin(range_of_boxes),
                                                geofeatures_boost::end(range_of_boxes),
        ...
        for (iterator_type it = geofeatures_boost::begin(range_of_boxes);
             it != geofeatures_boost::end(range_of_boxes);
             ++it)
        {
