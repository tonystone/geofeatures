...
struct envelope_range
{
    ...
    {
        return apply(geofeatures_boost::begin(range), geofeatures_boost::end(range), mbr);
    }
};
...
struct envelope_multi_range
{
    ...
    static inline void apply(MultiRange const& multirange, Box& mbr)
    {
        ...
        for (iterator_type it = geofeatures_boost::begin(multirange);
             it != geofeatures_boost::end(multirange);
             ++it)
        {
