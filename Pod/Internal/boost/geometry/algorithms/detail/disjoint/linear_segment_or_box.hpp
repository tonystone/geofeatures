...
struct disjoint_range_segment_or_box
{
    ...
    bool apply(Range const& range, SegmentOrBox const& segment_or_box)
    {
        ...
        typedef typename ::geofeatures_boost::range_value<view_type>::type point_type;
        ...
        const size_type count = ::geofeatures_boost::size(view);
        ...
        {
            const_iterator it0 = ::geofeatures_boost::begin(view);
            const_iterator it1 = ::geofeatures_boost::begin(view) + 1;
            const_iterator last = ::geofeatures_boost::end(view);
