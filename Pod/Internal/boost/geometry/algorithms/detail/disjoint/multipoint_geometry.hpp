...
public:
    ...
    {
        BOOST_GEOMETRY_ASSERT( geofeatures_boost::size(multipoint1) <= geofeatures_boost::size(multipoint2) );

        typedef typename geofeatures_boost::range_value<MultiPoint1>::type point1_type;

        std::vector<point1_type> points1(geofeatures_boost::begin(multipoint1),
