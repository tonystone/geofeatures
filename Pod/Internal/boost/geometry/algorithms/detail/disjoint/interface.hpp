...
struct disjoint<geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Geometry2>
{
...
struct disjoint<Geometry1, geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{
    struct visitor: geofeatures_boost::static_visitor<bool>
    {
