...
struct compute_tmin_tmax_per_dim
{
                             ...
                             RelativeDistance& diff)
    {
        ...
        RelativeDistance c_p0 = geofeatures_boost::numeric_cast
            <
                point_coordinate_type
            >( geometry::get<I>(p0) );

        RelativeDistance c_p1 = geofeatures_boost::numeric_cast
            <
                point_coordinate_type
            >( geometry::get<I>(p1) );

        RelativeDistance c_b_min = geofeatures_boost::numeric_cast
            <
                box_coordinate_type
            >( geometry::get<geometry::min_corner, I>(box) );

        RelativeDistance c_b_max = geofeatures_boost::numeric_cast
            <
                box_coordinate_type
