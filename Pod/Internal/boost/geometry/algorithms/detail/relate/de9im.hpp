...
class static_mask
    : public detail::relate::static_mask
        <
            geofeatures_boost::mpl::vector_c
                <
...
<
    typename Seq,
    typename T,
    bool IsSeq = geofeatures_boost::mpl::is_sequence<Seq>::value
>
struct push_back
{
    typedef typename geofeatures_boost::mpl::push_back
        <
            Seq,
            T
        >::type type;
...
geofeatures_boost::tuples::cons
    <
        mask,
        geofeatures_boost::tuples::cons<mask, geofeatures_boost::tuples::null_type>
    >
...
typename index::detail::tuples::push_back
    <
        geofeatures_boost::tuples::cons<mask, Tail>,
        mask
    >::type
operator||(geofeatures_boost::tuples::cons<mask, Tail> const& t, mask const& m)
{
    namespace bt = geofeatures_boost::tuples;
...
{
    return geofeatures_boost::mpl::vector
            <
                static_mask<II1, IB1, IE1, BI1, BB1, BE1, EI1, EB1, EE1>,
                static_mask<II2, IB2, IE2, BI2, BB2, BE2, EI2, EB2, EE2>
            >();
