        ...
        IteratorVector& exceeding)
{
    ...
    for(it_type it = geofeatures_boost::begin(input); it != geofeatures_boost::end(input); ++it)
    {
...
{
    typedef typename geofeatures_boost::range_iterator<IteratorVector const>::type it_type;
    for(it_type it = geofeatures_boost::begin(input); it != geofeatures_boost::end(input); ++it)
    {
...
{
    if (geofeatures_boost::size(input) == 0)
    {
        return;
    }
    ...
    for (it_type it1 = geofeatures_boost::begin(input); it1 != geofeatures_boost::end(input); ++it1)
    {
        it_type it2 = it1;
        for (++it2; it2 != geofeatures_boost::end(input); ++it2)
        {
        ...
        Policy& policy)
{
    ...
    if (geofeatures_boost::size(input1) == 0 || geofeatures_boost::size(input2) == 0)
    {
        return;
    }

    for(iterator_type1 it1 = geofeatures_boost::begin(input1);
        it1 != geofeatures_boost::end(input1);
        ++it1)
    {
        for(iterator_type2 it2 = geofeatures_boost::begin(input2);
            it2 != geofeatures_boost::end(input2);
            ++it2)
        {
            policy.apply(**it1, **it2);
        }
...
{
    return geofeatures_boost::size(input) >= min_elements
        && level < 100;
}
...
inline bool recurse_ok(IteratorVector1 const& input1,
                ...
                std::size_t min_elements, std::size_t level)
{
    return geofeatures_boost::size(input1) >= min_elements
...
public :
            ...
            Policy& policy, VisitBoxPolicy& box_policy)
    {
        ...
        if (geofeatures_boost::size(exceeding) > 0)
        {
...
public :
            ...
            Policy& policy, VisitBoxPolicy& box_policy)
    {
        ...
        if (geofeatures_boost::size(exceeding1) > 0)
        {
        ...
        if (geofeatures_boost::size(exceeding2) > 0)
        {
...
class partition
{
    ...
    {
        for(typename geofeatures_boost::range_iterator<ForwardRange const>::type it
            = geofeatures_boost::begin(forward_range);
            it != geofeatures_boost::end(forward_range);
            ++it)
        {
...
public :
            ...
            )
    {
        ...
        if (std::size_t(geofeatures_boost::size(forward_range)) > min_elements)
        {
        ...
        {
            for(iterator_type it1 = geofeatures_boost::begin(forward_range);
                it1 != geofeatures_boost::end(forward_range);
                ++it1)
            {
                iterator_type it2 = it1;
                for(++it2; it2 != geofeatures_boost::end(forward_range); ++it2)
                {
                ...
                )
    {
        ...
        if (std::size_t(geofeatures_boost::size(forward_range1)) > min_elements
            && std::size_t(geofeatures_boost::size(forward_range2)) > min_elements)
        {
        ...
        {
            for(iterator_type1 it1 = geofeatures_boost::begin(forward_range1);
                it1 != geofeatures_boost::end(forward_range1);
                ++it1)
            {
                for(iterator_type2 it2 = geofeatures_boost::begin(forward_range2);
                    it2 != geofeatures_boost::end(forward_range2);
                    ++it2)
                {
                    visitor.apply(*it1, *it2);
                }
