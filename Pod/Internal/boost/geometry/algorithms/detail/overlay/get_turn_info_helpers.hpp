...
struct side_calculator
{
    ...
    typedef geofeatures_boost::geometry::strategy::side::side_by_triangle<> side;
...
public:
    ...
    typedef typename geofeatures_boost::tuples::element<0, result_type>::type i_info_type; // intersection_info
    typedef typename geofeatures_boost::tuples::element<1, result_type>::type d_info_type; // dir_info
