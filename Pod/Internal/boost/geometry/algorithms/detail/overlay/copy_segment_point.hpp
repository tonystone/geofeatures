...
struct copy_segment_point_range
{
            ...
            PointOut& point)
    {
        ...
        signed_size_type const n = geofeatures_boost::size(view);
        ...
        geometry::convert(*(geofeatures_boost::begin(view) + index), point);
        return true;
    }
};
...
struct copy_segment_point_box
{
            ...
            PointOut& point)
    {
        ...
        geofeatures_boost::array<typename point_type<Box>::type, 4> bp;
                             ...
                             PointOut& point)
    {
        ...
        BOOST_GEOMETRY_ASSERT
            (
                ...
                && seg_id.multi_index < int(geofeatures_boost::size(multi))
            );
