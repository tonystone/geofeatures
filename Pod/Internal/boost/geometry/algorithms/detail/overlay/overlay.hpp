        ...
        TurnPoints const& turn_points)
{
    ...
    for (typename geofeatures_boost::range_iterator<TurnPoints const>::type
         ...
         ++it)
    {
        typename geofeatures_boost::range_value<TurnPoints>::type const& turn_info = *it;
        ...
        for (typename geofeatures_boost::range_iterator<container_type const>::type
                op_it = geofeatures_boost::begin(turn_info.operations);
            op_it != geofeatures_boost::end(turn_info.operations);
            ++op_it)
        {
...
std::cout << "traverse" << std::endl;
        ...
        // Add rings created during traversal
        {
            ...
            for (typename geofeatures_boost::range_iterator<ring_container_type>::type
