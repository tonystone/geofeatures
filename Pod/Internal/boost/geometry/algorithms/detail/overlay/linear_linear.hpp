    ...
    >
{
    ...
    static inline OutputIterator apply(MultiLineString const& multilinestring,
                                       OutputIterator oit)
    {
        for (typename geofeatures_boost::range_iterator<MultiLineString const>::type
                 it = geofeatures_boost::begin(multilinestring);
             it != geofeatures_boost::end(multilinestring); ++it)
        {
            LineStringOut ls_out;
...
protected:
                          ...
                          OutputIterator oit)
    {
        ...
        std::sort(geofeatures_boost::begin(turns), geofeatures_boost::end(turns),
        ...
        return detail::overlay::following::linear::follow
            <
                ...
                !EnableFilterContinueTurns || OverlayType == overlay_intersection
            >::apply(linear1, linear2, geofeatures_boost::begin(turns), geofeatures_boost::end(turns),
                     oit);
    }
