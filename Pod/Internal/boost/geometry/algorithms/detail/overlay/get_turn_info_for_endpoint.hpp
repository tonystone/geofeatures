...
struct get_turn_info_for_endpoint
{
                                       ...
                                       operation_type & op1, operation_type & op2)
    {
        ...
        geofeatures_boost::ignore_unused_variable_warning(j2);
        geofeatures_boost::ignore_unused_variable_warning(ip_index);
        geofeatures_boost::ignore_unused_variable_warning(tp_model);
