...
# define BOOST_SP_INTERLOCKED_INCREMENT ::geofeatures_boost::detail::InterlockedIncrement
# define BOOST_SP_INTERLOCKED_DECREMENT ::geofeatures_boost::detail::InterlockedDecrement
# define BOOST_SP_INTERLOCKED_COMPARE_EXCHANGE ::geofeatures_boost::detail::InterlockedCompareExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE ::geofeatures_boost::detail::InterlockedExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE_ADD ::geofeatures_boost::detail::InterlockedExchangeAdd
