...
{
    static geofeatures_boost::core::typeinfo ti_;
...
template<class T> geofeatures_boost::core::typeinfo core_typeid_< T >::ti_ = core_typeid_< T >::name();
#else
template<class T> geofeatures_boost::core::typeinfo core_typeid_< T >::ti_(core_typeid_< T >::name());
#endif
...
#define BOOST_CORE_TYPEID(T) (geofeatures_boost::detail::core_typeid_<T>::ti_)
