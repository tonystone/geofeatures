...
public:
    ...
    */
    BOOST_FORCEINLINE explicit reference_wrapper(T& t): t_(geofeatures_boost::addressof(t)) {}

#if defined( BOOST_MSVC ) && BOOST_WORKAROUND( BOOST_MSVC, == 1600 )

    BOOST_FORCEINLINE explicit reference_wrapper( T & t, ref_workaround_tag ): t_( geofeatures_boost::addressof( t ) ) {}
