...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace mpl { namespace aux {
...
template< typename T, typename name = ::geofeatures_boost::mpl::aux::has_xxx_tag > \
struct BOOST_PP_CAT(trait,_impl) : T \
{ \
    static geofeatures_boost::mpl::aux::no_tag \
    test(void(*)(::geofeatures_boost::mpl::aux::has_xxx_tag)); \
    \
    static geofeatures_boost::mpl::aux::yes_tag test(...); \
    \
    BOOST_STATIC_CONSTANT(bool, value = \
          sizeof(test(static_cast<void(*)(name)>(0))) \
            != sizeof(geofeatures_boost::mpl::aux::no_tag) \
        ); \
    typedef geofeatures_boost::mpl::bool_<value> type; \
}; \
\
template< typename T, typename fallback_ = geofeatures_boost::mpl::bool_<default_> > \
struct trait \
    : geofeatures_boost::mpl::if_c< \
          geofeatures_boost::mpl::aux::msvc_is_incomplete<T>::value \
        , geofeatures_boost::mpl::bool_<false> \
...
{ \
    BOOST_STATIC_CONSTANT(bool, value = false); \
    typedef geofeatures_boost::mpl::bool_<false> type; \
}; \
/**/
...
{ \
    ...
    { \
        template < class U > \
        static int  resolve( geofeatures_boost::mpl::aux::type_wrapper<U> const volatile * \
                           , geofeatures_boost::mpl::aux::type_wrapper<typename U::name >* = 0 ); \
        static char resolve( ... ); \
    }; \
    typedef geofeatures_boost::mpl::aux::type_wrapper<T> t_; \
    BOOST_STATIC_CONSTANT( bool, value = ( sizeof( trait_tester_impl::resolve( static_cast< t_ * >(0) ) ) == sizeof(int) ) ); \
}; \
template< typename T, typename fallback_ = geofeatures_boost::mpl::bool_<default_> > \
struct trait           \
{                      \
    BOOST_STATIC_CONSTANT( bool, value = (trait_tester< T, geofeatures_boost::is_class< T >::value >::value) );     \
    typedef geofeatures_boost::mpl::bool_< trait< T, fallback_ >::value > type; \
};
...
{ \
    ...
    { \
        template< typename U > \
        static geofeatures_boost::mpl::aux::yes_tag test( \
              geofeatures_boost::mpl::aux::type_wrapper<U> const volatile* \
            , geofeatures_boost::mpl::aux::type_wrapper<BOOST_MSVC_TYPENAME U::name>* = 0 \
            ); \
    \
        static geofeatures_boost::mpl::aux::no_tag test(...); \
    }; \
    \
    typedef geofeatures_boost::mpl::aux::type_wrapper<T> t_; \
    BOOST_STATIC_CONSTANT(bool, value = \
          sizeof(gcc_3_2_wknd::test(static_cast<t_*>(0))) \
            == sizeof(geofeatures_boost::mpl::aux::yes_tag) \
        ); \
    typedef geofeatures_boost::mpl::bool_<value> type; \
}; \
/**/
...
#     define BOOST_MPL_HAS_MEMBER_MULTI_ACCEPT(z, n, args) \
        template< typename V > \
        static geofeatures_boost::mpl::aux::yes_tag \
        BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
            geofeatures_boost::mpl::aux::type_wrapper< V > const volatile* \
...
#       define BOOST_MPL_HAS_MEMBER_TEST(args) \
          sizeof( \
              BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
                  static_cast< geofeatures_boost::mpl::aux::type_wrapper< U >* >(0) \
              ) \
          ) == sizeof(geofeatures_boost::mpl::aux::yes_tag) \
        /**/
#     else
...
#   define BOOST_MPL_HAS_MEMBER_IMPLEMENTATION( \
      ...
      template< \
          typename T \
        , typename fallback_ \
              = geofeatures_boost::mpl::bool_< BOOST_PP_ARRAY_ELEM(3, args) > \
      > \
...
#   define BOOST_MPL_HAS_XXX_TEMPLATE_NAMED_DEF(trait, name, default_) \
      template< typename T \
              , typename fallback_ = geofeatures_boost::mpl::bool_< default_ > > \
      struct trait { \
          BOOST_STATIC_CONSTANT(bool, value = fallback_::value); \
          typedef fallback_ type; \
      }; \
