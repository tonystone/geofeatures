...
template<>
class integer_traits< ::geofeatures_boost::long_long_type>
  : public std::numeric_limits< ::geofeatures_boost::long_long_type>,
    public detail::integer_traits_base< ::geofeatures_boost::long_long_type, LLONG_MIN, LLONG_MAX>
{ };

template<>
class integer_traits< ::geofeatures_boost::ulong_long_type>
  : public std::numeric_limits< ::geofeatures_boost::ulong_long_type>,
    public detail::integer_traits_base< ::geofeatures_boost::ulong_long_type, 0, ULLONG_MAX>
{ };

#elif defined(ULONG_LONG_MAX) && defined(BOOST_HAS_LONG_LONG)

template<>
class integer_traits< ::geofeatures_boost::long_long_type>  : public std::numeric_limits< ::geofeatures_boost::long_long_type>,    public detail::integer_traits_base< ::geofeatures_boost::long_long_type, LONG_LONG_MIN, LONG_LONG_MAX>{ };
template<>
class integer_traits< ::geofeatures_boost::ulong_long_type>
  : public std::numeric_limits< ::geofeatures_boost::ulong_long_type>,
    public detail::integer_traits_base< ::geofeatures_boost::ulong_long_type, 0, ULONG_LONG_MAX>
{ };
...
class integer_traits< ::geofeatures_boost::long_long_type>
  : public std::numeric_limits< ::geofeatures_boost::long_long_type>,
    public detail::integer_traits_base< ::geofeatures_boost::long_long_type, LONGLONG_MIN, LONGLONG_MAX>
{ };

template<>
class integer_traits< ::geofeatures_boost::ulong_long_type>
  : public std::numeric_limits< ::geofeatures_boost::ulong_long_type>,
    public detail::integer_traits_base< ::geofeatures_boost::ulong_long_type, 0, ULONGLONG_MAX>
{ };
...
class integer_traits< ::geofeatures_boost::long_long_type>
  : public std::numeric_limits< ::geofeatures_boost::long_long_type>,
    public detail::integer_traits_base< ::geofeatures_boost::long_long_type, -_LLONG_MAX - _C2, _LLONG_MAX>
{ };

template<>
class integer_traits< ::geofeatures_boost::ulong_long_type>
  : public std::numeric_limits< ::geofeatures_boost::ulong_long_type>,
    public detail::integer_traits_base< ::geofeatures_boost::ulong_long_type, 0, _ULLONG_MAX>
{ };
...
class integer_traits< ::geofeatures_boost::long_long_type>
  : public std::numeric_limits< ::geofeatures_boost::long_long_type>,
    public detail::integer_traits_base< ::geofeatures_boost::long_long_type, (1LL << (sizeof(::geofeatures_boost::long_long_type) * CHAR_BIT - 1)), ~(1LL << (sizeof(::geofeatures_boost::long_long_type) * CHAR_BIT - 1))>
{ };

template<>
class integer_traits< ::geofeatures_boost::ulong_long_type>
  : public std::numeric_limits< ::geofeatures_boost::ulong_long_type>,
    public detail::integer_traits_base< ::geofeatures_boost::ulong_long_type, 0, ~0uLL>
{ };
