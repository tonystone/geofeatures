...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return IteratorT( geofeatures_boost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return IteratorT( geofeatures_boost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( geofeatures_boost::begin(l),
                                                 geofeatures_boost::end(l),
                                                 geofeatures_boost::begin(r),
                                                 geofeatures_boost::end(r) );
        }
        ...
        {
            return geofeatures_boost::equal(l, r);
        }
...
incrementable_t test_traversal_tag(geofeatures_boost::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(geofeatures_boost::bidirectional_traversal_tag);
random_access_t test_traversal_tag(geofeatures_boost::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef geofeatures_boost::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef geofeatures_boost::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef geofeatures_boost::random_access_traversal_tag type;
};
...
public:
    ...
    reference back() const
    {
        ...
        return *geofeatures_boost::prior(this->m_End);
    }
    ...
    typedef BOOST_DEDUCED_TYPENAME
        geofeatures_boost::mpl::if_<
            geofeatures_boost::mpl::or_<
                geofeatures_boost::is_abstract<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                geofeatures_boost::is_array<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                geofeatures_boost::is_function<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >
            >,
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                geofeatures_boost::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
        ...
        */
        ...
        public:
            ...
            iterator_range(
                ...
                BOOST_DEDUCED_TYPENAME ::geofeatures_boost::enable_if<
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline BOOST_DEDUCED_TYPENAME geofeatures_boost::enable_if<
        ...
        template< class IteratorT, class ForwardRange >
        inline BOOST_DEDUCED_TYPENAME geofeatures_boost::enable_if<
            mpl::not_<geofeatures_boost::is_base_and_derived<iterator_range_detail::iterator_range_tag, ForwardRange> >,
            bool
        >::type
        operator!=( const ForwardRange& l, const iterator_range<IteratorT>& r )
        {
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, geofeatures_boost::next(first, n));
        }
        ...
        make_iterator_range( Range& r )
        {
            return iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<Range>::type >
                ( geofeatures_boost::begin( r ), geofeatures_boost::end( r ) );
        }
        ...
        namespace iterator_range_detail
        {
                             ...
                             BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                ...
                BOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = geofeatures_boost::begin( r ),
                    new_end   = geofeatures_boost::end( r );
        ...
        */
        ...
        {
            return SeqT( geofeatures_boost::begin( r ), geofeatures_boost::end( r ) );
        }
