...
rend( C& c )
{
    return BOOST_DEDUCED_TYPENAME range_reverse_iterator<C>::type( geofeatures_boost::begin( c ) );
}
...
rend( C& c )
{
    typedef BOOST_DEDUCED_TYPENAME range_reverse_iterator<C>::type
               iter_type;
    return iter_type( geofeatures_boost::begin( c ) );
}
...
{
    return geofeatures_boost::rend( r );
}
