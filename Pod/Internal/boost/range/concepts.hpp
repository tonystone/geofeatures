...
// during the search for black listed compilers.
    ...
    #define BOOST_RANGE_CONCEPT_ASSERT( x )
        ...
        // use case is the combination of the geofeatures_boost::adaptors::filtered
        // class with a geofeatures_boost::lambda::bind generated functor.
            ...
            , EqualityComparable<Iterator>
        {
            ...
            {
                Iterator i2(++i);
                geofeatures_boost::ignore_unused_variable_warning(i2);
                ...
                BOOST_DEDUCED_TYPENAME geofeatures_boost::detail::iterator_traits<Iterator>::reference r1(*i);
                geofeatures_boost::ignore_unused_variable_warning(r1);

                BOOST_DEDUCED_TYPENAME geofeatures_boost::detail::iterator_traits<Iterator>::reference r2(*(++i));
                geofeatures_boost::ignore_unused_variable_warning(r2);
            }
        private:
            Iterator i;
#endif
        ...
        {
#if BOOST_RANGE_ENABLE_CONCEPT_ASSERT
            typedef BOOST_DEDUCED_TYPENAME geofeatures_boost::detail::iterator_traits<Iterator>::difference_type difference_type;
            ...
            BOOST_CONCEPT_USAGE(ForwardIteratorConcept)
            {
                ...
                Iterator i2(i++);
                geofeatures_boost::ignore_unused_variable_warning(i2);
                BOOST_DEDUCED_TYPENAME geofeatures_boost::detail::iterator_traits<Iterator>::reference r(*(i++));
    ...
    struct SinglePassRangeConcept
    {
        ...
        BOOST_CONCEPT_USAGE(SinglePassRangeConcept)
        {
            ...
            iterator i1 = geofeatures_boost::begin(*m_range);
            iterator i2 = geofeatures_boost::end(*m_range);

            geofeatures_boost::ignore_unused_variable_warning(i1);
            geofeatures_boost::ignore_unused_variable_warning(i2);
    ...
    private:
        ...
        {
            const_iterator ci1 = geofeatures_boost::begin(const_range);
            const_iterator ci2 = geofeatures_boost::end(const_range);

            geofeatures_boost::ignore_unused_variable_warning(ci1);
            geofeatures_boost::ignore_unused_variable_warning(ci2);
        }
