...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace function_types { namespace detail {
...
struct cv_code
{
  ...
  BOOST_STATIC_CONSTANT(std::size_t, value = 
      sizeof(::geofeatures_boost::function_types::detail::switch_cv(
         ::geofeatures_boost::function_types::detail::ref_to_ptr(_t) ) ));
};

template<typename T> struct cv_traits 
{
  typedef typename geofeatures_boost::function_types::detail::cv_tag_impl< 
    ::geofeatures_boost::function_types::detail::cv_code<T>::value >::type
  tag;

  // may require Boost.TypeTraits broken compiler specializations
  // to work
  typedef typename geofeatures_boost::remove_cv<
              typename geofeatures_boost::remove_pointer<
                  typename geofeatures_boost::remove_reference<T>::type 
              >::type 
          >::type type; 
};
#endif

} } } // namespace geofeatures_boost::function_types::detail
