...
#   define BOOST_FT_variations BOOST_FT_pointer
    ...
    struct components_impl<T C::*, L>
      : detail::retagged_if
        < detail::components_impl<typename geofeatures_boost::remove_cv<T>::type *, L>
    ...
    template<typename T> struct cv_tag_mfp
      : detail::cv_tag_mfp_impl
        < ::geofeatures_boost::function_types::detail::encode_mfp_cv<T>::value >
    { };
    ...
    template<typename T, typename D, typename L> struct bcc_class_transform 
      : bcc_class_transform_impl
        < typename decode_cv
          < T
          , ::geofeatures_boost::function_types::detail::encode_mfp_cv<D>::value 
          >::type
        , L
        > 
    { };
