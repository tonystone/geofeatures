...
{
    typedef typename ::geofeatures_boost::remove_cv<typename
     ::geofeatures_boost::remove_reference<T>::type>::type  type;

};  // geofeatures_boost::detail::remove_cv_ref
...
struct is_related
    : public ::geofeatures_boost::is_same<
     typename ::geofeatures_boost::detail::remove_cv_ref<T>::type,
     typename ::geofeatures_boost::detail::remove_cv_ref<U>::type >
{};
...
struct enable_if_unrelated
    : public ::geofeatures_boost::enable_if_c<true>
{};

template<typename T, typename U, typename ...U2>
struct enable_if_unrelated<T, U, U2...>
    : public ::geofeatures_boost::disable_if< ::geofeatures_boost::detail::is_related<T, U> >
{};
#endif
...
protected:
    ...
    template <typename ...T, typename EnableIf = typename
     ::geofeatures_boost::detail::enable_if_unrelated<base_from_member, T...>::type>
...
};  // geofeatures_boost::base_from_member
