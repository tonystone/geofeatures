...
struct tr1_result_of<F(BOOST_RESULT_OF_ARGS)>
    : mpl::if_<
        ...
        , geofeatures_boost::detail::tr1_result_of_impl<
            typename remove_cv<F>::type,
            typename remove_cv<F>::type(BOOST_RESULT_OF_ARGS),
            (geofeatures_boost::detail::has_result_type<F>::value)>
        , geofeatures_boost::detail::tr1_result_of_impl<
            F,
            F(BOOST_RESULT_OF_ARGS),
            (geofeatures_boost::detail::has_result_type<F>::value)> >::type { };
#endif
...
struct BOOST_PP_CAT(result_of_is_callable_, BOOST_PP_ITERATION()) {
    ...
    static const bool value = (
        sizeof(result_of_no_type) == sizeof(detail::result_of_is_private_type(
            (geofeatures_boost::declval<wrapper_t>()(BOOST_PP_ENUM_BINARY_PARAMS(BOOST_PP_ITERATION(), geofeatures_boost::declval<T, >() BOOST_PP_INTERCEPT)), result_of_weird_type())
        ))
    );
...
{
  typedef decltype(
    geofeatures_boost::declval<F>()(
      BOOST_PP_ENUM_BINARY_PARAMS(BOOST_PP_ITERATION(), geofeatures_boost::declval<T, >() BOOST_PP_INTERCEPT)
    )
  ) type;
};
