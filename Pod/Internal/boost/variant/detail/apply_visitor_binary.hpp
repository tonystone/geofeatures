...
public: // visitor interfaces
    ...
    operator()(Value1& value1)
    {
        ...
        return geofeatures_boost::apply_visitor(invoker, visitable2_);
    }
...
{
    ::geofeatures_boost::detail::variant::apply_visitor_binary_unwrap<
          Visitor, Visitable2
        > unwrapper(visitor, visitable2);

    return geofeatures_boost::apply_visitor(unwrapper, visitable1);
}
...
inline decltype(auto) apply_visitor(Visitor& visitor, Visitable1& visitable1, Visitable2& visitable2,
    ...
    >::type* = 0)
{
    ::geofeatures_boost::detail::variant::apply_visitor_binary_unwrap_cpp14<
          Visitor, Visitable2
        > unwrapper(visitor, visitable2);
