...
template <typename R = ::geofeatures_boost::detail::static_visitor_default_return>
...
template< typename T > struct is_static_visitor
	: public ::geofeatures_boost::integral_constant<bool,(::geofeatures_boost::detail::is_static_visitor_impl<T>::value)>
{
public:
