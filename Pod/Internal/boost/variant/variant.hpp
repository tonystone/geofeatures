...
struct add_alignment
{
    ...
    struct apply
        : mpl::size_t<
              ::geofeatures_boost::math::static_lcm<
                  BOOST_MPL_AUX_VALUE_WKND(State)::value
                , ::geofeatures_boost::alignment_of<Item>::value
                >::value
            >
    {};
};
...
//
// This implementation is designed to prefer geofeatures_boost::blank over other potential
...
private: // helpers, for metafunction result (below)
    ...
    // [...now search the rest of the sequence for geofeatures_boost::blank...]

    typedef typename mpl::iter_fold_if<
          mpl::iterator_range< first_result_it,end_it >
        , first_result_index, mpl::protect< mpl::next<> >
        , mpl::protect< mpl::not_same_as<geofeatures_boost::blank> >
        >::type second_result_;
...
struct is_variant_move_noexcept_constructible {
    typedef typename geofeatures_boost::mpl::find_if<
        Types, mpl::not_<geofeatures_boost::is_nothrow_move_constructible<geofeatures_boost::mpl::_1> >
    >::type iterator_t;

    typedef typename geofeatures_boost::mpl::end<Types>::type end_t;
    typedef typename geofeatures_boost::is_same<
        iterator_t, end_t
    >::type type;
};
...
struct is_variant_move_noexcept_assignable {
    typedef typename geofeatures_boost::mpl::find_if<
        Types, mpl::not_<geofeatures_boost::is_nothrow_move_assignable<geofeatures_boost::mpl::_1> >
    >::type iterator_t;
...
public: // visitor interface
    ...
    T& operator()(U&) const
    {
        ...
        return ::geofeatures_boost::detail::variant::forced_return< T& >();
    }
};
...
public: // internal visitor interface
    ...
    template <typename T>
        BOOST_VARIANT_AUX_RETURN_VOID_TYPE
    internal_visit(geofeatures_boost::detail::variant::backup_holder<T>& operand, long) const
    {
    ...
    template <typename T>
        BOOST_VARIANT_AUX_RETURN_VOID_TYPE
    internal_visit(const geofeatures_boost::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( operand.get() );
        BOOST_VARIANT_AUX_RETURN_VOID;
    }
...
public: // internal visitor interface
    ...
    internal_visit(geofeatures_boost::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( ::geofeatures_boost::detail::variant::move(operand.get()) );
        BOOST_VARIANT_AUX_RETURN_VOID;
    }

    template <typename T>
        BOOST_VARIANT_AUX_RETURN_VOID_TYPE
    internal_visit(T& operand, int) const BOOST_NOEXCEPT_IF(BOOST_NOEXCEPT_EXPR(T(geofeatures_boost::declval<T>())))
    {
        new(storage_) T(::geofeatures_boost::detail::variant::move(operand));
        BOOST_VARIANT_AUX_RETURN_VOID;
    }
};
#endif
...
public: // internal visitor interfaces
    ...
    {
        lhs_content.get()
            = ::geofeatures_boost::detail::variant::move(static_cast<backup_holder<T>* >(rhs_storage_)->get());
        BOOST_VARIANT_AUX_RETURN_VOID;
    }
    ...
    internal_visit(T& lhs_content, int) const
    {
        ...
        // Hint: Are any of the bounded types const-qualified or references?
        //
        lhs_content = ::geofeatures_boost::detail::variant::move(*static_cast<T* >(rhs_storage_));
        BOOST_VARIANT_AUX_RETURN_VOID;
    }
...
public: // visitor interface
    ...
    bool operator()(T& lhs)
    {
        lhs = ::geofeatures_boost::detail::variant::move(rhs_);
        return true;
    }
...
private: // helpers, for visitor interface (below)
        ...
        )
    {
        ...
        LhsT backup_lhs_content(
              ::geofeatures_boost::detail::variant::move(lhs_content)
            ); // nothrow
        ...
        BOOST_CATCH (...)
        {
            ...
            new(lhs_.storage_.address())
                LhsT(
                      ::geofeatures_boost::detail::variant::move(backup_lhs_content)
                    ); // nothrow
...
public: // internal visitor interfaces
    ...
    void operator()(T& operand) const
    {
        ...
        // ...and swap:
        ::geofeatures_boost::detail::variant::move_swap( operand, other );
    }
...
class reflect
    : public static_visitor<const geofeatures_boost::typeindex::type_info&>
{
public: // visitor interfaces

    template <typename T>
    const geofeatures_boost::typeindex::type_info& operator()(const T&) const BOOST_NOEXCEPT
    {
        return geofeatures_boost::typeindex::type_id<T>().type_info();
    }
...
public: // internal visitor interfaces, cont.
    ...
    template <typename T>
        BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(geofeatures_boost::recursive_wrapper<T>& operand, long)
    {
    ...
    template <typename T>
        BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(const geofeatures_boost::recursive_wrapper<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
    ...
    template <typename T>
        BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(geofeatures_boost::detail::reference_content<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
    ...
    template <typename T>
        BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(const geofeatures_boost::detail::reference_content<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
    ...
    template <typename T>
        BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(geofeatures_boost::detail::variant::backup_holder<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
    ...
    template <typename T>
        BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(const geofeatures_boost::detail::variant::backup_holder<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
...
private: // helpers, for typedefs (below)
    ...
    BOOST_STATIC_ASSERT((
          ::geofeatures_boost::mpl::not_< mpl::empty<specified_types> >::value
        ));
...
public: // structors
    ...
    variant() BOOST_NOEXCEPT_IF(geofeatures_boost::has_nothrow_constructor<internal_T0>::value)
    {
#ifdef _MSC_VER
#pragma warning( push )
...
#   endif
        ...
        template <typename T>
        int internal_visit(geofeatures_boost::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const geofeatures_boost::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(geofeatures_boost::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const geofeatures_boost::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(geofeatures_boost::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const geofeatures_boost::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }
...
private: // helpers, for structors, below 
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <typename T>
    typename geofeatures_boost::enable_if<geofeatures_boost::is_rvalue_reference<T&&> >::type convert_construct(
          T&& operand
        , int
        , mpl::false_ = mpl::false_() // is_foreign_variant
        )
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <typename Variant>
    typename geofeatures_boost::enable_if<geofeatures_boost::is_rvalue_reference<Variant&&> >::type convert_construct(
          Variant&& operand
        , long
        , mpl::true_// is_foreign_variant
        )
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <typename Variant>
    typename geofeatures_boost::enable_if<geofeatures_boost::is_rvalue_reference<Variant&&> >::type convert_construct_variant(Variant&& operand)
    {
        // [Determine if the given variant is itself a bounded type, or if its
        //  content needs to be converted (i.e., it is a 'foreign' variant):]
        //
    ...
    void convert_construct(
          geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>& operand
        , long
        )
    {
    ...
    template <BOOST_VARIANT_ENUM_PARAMS(typename U)>
    void convert_construct(
          const geofeatures_boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>& operand
        , long
        )
    {
        convert_construct_variant(operand);    
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <class T>
    variant(T&& operand, typename geofeatures_boost::enable_if<geofeatures_boost::is_rvalue_reference<T&&> >::type* = 0, 
        typename geofeatures_boost::disable_if<geofeatures_boost::is_const<T> >::type* = 0)
    {
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <class T>
    typename geofeatures_boost::enable_if_c<geofeatures_boost::is_rvalue_reference<T&&>::value && !geofeatures_boost::is_const<T>::value, variant& >::type 
        operator=(T&& rhs) 
    {
...
public: // queries
    ...
    const geofeatures_boost::typeindex::type_info& type() const
    {
...
private: // precondition assertions
    ...
    BOOST_STATIC_ASSERT(( ::geofeatures_boost::mpl::is_sequence<Types>::value ));
