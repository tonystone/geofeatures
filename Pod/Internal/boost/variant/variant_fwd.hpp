...
//
// Exposes a geofeatures_boost::variant with recursive_variant_ tags (below) substituted
// with the variant itself (wrapped as needed with geofeatures_boost::recursive_wrapper).
//
