...
{
   typedef typename geofeatures_boost::detail::cv_traits_imp<BOOST_TT_AUX_CV_TRAITS_IMPL_PARAM(T)>::unqualified_type type;
};
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_cv,T,typename geofeatures_boost::detail::rvalue_ref_filter_rem_cv<T>::type)
