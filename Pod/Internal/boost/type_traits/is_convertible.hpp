...
#  define BOOST_TT_CXX11_IS_CONVERTIBLE
   ...
   template<typename From, typename To, bool b = or_helper<geofeatures_boost::is_void<From>, geofeatures_boost::is_function<To>, geofeatures_boost::is_array<To> >::value>
   ...
   class is_convertible_basic_impl<From, To, false>
   {
      ...
      static decltype(test_aux<To1>(geofeatures_boost::declval<From1>()), one()) test(int);
...
#pragma option push -w-8074
    ...
    {
        static ::geofeatures_boost::type_traits::no_type BOOST_TT_DECL _m_check(...);
        static ::geofeatures_boost::type_traits::yes_type BOOST_TT_DECL _m_check(T);
    };

    static typename add_lvalue_reference<From>::type  _m_from;
    static bool const value = sizeof( checker<To>::_m_check(_m_from) )
        == sizeof(::geofeatures_boost::type_traits::yes_type);
#pragma option pop
};
...
template <typename T> struct checker
{
    static geofeatures_boost::type_traits::no_type _m_check(any_conversion ...);
    static geofeatures_boost::type_traits::yes_type _m_check(T, int);
};
...
struct is_convertible_basic_impl
{
    ...
    static bool const value =
        sizeof( geofeatures_boost::detail::checker<To>::_m_check(static_cast<rvalue_type>(_m_from), 0) )
        == sizeof(::geofeatures_boost::type_traits::yes_type);
#else
    static bool const value =
        sizeof( geofeatures_boost::detail::checker<To>::_m_check(_m_from, 0) )
        == sizeof(::geofeatures_boost::type_traits::yes_type);
#endif
};
...
struct is_convertible_basic_impl
{
    static ::geofeatures_boost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion ...);
    static ::geofeatures_boost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type; 
    static lvalue_type _m_from;
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0) ) == sizeof(::geofeatures_boost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from, 0) ) == sizeof(::geofeatures_boost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl
{
    ...
    template <class T>
    static ::geofeatures_boost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion,  float, T);
    static ::geofeatures_boost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    enum { value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0, 0) ) == sizeof(::geofeatures_boost::type_traits::yes_type)
        };
#else
    enum { value =
        sizeof( _m_check(_m_from, 0, 0) ) == sizeof(::geofeatures_boost::type_traits::yes_type)
        };
#endif
};
...
{
    static ::geofeatures_boost::type_traits::no_type BOOST_TT_DECL _m_check(...);
    static ::geofeatures_boost::type_traits::yes_type BOOST_TT_DECL _m_check(To);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from)) ) == sizeof(::geofeatures_boost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from) ) == sizeof(::geofeatures_boost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl:
  is_convertible_basic_impl_aux<
    From,To,
    ::geofeatures_boost::is_function<typename ::geofeatures_boost::remove_reference<From>::type>::value
  >
{};
    ...
    enum { value =
        (::geofeatures_boost::type_traits::ice_and<
            ::geofeatures_boost::type_traits::ice_or<
               ::geofeatures_boost::detail::is_convertible_basic_impl<From,To>::value,
               ::geofeatures_boost::is_void<To>::value
            >::value,
            ::geofeatures_boost::type_traits::ice_not<
               ::geofeatures_boost::is_array<To>::value
            >::value,
            ::geofeatures_boost::type_traits::ice_not<
               ::geofeatures_boost::is_function<To>::value
            >::value
        >::value) };
};
...
struct is_convertible_impl_dispatch_base
{
   ...
   typedef is_convertible_impl_select< 
      ::geofeatures_boost::is_arithmetic<From>::value, 
      ::geofeatures_boost::is_arithmetic<To>::value,
      ...
      ::geofeatures_boost::is_abstract<To>::value
#else
      false
#endif
   > selector;
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(is_convertible,From,To,(::geofeatures_boost::detail::is_convertible_impl_dispatch<From,To>::value))
