...
#  ifdef __clang__
   BOOST_STATIC_CONSTANT(bool, value = BOOST_HAS_TRIVIAL_COPY(T) && geofeatures_boost::is_copy_constructible<T>::value);
#  else
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_copy,T,::geofeatures_boost::detail::has_trivial_copy_impl<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_copy_constructor,T,::geofeatures_boost::detail::has_trivial_copy_impl<T>::value)
