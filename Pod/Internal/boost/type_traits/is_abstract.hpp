...
struct is_abstract_imp
{
   typedef is_abstract_select< ::geofeatures_boost::is_class<T>::value> selector;
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_abstract,T,::geofeatures_boost::detail::is_abstract_imp<T>::value)
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_abstract,T,::geofeatures_boost::detail::is_polymorphic_imp<T>::value)
#endif
