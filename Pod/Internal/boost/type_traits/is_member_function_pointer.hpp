...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(
    ...
    , T
    , ::geofeatures_boost::type_traits::is_mem_fun_pointer_impl<typename remove_cv<T>::type>::value
    )
...
struct is_mem_fun_pointer_select
    : public ::geofeatures_boost::type_traits::false_result
{
};
...
#pragma warning(disable:6334)
        ...
        BOOST_STATIC_CONSTANT(
            bool, value = (
                1 == sizeof(::geofeatures_boost::type_traits::is_mem_fun_pointer_tester(self_type::make_t))
            ));
#if BOOST_WORKAROUND(BOOST_MSVC_FULL_VER, >= 140050000)
#pragma warning(pop)
#endif
...
struct is_member_function_pointer_impl
    : public is_mem_fun_pointer_select<
          ::geofeatures_boost::type_traits::ice_or<
            ...
            , ::geofeatures_boost::is_array<T>::value
            >::value
        >::template result_<T>
{
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_member_function_pointer,T,::geofeatures_boost::detail::is_member_function_pointer_impl<T>::value)
