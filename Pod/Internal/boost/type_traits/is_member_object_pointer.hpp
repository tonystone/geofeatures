...
struct is_member_object_pointer_impl
{
   BOOST_STATIC_CONSTANT(
      bool, value = (::geofeatures_boost::type_traits::ice_and<
         ::geofeatures_boost::is_member_pointer<T>::value,
         ::geofeatures_boost::type_traits::ice_not<
            ::geofeatures_boost::is_member_function_pointer<T>::value
         >::value
      >::value ));
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_member_object_pointer,T,::geofeatures_boost::detail::is_member_object_pointer_impl<T>::value)
