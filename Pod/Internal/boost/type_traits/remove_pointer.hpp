...
namespace detail{
   ...
   {
      typedef typename remove_pointer_imp<typename geofeatures_boost::remove_cv<T>::type>::type type;
   };
   ...
   {
      typedef typename remove_pointer_imp3<T, ::geofeatures_boost::is_pointer<T>::value>::type type;
   };
}

BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_pointer,T,typename geofeatures_boost::detail::remove_pointer_imp2<T>::type)
