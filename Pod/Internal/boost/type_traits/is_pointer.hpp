...
struct is_pointer_impl
{
    BOOST_STATIC_CONSTANT(bool, value =
        ...
        ::geofeatures_boost::detail::is_pointer_helper<typename remove_cv<T>::type>::value
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_pointer,T,::geofeatures_boost::detail::is_pointer_impl<T>::value)
