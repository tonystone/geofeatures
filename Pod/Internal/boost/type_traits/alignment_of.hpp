...
struct alignment_of_impl
{
    ...
    BOOST_STATIC_CONSTANT(std::size_t, value =
        (::geofeatures_boost::detail::alignment_logic<
            sizeof(::geofeatures_boost::detail::alignment_of_hack<T>) - sizeof(T),
            __alignof(T)
        >::value));
...
BOOST_TT_AUX_SIZE_T_TRAIT_DEF1(alignment_of,T,::geofeatures_boost::detail::alignment_of_impl<T>::value)
