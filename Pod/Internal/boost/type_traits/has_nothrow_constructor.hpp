...
#else
   BOOST_STATIC_CONSTANT(bool, value = ::geofeatures_boost::has_trivial_constructor<T>::value);
#endif
};

}

BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_nothrow_constructor,T,::geofeatures_boost::detail::has_nothrow_constructor_imp<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_nothrow_default_constructor,T,::geofeatures_boost::detail::has_nothrow_constructor_imp<T>::value)
