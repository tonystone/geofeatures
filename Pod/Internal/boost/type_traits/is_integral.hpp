...
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral, ::geofeatures_boost::ulong_long_type,true)
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral, ::geofeatures_boost::long_long_type,true)
...
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,geofeatures_boost::int128_type,true)
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,geofeatures_boost::uint128_type,true)
#endif
