...
struct is_reference_impl
{
   BOOST_STATIC_CONSTANT(bool, value =
      (::geofeatures_boost::type_traits::ice_or<
         ::geofeatures_boost::is_lvalue_reference<T>::value, ::geofeatures_boost::is_rvalue_reference<T>::value
       >::value));
};

} // namespace detail

BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_reference,T,::geofeatures_boost::detail::is_reference_impl<T>::value)
