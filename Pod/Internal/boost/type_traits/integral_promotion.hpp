...
// 4.5/2
template <class T> struct need_promotion : public geofeatures_boost::is_enum<T> {};
...
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(geofeatures_boost::ulong_long_type)
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(geofeatures_boost::long_long_type )
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTE_FROM_INDEX(5, geofeatures_boost::long_long_type )
BOOST_TT_AUX_PROMOTE_FROM_INDEX(6, geofeatures_boost::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(5, geofeatures_boost::long_long_type )
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(6, geofeatures_boost::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
struct integral_promotion_impl
{
    typedef BOOST_DEDUCED_TYPENAME promote_from_index<
        (geofeatures_boost::type_traits::detail::promoted_index<T>::value)
      , (geofeatures_boost::is_const<T>::value)
      , (geofeatures_boost::is_volatile<T>::value)
      >::type type;
};

template<class T>
struct integral_promotion
  : public geofeatures_boost::mpl::eval_if<
        need_promotion<BOOST_DEDUCED_TYPENAME remove_cv<T>::type>
      , integral_promotion_impl<T>
      , geofeatures_boost::mpl::identity<T>
      >
{
};
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(
    ...
    , BOOST_DEDUCED_TYPENAME
        geofeatures_boost::type_traits::detail::integral_promotion<T>::type
    )
}
