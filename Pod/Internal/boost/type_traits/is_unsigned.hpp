...
{
   BOOST_STATIC_CONSTANT(bool, value = (::geofeatures_boost::detail::is_unsigned_values<T>::minus_one > ::geofeatures_boost::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned_imp
{
   typedef is_ununsigned_select_helper< 
      ::geofeatures_boost::type_traits::ice_or<
         ...
         ::geofeatures_boost::is_enum<T>::value>::value 
   > selector;
...
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_unsigned,T,::geofeatures_boost::detail::is_unsigned_imp<T>::value)
#endif
