...
struct operator_returns_void {
   ...
   static ::geofeatures_boost::type_traits::yes_type returns_void(returns_void_t);
   static ::geofeatures_boost::type_traits::no_type returns_void(int);
   BOOST_STATIC_CONSTANT(bool, value = (sizeof(::geofeatures_boost::type_traits::yes_type)==sizeof(returns_void((make<Lhs>() BOOST_TT_TRAIT_OP make<Rhs>(),returns_void_t())))));
};
...
struct operator_returns_Ret < Lhs, Rhs, Ret, false > {
   static ::geofeatures_boost::type_traits::yes_type is_convertible_to_Ret(Ret); // this version is preferred for types convertible to Ret
   static ::geofeatures_boost::type_traits::no_type is_convertible_to_Ret(...); // this version is used otherwise

   BOOST_STATIC_CONSTANT(bool, value = (sizeof(is_convertible_to_Ret(make<Lhs>() BOOST_TT_TRAIT_OP make<Rhs>()))==sizeof(::geofeatures_boost::type_traits::yes_type)));
};
...
struct operator_exists {
   static ::geofeatures_boost::type_traits::yes_type s_check(has_operator); // this version is preferred when operator exists
   static ::geofeatures_boost::type_traits::no_type s_check(no_operator); // this version is used otherwise

   BOOST_STATIC_CONSTANT(bool, value = (sizeof(s_check(((make<Lhs>() BOOST_TT_TRAIT_OP make<Rhs>()),make<has_operator>())))==sizeof(::geofeatures_boost::type_traits::yes_type)));
};
...
template < typename Lhs, typename Rhs, typename Ret >
struct trait_impl {
   typedef typename ::geofeatures_boost::remove_reference<Lhs>::type Lhs_noref;
   typedef typename ::geofeatures_boost::remove_reference<Rhs>::type Rhs_noref;
   typedef typename ::geofeatures_boost::remove_cv<Lhs_noref>::type Lhs_nocv;
   typedef typename ::geofeatures_boost::remove_cv<Rhs_noref>::type Rhs_nocv;
   typedef typename ::geofeatures_boost::remove_cv< typename ::geofeatures_boost::remove_reference< typename ::geofeatures_boost::remove_pointer<Lhs_noref>::type >::type >::type Lhs_noptr;
   typedef typename ::geofeatures_boost::remove_cv< typename ::geofeatures_boost::remove_reference< typename ::geofeatures_boost::remove_pointer<Rhs_noref>::type >::type >::type Rhs_noptr;
...
BOOST_TT_AUX_BOOL_TRAIT_DEF3(BOOST_TT_TRAIT_NAME, Lhs, Rhs=Lhs, Ret=::geofeatures_boost::detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME,_impl)::dont_care, (::geofeatures_boost::detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME,_impl)::trait_impl < Lhs, Rhs, Ret >::value))
