...
struct operator_returns_void {
   ...
   BOOST_STATIC_CONSTANT(bool, value = (sizeof(::geofeatures_boost::type_traits::yes_type)==sizeof(returns_void((make<Lhs>() BOOST_TT_TRAIT_OP,returns_void_t())))));
};
...
struct operator_returns_Ret < Lhs, Ret, false > {
   ...
   BOOST_STATIC_CONSTANT(bool, value = (sizeof(is_convertible_to_Ret(make<Lhs>() BOOST_TT_TRAIT_OP))==sizeof(::geofeatures_boost::type_traits::yes_type)));
};
...
struct operator_exists {
   ...
   BOOST_STATIC_CONSTANT(bool, value = (sizeof(s_check(((make<Lhs>() BOOST_TT_TRAIT_OP),make<has_operator>())))==sizeof(::geofeatures_boost::type_traits::yes_type)));
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(BOOST_TT_TRAIT_NAME, Lhs, Ret=::geofeatures_boost::detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME,_impl)::dont_care, (::geofeatures_boost::detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME,_impl)::trait_impl< Lhs, Ret >::value))
