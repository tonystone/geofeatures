...
// https://connect.microsoft.com/VisualStudio/feedback/details/800328/std-is-copy-constructible-is-broken
    ...
    template <class T1>
    static geofeatures_boost::type_traits::yes_type test(T1&, geofeatures_boost::mpl::int_<sizeof(T1(geofeatures_boost::declval<T1&>()))>* = 0);
#else
    template <class T1>
    static geofeatures_boost::type_traits::yes_type test(T1&, decltype(T1(geofeatures_boost::declval<T1&>()))* = 0);
#endif

    static geofeatures_boost::type_traits::no_type test(...);
#else
    template <class T1>
    ...
    BOOST_STATIC_CONSTANT(bool, value = (
            sizeof(test(
                geofeatures_boost::declval<BOOST_DEDUCED_TYPENAME geofeatures_boost::add_reference<T>::type>()
            )) == sizeof(geofeatures_boost::type_traits::yes_type)
        ||
            geofeatures_boost::is_rvalue_reference<T>::value
    ));
};
...
struct is_copy_constructible_impl {
    ...
    BOOST_STATIC_CONSTANT(bool, value = (
        geofeatures_boost::detail::is_copy_constructible_impl2<
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_copy_constructible,T,::geofeatures_boost::detail::is_copy_constructible_impl<T>::value)
