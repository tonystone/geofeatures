...
{
   typedef is_polymorphic_selector< ::geofeatures_boost::is_class<T>::value> selector;
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_polymorphic,T,::geofeatures_boost::detail::is_polymorphic_imp<T>::value)
