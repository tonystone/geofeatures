...
struct make_signed_imp
{
   ...
   typedef typename mpl::if_c<
      (::geofeatures_boost::type_traits::ice_and< 
         ::geofeatures_boost::is_signed<T>::value,
            ...
            typename mpl::if_<
               ...
               typename mpl::if_<
                  ...
                  typename mpl::if_<
                     ...
                     typename mpl::if_c<
                        sizeof(t_no_cv) == sizeof(geofeatures_boost::long_long_type), 
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(make_signed,T,typename geofeatures_boost::detail::make_signed_imp<T>::type)
