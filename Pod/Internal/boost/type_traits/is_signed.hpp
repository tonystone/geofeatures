...
{
   typedef typename remove_cv<T>::type no_cv_t;
   BOOST_STATIC_CONSTANT(bool, value = (!(::geofeatures_boost::detail::is_signed_values<T>::minus_one  > geofeatures_boost::detail::is_signed_values<T>::zero)));
};
...
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_signed,T,::geofeatures_boost::detail::is_signed_imp<T>::value)
#endif
