...
{
   BOOST_STATIC_CONSTANT(std::size_t, value = (::geofeatures_boost::detail::extent_imp<T, N-1>::value));
};
...
}   // ::geofeatures_boost::detail

template <class T, std::size_t N = 0>
struct extent
   : public ::geofeatures_boost::integral_constant<std::size_t, ::geofeatures_boost::detail::extent_imp<T,N>::value>
{
