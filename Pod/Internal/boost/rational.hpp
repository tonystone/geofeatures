...
#include <boost/operators.hpp>   // for geofeatures_boost::addable etc
#include <cstdlib>               // for std::abs
#include <boost/call_traits.hpp> // for geofeatures_boost::call_traits
#include <boost/detail/workaround.hpp> // for BOOST_WORKAROUND
#include <boost/assert.hpp>      // for BOOST_ASSERT
#include <boost/integer/common_factor_rt.hpp> // for geofeatures_boost::integer::gcd, lcm
    ...
    > > > > > > > > > > > > > > > >
{
    ...
    // Helper types
    typedef typename geofeatures_boost::call_traits<IntType>::param_type param_type;
