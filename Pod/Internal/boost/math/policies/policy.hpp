...
#define BOOST_MATH_META_INT(type, name, Default)\
   template <type N = Default> struct name : public geofeatures_boost::mpl::int_<N>{};\
   namespace detail{\
   template <type N>\
   ...
   template <class T> struct is_##name : public geofeatures_boost::mpl::bool_< ::geofeatures_boost::math::policies::detail::is_##name##_imp<T>::value>{};

#define BOOST_MATH_META_BOOL(name, Default)\
   template <bool N = Default> struct name : public geofeatures_boost::mpl::bool_<N>{};\
   namespace detail{\
   template <bool N>\
   char test_is_valid_arg(const name<N>*);\
   char test_is_default_arg(const name<Default>*);\
...
#define BOOST_MATH_META_INT(Type, name, Default)\
   ...
   {\
      static T inst;\
      BOOST_STATIC_CONSTANT(bool, value = sizeof( ::geofeatures_boost::math::policies::detail::is_##name##_tester<T>::test(inst)) == 1);\
   };\
   }\
   template <class T> struct is_##name : public geofeatures_boost::mpl::bool_< ::geofeatures_boost::math::policies::detail::is_##name##_imp<T>::value>\
   {\
...
#ifdef __BORLANDC__
   typedef typename mpl::if_c<
      (Digits2::value > ::geofeatures_boost::math::policies::detail::precision<Digits10,Digits2>::digits2_type::value),
...
public:
   typedef typename select_result<
      DefaultType, iter,
      ::geofeatures_boost::is_same<iter, end_type>::value>::type type;
};
...
{
   BOOST_STATIC_CONSTANT(bool, value = sizeof(::geofeatures_boost::math::policies::detail::test_is_valid_arg(static_cast<T*>(0))) == 1);
};

template <class T>
struct is_default_policy_imp
{
   BOOST_STATIC_CONSTANT(bool, value = sizeof(::geofeatures_boost::math::policies::detail::test_is_default_arg(static_cast<T*>(0))) == 1);
};

template <class T> struct is_valid_policy 
: public mpl::bool_< 
   ::geofeatures_boost::math::policies::detail::is_valid_policy_imp<T>::value>
{};

template <class T> struct is_default_policy 
: public mpl::bool_< 
   ::geofeatures_boost::math::policies::detail::is_default_policy_imp<T>::value>
{
   template <class U>
   struct apply
   {
...
private:
   ...
   //
   BOOST_STATIC_ASSERT(::geofeatures_boost::math::policies::detail::is_valid_policy<A1>::value);
   BOOST_STATIC_ASSERT(::geofeatures_boost::math::policies::detail::is_valid_policy<A2>::value);
   BOOST_STATIC_ASSERT(::geofeatures_boost::math::policies::detail::is_valid_policy<A3>::value);
   BOOST_STATIC_ASSERT(::geofeatures_boost::math::policies::detail::is_valid_policy<A4>::value);
   BOOST_STATIC_ASSERT(::geofeatures_boost::math::policies::detail::is_valid_policy<A5>::value);
   BOOST_STATIC_ASSERT(::geofeatures_boost::math::policies::detail::is_valid_policy<A6>::value);
   BOOST_STATIC_ASSERT(::geofeatures_boost::math::policies::detail::is_valid_policy<A7>::value);
   BOOST_STATIC_ASSERT(::geofeatures_boost::math::policies::detail::is_valid_policy<A8>::value);
   BOOST_STATIC_ASSERT(::geofeatures_boost::math::policies::detail::is_valid_policy<A9>::value);
   BOOST_STATIC_ASSERT(::geofeatures_boost::math::policies::detail::is_valid_policy<A10>::value);
   BOOST_STATIC_ASSERT(::geofeatures_boost::math::policies::detail::is_valid_policy<A11>::value);
   BOOST_STATIC_ASSERT(::geofeatures_boost::math::policies::detail::is_valid_policy<A12>::value);
   BOOST_STATIC_ASSERT(::geofeatures_boost::math::policies::detail::is_valid_policy<A13>::value);
   //
...
private:
   ...
   //
   typedef typename detail::append_N<reduced_list, default_policy, (14 - ::geofeatures_boost::mpl::size<reduced_list>::value)>::type result_type;
public:
   typedef policy<
...
#endif
   typedef typename geofeatures_boost::math::policies::precision<T, Policy>::type p_t;
   return p_t::value;
}
...
{
   return geofeatures_boost::math::policies::digits<T, Policy>() * 301 / 1000L;
}
...
struct series_factor_calc<T, Digits, mpl::true_, mpl::true_>
{
   static T get()
   {
      return geofeatures_boost::math::tools::epsilon<T>();
   }
};
template <class T, class Digits>
struct series_factor_calc<T, Digits, mpl::true_, mpl::false_>
{
   static T get()
   {
      static const geofeatures_boost::uintmax_t v = static_cast<geofeatures_boost::uintmax_t>(1u) << (Digits::value - 1);
...
#endif
   typedef typename geofeatures_boost::math::policies::precision<T, Policy>::type p_t;
   typedef mpl::bool_<p_t::value <= std::numeric_limits<geofeatures_boost::uintmax_t>::digits> is_small_int;
...
{
   BOOST_STATIC_CONSTANT(bool, value = (sizeof(::geofeatures_boost::math::policies::detail::test_is_policy(static_cast<P*>(0))) == 1));
};

}

template <class P>
struct is_policy : public mpl::bool_< ::geofeatures_boost::math::policies::detail::is_policy_imp<P>::value> {};
