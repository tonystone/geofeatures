...
#define BOOST_TYPEOF_VECTOR(n) BOOST_PP_CAT(geofeatures_boost::type_of::vector, n)

#define BOOST_TYPEOF_sizer_item(z, n, _)\
    char item ## n[V::item ## n ::value];

namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace type_of {
    template<class V>
    struct sizer
    {
...
#define BOOST_TYPEOF_TYPEITEM(z, n, expr)\
    geofeatures_boost::mpl::size_t<sizeof(geofeatures_boost::type_of::encode<BOOST_TYPEOF_VECTOR(0)<> >(expr).item ## n)>
...
#define BOOST_TYPEOF(Expr)\
    geofeatures_boost::type_of::decode_begin<BOOST_TYPEOF_ENCODED_VECTOR(Expr) >::type
...
namespace geofeatures_boost {} namespace boost = geofeatures_boost; namespace geofeatures_boost { namespace type_of {
    ...
    struct push_back<geofeatures_boost::type_of::offset_vector<V,Offset>,T> {
        typedef offset_vector<V,typename Offset::prior> type;
    };

    template<class V,class T>
    struct push_back<geofeatures_boost::type_of::offset_vector<V,mpl::size_t<0> >,T> {
        typedef typename push_back<V,T>::type type;
    };
}}

#define BOOST_TYPEOF_NESTED_TYPEITEM(z, n, expr)\
    BOOST_STATIC_CONSTANT(int,BOOST_PP_CAT(value,n) = sizeof(geofeatures_boost::type_of::encode<_typeof_start_vector>(expr).item ## n));\
    typedef geofeatures_boost::mpl::size_t<BOOST_PP_CAT(self_t::value,n)> BOOST_PP_CAT(item,n);
...
#define BOOST_TYPEOF_NESTED_TYPEDEF_IMPL(expr) \
        ...
        struct _typeof_encode_fraction {\
            ...
            typedef geofeatures_boost::type_of::offset_vector<BOOST_TYPEOF_VECTOR(0)<>,geofeatures_boost::mpl::size_t<self_t::_typeof_encode_offset> > _typeof_start_vector;\
        ...
        struct _typeof_fraction_iter {\
            typedef geofeatures_boost::type_of::generic_typeof_fraction_iter<Pos,_typeof_encode_fraction<0> > self_t;\
...
#define BOOST_TYPEOF_NESTED_TYPEDEF_IMPL(expr) \
        ...
        struct _typeof_fraction_iter {\
            ...
            typedef typename geofeatures_boost::type_of::v_iter<fraction_type,geofeatures_boost::mpl::int_<self_t::where> >::type type;\
...
struct BOOST_PP_CAT(_typeof_template_,name) {\
    ...
    typedef typename geofeatures_boost::type_of::decode_type<_typeof_fraction_iter<geofeatures_boost::mpl::size_t<0> > >::type type;\
};\
...
# define BOOST_TYPEOF_NESTED_TYPEDEF(name,expr) \
    struct name {\
        BOOST_TYPEOF_NESTED_TYPEDEF_IMPL(expr)\
        typedef geofeatures_boost::type_of::decode_type<_typeof_fraction_iter<geofeatures_boost::mpl::size_t<0> > >::type type;\
    };
#endif
