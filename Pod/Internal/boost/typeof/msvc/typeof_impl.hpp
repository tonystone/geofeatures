...
# define BOOST_TYPEOF_INDEX(T) (sizeof(*geofeatures_boost::type_of::encode_index((geofeatures_boost::type_of::encode_counter<1005>*)0)))
...
# define BOOST_TYPEOF(expr) \
    geofeatures_boost::type_of::msvc_typeid_wrapper<typeid(geofeatures_boost::type_of::encode_start(expr))>::type

# define BOOST_TYPEOF_TPL(expr) typename BOOST_TYPEOF(expr)

# define BOOST_TYPEOF_NESTED_TYPEDEF_TPL(name,expr) \
struct name {\
    enum {_typeof_register_value=sizeof(typeid(geofeatures_boost::type_of::typeof_register_type<name>(expr)))};\
    typedef typename geofeatures_boost::type_of::msvc_extract_type<name>::id2type id2type;\
...
struct name {\
    enum {_typeof_register_value=sizeof(typeid(geofeatures_boost::type_of::typeof_register_type<name>(expr)))};\
    typedef geofeatures_boost::type_of::msvc_extract_type<name>::id2type id2type;\
...
# define BOOST_TYPEOF(expr) \
    geofeatures_boost::type_of::msvc_typeid_wrapper<sizeof(*geofeatures_boost::type_of::encode_start(expr))>::type

# define BOOST_TYPEOF_TPL(expr) typename BOOST_TYPEOF(expr)

# define BOOST_TYPEOF_NESTED_TYPEDEF_TPL(name,expr) \
    struct name {\
        BOOST_STATIC_CONSTANT(int,_typeof_register_value=sizeof(geofeatures_boost::type_of::typeof_register_type<name>(expr)));\
        typedef typename geofeatures_boost::type_of::msvc_extract_type<name>::id2type id2type;\
        typedef typename id2type::type type;\
    };
