...
#     define BOOST_TYPEOF_define_vector(n)\
        ...
        struct vector ## n\
        {\
            typedef v_iter<vector ## n<BOOST_PP_ENUM_PARAMS(n,P)>, geofeatures_boost::mpl::int_<0> > begin;\
...
#     define BOOST_TYPEOF_spec_push_back(n)\
        ...
        struct push_back<BOOST_PP_CAT(geofeatures_boost::type_of::vector, n)<BOOST_PP_ENUM_PARAMS(n, P)>, T>\
        {\
            typedef BOOST_PP_CAT(geofeatures_boost::type_of::vector, BOOST_PP_INC(n))<\
