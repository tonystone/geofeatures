...
#define BOOST_TYPEOF_REGISTER_TEMPLATE_IMPL(Name, Params, Size, ID)\
    ...
    {\
        typedef typename geofeatures_boost::type_of::push_back<V, geofeatures_boost::mpl::size_t<ID> >::type V0;\
    ...
    {\
        typedef decode_type_impl<geofeatures_boost::mpl::size_t<ID>, Iter> self_t;\
        typedef geofeatures_boost::mpl::size_t<ID> self_id;\
        typedef Iter iter0;\
