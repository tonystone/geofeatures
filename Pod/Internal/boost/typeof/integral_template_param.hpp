...
#define BOOST_TYPEOF_INTEGRAL_PARAM_ENCODE(This, n)\
    typedef typename geofeatures_boost::type_of::encode_integral<\
        BOOST_PP_CAT(V, n),\
...
#define BOOST_TYPEOF_INTEGRAL_PARAM_DECODE(This, n)\
    typedef geofeatures_boost::type_of::decode_integral<BOOST_TYPEOF_INTEGRAL_PARAM_GETTYPE(This), BOOST_PP_CAT(iter, n)> BOOST_PP_CAT(d, n);\
