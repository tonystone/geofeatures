...
{
    typedef geofeatures_boost::iterators::detail::minimum_category_impl<
        ::geofeatures_boost::is_convertible<T1,T2>::value
      , ::geofeatures_boost::is_convertible<T2,T1>::value
    > outer;
