...
//Forward declare geofeatures_boost::rv
...
{
   return ::geofeatures_boost::move_detail::addressof_impl<T>::f
      ( ::geofeatures_boost::move_detail::addr_impl_ref<T>( v ), 0 );
}
...
struct has_move_emulation_enabled_impl
   : is_convertible< T, ::geofeatures_boost::rv<T>& >
{};
...
template<class T>
struct has_move_emulation_enabled_impl< ::geofeatures_boost::rv<T> >
{  static const bool value = false;  };
...
template< class T >
struct is_rvalue_reference< geofeatures_boost::rv<T>& >
{  static const bool value = true;  };

template< class T >
struct is_rvalue_reference< const geofeatures_boost::rv<T>& >
{  static const bool value = true;  };
...
namespace detail_add_rvalue_reference
{
   ...
   struct add_rvalue_reference_impl< T, true, rv > { typedef ::geofeatures_boost::rv<T>& type; };
} // namespace detail_add_rvalue_reference
