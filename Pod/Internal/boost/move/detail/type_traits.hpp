...
// BOOST_MOVE_HAS_TRIVIAL_MOVE_CONSTRUCTOR(T) should evaluate to true if T(geofeatures_boost::move(t)) <==> memcpy
// BOOST_MOVE_HAS_TRIVIAL_ASSIGN(T) should evaluate to true if t = u <==> memcpy
// BOOST_MOVE_HAS_TRIVIAL_MOVE_ASSIGN(T) should evaluate to true if t = geofeatures_boost::move(u) <==> memcpy
...
#   define BOOST_MOVE_HAS_TRIVIAL_COPY(T)          (__has_trivial_copy(T)|| ::geofeatures_boost::move_detail::is_pod<T>::value)
#   define BOOST_MOVE_HAS_TRIVIAL_ASSIGN(T)        (__has_trivial_assign(T) || ::geofeatures_boost::move_detail::is_pod<T>::value)
#   define BOOST_MOVE_HAS_TRIVIAL_DESTRUCTOR(T)    (__has_trivial_destructor(T) || ::geofeatures_boost::move_detail::is_pod<T>::value)
#   define BOOST_MOVE_HAS_NOTHROW_CONSTRUCTOR(T)   (__has_nothrow_constructor(T) || ::geofeatures_boost::move_detail::is_trivially_default_constructible<T>::value)
#   define BOOST_MOVE_HAS_NOTHROW_COPY(T)          (__has_nothrow_copy(T) || ::geofeatures_boost::move_detail::is_trivially_copy_constructible<T>::value)
#   define BOOST_MOVE_HAS_NOTHROW_ASSIGN(T)        (__has_nothrow_assign(T) || ::geofeatures_boost::move_detail::is_trivially_copy_assignable<T>::value)

#   define BOOST_MOVE_IS_ENUM(T) __is_enum(T)
#   if defined(_MSC_VER) && (_MSC_VER >= 1700)
#       define BOOST_MOVE_HAS_TRIVIAL_MOVE_CONSTRUCTOR(T)   (__has_trivial_move_constructor(T) || ::geofeatures_boost::move_detail::is_pod<T>::value)
#       define BOOST_MOVE_HAS_TRIVIAL_MOVE_ASSIGN(T)        (__has_trivial_move_assign(T) || ::geofeatures_boost::move_detail::is_pod<T>::value)
#   endif
#endif
...
#     define BOOST_MOVE_HAS_TRIVIAL_COPY(T) (__has_trivial_copy(T) && ::geofeatures_boost::move_detail::is_copy_constructible<T>::value)
#   endif
...
#ifdef BOOST_INTEL
#  define BOOST_MOVE_INTEL_TT_OPTS || ::geofeatures_boost::move_detail::is_pod<T>::value
#else
...
//Fallback definitions
   ...
   #define BOOST_MOVE_IS_POD_IMPL(T) (::geofeatures_boost::move_detail::is_scalar<T>::value ||\
                                      ::geofeatures_boost::move_detail::is_void<T>::value   ||\
                                       BOOST_MOVE_IS_POD(T))
#else
   #define BOOST_MOVE_IS_POD_IMPL(T) \
      (::geofeatures_boost::move_detail::is_scalar<T>::value || ::geofeatures_boost::move_detail::is_void<T>::value)
#endif

#ifdef BOOST_MOVE_IS_EMPTY
   #define BOOST_MOVE_IS_EMPTY_IMPL(T) BOOST_MOVE_IS_EMPTY(T)
#else
   #define BOOST_MOVE_IS_EMPTY_IMPL(T)    ::geofeatures_boost::move_detail::is_empty_nonintrinsic<T>::value
#endif

#ifdef BOOST_MOVE_HAS_TRIVIAL_COPY
   #define BOOST_MOVE_IS_TRIVIALLY_COPY_CONSTRUCTIBLE(T)   BOOST_MOVE_HAS_TRIVIAL_COPY(T)
#else
   #define BOOST_MOVE_IS_TRIVIALLY_COPY_CONSTRUCTIBLE(T)   ::geofeatures_boost::move_detail::is_pod<T>::value
#endif
...
#else
   #define BOOST_MOVE_IS_TRIVIALLY_DEFAULT_CONSTRUCTIBLE(T)  ::geofeatures_boost::move_detail::is_pod<T>::value
#endif
...
#else
   #define BOOST_MOVE_IS_TRIVIALLY_MOVE_CONSTRUCTIBLE(T)   ::geofeatures_boost::move_detail::is_pod<T>::value
#endif

#ifdef BOOST_MOVE_HAS_TRIVIAL_ASSIGN
   #define BOOST_MOVE_IS_TRIVIALLY_COPY_ASSIGNABLE(T) BOOST_MOVE_HAS_TRIVIAL_ASSIGN(T)
#else
   #define BOOST_MOVE_IS_TRIVIALLY_COPY_ASSIGNABLE(T) ::geofeatures_boost::move_detail::is_pod<T>::value
#endif
...
#else
   #define BOOST_MOVE_IS_TRIVIALLY_MOVE_ASSIGNABLE(T)  ::geofeatures_boost::move_detail::is_pod<T>::value
#endif

#ifdef BOOST_MOVE_HAS_TRIVIAL_DESTRUCTOR
   #define BOOST_MOVE_IS_TRIVIALLY_DESTRUCTIBLE(T)   BOOST_MOVE_HAS_TRIVIAL_DESTRUCTOR(T)
#else
   #define BOOST_MOVE_IS_TRIVIALLY_DESTRUCTIBLE(T)   ::geofeatures_boost::move_detail::is_pod<T>::value
#endif
...
#else
   #define BOOST_MOVE_IS_NOTHROW_DEFAULT_CONSTRUCTIBLE(T)  ::geofeatures_boost::move_detail::is_pod<T>::value
#endif

#ifdef BOOST_MOVE_HAS_NOTHROW_COPY
   #define BOOST_MOVE_IS_NOTHROW_COPY_CONSTRUCTIBLE(T)   BOOST_MOVE_HAS_NOTHROW_COPY(T)
#else
   #define BOOST_MOVE_IS_NOTHROW_COPY_CONSTRUCTIBLE(T)   ::geofeatures_boost::move_detail::is_pod<T>::value
#endif

#ifdef BOOST_MOVE_HAS_NOTHROW_MOVE
   #define BOOST_MOVE_IS_NOTHROW_MOVE_CONSTRUCTIBLE(T)   BOOST_MOVE_HAS_NOTHROW_MOVE(T)
#else
   #define BOOST_MOVE_IS_NOTHROW_MOVE_CONSTRUCTIBLE(T)   ::geofeatures_boost::move_detail::is_pod<T>::value
#endif

#ifdef BOOST_MOVE_HAS_NOTHROW_ASSIGN
   #define BOOST_MOVE_IS_NOTHROW_COPY_ASSIGNABLE(T) BOOST_MOVE_HAS_NOTHROW_ASSIGN(T)
#else
   #define BOOST_MOVE_IS_NOTHROW_COPY_ASSIGNABLE(T) ::geofeatures_boost::move_detail::is_pod<T>::value
#endif
...
#else
   #define BOOST_MOVE_IS_NOTHROW_MOVE_ASSIGNABLE(T) ::geofeatures_boost::move_detail::is_pod<T>::value
#endif

#ifdef BOOST_MOVE_IS_ENUM
   #define BOOST_MOVE_IS_ENUM_IMPL(T)   BOOST_MOVE_IS_ENUM(T)
#else
   #define BOOST_MOVE_IS_ENUM_IMPL(T)   ::geofeatures_boost::move_detail::is_enum_nonintrinsic<T>::value
#endif
...
template <> struct make_unsigned_impl< ::geofeatures_boost::long_long_type >  {  typedef ::geofeatures_boost::ulong_long_type type; };
#endif
...
#ifdef BOOST_HAS_LONG_LONG
template<> struct is_integral_cv< ::geofeatures_boost:: long_long_type>{  static const bool value = true; };
template<> struct is_integral_cv< ::geofeatures_boost::ulong_long_type>{  static const bool value = true; };
#endif
...
struct is_copy_constructible
{
   ...
   // static yes_type test(U&, decltype(U(geofeatures_boost::declval<U&>()))* = 0);
   //                                                        ^ 
...
//
// error: function *function_name* cannot be referenced -- it is a deleted function
// static geofeatures_boost::type_traits::yes_type test(T1&, decltype(T1(geofeatures_boost::declval<T1&>()))* = 0);
//                                                        ^ 
//
// MSVC 12.0 (Visual 2013) has problems when the copy constructor has been deleted. See:
// https://connect.microsoft.com/VisualStudio/feedback/details/800328/std-is-copy-constructible-is-broken
...
struct is_trivially_copy_constructible
{
   ...
   static const bool value = ::geofeatures_boost::move_detail::is_pod<T>::value ||
                             ( ::geofeatures_boost::move_detail::is_copy_constructible<T>::value &&
...
struct is_trivially_copy_assignable
{
   ...
   //deleted copy constructors so make sure the type is copy constructible.
   static const bool value = ::geofeatures_boost::move_detail::is_pod<T>::value ||
                             ( ::geofeatures_boost::move_detail::is_copy_assignable<T>::value &&
...
union max_align
{
   ...
   long        long_;
   #ifdef BOOST_HAS_LONG_LONG
   ::geofeatures_boost::long_long_type   long_long_;
   #endif
   float       float_;
   double      double_;
   void *      void_ptr_;
...
#define BOOST_MOVE_ALIGNED_NEXT_STEP(TYPE, NEXT_TYPE)\
   ...
   #ifdef BOOST_HAS_LONG_LONG
      BOOST_MOVE_ALIGNED_NEXT_STEP(::geofeatures_boost::long_long_type, double)
      BOOST_MOVE_ALIGNED_NEXT_STEP(long, ::geofeatures_boost::long_long_type)
   #else
