...
# if defined(BOOST_HAS_LONG_LONG)
  template <> struct Integer< ::geofeatures_boost::long_long_type> {};
  template <> struct Integer< ::geofeatures_boost::ulong_long_type> {};
...
# if defined(BOOST_HAS_LONG_LONG)
  template <> struct SignedInteger< ::geofeatures_boost::long_long_type> {};
# elif defined(BOOST_HAS_MS_INT64)
...
# if defined(BOOST_HAS_LONG_LONG)
  template <> struct UnsignedInteger< ::geofeatures_boost::ulong_long_type> {};
# elif defined(BOOST_HAS_MS_INT64)
...
#define BOOST_DEFINE_BINARY_OPERATOR_CONSTRAINT(OP,NAME)    \
  ...
  BOOST_concept(Generator,(Func)(Return))
  {
   ...
   private:
      void test(geofeatures_boost::mpl::false_)
      {
      ...
      void test(geofeatures_boost::mpl::true_)
      {
          f();
      }
  ...
  BOOST_concept(UnaryFunction,(Func)(Return)(Arg))
  {
   ...
   private:
      ...
      // (warning: non-static reference "const double& geofeatures_boost::UnaryFunction<YourClassHere>::arg"
  ...
  BOOST_concept(BinaryFunction,(Func)(Return)(First)(Second))
  {
   ...
   private:
      ...
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a refence type.
      // (warning: non-static reference "const double& geofeatures_boost::BinaryFunction<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
      BinaryFunction();
#endif
  ...
  BOOST_concept(UnaryPredicate,(Func)(Arg))
  {
   ...
   private:
      ...
      // Declare a dummy constructor to make gcc happy.
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a refence type.
      // (warning: non-static reference "const double& geofeatures_boost::UnaryPredicate<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
      UnaryPredicate();
#endif
  ...
  BOOST_concept(BinaryPredicate,(Func)(First)(Second))
  {
   ...
   private:
      ...
      // Declare a dummy constructor to make gcc happy.
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a refence type.
      // (warning: non-static reference "const double& geofeatures_boost::BinaryPredicate<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
      BinaryPredicate();
#endif
    Func f;
    ...
    : BinaryPredicate<Func, First, Second>
  {
   ...
   private:
    void const_constraints(const Func& fun) {
      ...
      // Declare a dummy constructor to make gcc happy.
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a refence type.
      // (warning: non-static reference "const double& geofeatures_boost::Const_BinaryPredicate<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
  ...
  {
      typedef typename geofeatures_boost::detail::iterator_traits<TT>::value_type value_type;
      typedef typename geofeatures_boost::detail::iterator_traits<TT>::difference_type difference_type;
      typedef typename geofeatures_boost::detail::iterator_traits<TT>::reference reference;
      typedef typename geofeatures_boost::detail::iterator_traits<TT>::pointer pointer;
      typedef typename geofeatures_boost::detail::iterator_traits<TT>::iterator_category iterator_category;
    ...
    , Comparable<TT>
  {
   ...
   private:
    TT a, b;
    TT i, j;
      typename geofeatures_boost::detail::iterator_traits<TT>::difference_type n;
  };
    ...
    : AssociativeContainer<C>
  {
      BOOST_CONCEPT_USAGE(SimpleAssociativeContainer)
      {
          typedef typename C::key_type key_type;
          typedef typename C::value_type value_type;
          BOOST_MPL_ASSERT((geofeatures_boost::is_same<key_type,value_type>));
      }
  };
    ...
    : AssociativeContainer<C>
  {
      BOOST_CONCEPT_USAGE(PairAssociativeContainer)
      {
          ...
          BOOST_MPL_ASSERT((geofeatures_boost::is_same<value_type,required_value_type>));
      }
  };
  ...
  BOOST_concept(Collection,(C))
  {
      ...
      {
        geofeatures_boost::function_requires<geofeatures_boost::InputIteratorConcept<iterator> >();
        geofeatures_boost::function_requires<geofeatures_boost::InputIteratorConcept<const_iterator> >();
        geofeatures_boost::function_requires<geofeatures_boost::CopyConstructibleConcept<value_type> >();
        const_constraints(c);
        i = c.begin();
        i = c.end();
        c.swap(c);
