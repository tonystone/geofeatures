...
};  // geofeatures_boost::integer::gcd_evaluator
...
};  // geofeatures_boost::integer::lcm_evaluator
...
#define BOOST_PRIVATE_GCD_UF( Ut )                  \
    ...
    BOOST_PRIVATE_GCD_UF( geofeatures_boost::ulong_long_type );
...
#ifdef BOOST_HAS_LONG_LONG
    BOOST_PRIVATE_GCD_SF( geofeatures_boost::long_long_type, geofeatures_boost::ulong_long_type );
#elif defined(BOOST_HAS_MS_INT64)
