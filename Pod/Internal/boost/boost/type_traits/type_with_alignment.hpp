...
#define BOOST_TT_ALIGNMENT_BASE_TYPES BOOST_PP_TUPLE_TO_LIST( \
        12, ( \
        char, short, int, long,  ::geofeatures_boost::long_long_type, float, double, long double \
...
#define BOOST_TT_HAS_ONE_T(D,Data,T) geofeatures_boost::detail::has_one_T< T >
...
struct is_pod< ::geofeatures_boost::detail::lower_alignment<Align> >
{
...
{
    typedef ::geofeatures_boost::detail::lower_alignment<Align> t1;
    typedef typename mpl::if_c<
          ::geofeatures_boost::detail::is_aligned< ::geofeatures_boost::alignment_of<t1>::value,Align >::value
        , t1
        , ::geofeatures_boost::detail::max_align
        >::type align_t;
...
class type_with_alignment 
  : public ::geofeatures_boost::detail::type_with_alignment_imp<Align>
{
};
...
namespace detail {
BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod,::geofeatures_boost::tt_align_ns::a2,true)
BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod,::geofeatures_boost::tt_align_ns::a4,true)
BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod,::geofeatures_boost::tt_align_ns::a8,true)
BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod,::geofeatures_boost::tt_align_ns::a16,true)
BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod,::geofeatures_boost::tt_align_ns::a32,true)
BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod,::geofeatures_boost::tt_align_ns::a64,true)
BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod,::geofeatures_boost::tt_align_ns::a128,true)
}
#endif
...
{ 
   typedef mpl::if_c<
      ::geofeatures_boost::alignment_of<geofeatures_boost::detail::max_align>::value < 8,
      tt_align_ns::a8,
      geofeatures_boost::detail::type_with_alignment_imp<8> >::type t1; 
public: 
...
{ 
   typedef mpl::if_c<
      ::geofeatures_boost::alignment_of<geofeatures_boost::detail::max_align>::value < 16,
      tt_align_ns::a16,
      geofeatures_boost::detail::type_with_alignment_imp<16> >::type t1; 
public: 
   typedef t1::type type;
};
...
{ 
   typedef mpl::if_c<
      ::geofeatures_boost::alignment_of<geofeatures_boost::detail::max_align>::value < 32,
      tt_align_ns::a32,
      geofeatures_boost::detail::type_with_alignment_imp<32> >::type t1; 
public: 
   typedef t1::type type;
};
template<> class type_with_alignment<64> {
   typedef mpl::if_c<
      ::geofeatures_boost::alignment_of<geofeatures_boost::detail::max_align>::value < 64,
      tt_align_ns::a64,
      geofeatures_boost::detail::type_with_alignment_imp<64> >::type t1; 
public: 
   typedef t1::type type;
};
template<> class type_with_alignment<128> {
   typedef mpl::if_c<
      ::geofeatures_boost::alignment_of<geofeatures_boost::detail::max_align>::value < 128,
      tt_align_ns::a128,
      geofeatures_boost::detail::type_with_alignment_imp<128> >::type t1; 
public: 
   typedef t1::type type;
};
...
typedef ::geofeatures_boost::tt_align_ns::a16 max_align;
