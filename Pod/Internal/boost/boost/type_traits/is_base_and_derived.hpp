...
{
    BOOST_STATIC_CONSTANT(bool, value =
        (::geofeatures_boost::is_convertible<D*,B*>::value));
};
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::geofeatures_boost::is_class<B>::value,
       ::geofeatures_boost::is_class<D>::value,
       ::geofeatures_boost::is_same<ncvB,ncvD>::value> selector;
...
struct is_base_and_derived_impl
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = (BOOST_IS_BASE_OF(B,D) && ! ::geofeatures_boost::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(
    ...
    , Base
    , Derived
    , (::geofeatures_boost::detail::is_base_and_derived_impl<Base,Derived>::value)
    )
