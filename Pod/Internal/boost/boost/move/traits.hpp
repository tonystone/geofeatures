...
struct has_trivial_destructor_after_move
   : ::geofeatures_boost::move_detail::is_trivially_destructible<T>
{};

//! By default this traits returns
//! <pre>geofeatures_boost::is_nothrow_move_constructible<T>::value && geofeatures_boost::is_nothrow_move_assignable<T>::value </pre>.
//! Classes with non-throwing move constructor
//! and assignment can specialize this trait to obtain some performance improvements.
template <class T>
struct has_nothrow_move
{
   static const bool value = geofeatures_boost::move_detail::is_nothrow_move_constructible<T>::value &&
                             geofeatures_boost::move_detail::is_nothrow_move_assignable<T>::value;
};
