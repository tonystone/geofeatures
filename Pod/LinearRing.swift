...
/**
 LinearRing
 */
public struct LinearRing: LinearType {
...
extension LinearRing : GeometryType {
...
extension LinearRing {
    ...
    mutating   public func appendContentsOf<C : CollectionType where C.Generator.Element == Element>(newElements: C) {
